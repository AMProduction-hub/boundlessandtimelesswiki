...
## 📜 Standard 5e Rules (Quick Reminder)
...
## ⚔️ House Rule: Persistent Death Save Failures
...
{{< hint danger >}}
**💀 If all 3 Failure slots are marked:** The next time you drop to 0 HP, **you die instantly** with no Death Saving Throws.
{{< /hint >}}

---

## 🛡️ Recovering Failure Slots: Safe Spots
...
{{< hint info >}}
**🏕️ Safe Spots** are clearly marked by the DM. When in doubt, ask: "Is this location safe enough for full recovery?"
{{< /hint >}}

### Full Recovery

When you complete a **Long Rest at a Safe Spot**:
- ✅ All HP restored (as normal)
- ✅ All spell slots restored (as normal)
- ✅ All hit dice restored (as normal)
- ✅ **All Death Save Failure slots cleared**

---

## 📊 Tracking Your Death Save Status

Keep track of your Death Save status on your character sheet:

**Death Save Failures:**
```
○ ○ ○  (All clear - fresh character)
☒ ○ ○  (1 failure marked)
☒ ☒ ○  (2 failures marked - getting dangerous!)
☒ ☒ ☒  (3 failures marked - next time you drop, you're DEAD)
```
...
**Situation:** Kairos has 2 failures marked (☒ ☒ ○) from a previous fight
- Party reaches a Safe Spot (friendly temple)
- Kairos takes a Long Rest
- **All failure slots cleared** (○ ○ ○)
- **Status:** Fully recovered

### Example 3: The Final Stand
**Situation:** Minerva has 3 failures marked (☒ ☒ ☒)
...
These persistent wounds aren't just mechanical—they're story opportunities:
...
**3 Failures Marked:**
> *"You're living on borrowed time. One more mistake, one more moment of carelessness, and it's over. The others see it in your eyes—the shadow of mortality."*
...
{{< hint tip >}}
**🏥 Survival Tip:** Always know where the nearest Safe Spot is. Mark them on your map. They might save your life!
{{< /hint >}}

---

*Death is not the end—but it's closer than you think.*