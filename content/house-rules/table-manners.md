...
{{< hint tip >}}
**At the Table**: Keep the game moving—trust the GM's ruling.  
**After the Session**: Discuss rules interpretations respectfully if needed.
{{< /hint >}}
...
2. 🎭 **Let others have their moment** — don't interrupt
3. 🎬 **Match the campaign's tone** and style
4. 🛡️ **Respect everyone's boundaries** and safety tools
5. 📖 **Trust the GM's rulings** during play
6. 🤐 **Give feedback privately**, not through comparisons
7. 🤝 **Work together** to create a fun experience for everyone
