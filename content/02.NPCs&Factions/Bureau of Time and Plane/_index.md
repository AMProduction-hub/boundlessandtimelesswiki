...
```mermaid
graph TD;
    Awanama["Leader (Awanama)"] -->|Mengawasi| Pustakawan["Second-in-Command"]
    Pustakawan -->|Mengelola Operasi| Shaperite["Senior Field Agent"]
    Shaperite -->|Membimbing Agen Baru| Agent["Field Agents"]
    Agent -->|Menjalankan Misi| Contractors["Contractors (Termasuk Pemain)"]
```
...
- **[[Pustakawan - Second-in-Command|Second-in-Command]]:**
