...
**Party Members**:
- [Kairos]({{< relref "/campaigns/boundless-and-timeless/player-characters/kairos" >}})
- [Froggo]({{< relref "/campaigns/boundless-and-timeless/player-characters/froggo" >}})
- [Minerva]({{< relref "/campaigns/boundless-and-timeless/player-characters/minerva" >}})
- [Sephire]({{< relref "/campaigns/boundless-and-timeless/player-characters/sephire" >}})
- [Asep]({{< relref "/campaigns/boundless-and-timeless/player-characters/asep" >}})
- [Verdian Suyanti]({{< relref "/campaigns/boundless-and-timeless/player-characters/verdian-suyanti" >}})
...
{{< hint tip >}}
**Sessions are listed newest to oldest** - Scroll down to see earlier adventures!
{{< /hint >}}
