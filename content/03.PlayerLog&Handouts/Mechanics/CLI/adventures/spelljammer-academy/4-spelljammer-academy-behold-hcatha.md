...
![](036-03-001-sja-04-splash.webp#center)
...
![](037-03-002-bag-of-holdingh.webp#center)
...
![](038-03-003-boatswain-tarto.webp#center)
...
![](039-03-004-sarthe-abizjn.webp#center)
...
Characters can easily ascertain where the meteorite came to rest after tumbling down the mountainside. However, the meteorite is nowhere to be seen. Characters who search the area find a single set of tracks leading from the place where the meteorite came to rest to a 15-foot-wide, 20-foot-high cave mouth at the base of the Spindle, about 250 feet away. Any character who examines the tracks and succeeds on a DC 10 Wisdom ([Survival](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Survival)) check identifies them as belonging to a Large Giant of some kind, possibly an [ogre](ogre.md).
...
![Spindle Cavern Map](040-03-009-spindle-cavern.webp#center)
...
- **Meteorite.** The meteorite looks like it was dropped in the middle of the floor. The 500-pound hunk of blackened metal takes on a dark-blue sheen when its surface is illuminated. The meteorite is 2 feet long, 18 inches wide, and 18 inches tall. It can fit inside the characters' [bag of holding](bag-of-holding.md).  

#### Creatures

Two [spectators](spectator.md) and six [gazers](gazer-mpmm.md) gather around the meteorite. The spectators can't decide which of them should guard the meteorite, and they are anxious for someone to help resolve their dispute. The gazers were drawn to the cavern by the spectators' argument but lack the intelligence to be of assistance. The cyclopean [ogre](ogre.md) is a simple-minded brute who found the meteorite and brought it here. The ogre serves a powerful beholder named Kurrzot who, fortunately, lives much deeper in the mountain and doesn't appear in this adventure.
...
![](041-03-005-orlob-spectator.webp#center)
...
Once they've bagged the meteorite, the characters can use their [sending stone](sending-stones.md) to contact Boatswain Tarto, or they can simply head back to the tyrant ship. If they use the stone, Tarto replies as follows:
...
The characters have no encounters on their way back to the tyrant ship. Once they climb the rope ladder and get back aboard, Boatswain Tarto takes back the characters' *sending stone* as well as the [bag of holding](bag-of-holding.md).
...
Attempting to hide behind the asteroid is a damselfly ship crewed by githyanki. Characters who succeed on a DC 18 Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) check can see a brief glint suggestive of a metallic vessel moments before it disappears behind the asteroid.
...
Qitru, a [githyanki warrior](githyanki-warrior.md), rides a star lancer. The star lancer used Invisibility Cloak to approach the tyrant ship unseen.
...
![](042-03-006-star-lancer.webp#center)
...
If a character uses the [sending stone](sending-stones.md) to request help from Boatswain Tarto, she says, "I'll be right there!" and heads to the Hollow Deck. Tarto is armed with a musket (+7 to hit) that deals `1d12 + 3` piercing damage on a hit.
...
Characters who search Qitru or observe her closely notice a strange sigil tattooed on the back of her right hand. A [detect magic](detect-magic.md) spell reveals an aura of transmutation magic around the tattoo. The tattoo is Vocath's sigil, worn by those who are closest to the mercane.
...
The damselfly ship has a crew of four [giff shipmates](giff-shipmate-bam.md) and four [githyanki warriors](githyanki-warrior.md) (not including Qitru). As the tyrant ship moves away from the asteroid, the damselfly's canny giff captain, Mustaf Shultz, instructs the ship's spelljammer, a githyanki named Nalvoor, to follow the tyrant ship to Toril while keeping a safe distance.
...
The characters aren't allowed to attend the senior staff briefing or see Miken, who is confined to his quarters. Two [veterans](veteran.md) stand guard outside Miken's room, the door to which has an [arcane lock](arcane-lock.md) spell cast on it.
...
The two [giff shipmates](giff-shipmate-bam.md) have orders to secure the *Flighty Foundling* while an extraction team retrieves Miken, dead or alive. The giff give the characters a chance to flee the vessel. If the characters stand their ground, the giff hurl grenades at them before closing to melee range.
...
> [!gallery]
> ![Hammerhead Ship Map](043-map-3-02-hammerhead.webp#gallery)
> ![Player Version](044-map-3-02-hammerhead-player.webp#gallery)
...
This area is brightly lit by [continual flame](continual-flame.md) spells cast on wall sconces.
...
![](045-03-007-githyanki-warrior.webp#center)

#### Creatures

Two wounded [githyanki warriors](githyanki-warrior.md) (each with 30 hit points remaining) have Miken (an [apprentice wizard](apprentice-wizard-mpmm.md) with 2 hit points remaining and at-will spells only) in custody. The githyanki are heading toward the *Flighty Foundling* when the characters intercept them. The githyanki don't bother engaging in dialogue. One of them [grapples](actions.md#Grapple) Miken while the other one attacks.
...
Wizpop is a noncombatant but has found his courage and wants to help in this dire situation. The characters might have him go to get additional help or cause a distraction. If he goes to find help, a few rounds later he returns with two guards (use the [veteran](veteran.md) stat block) to aid in the fight.
...
The two [githyanki warriors](githyanki-warrior.md) (each with 30 hit points remaining) have Miken (an [apprentice wizard](apprentice-wizard-mpmm.md) with 2 hit points remaining and at-will spells only) in custody. One of them grapples Miken while the other one uses [misty step](misty-step.md) to board the ship and attack.
...
![](046-03-008-star-moth-splash.webp#center)
...
> [!gallery]
> ![Spelljammer Academy Handout](047-map-1-01-spelljammer-academy.webp#gallery)