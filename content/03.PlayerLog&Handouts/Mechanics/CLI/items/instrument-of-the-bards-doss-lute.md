...
![](instrument-of-the-bards-doss-lute.webp#right)
...
In addition, the Doss lute can be used to cast [animal friendship](animal-friendship.md), [protection from energy](protection-from-energy.md) (fire only), and [protection from poison](protection-from-poison.md).
