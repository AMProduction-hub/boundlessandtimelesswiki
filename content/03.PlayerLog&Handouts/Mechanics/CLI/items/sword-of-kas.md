...
While the sword is on your person, you can use an action to cast one of the following spells (save 18) from it: [call lightning](call-lightning.md), [divine word](divine-word.md), or [finger of death](finger-of-death.md). Once you use the sword to cast a spell, you can't cast that spell again from it until the next dawn.

## Sentience

The Sword of Kas is a sentient chaotic evil weapon with an Intelligence of 15, a Wisdom of 13, and a Charisma of 16. It has hearing and [darkvision](senses.md#Darkvision) out to a range of 120 feet.
...
The Sword of Kas also seeks to destroy anyone corrupted by the Eye and [Hand of Vecna](hand-of-vecna.md). The sword's obsession with those artifacts eventually becomes a fixation for its wielder.

## Destroying the Sword

A creature attuned to both the [Eye of Vecna](eye-of-vecna.md) and the [Hand of Vecna](hand-of-vecna.md) can use the wish property of those combined artifacts to unmake the Sword of Kas. The creature must cast the [wish](03.PlayerLog&Handouts/Mechanics/CLI/spells/wish.md) spell and make a Charisma check contested by the Charisma check of the sword. The sword must be within 30 feet of the creature, or the spell fails. If the sword wins the contest, nothing happens, and the [wish](03.PlayerLog&Handouts/Mechanics/CLI/spells/wish.md) spell is wasted. If the sword loses the contest, it is destroyed.
