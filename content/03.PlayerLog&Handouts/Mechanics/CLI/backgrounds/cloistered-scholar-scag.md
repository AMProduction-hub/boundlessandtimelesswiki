...
- **Equipment.** The scholar's [robes](robes.md) of your cloister, a writing kit (small [pouch](pouch.md) with a quill, ink, folded parchment, and a small penknife), a borrowed [book](book.md) on the subject of your current study, and a [pouch](pouch.md) containing 10 gp  
...
Use the tables for the [sage](sage.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a cloistered scholar.
