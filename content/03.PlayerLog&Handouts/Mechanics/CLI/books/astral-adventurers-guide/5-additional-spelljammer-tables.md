...
| dice: d12 | Cargo |
|-----------|-------|
| 1 | Trunk containing ten outfits of [traveler's clothes](travelers-clothes.md) (2 gp each) |
...
| 10 | Chest containing fifty [vials of perfume](perfume-vial.md) (2 gp each) |
...
| dice: d12 | Cargo |
|-----------|-------|
| 1 | Crate containing fifty blank [spellbooks](spellbook.md) (50 gp each) |
| 2 | Crate containing one hundred [1-ounce bottles of ink](ink-1-ounce-bottle.md) (10 gp each) and one thousand sheets of [parchment](parchment-one-sheet.md) (1 sp each) |
| 3 | Crate containing twenty [potions of healing](potion-of-healing.md), [flasks of alchemist's fire](alchemists-fire-flask.md), or [vials of antitoxin](antitoxin-vial.md) (50 gp each) |
| 4 | Crate containing one hundred bottles of exquisite wine (25 gp each) |
| 5 | Set of exquisitely crafted furniture (2,500 gp) |
| 6 | Locked trunk containing five unloaded [pistols](pistol.md) (250 gp each) and a box of 100 bullets |
| 7 | Locked case containing an exquisite Dragonchess set made of crystal or ivory (2,500 gp) |
| 8 | Locked trunk containing ten [bombs](bomb.md) (150 gp each; see ""Explosives"" in the "Dungeon Master's Guide") |
| 9 | Crate containing one hundred fireworks (25 gp each) |
| 10 | Crate containing five unloaded [muskets](musket.md) (500 gp each) and a box of 100 bullets |
| 11 | Locked case containing five [spyglasses](spyglass.md) (1,000 gp each) |
| 12 | Ten 20-pound [kegs of gunpowder](gunpowder-keg.md) (250 gp each; see ""Explosives"" in the "Dungeon Master's Guide") |
^expensive-cargo