...
![There's only one rule on t...](067-03-001-rock-of-bral-splash.webp#center "There's only one rule on the Rock of Bral: leave your vendettas at the docks")
...
Serious crimes, such as arson, can be reported to one of the city's three magistrates, who preside over the Low City, the Middle City, and the High City, respectively. If the magistrate concludes that the situation warrants their attention, the Magistrate's Watch is dispatched to investigate and take offenders into custody, if necessary. Most members of the Magistrate's Watch use the [veteran](veteran.md) stat block.
...
![Elmandar's Star Charts is ...](068-03-002-elmandar-star-charts.webp#center "Elmandar's Star Charts is run by a retired elf adventurer who once served as the spelljammer aboard a space galleon called the Eclipse (shown here as a model)")
...
One of the largest and busiest taverns in Bral is the Edge, an establishment that's popular among space travelers visiting the Rock. A chatty, philosophical [thri-kreen mystic](thri-kreen-mystic-bam.md) (see "Boo's Astral Menagerie") named Vikka tends bar.
...
This prosperous tavern is owned and run by Large Luigi, a locally famous, lawful neutral [beholder](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/beholder.md). Luigi has encyclopedic knowledge of all sorts of topics, and he's more than happy to share information with just about anybody. He is a civic-minded, well-liked citizen who has no political ambitions. His tavern is rarely troubled by bullies or thieves.

![Large Luigi, the proprieto...](069-03-003-large-luigi-splash.webp#center "Large Luigi, the proprietor of the Happy Beholder, is delighted to meet new patrons")
...
[Mercanes](mercane-bam.md) (see "Boo's Astral Menagerie") recently established a presence on the Rock by taking over an unmarked, inconspicuous building near the Lesser Market. The place is occupied by a small staff of agents who act as an intermediary between the mercanes and those who want to do business with them. Such business typically involves the purchase of [spelljamming helms](spelljamming-helm-aag.md) and other magic items.
