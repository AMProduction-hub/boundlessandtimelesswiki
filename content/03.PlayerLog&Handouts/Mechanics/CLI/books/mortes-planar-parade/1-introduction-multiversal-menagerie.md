...
Planar travelers often find [mimirs](mimir-sato.md) invaluable in learning about reality and avoiding doom at the hands, claws, fangs, tentacles, proboscises, ovipositors, and other appendages of the multiverse's countless predatory and lethally grumpy inhabitants.

![Creatures from every corne...](000-00-001-sigil-busy.webp#center "Creatures from every corner of the multiverse crowd Sigil's busy streets")

[Morte](morte-tofw.md), however, isn't a [mimir](mimir-sato.md).
...
![Sunflies influenced by var...](001-00-002-sunfly-side.webp#center "Sunflies influenced by various Outer Planes inhabit every corner of the Outlands")
...
> 
> **Soul Shape.** A dead petitioner can be returned to life only by the [true resurrection](true-resurrection.md) spell or the [wish](03.PlayerLog&Handouts/Mechanics/CLI/spells/wish.md) spell. If affected by these spells, a petitioner chooses whether to return in its original mortal form or as a petitioner.
^005
...
> 
> **Poison Tolerant.** The creature has advantage on saving throws it makes to avoid or end the [poisoned](conditions.md#Poisoned) condition on itself.
> 
...
> [!note] 
> 
> **Battle Lust.** Whenever the creature reduces another creature to 0 hit points with a melee attack on its turn, it gains 10 "temporary hit points", and it can take a bonus action to move up to its speed without provoking [opportunity attacks](actions.md#Opportunity%20Attack).
> 
...
> 
> **Pack Tactics.** The creature has advantage on an attack roll against a target if at least one of the creature's allies is within 5 feet of the target and the ally doesn't have the [incapacitated](conditions.md#Incapacitated) condition.
^011

![A Beastlands-influenced ex...](002-00-003-picnic.webp#center "A Beastlands-influenced explorer picnics with her animal friends in an idyllic glade")
...
> 
> **Unshakable Resolve.** An invisible, magical aura of confidence and hope surrounds the creature. When another creature that has the [frightened](conditions.md#Frightened) condition starts its turn within 5 feet of the creature, the [frightened](conditions.md#Frightened) condition affecting it is suppressed for 1 minute. When this suppression ends, the condition resumes if its duration hasn't expired.
^01a

### The Beastlands

Creatures influenced by the Beastlands gain wilder or more animalistic features, such as larger eyes, thicker fur, or more prominent canine teeth. Beasts influenced by the Beastlands are often affected per the [awaken](awaken.md) spell—though normal Beasts also typically range through these areas in large numbers. A creature influenced by the Beastlands also gains one or more of following traits of your choice:
...
> 
> **Tracker's Eye.** The creature can see [invisible](conditions.md#Invisible) creatures and objects as if they were visible.
> 
...
> [!note] 
> 
> **Hardy Body.** The creature no longer needs food or water, and the creature can have no more than 4 levels of [exhaustion](conditions.md#Exhaustion).
> 
...
![A unicorn influenced by Ge...](003-00-004-gehenna-unicorn.webp#center "A unicorn influenced by Gehenna charges through a pustuled forest")
...
> 
> **Larval Rebirth.** When the creature dies, it re-forms somewhere in Hades as a [larva](larva-dmg.md) (see the "Dungeon Master's Guide") in `1d10` days.
> 
...
> [!note] 
> 
> **Chaotic Magic.** The creature can cast the [thaumaturgy](thaumaturgy.md) cantrip, choosing a magical effect at random. Charisma is the spellcasting ability for this spell.
> 
...
> - **5–6.** Disrupted Gravity. Each creature within 20 feet of the creature must succeed on a DC 15 Constitution saving throw or rise vertically, up to 20 feet, and remain magically suspended there for 1 minute. While suspended in this way, a creature has the [restrained](conditions.md#Restrained) condition.  
> 
> **Hidden Slaad.** When the creature dies, a [slaad tadpole](slaad-tadpole.md) bursts from the creature's chest.
^039

![A night hag sells larvae f...](004-00-005-hag-larvae.webp#center "A night hag sells larvae fresh from the Lower Planes")
...
> 
> **Structural Repair (1/Day).** After being in continuous physical contact with a nonmagical object for 1 minute, the creature can magically repair the object as though it had cast a [mending](mending.md) spell on it.
^03e
...
![A gleaming wyvern imbued w...](005-00-006-gleaming-wyvern.webp#center "A gleaming wyvern imbued with the radiance of Mount Celestia navigates a crystalline cave")
...
> 
> **Viper Nest.** When the creature dies, its body disgorges a [swarm of poisonous snakes](swarm-of-poisonous-snakes.md) in the same space.
^046
...
> 
> **Ysgardian Stand (2/Day).** If the creature has the [prone](conditions.md#Prone) condition at the start of its turn, it can, at that time, end the [prone](conditions.md#Prone) condition on itself and stand up without expending any movement. The creature can't use this trait while it has the [incapacitated](conditions.md#Incapacitated) condition.
^04e
...
![Mechanical dinosaurs roam ...](006-00-007-mechanus-dinosaurs.webp#center "Mechanical dinosaurs roam an orderly realm influenced by the lawful energies of Mechanus")
...
![In a landscape warped by L...](007-00-008-limbo-madness.webp#center "In a landscape warped by Limbo's pure chaos, an animal-headed ettin fights a massive, many-eyed ooze")
...
![](008-00-017-morte-meet-dragon.webp#center)
