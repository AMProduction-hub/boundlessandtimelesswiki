...
Welcome to my GM portfolio and campaign resource hub! This site contains everything you need to know about my campaigns, house rules, and table expectations. Whether you're a current player or considering joining a future game, you'll find all the information you need here.
...
Past adventures that have concluded their stories:
...
A short Daggerheart system adventure exploring new mechanics!

---

## 🎯 My GMing Philosophy

**Player Agency First**: Your choices matter and shape the world.

**Rule of Cool**: If it's awesome and makes sense narratively, we'll make it work.

**Collaborative Storytelling**: We build the story together, not just me telling it to you.

**Meaningful Consequences**: Actions have weight, both good and bad.

**Fun Over Rules**: The rules serve the story, not the other way around.
...
### For Current Players
- **Session Notes**: Find recaps under your party's section
- **House Rules Reference**: Quick reference for rule modifications
- **Character Sheets**: Keep them updated in your party section
- **NPCs**: Track important NPCs and their relationships

---

{{< hint tip >}}
**Have Questions?** Don't hesitate to reach out! I'm always happy to clarify rules, discuss character concepts, or talk about the campaign.
{{< /hint >}}
