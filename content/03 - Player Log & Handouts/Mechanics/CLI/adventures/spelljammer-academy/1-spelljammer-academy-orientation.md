...
![](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/adventures/spelljammer-academy/img/000-01-001-o-sja01-splash.webp#center)
...
![Forecastle Map](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/adventures/spelljammer-academy/img/001-01-009-o-forecastle.webp#center)

### Fighting the Reavers

At the start of combat, place two astral reavers ([bandits](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md)) at the edge of the forecastle area. Don't roll initiative for these enemies. Instead, all reavers act at the end of the initiative order, after the characters have taken their turns. More reavers then appear during the round (see below).
...
| dice: d20 | Event |
|-----------|-------|
| 1–12 | A new astral reaver ([bandit](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md)) jumps into an unoccupied space within 30 feet of the character. |
| 13 | An explosion rocks the ship. Each creature on the deck must succeed on a DC 10 Dexterity saving throw or fall [prone](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Prone). |
...
| 16 | Loose rigging careens across the deck. Choose a character. That character must succeed on a DC 10 Dexterity ([Acrobatics](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/skills.md#Acrobatics)) check to grab the rigging and be safely flung to an unoccupied space within 40 feet of their current position. On a failure, they stay where they are and fall [prone](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Prone). |
...
The reavers are coal-hearted miscreants united only by the urge to raid and pillage. Each reaver has the statistics of a [bandit](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md) but has a unique appearance determined by the Astral Reavers table.
...
![](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/adventures/spelljammer-academy/img/002-01-002-o-boatswain-tarto.webp#center)
...
![Handout 2.1](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/adventures/spelljammer-academy/img/003-01-007-o-orientation-tasks.webp#center)
...
![Handout 2.2](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/adventures/spelljammer-academy/img/004-01-008-o-warning.webp#center)
...
Security checkpoints are set up throughout the academy, each guarded by three [veterans](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/humanoid/veteran.md). Each guard carries a shortsword that has a green-glowing blade. Any creature reduced to 0 hit points by one of these blades is instantly turned to dust, as if affected by a [disintegrate](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/disintegrate.md) spell. Such a sword loses its magical properties if removed from Spelljammer Academy.
...
| 5 | A manacled [mind flayer](mind-flayer.md) passes by on a gurney pushed by fleet officers. The mind flayer wears an iron mask with bands restraining its facial tentacles. |
...
> 
> The thri-kreen receptionist Sor'kur (pronounced SOAR-ker) is always busy, and there's no one better suited for the job. Whether she's sorting mail, passing messages, asking requests for assistance via several [sending stones](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/items/sending-stones.md), or handing out welcome packs to new recruits, her multiple arms make it all look easy. Sor'kur has white chitin mottled with patches of brilliant blue, and matching blue eyes.
> 
...
Veena is testing the new cadets. A character who succeeds on a DC 15 Charisma ([Intimidation](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/skills.md#Intimidation)) check can scare her and her friends away. Otherwise, the arrogant cadets are more than willing to use force to teach the upstart characters who's boss. Give "inspiration" to any character who overcomes the situation without resorting to violence.

Veena and the other cadets use the [bandit](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md) stat block but carry no weapons. Instead, they make unarmed attacks (+3 to hit, 2 bludgeoning damage on a hit). Anyone reduced to 0 hit points by such attacks is knocked [unconscious](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Unconscious) for 5 minutes but doesn't make death saving throws. Veena and her friends flee if they take 2 or more damage in total.
...
- Leap across levitating platforms over pools of electrified water, requiring a successful DC 10 Strength ([Athletics](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/skills.md#Athletics)) or Dexterity ([Acrobatics](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/skills.md#Acrobatics)) check.  
- Swing from ropes through a spinning wheel of maces, requiring a successful DC 12 Dexterity saving throw.  
- Climb a slippery pole and ring a gong at the top, requiring a successful DC 12 Strength ([Athletics](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/skills.md#Athletics)) check.  
...
Any character reduced to 0 hit points during the obstacle course falls [unconscious](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Unconscious) and must sit out the remainder of the event. Give inspiration to any character who successfully completes the course.
...
![](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/adventures/spelljammer-academy/img/005-01-003-o-sky-dock.webp#center)
...
![](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/adventures/spelljammer-academy/img/006-01-004-o-sarthe-abizjn.webp#center)
...
![](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/adventures/spelljammer-academy/img/007-01-005-o-mister-blip.webp#center)
...
![Mirt's Quarters](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/adventures/spelljammer-academy/img/008-01-010-o-mirts-quarters.webp#center)

#### Fishbowl

The fishbowl contains a number of tiny harmless octopuses. If the bowl is broken (it has AC 5, 2 hit points, and immunity to poison and psychic damage), each creature within 5 feet of the tank is knocked [prone](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Prone) and soaked through by the sudden outflow of water.
...
Mirt's leathery bed shifts and rocks, and close inspection reveals that it's filled with water. If the waterbed is damaged (it has AC 5, 3 hit points, and immunity to poison and psychic damage), each creature within 5 feet of it is knocked [prone](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Prone) and soaked through by the sudden outflow of water.
...
Eight [neogi hatchlings](neogi-hatchling-mpmm.md) emerge from hiding inside the crate, positioning themselves around it before combat begins. Each round, the hatchlings attack any characters they can reach. As Tiny creatures, two hatchlings can occupy a single 5-foot space if needed.
...
![](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/adventures/spelljammer-academy/img/009-01-006-o-neogi-hatchlings.webp#center)
...
> [!gallery]
> ![Spelljammer Academy](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/adventures/spelljammer-academy/img/010-map-1-01-spelljammer-academy.webp#gallery)
> ![Player Version](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/adventures/spelljammer-academy/img/011-map-1-01-spelljammer-academy-player.webp#gallery)