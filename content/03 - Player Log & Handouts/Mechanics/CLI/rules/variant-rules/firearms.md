...
It's up to you to decide whether a character has proficiency with a firearm. Characters in most D&D worlds wouldn't have such proficiency. During their downtime, characters can use the [training](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/variant-rules/downtime-activity-training.md) rules in the "Player's Handbook" to acquire proficiency, assuming that they have enough ammunition to keep the weapons working while mastering their use.
