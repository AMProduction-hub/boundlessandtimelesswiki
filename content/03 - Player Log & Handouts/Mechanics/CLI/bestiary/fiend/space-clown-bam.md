...
aliases: ["Space Clown"]
---
# [Space Clown](03 - Player Log & Handouts\Mechanics\CLI\bestiary\fiend/space-clown-bam.md)
...
- "desc": "The clown casts one of the following spells, requiring no material components\
    \ and using Charisma as the spellcasting ability:\n\nAt will: [friends](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/friends.md),\
...
- "desc": "The clown veils itself and everything it is wearing and carrying in an\
    ...
    \ as a floating balloon). Maintaining this effect requires the clown's [concentration](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Concentration)\
    \ (as if [concentrating](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Concentration)\
    \ on a spell), and the illusion fails to hold up to physical inspection. As an\
    \ action, a creature that can see the clown's illusory form can make a DC 15 Wisdom\
...
- "BAM"
- "LoX"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/fiend/token/space-clown-bam.webp"
```
^statblock