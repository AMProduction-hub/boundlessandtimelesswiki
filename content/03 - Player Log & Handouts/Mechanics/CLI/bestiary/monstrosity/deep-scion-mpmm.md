...
aliases: ["Deep Scion"]
---
# [Deep Scion](03 - Player Log & Handouts\Mechanics\CLI\bestiary\monstrosity/deep-scion-mpmm.md)
...
- "desc": "The deep scion emits a terrible scream audible within 300 feet. Creatures\
    ...
    \ until the end of the deep scion's next turn. In water, the psychic screech also\
    \ telepathically transmits the deep scion's memories of the last 24 hours to its\
    \ master, regardless of distance, so long as it and its master are in the same\
    \ body of water."
...
- "MPMM"
- "VGM"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/monstrosity/token/deep-scion-mpmm.webp"
```
^statblock
