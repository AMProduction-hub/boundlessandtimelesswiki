...
aliases: ["Bodak"]
---
# [Bodak](03 - Player Log & Handouts\Mechanics\CLI\bestiary\undead/bodak-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 64, Volo's Guide to Monsters p. 127, Sigil and the Outlands*  
...
- "desc": "When a creature that can see the bodak's eyes starts its turn within 30\
    ...
    \ throw if the bodak isn't [incapacitated](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
    \ and can see the creature. If the saving throw fails by 5 or more, the creature\
    \ is reduced to 0 hit points unless it is immune to the [frightened](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
...
- "VGM"
- "SatO"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/undead/token/bodak-mpmm.webp"
```
^statblock
