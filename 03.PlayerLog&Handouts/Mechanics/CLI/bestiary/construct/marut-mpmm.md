...
"actions":
  ...
  - "desc": "Arcane energy emanates from the marut's chest in a 60-foot cube. Every\
      ...
      \ of this damage must succeed on a DC 20 Wisdom saving throw or be [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned)\
      \ until the end of the marut's next turn."
    "name": "Blazing Edict (Recharge 5-6)"
  - "desc": "The marut casts [plane shift](03.PlayerLog&Handouts/Mechanics/CLI/spells/plane-shift.md),\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/token/marut-mpmm.webp"
```
^statblock