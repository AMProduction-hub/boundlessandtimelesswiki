...
"actions":
  - "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 6\
      ...
      \ creature is visible within 30 feet, it takes the [Dash](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Dash)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/token/clockwork-iron-cobra-mpmm.webp"
```
^statblock
