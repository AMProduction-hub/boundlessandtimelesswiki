...
A stone juggernaut is fast, but it lacks maneuverability and can move in only one direction on its turn. It poses little danger to creatures it can't crush beneath its rollers. Its best tactic is to slam into a creature, knock it [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone), and then roll over it.
...
"cr": "12"
"traits":
  - "desc": "The juggernaut can move through the space of a [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)\
  ...
  - "desc": "The juggernaut is immune to any spell or effect that would alter its\
      \ form."
    "name": "Immutable Form"
  - "desc": "As long as it has 1 hit point left, the juggernaut magically regains\
      \ all its hit points daily at dawn. The juggernaut is destroyed and doesn't\
      \ regenerate if it drops to 0 hit points."
    "name": "Regeneration"
...
"source":
  - "ToA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/token/stone-juggernaut-toa.webp"
```
^statblock