...
- Autognome
---
# [Autognome](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\construct/autognome-bam.md)
...
"traits":
  - "desc": "Whenever the autognome takes 15 damage or more from a single source and\
      ...
      \ autognome to be [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded)\
...
"source":
  - "BAM"
  - "LoX"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/token/autognome-bam.webp"
```
^statblock