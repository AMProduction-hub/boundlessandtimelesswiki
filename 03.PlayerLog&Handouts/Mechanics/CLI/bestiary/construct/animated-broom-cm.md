...
"traits":
  - "desc": "If the broom is motionless at the start of combat, it has advantage on\
      ...
      \ or act, that creature must succeed on a DC 15 Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
      \ check to discern that the broom is animate."
    "name": "False Object"
  - "desc": "The broom doesn't provoke opportunity attacks when it flies out of an\
      \ enemy's reach."
    "name": "Flyby"
"actions":
...
"source":
  - "CM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/token/animated-broom-cm.webp"
```
^statblock