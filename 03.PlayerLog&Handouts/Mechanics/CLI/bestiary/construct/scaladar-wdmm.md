...
"traits":
  - "desc": "Whenever the scaladar is subjected to lightning damage, it takes no damage,\
      \ and its sting deals an extra 11 (2d10) lightning damage until the end of\
      \ its next turn."
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/token/scaladar-wdmm.webp"
```
^statblock