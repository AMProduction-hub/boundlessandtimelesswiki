...
"traits":
  - "desc": "If the carrionette is motionless at the start of combat, it has advantage\
      ...
      \ move or act, that creature must succeed on a DC 15 Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "The carrionette targets a creature it can see within 15 feet of it that\
      ...
      \ body, and the target is [unconscious](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Unconscious)\
      ...
      \ die. A [protection from evil and good](03.PlayerLog&Handouts/Mechanics/CLI/spells/protection-from-evil-and-good.md)\
...
"source":
  - "VRGR"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/token/carrionette-vrgr.webp"
```
^statblock