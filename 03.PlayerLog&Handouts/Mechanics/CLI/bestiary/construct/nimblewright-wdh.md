...
A nimblewright doesn't require air, food, drink, or sleep. Damage it takes can be repaired with [mending](03.PlayerLog&Handouts/Mechanics/CLI/spells/mending.md) spells, but a nimblewright reduced to 0 hit points is permanently destroyed.
...
"traits":
  ...
  - "desc": "As long as it has at least 1 hit point remaining, the nimblewright regains\
      \ 1 hit point when a [mending](03.PlayerLog&Handouts/Mechanics/CLI/spells/mending.md)\
      \ spell is cast on it."
    "name": "Repairable"
  - "desc": "The nimblewright has advantage on Strength and Dexterity saving throws\
      \ made against effects that would knock it [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)."
    "name": "Sure-Footed"
"actions":
...
"source":
  - "WDH"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/token/nimblewright-wdh.webp"
```
^statblock