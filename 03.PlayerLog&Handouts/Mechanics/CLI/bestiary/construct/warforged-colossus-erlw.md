...
- "Arkus" (Colossus WX-11) lies [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone) at the bottom of the Glowing Chasm in the northern part of the Mournland, with one of its arms torn off.  
...
"traits":
  ...
  - "desc": "Any enemy outside the colossus that starts its turn within 30 feet of\
      \ it must succeed on a DC 26 Wisdom saving throw or be [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
...
"actions":
  ...
  - "desc": "The colossus stomps one of its feet at a point on the ground within 20\
      ...
      \ bludgeoning damage and fall [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone).\
      \ Until the colossus uses its Stomp again or moves, the creature is [restrained](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Restrained).\
      ...
      \ no longer [restrained](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Restrained).\n\
...
"source":
  - "ERLW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/token/warforged-colossus-erlw.webp"
```
^statblock