...
- Crystal Golem
---
# [Crystal Golem](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\construct/crystal-golem-wdmm.md)
...
"traits":
  ...
  - "desc": "Any creature that starts its turn within 10 feet of the illuminated golem\
      \ and can see the golem must succeed on a DC 17 Wisdom saving throw or be [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded)\
      ...
      \ its eyes again. If the creature looks at the golem in the meantime, it must\
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/token/crystal-golem-wdmm.webp"
```
^statblock