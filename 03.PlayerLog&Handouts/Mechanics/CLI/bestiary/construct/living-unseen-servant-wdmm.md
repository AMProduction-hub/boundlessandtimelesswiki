...
The process that creates a living spell changes the nature of its magic. A living spell isn't subject to [dispel magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/dispel-magic.md) and isn't affected by an [antimagic field](03.PlayerLog&Handouts/Mechanics/CLI/spells/antimagic-field.md).

Like an overzealous butler or maid, a living [unseen servant](03.PlayerLog&Handouts/Mechanics/CLI/spells/unseen-servant.md) spell busies itself with tasks in hopes of pleasing its creator. It can wield simple weapons but prefers not to. [See invisibility](03.PlayerLog&Handouts/Mechanics/CLI/spells/see-invisibility.md), [true seeing](03.PlayerLog&Handouts/Mechanics/CLI/spells/true-seeing.md), and similar effects reveal that the servant has a shape similar to that of a slender humanoid adult.
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/token/living-unseen-servant-wdmm.webp"
```
^statblock