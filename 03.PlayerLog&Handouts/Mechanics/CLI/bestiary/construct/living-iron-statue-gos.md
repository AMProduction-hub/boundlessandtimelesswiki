...
- Living Iron Statue
---
# [Living Iron Statue](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\construct/living-iron-statue-gos.md)
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 10\
    ...
    "name": "Blade"
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 10\
      \ (2d6 + 3) bludgeoning damage, and the target is knocked [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)."
    "name": "Hammer"
...
"source":
  - "GoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/token/living-iron-statue-gos.webp"
```
^statblock