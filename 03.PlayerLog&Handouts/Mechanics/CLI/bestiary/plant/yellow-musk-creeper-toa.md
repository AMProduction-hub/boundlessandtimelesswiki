...
- Yellow Musk Creeper
---
# [Yellow Musk Creeper](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\plant/yellow-musk-creeper-toa.md)
...
"cr": "2"
"traits":
  - "desc": "While the creeper remains motionless, it is indistinguishable from an\
      \ ordinary flowering vine."
  ...
  - "desc": "The creeper regains 10 hit points at the start of its turn. If the creeper\
      ...
      \ start of its next turn. The creeper dies only if it starts its turn with 0\
      \ hit points and doesn't regenerate."
    "name": "Regeneration"
"actions":
  - "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one creature. Hit:\
      \ 13 (3d8) psychic damage. If the target is a humanoid that drops to 0 hit\
      \ points as a result of this damage, it dies and is implanted with a yellow\
      \ musk creeper bulb. Unless the bulb is destroyed, the corpse animates as a\
      \ yellow musk zombie after being dead for 24 hours. The bulb is destroyed if\
      \ the creature is raised from the dead before it can transform into a yellow\
      \ musk zombie, or if the corpse is targeted by a [remove curse](03.PlayerLog&Handouts/Mechanics/CLI/spells/remove-curse.md)\
  ...
  - "desc": "The creeper's flowers release a strong musk that targets all humanoids\
      ...
      \ or be [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ by the creeper for 1 minute. A creature [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ in this way does nothing on its turn except move as close as it can to the\
      \ creeper. A creature [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ by the creeper can repeat the saving throw at the end of each of its turns,\
      \ ending the effect on itself on a success."
    "name": "Yellow Musk (3/Day)"
"source":
  - "ToA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/token/yellow-musk-creeper-toa.webp"
```
^statblock