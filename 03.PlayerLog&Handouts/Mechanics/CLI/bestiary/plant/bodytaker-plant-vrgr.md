...
- Bodytaker Plant
---
# [Bodytaker Plant](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\plant/bodytaker-plant-vrgr.md)
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +7 to hit, reach 20 ft., one target. Hit:\
      \ 11 (2d6 + 4) slashing damage. If the target is a creature, it is [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
  ...
  - "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one Medium or smaller\
      ...
      \ by the plant. Hit: 22 (4d8 + 4) acid damage, and the target is pulled\
      \ into the plant's space and enveloped by the pod, and the grapple ends. While\
      \ enveloped, the target is [restrained](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Restrained),\
      ...
      \ dies. The enveloped target doesn't require air and gains 1 level of [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion)\
      ...
      \ dies, the target is no longer [restrained](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Restrained)\
      \ and can escape from the pod by spending 10 feet of movement, exiting [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone).\
      \ The plant has one pod, which can envelop one creature at a time."
    "name": "Entrapping Pod"
"source":
  - "VRGR"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/token/bodytaker-plant-vrgr.webp"
```
^statblock