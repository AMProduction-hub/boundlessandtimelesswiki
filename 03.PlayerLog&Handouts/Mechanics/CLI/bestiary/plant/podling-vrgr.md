...
"traits":
  - "desc": "The podling is a physical copy of a creature digested by a bodytaker\
      ...
      \ creature can recognize the discrepancies with a successful DC 20 Wisdom ([Insight](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Insight))\
...
"source":
  - "VRGR"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/token/podling-vrgr.webp"
```
^statblock