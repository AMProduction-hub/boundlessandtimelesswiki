...
---
# [Half-Green Dragon Assassin](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\humanoid/half-green-dragon-assassin-rot.md)
...
"cr": "8"
"traits":
  - "desc": "During its first turn, the half-dragon has advantage on attack rolls\
      \ against any creature that hasn't taken a turn. Any hit the half-dragon scores\
      \ against a [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
      \ creature is a critical hit."
    "name": "Assassinate"
  - "desc": "If the half-dragon is subjected to an effect that allows it to make a\
      \ Dexterity saving throw to take only half damage, the half-dragon instead takes\
  ...
  - "desc": "The half-dragon deals an extra 14 (4d6) damage when it hits a target\
      ...
      \ is within 5 feet of an ally of the half-dragon that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "RoT"
  - "ToD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/half-green-dragon-assassin-rot.webp"
```
^statblock