...
A matron mother is almost never encountered alone. She is typically accompanied by a [drow favored consort](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/drow-favored-consort-mpmm.md) and a [drow house captain](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/drow-house-captain-mpmm.md), each of whom appears in this book. Other Underdark creatures might also be in the priestess's presence, providing protection or advice.

## Mothers of Rebellion

Some matron mothers renounce [Lolth](03.PlayerLog&Handouts/Mechanics/CLI/deities/drow-lolth-mtf.md) and join the war against their former goddess. Such drow could be of any alignment, and they lose the following abilities in the stat block: Lolth's Fickle Favor, Summon Servant, and Compel Demon. Even without these abilities, drow matron mothers are formidable opponents, and several of them hold positions of great influence in the Underdark armies arrayed against the followers of Lolth.
...
"traits":
  - "desc": "The drow has advantage on saving throws against being [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed),\
    ...
    "name": "Fey Ancestry"
  - "desc": "The drow wields a [tentacle rod](03.PlayerLog&Handouts/Mechanics/CLI/items/tentacle-rod.md)."
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +10 to hit, reach 5 ft., one target. Hit:\
      ...
      \ of the drow for 1 minute. The [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
  ...
  - "desc": "The drow casts one of the following spells, requiring no material components\
      ...
      \ [gate](03.PlayerLog&Handouts/Mechanics/CLI/spells/gate.md), [levitate](03.PlayerLog&Handouts/Mechanics/CLI/spells/levitate.md)\
...
"bonus_actions":
  ...
  - "desc": "The drow magically summons a [glabrezu](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/glabrezu.md)\
      \ or a [yochlol](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/yochlol.md).\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/drow-matron-mother-mpmm.webp"
```
^statblock
