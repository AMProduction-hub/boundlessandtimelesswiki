...
"actions":
  ...
  - "desc": "Five aarakocra within 30 feet of each other can magically summon an air\
      ...
      \ turns to perform an aerial dance and must maintain [concentration](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration)\
      \ while doing so (as if [concentrating](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration)\
...
"source":
  - "SKT"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/aarakocra-simulacrum-skt.webp"
```
^statblock