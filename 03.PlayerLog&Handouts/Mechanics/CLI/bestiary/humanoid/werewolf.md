...
"traits":
  - "desc": "The werewolf can use its action to polymorph into a wolf-humanoid hybrid\
    ...
    "name": "Shapechanger"
  - "desc": "The werewolf has advantage on Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
...
"source":
  ...
  - "IDRotF"
  - "CM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/werewolf.webp"
```
^statblock
