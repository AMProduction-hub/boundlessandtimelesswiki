...
"actions":
  ...
  - "desc": "Each creature in a 20-foot-radius sphere centered on a point the inquisitor\
      ...
      \ throw or take 31 (6d8 + 4) force damage and be knocked [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)\
...
"source":
  - "VRGR"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/inquisitor-of-the-tome-vrgr.webp"
```
^statblock