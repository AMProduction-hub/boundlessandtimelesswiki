...
- Rock Gnome Recluse
---
# [Rock Gnome Recluse](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\humanoid/rock-gnome-recluse-dip.md)
...
"traits":
  - "desc": "The gnome is a 2nd-level spellcaster. Its spellcasting ability is Intelligence\
      ...
      \ (see \"Actions\" below)\n\n1st level (3 slots): [detect magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-magic.md),\
      \ [mage armor](03.PlayerLog&Handouts/Mechanics/CLI/spells/mage-armor.md), [magic\
      \ missile](03.PlayerLog&Handouts/Mechanics/CLI/spells/magic-missile.md) (see\
      \ \"Actions\" below), [shield](03.PlayerLog&Handouts/Mechanics/CLI/spells/shield.md)"
    "name": "Spellcasting"
...
"source":
  - "DIP"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/rock-gnome-recluse-dip.webp"
```
^statblock