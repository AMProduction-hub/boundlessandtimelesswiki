...
"bonus_actions":
  - "desc": "Choose one creature within 30 feet of the drow that the drow can see.\
      ...
      \ reaction to make one melee attack or to take the [Dodge](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Dodge)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/drow-house-captain-mpmm.webp"
```
^statblock
