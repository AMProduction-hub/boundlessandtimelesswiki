...
"traits":
  - "desc": "The Shard Shunner can use their action to polymorph into a rat-humanoid\
      ...
      \ form if they die."
    "name": "Shapechanger"
  - "desc": "The Shard Shunner has advantage on Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
      \ checks that rely on smell."
    "name": "Keen Smell"
  - "desc": "The Shard Shunner can move through the space of creatures that is of\
      \ a size larger than them."
    "name": "Halfling Nimbleness"
  - "desc": "The Shard Shunner has advantage on saving throws against being [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)."
    "name": "Brave"
"actions":
...
"source":
  - "WDH"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/shard-shunner-wdh.webp"
```
^statblock