...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 5 ft., one target. *Hit:* 11\
      \ (2d6 + 4) slashing damage plus 10 (3d6) necrotic damage. If the target\
      \ is a creature, they can't regain hit points until the start of Varrox's next\
      \ turn."
    "name": "Soulsword"
...
"reactions":
  - "desc": "When a non-minion hobgoblin who Varrox can see within 60 feet of him\
      \ takes damage, Varrox magically summons three hobgoblin recruits who appear\
      \ in unoccupied spaces nearest to the damaged hobgoblin."
    "name": "An Army from Blood"
"legendary_description": "Varrox has three villain actions. He can take each action\
  \ once during an encounter after an enemy's turn. He can take these actions in any\
  \ order but can use only one per round."
"legendary_actions":
  - "desc": "Varrox chooses up to six non-minion allies within 60 feet of him who\
      \ can see or hear him. Varrox and each chosen creature gain 10 temporary hit\
      \ points and can move up to their speed."
    "name": "Action 1: Uncanny Leadership"
  - "desc": "Varrox and each ally within 60 feet of him can teleport up to 60 feet\
  ...
  - "desc": "Each enemy within 20 feet of Varrox must make a DC 15 Constitution saving\
      \ throw, taking 11 (2d10) fire damage plus 11 (2d10) necrotic damage on\
      \ a failed save, or half as much damage on a successful one. After the explosion,\
      \ a shroud of black flame covers Varrox for 1 minute. For the duration, each\
      \ time another creature hits Varrox with an attack while within 5 feet of him\
      \ or touches him, that creature takes 5 (1d10) fire damage plus 5 (1d10)\
      \ necrotic damage."
    "name": "Action 3: I Am Fire and Death"
"source":
  - "FleeMortals"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/bloodlord-varrox-fleemortals.png"
```
^statblock