...
"traits":
  - "desc": "If the pledgemage is subjected to an effect that allows it to make a\
      ...
      \ provided it isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)."
    "name": "Evasion"
"actions":
  - "desc": "The pledgemage makes two Elemental Strike attacks."
    "name": "Multiattack"
  - "desc": "Melee  or Ranged Spell Attack: +5 to hit, reach 5 ft. or range 60\
      \ ft., one target. Hit: 12 (3d6 + 2) fire or cold damage (the pledgemage's\
      \ choice)."
  ...
  - "desc": "The pledgemage shines with elemental magic, targeting one creature it\
      ...
      \ pledgemage's choice) and is [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned)\
...
"bonus_actions":
  - "desc": "The pledgemage moves up to its speed, surrounding itself with elemental\
      ...
      \ If the pledgemage ends its turn in another creature's space, the pledgemage\
      \ takes 5 (d10) force damage and is pushed into the nearest unoccupied space."
    "name": "Surge of Artistry (Recharge 4-6)"
"source":
  - "SCC"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/prismari-pledgemage-scc.webp"
```
^statblock