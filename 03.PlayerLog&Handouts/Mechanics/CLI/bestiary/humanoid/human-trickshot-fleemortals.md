...
"cr": "2"
"traits":
  - "desc": "When the trickshot makes an attack, they have advantage on the attack\
      \ roll."
    "name": "Exploit Opening (3/Day)"
  - "desc": "When the trickshot hits a creature within 30 feet of them with a ranged\
      \ weapon attack, they deal an extra 7 (2d6) piercing damage. Additionally,\
      \ being within 5 feet of an enemy doesn't impose disadvantage on the trickshot's\
      \ ranged attack rolls."
...
"source":
  - "FleeMortals"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/human-trickshot-fleemortals.png"
```
^statblock