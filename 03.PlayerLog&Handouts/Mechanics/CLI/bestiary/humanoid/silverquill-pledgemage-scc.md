...
"bonus_actions":
  - "desc": "The pledgemage hurls magical insults at one creature it can see within\
      ...
      \ of the pledgemage for 1 minute. While [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
...
"source":
  - "SCC"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/silverquill-pledgemage-scc.webp"
```
^statblock