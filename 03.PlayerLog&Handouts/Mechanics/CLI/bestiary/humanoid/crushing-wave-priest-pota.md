...
---
# [Crushing Wave Priest](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\humanoid/crushing-wave-priest-pota.md)
...
"traits":
  - "desc": "The priest is a 5th-level spellcaster. Its spellcasting ability is Charisma\
      ...
      \ (3 slots): [blur](03.PlayerLog&Handouts/Mechanics/CLI/spells/blur.md), [hold\
      \ person](03.PlayerLog&Handouts/Mechanics/CLI/spells/hold-person.md)\n\n3rd\
      \ level (2 slots): [sleet storm](03.PlayerLog&Handouts/Mechanics/CLI/spells/sleet-storm.md)"
    "name": "Spellcasting"
"actions":
...
"source":
  - "PotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/crushing-wave-priest-pota.webp"
```
^statblock