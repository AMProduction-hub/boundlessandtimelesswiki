...
---
# [Uthgardt Shaman (Gray Wolf)](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\humanoid/uthgardt-shaman-gray-wolf-skt.md)
*Source: Storm King's Thunder p. 243*  

```statblock
"name": "Uthgardt Shaman (Gray Wolf) (SKT)"
"size": "Medium"
"type": "humanoid"
"subtype": "human"
...
"actions":
  ...
  - "desc": "The shaman casts one of the following spells, using Wisdom as the spellcasting\
      ...
      \ [beast sense](03.PlayerLog&Handouts/Mechanics/CLI/spells/beast-sense.md) (wolf\
      \ or dire wolf only), [moonbeam](03.PlayerLog&Handouts/Mechanics/CLI/spells/moonbeam.md),\
      \ [speak with animals](03.PlayerLog&Handouts/Mechanics/CLI/spells/speak-with-animals.md)\
      \ (wolf or dire wolf only)"
