...
"reactions":
  - "desc": "When the burrowshark is subjected to an effect that would move it, knock\
      \ it [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone),\
      \ or both, it can use its reaction to be neither moved nor knocked [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)."
    "name": "Unyielding"
"source":
  - "PotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/burrowshark-pota.webp"
```
^statblock