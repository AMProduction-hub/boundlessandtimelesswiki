...
| 5 | [Torch](03.PlayerLog&Handouts/Mechanics/CLI/items/torch.md) carved so that a hand appears to be holding the flame |
| 6 | Circlet of woven reeds |
| 7 | Scrimshawed bone |
| 8 | Vessel such as a cup, a [jug](03.PlayerLog&Handouts/Mechanics/CLI/items/jug.md), an urn, or an amphora |
^war-priest-holy-symbols
...
"actions":
  ...
  - "desc": "The war priest targets one creature it can see within 60 feet of it.\
      ...
      \ takes 12 (2d8 + 3) radiant damage, and it is [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded)\
...
"source":
  - "MPMM"
  - "VGM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/war-priest-mpmm.webp"
```
^statblock
