...
"legendary_actions":
  ...
  - "desc": "The githzerai teleports, along with any equipment it is wearing or carrying,\
    ...
    "name": "Teleport"
  - "desc": "The githzerai casts the [reverse gravity](03.PlayerLog&Handouts/Mechanics/CLI/spells/reverse-gravity.md)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/githzerai-anarch-mpmm.webp"
```
^statblock