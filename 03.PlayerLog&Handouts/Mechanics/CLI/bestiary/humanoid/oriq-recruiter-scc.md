...
"traits":
  ...
  - "desc": "The recruiter wears an Oriq mask. While wearing the mask, the recruiter\
      ...
      \ sensors, and it adds double its proficiency bonus to Charisma ([Deception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Deception))\
...
"source":
  - "SCC"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/oriq-recruiter-scc.webp"
```
^statblock