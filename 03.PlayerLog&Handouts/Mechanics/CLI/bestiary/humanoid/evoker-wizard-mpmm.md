...
"actions":
  ...
  - "desc": "The evoker unleashes a magical explosion of a particular damage type:\
      ...
      \ damage of the chosen type and is knocked [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone).\
...
"source":
  - "MPMM"
  - "VGM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/evoker-wizard-mpmm.webp"
```
^statblock
