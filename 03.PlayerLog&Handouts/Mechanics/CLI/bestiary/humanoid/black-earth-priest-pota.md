...
- Black Earth Priest
---
# [Black Earth Priest](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\humanoid/black-earth-priest-pota.md)
...
"traits":
  - "desc": "The priest is a 5th-level spellcaster. Its spellcasting ability is Charisma\
      ...
      \n1st level (4 slots): [earth tremor](03.PlayerLog&Handouts/Mechanics/CLI/spells/earth-tremor-xge.md),\
      ...
      \ (3 slots): [shatter](03.PlayerLog&Handouts/Mechanics/CLI/spells/shatter.md),\
      \ [spider climb](03.PlayerLog&Handouts/Mechanics/CLI/spells/spider-climb.md)\n\
      \n3rd level (2 slots): [slow](03.PlayerLog&Handouts/Mechanics/CLI/spells/slow.md)"
    "name": "Spellcasting"
"actions":
...
"source":
  - "PotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/black-earth-priest-pota.webp"
```
^statblock