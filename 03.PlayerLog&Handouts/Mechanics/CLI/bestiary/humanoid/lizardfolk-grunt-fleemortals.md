...
"traits":
  - "desc": "The grunt can breathe air and water."
    "name": "Amphibious"
  - "desc": "If the grunt takes damage from an attack or as the result of a failed\
      \ saving throw, their hit points are reduced to 0. If the grunt takes damage\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 1\
      ...
      \ this grapple ends, the target is [restrained](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Restrained),\
