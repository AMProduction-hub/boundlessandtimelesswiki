...
---
# [Uthgardt Shaman (Blue Bear)](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\humanoid/uthgardt-shaman-blue-bear-skt.md)
*Source: Storm King's Thunder p. 243*  

```statblock
"name": "Uthgardt Shaman (Blue Bear) (SKT)"
"size": "Medium"
"type": "humanoid"
"subtype": "human"
...
"actions":
  ...
  - "desc": "The shaman casts one of the following spells, using Wisdom as the spellcasting\
      ...
      \ (bear's endurance only), [heroism](03.PlayerLog&Handouts/Mechanics/CLI/spells/heroism.md)"
