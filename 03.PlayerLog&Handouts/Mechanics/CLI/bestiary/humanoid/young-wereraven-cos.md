...
"traits":
  ...
  - "desc": "The wereraven can mimic simple sounds it has heard, such as a person\
      ...
      \ the sounds can tell they are imitations with a successful DC 10 Wisdom ([Insight](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Insight))\
      \ check."
    "name": "Mimicry"
...
"source":
  - "CoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/young-wereraven-cos.webp"
```
^statblock