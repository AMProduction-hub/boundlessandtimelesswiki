...
"traits":
  ...
  - "desc": "At the end of a 10-minute ritual, the pledgemage can touch one willing\
      ...
      \ and it can add 1d6 to its initiative rolls while it wears the talisman.\
      \ These benefits last for 1 hour or until the pledgemage conducts another ritual\
      \ to bestow another talisman. When the benefits expire, the talisman crumbles\
      \ to dust."
...
"reactions":
  - "desc": "When the pledgemage sees a creature within 30 feet of itself drop to\
      ...
      \ in this way, the target takes 3 (1d6) poison damage at the start of each\
