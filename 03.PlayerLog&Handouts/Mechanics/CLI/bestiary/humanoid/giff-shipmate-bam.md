...
- Giff Shipmate
---
# [Giff Shipmate](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\humanoid/giff-shipmate-bam.md)
...
"traits":
  ...
  - "desc": "On the deck of a ship, the giff has advantage on ability checks and saving\
      \ throws made against effects that would knock it [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)\
...
"source":
  - "BAM"
  - "LoX"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/giff-shipmate-bam.webp"
```
^statblock