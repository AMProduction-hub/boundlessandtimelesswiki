...
A player character who becomes a werebat gains a Dexterity of 17 if their score isn't already higher. [Attack](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Attack) and damage rolls for the werebat's bite attack are based on the character's Strength or Dexterity score, whichever is higher.
...
"traits":
  ...
  - "desc": "The werebat has blindsight out to a range of 60 feet as long as it's\
      \ not [deafened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Deafened)."
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/werebat-wdmm.webp"
```
^statblock