...
- ttrpg-cli/monster/type/humanoid/mage
statblock: inline
statblock-link: "#^statblock"
aliases:
- Spellcaster (Mage)
---
# [Spellcaster (Mage)](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\humanoid/spellcaster-mage-dc.md)
*Source: Divine Contention*  

```statblock
"name": "Spellcaster (Mage) (DC)"
"size": "Medium"
"type": "humanoid"
"subtype": "mage"
"alignment": "Unaligned"
...
"traits":
  - "desc": "The spellcaster's spellcasting ability is Intelligence (spell save DC\
      \ 16, +8 to hit with spell attacks). The spellcaster has following wizard\
      ...
      \ slots): [polymorph](03.PlayerLog&Handouts/Mechanics/CLI/spells/polymorph.md),\
      \ [wall of fire](03.PlayerLog&Handouts/Mechanics/CLI/spells/wall-of-fire.md)\n\
      \n5th level (2 slots): [cone of cold](03.PlayerLog&Handouts/Mechanics/CLI/spells/cone-of-cold.md),\
...
"source":
  - "DC"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/spellcaster-mage-dc.webp"
```
^statblock