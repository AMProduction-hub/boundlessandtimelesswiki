...
- Pirate First Mate
---
# [Pirate First Mate](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\humanoid/pirate-first-mate-gos.md)
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 6\
      ...
      \ two hands. If the target is a creature, the first mate can choose to deal\
      \ no damage with the attack to disarm the target. The target must succeed on\
      \ a DC 14 Strength saving throw or drop one item it is holding on the ground."
    "name": "Longsword"
"source":
  - "GoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/pirate-first-mate-gos.webp"
```
^statblock