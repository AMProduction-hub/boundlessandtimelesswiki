...
"traits":
  - "desc": "The deep diver has advantage on melee attack rolls against any creature\
    ...
    "name": "Blood Frenzy"
  - "desc": "The deep diver has advantage on Dexterity ([Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth))\
...
"actions":
  ...
  - "desc": "The deep diver pulses magical light from its lure. Any creature within\
      ...
      \ until the end of its next turn. A creature [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ in this way is [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
      \ as it stares at the light."
    "name": "Light of Sekolah"
"source":
  - "GoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/sahuagin-deep-diver-gos.webp"
```
^statblock