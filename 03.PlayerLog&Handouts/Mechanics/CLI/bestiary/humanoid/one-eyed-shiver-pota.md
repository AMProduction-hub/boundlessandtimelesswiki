...
"actions":
  ...
  - "desc": "The one-eyed shiver casts [ray of frost](03.PlayerLog&Handouts/Mechanics/CLI/spells/ray-of-frost.md)\
      ...
      \ in this way can end the condition by using an action, succeeding on a DC 13\
      \ Strength check."
    "name": "Eye of Frost"
"source":
  - "PotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/token/one-eyed-shiver-pota.webp"
```
^statblock