...
"traits":
  ...
  - "desc": "When a creature starts its turn within 30 feet of the ashen rider, the\
      ...
      \ the next 24 hours. On a failed save, the creature can't speak and is [deafened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Deafened)\
  ...
  - "desc": "If the ashen rider isn't mounted, it can use a bonus action to magically\
      ...
      \ the ashen rider can't be [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised),\
...
"source":
  - "MOT"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/celestial/token/ashen-rider-mot.webp"
```
^statblock