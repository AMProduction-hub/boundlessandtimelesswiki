...
aliases: ["Couatl"]
---
# [Couatl](03 - Player Log & Handouts\Mechanics\CLI\bestiary\celestial/couatl.md)
...
- "desc": "The couatl's spellcasting ability is Charisma (spell save DC 14). It can\
    ...
    \ will: [detect evil and good](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/detect-evil-and-good.md),\
    ...
    \n3/day each: [bless](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/bless.md),\
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one creature. Hit: 8\
    ...
    \ for 24 hours. Until this poison ends, the target is [unconscious](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Unconscious).\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 10 ft., one Medium or smaller\
    \ creature. Hit: 10 (2d6 + 3) bludgeoning damage, and the target is [grappled](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
...
"source":
- "MM"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/celestial/token/couatl.webp"
```
^statblock
