...
---
# [Starlight Apparition](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\celestial/starlight-apparition-bam.md)
...
"actions":
  - "desc": "Melee  or Ranged Spell Attack: +6 to hit, reach 5 ft. or range 120\
      ...
      \ a creature, it must succeed on a DC 14 Wisdom saving throw or be [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded)\
  ...
  - "desc": "One Humanoid that the apparition can see within 5 feet of itself must\
      ...
      \ the apparition then disappears, and the target is [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
      ...
      \ action, the body leaves the Astral Plane, or the apparition is forced out\
      \ by an effect like the [dispel evil and good](03.PlayerLog&Handouts/Mechanics/CLI/spells/dispel-evil-and-good.md)\
...
"source":
  - "BAM"
  - "LoX"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/celestial/token/starlight-apparition-bam.webp"
```
^statblock