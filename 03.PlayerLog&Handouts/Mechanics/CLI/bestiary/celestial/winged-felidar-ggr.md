...
- Winged Felidar
---
# [Winged Felidar](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\celestial/winged-felidar-ggr.md)
*Source: Guildmasters' Guide to Ravnica p. 199*  

```statblock
"name": "Winged Felidar (GGR)"
"size": "Large"
"type": "celestial"
...
"traits":
  - "desc": "The felidar can magically bond with one creature it can see, right after\
    ...
    "name": "Bonding"
  - "desc": "The felidar has advantage on Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
  ...
  - "desc": "If the felidar moves at least 20 feet straight toward a creature and\
      ...
      \ DC 15 Strength saving throw or be knocked [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone).\
