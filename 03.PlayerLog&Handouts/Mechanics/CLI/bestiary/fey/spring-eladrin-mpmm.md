...
Whenever one of the eladrin presented here finishes a long rest, they can associate themself with a different season, provided they aren't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated). When the eladrin makes this change, they use the stat block of the new season rather than their old stat block. Any damage the eladrin sustained in their previous form applies to the new form, as do any conditions or other ongoing effects affecting them.
...
"traits":
  - "desc": "Any non-eladrin creature that starts its turn within 60 feet of the eladrin\
      ...
      \ to any eladrin's Joyful Presence for 24 hours.\n\nWhenever the eladrin deals\
      \ damage to the [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ creature, the [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
...
"actions":
  ...
  - "desc": "The eladrin casts one of the following spells, requiring no material\
      ...
      \nAt will: [Tasha's hideous laughter](03.PlayerLog&Handouts/Mechanics/CLI/spells/tashas-hideous-laughter.md)\n\
      \n1/day each: [major image](03.PlayerLog&Handouts/Mechanics/CLI/spells/major-image.md),\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/token/spring-eladrin-mpmm.webp"
```
^statblock
