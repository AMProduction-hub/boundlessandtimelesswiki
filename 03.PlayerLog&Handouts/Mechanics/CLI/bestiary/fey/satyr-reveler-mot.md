...
"traits":
  - "desc": "If the satyr performs for at least 1 minute, it chooses up to four humanoids\
      ...
      \ target must succeed on a DC 13 Wisdom saving throw or be [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed).\
      ...
      \ revels. The [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
...
"source":
  - "MOT"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/token/satyr-reveler-mot.webp"
```
^statblock