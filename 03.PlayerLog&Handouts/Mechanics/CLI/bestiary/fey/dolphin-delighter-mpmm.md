...
---
# [Dolphin Delighter](03 - Player Log & Handouts\Mechanics\CLI\bestiary\fey/dolphin-delighter-mpmm.md)
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 5 (1d6\
    \ + 2) bludgeoning damage plus 7 (2d6) psychic damage, and the target is [blinded](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Blinded)\
...
"source":
- "MPMM"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/fey/token/dolphin-delighter-mpmm.webp"
```
^statblock
