...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 12\
      ...
      \ in this way can use an action to make a DC 17 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics))\
  ...
  - "desc": "The dryad magically summons a mount, which appears in an unoccupied space\
      ...
      \ stat block of an [elk](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/elk.md)\
  ...
  - "desc": "The dryad targets one magic item it can see within 120 feet of it. If\
      ...
      \ 10 minutes, until the dryad is [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
      \ or dies, or until the dryad uses a bonus action to end the effect."
    "name": "Suppress Magic (Recharge 5-6)"
"source":
  - "GGR"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/token/conclave-dryad-ggr.webp"
```
^statblock