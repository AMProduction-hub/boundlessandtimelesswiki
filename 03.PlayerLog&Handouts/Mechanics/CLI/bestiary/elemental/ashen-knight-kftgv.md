...
- Ashen Knight
---
# [Ashen Knight](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\elemental/ashen-knight-kftgv.md)
...
"cr": "3"
"traits":
  - "desc": "The ashen knight has advantage on saving throws against being [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)."
    "name": "Brave"
...
"actions":
  ...
  - "desc": "For 1 minute, the ashen knight can utter a special command or warning\
      ...
      \ provided it can hear and understand the ashen knight. A creature can benefit\
      \ from only one Leadership die at a time. This effect ends if the ashen knight\
...
"source":
  - "KftGV"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/token/ashen-knight-kftgv.webp"
```
^statblock