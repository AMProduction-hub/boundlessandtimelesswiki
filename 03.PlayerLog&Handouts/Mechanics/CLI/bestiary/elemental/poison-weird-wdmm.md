...
- Poison Weird
---
# [Poison Weird](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\elemental/poison-weird-wdmm.md)
...
"cr": "4"
"traits":
  - "desc": "The weird is [invisible](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Invisible)\
      \ while fully immersed in toxic brew."
    "name": "Invisible in Water"
  - "desc": "The weird dies if forced to leave the basin of toxic brew it inhabits,\
      \ or if a [purify food and drink](03.PlayerLog&Handouts/Mechanics/CLI/spells/purify-food-and-drink.md)\
      \ spell is cast on the brew."
    "name": "Brew Bound"
  - "desc": "A creature takes 10 (3d6) poison damage at the start of each of its\
      \ turns while [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
      \ by a poison weird."
    "name": "Poisonous Body"
"actions":
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/token/poison-weird-wdmm.webp"
```
^statblock