...
"actions":
  ...
  - "desc": "The leviathan magically creates a wave of water that extends from a point\
      ...
      \ bludgeoning damage and is knocked [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone).\
      ...
      \ water spreads out across the ground in all directions, extinguishing unprotected\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/token/leviathan-mpmm.webp"
```
^statblock
