...
"traits":
  ...
  - "desc": "The phoenix can move through a space as narrow as 1 inch wide without\
    ...
    "name": "Fire Form"
  - "desc": "The phoenix doesn't provoke [opportunity attacks](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Opportunity%20Attack)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/token/phoenix-mpmm.webp"
```
^statblock
