...
*Source: Monster Manual p. 98, Tales from the Yawning Portal, Ghosts of Saltmarsh, Explorer's Guide to Wildemount, Mythic Odysseys of Theros. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"source":
  ...
  - "EGW"
  - "MOT"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/token/adult-red-dragon.webp"
```
^statblock
