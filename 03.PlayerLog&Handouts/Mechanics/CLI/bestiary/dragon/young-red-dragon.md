...
*Source: Monster Manual p. 98, Princes of the Apocalypse, Tomb of Annihilation, Waterdeep: Dungeon of the Mad Mage, Journeys through the Radiant Citadel, Light of Xaryxis, Dragonlance: Shadow of the Dragon Queen, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +10 to hit, reach 10 ft., one target. Hit:\
      \ 17 (2d10 + 6) piercing damage plus 3 (d6) fire damage."
    "name": "Bite"
...
"source":
  ...
  - "DSotDQ"
  - "KftGV"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/token/young-red-dragon.webp"
```
^statblock
