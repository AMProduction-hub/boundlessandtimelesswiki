...
"actions":
  ...
  - "desc": "The dragon casts one of the following spells, requiring no spell components\
      ...
      \ [divination](03.PlayerLog&Handouts/Mechanics/CLI/spells/divination.md), [greater\
...
"lair_actions":
  ...
  - "desc": "- Beguiling Whisper. The dragon telepathically whispers to one creature\
      ...
      \ in the glow. [Attack](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Attack)\
      \ rolls made against an outlined creature have advantage, and the creature can't\
      \ hide or benefit from being [invisible](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Invisible).\
...
"source":
  - "FTD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/token/ancient-crystal-dragon-ftd.webp"
```
^statblock