...
"legendary_description": "Legendary Action Uses: 3. Immediately after another creature's\
  \ turn, the black greatwyrm can expend a use to take one of the following actions.\
  \ The black greatwyrm regains all expended uses at the start of each of its turns."
"legendary_actions":
...
"source":
  - "FTD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/token/black-greatwyrm-ftd.webp"
```
^statblock