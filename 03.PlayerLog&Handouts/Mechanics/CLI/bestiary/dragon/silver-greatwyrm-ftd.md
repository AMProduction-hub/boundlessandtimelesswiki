...
"actions":
  ...
  - "desc": "The greatwyrm uses one of the following breath weapons:\n\n- **Elemental\
      ...
      \ rolls and saving throws until the end of the greatwyrm's next turn. An [unconscious](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Unconscious)\
...
"legendary_description": "Legendary Action Uses: 3. Immediately after another creature's\
  \ turn, the silver greatwyrm can expend a use to take one of the following actions.\
  \ The silver greatwyrm regains all expended uses at the start of each of its turns."
"legendary_actions":
...
"source":
  - "FTD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/token/silver-greatwyrm-ftd.webp"
```
^statblock