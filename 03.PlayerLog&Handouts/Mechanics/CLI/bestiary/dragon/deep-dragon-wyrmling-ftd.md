...
| 6 | An orphaned deep dragon wyrmling is cared for by a giant constrictor snake that is the recipient of a druid's [awaken](03.PlayerLog&Handouts/Mechanics/CLI/spells/awaken.md) spell. |
^connected-creatures
...
"source":
  - "FTD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/token/deep-dragon-wyrmling-ftd.webp"
```
^statblock