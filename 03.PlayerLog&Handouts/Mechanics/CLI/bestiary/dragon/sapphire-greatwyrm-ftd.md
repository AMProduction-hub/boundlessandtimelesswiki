...
"actions":
  ...
  - "desc": "The greatwyrm exhales crushing force in a 300-foot cone. Each creature\
      ...
      \ creature takes 71 (11d12) force damage and is knocked [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone).\
      \ On a successful save, it takes half as much damage and isn't knocked [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone).\
  ...
  - "desc": "The greatwyrm targets any number of creatures and objects it can see\
      ...
      \ creature must succeed on a DC 26 Strength saving throw or be [restrained](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Restrained)\
      ...
      \ of itself. In addition, it can choose any number of creatures [restrained](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Restrained)\
  ...
  - "desc": "The greatwyrm casts one of the following spells, requiring no spell components\
      ...
      \ stop](03.PlayerLog&Handouts/Mechanics/CLI/spells/time-stop.md)"
...
"legendary_description": "Legendary Action Uses: 3. Immediately after another creature's\
  \ turn, the sapphire greatwyrm can expend a use to take one of the following actions.\
  \ The sapphire greatwyrm regains all expended uses at the start of each of its turns."
"legendary_actions":
...
"source":
  - "FTD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/token/sapphire-greatwyrm-ftd.webp"
```
^statblock