...
"traits":
  ...
  - "desc": "Even when the cube is in plain sight, it takes a successful DC 15 Wisdom\
      ...
      \ tries to enter the cube's space while unaware of the cube is [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
      \ by the cube."
    "name": "Transparent"
"actions":
  ...
  - "desc": "The cube moves up to its speed. While doing so, it can enter Large or\
      ...
      \ can't breathe, is [restrained](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Restrained),\
