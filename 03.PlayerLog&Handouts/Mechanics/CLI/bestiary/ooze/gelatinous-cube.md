...
---
# [Gelatinous Cube](03 - Player Log & Handouts\Mechanics\CLI\bestiary\ooze/gelatinous-cube.md)
...
- "desc": "Even when the cube is in plain sight, it takes a successful DC 15 Wisdom\
    ...
    \ check to spot a cube that has neither moved nor attacked. A creature that tries\
    \ to enter the cube's space while unaware of the cube is [surprised](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
    \ by the cube."
  "name": "Transparent"
"actions":
...
"source":
- "MM"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/ooze/token/gelatinous-cube.webp"
```
^statblock
