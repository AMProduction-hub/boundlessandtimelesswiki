...
"actions":
  ...
  - "desc": "One Large or smaller creature that the slithering tracker can see within\
      \ 5 feet of it must succeed on a DC 13 Dexterity saving throw or be [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
      ...
      \ and unable to breathe unless it can breathe water. In addition, the [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
    ...
    "name": "Life Leech"
"bonus_actions":
  - "desc": "If underwater, the slithering tracker takes the [Hide](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Hide)\
      \ action, and it makes the Dexterity ([Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth))\
      \ check with advantage."
    "name": "Watery Stealth"
"source":
  - "MPMM"
  - "VGM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/ooze/token/slithering-tracker-mpmm.webp"
```
^statblock
