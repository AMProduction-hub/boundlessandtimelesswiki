...
aliases: ["Crab Folk"]
---
# [Crab Folk](03 - Player Log & Handouts\Mechanics\CLI\bestiary\giant/crab-folk-mff.md)
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 10 ft., one target. Hit: 7\
    \ (1d6 + 4) bludgeoning damage and the target is [grappled](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
...
"source":
- "MFF"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/giant/token/crab-folk-mff.webp"
```
^statblock