...
- "Mutated Drow"
---
# [Mutated Drow](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/mutated-drow-wdmm.md)
*Source: Waterdeep: Dungeon of the Mad Mage p. 143*  

```statblock
"name": "Mutated Drow (WDMM)"
"size": "Huge"
"type": "giant"
...
"traits":
  ...
  - "desc": "The drow has advantage on Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/token/mutated-drow-wdmm.webp"
```
^statblock