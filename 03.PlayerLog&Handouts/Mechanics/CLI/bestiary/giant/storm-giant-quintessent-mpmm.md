...
"legendary_actions":
  ...
  - "desc": "The giant vanishes, dispersing itself into the storm surrounding its\
      ...
      \ creature is using a [control weather](03.PlayerLog&Handouts/Mechanics/CLI/spells/control-weather.md)\
...
"lair_actions":
  ...
  - "desc": "- Deafening Boom. The giant creates a thunderclap centered on a point\
      ...
      \ on a DC 18 Constitution saving throw or be [deafened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Deafened)\
...
"source":
  - "MPMM"
  - "VGM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/token/storm-giant-quintessent-mpmm.webp"
```
^statblock
