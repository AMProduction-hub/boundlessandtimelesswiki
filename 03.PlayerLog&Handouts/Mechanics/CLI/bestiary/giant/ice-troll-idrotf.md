...
- If buried in the ground under a foot or more of earth, the heart melts away and summons a blizzard like that created by the [control weather](03.PlayerLog&Handouts/Mechanics/CLI/spells/control-weather.md) spell. It takes 10 minutes for the heart to melt and the blizzard to form. The blizzard lasts for 8 hours.  
- A hag or similar creature can perform a ritual that turns the heart into a magical talisman that acts like a patch of brown mold (see "[Brown Mold](03.PlayerLog&Handouts/Mechanics/CLI/traps-hazards/brown-mold.md)" in the "Dungeon Master's Guide"). This effect lasts until the heart is destroyed.  
- A creature proficient with alchemist's supplies can squeeze enough residual fluid out of the heart to mix with other alchemical ingredients, creating one [potion of resistance (cold)](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-cold-resistance.md). It takes 1 hour to create this potion.   
...
"traits":
  - "desc": "While it's alive, the troll generates an aura of bitter cold that fills\
    ...
    "name": "Cold Aura"
  - "desc": "The ice troll has advantage on Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
      \ checks that rely on smell."
    "name": "Keen Smell"
  - "desc": "The ice troll regains 10 hit points at the start of its turn. If the\
      \ troll takes acid or fire damage, this trait doesn't function at the start\
      \ of the troll's next turn. The ice troll dies only if it starts its turn with\
...
"source":
  - "IDRotF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/token/ice-troll-idrotf.webp"
```
^statblock