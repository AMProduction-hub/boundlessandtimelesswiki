...
*Source: Monster Manual p. 155, Storm King's Thunder, Tales from the Yawning Portal, Tomb of Annihilation, Explorer's Guide to Wildemount, Icewind Dale: Rime of the Frostmaiden. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"source":
  ...
  - "EGW"
  - "IDRotF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/token/frost-giant.webp"
```
^statblock
