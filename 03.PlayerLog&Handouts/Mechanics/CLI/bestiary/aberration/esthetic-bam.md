...
- Esthetic
---
# [Esthetic](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\aberration/esthetic-bam.md)
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +11 to hit, reach 30 ft., one target. Hit:\
      \ 17 (3d6 + 7) force damage, and if the target is a creature, it is [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
...
"source":
  - "BAM"
  - "LoX"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/token/esthetic-bam.webp"
```
^statblock