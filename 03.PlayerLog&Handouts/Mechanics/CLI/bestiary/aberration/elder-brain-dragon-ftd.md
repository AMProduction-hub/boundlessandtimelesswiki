...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +15 to hit, reach 15 ft., one creature. Hit:\
      \ 12 (1d8 + 8) psychic damage. If the target is Huge or smaller, it is [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
      \ (escape DC 18). The dragon can have up to four targets [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
      \ at a time."
    "name": "Tentacle"
  - "desc": "The dragon exhales brine in a 120-foot line that is 15 feet wide. Each\
      ...
      \ while infested, the creature is stable but remains [unconscious](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Unconscious)\
      \ for 6d12 hours. When the period of unconsciousness ends, the creature transforms\
      \ into a [mind flayer](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/mind-flayer.md)\
      \ (see the Monster Manual) with all its hit points. Casting a [wish](03.PlayerLog&Handouts/Mechanics/CLI/spells/wish.md)\
      \ spell on the [unconscious](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Unconscious)\
...
"legendary_actions":
  - "desc": "The dragon makes one Tentacle attack."
    "name": "Tentacle"
  - "desc": "The dragon targets a creature it is grappling. The target's [concentration](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration)\
...
"source":
  - "FTD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/token/elder-brain-dragon-ftd.webp"
```
^statblock