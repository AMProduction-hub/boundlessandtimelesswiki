...
As alien as their creator, the rooms in a beholder's lair reflect the creature's arrogance. It festoons its chambers with trophies from the battles it has won, including [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified) adventurers standing frozen in their horrified final moments, pieces of other beholders, and magic items wrested from powerful foes. A beholder judges its own worth by its acquisitions, and it never willingly parts with its treasures.
...
"traits":
  - "desc": "The beholder's central eye creates an area of antimagic, as in the [antimagic\
      ...
      \ in a 150-foot cone. At the start of each of its turns, the beholder decides\
...
"actions":
  ...
  - "desc": "The beholder shoots three of the following magical eye rays at random\
      ...
      \ or until the beholder is [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated).\
...
"source":
  ...
  - "LoX"
  - "KftGV"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/token/beholder.webp"
```
^statblock
