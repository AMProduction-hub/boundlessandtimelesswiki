...
"traits":
  - "desc": "The gazer can mimic simple sounds of speech it has heard, in any language.\
      ...
      \ DC 10 Wisdom ([Insight](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Insight))\
      \ check."
    "name": "Mimicry"
"actions":
  ...
  - "desc": "The gazer shoots two of the following magical eye rays at random (roll\
      ...
      \ on a DC 12 Wisdom saving throw or be [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ until the start of the gazer's next turn. While the target is [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
...
"source":
  - "MPMM"
  - "VGM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/token/gazer-mpmm.webp"
```
^statblock
