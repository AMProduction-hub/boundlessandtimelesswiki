...
"actions":
  ...
  - "desc": "The emissary expels bile that splashes all creatures in a 30-foot-radius\
      ...
      \ For each creature that fails the saving throw, a [gibbering mouther](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/gibbering-mouther.md)\
...
"source":
  - "VRGR"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/token/greater-star-spawn-emissary-vrgr.webp"
```
^statblock