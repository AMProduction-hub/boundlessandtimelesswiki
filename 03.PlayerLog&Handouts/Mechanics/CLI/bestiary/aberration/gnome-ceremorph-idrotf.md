...
A gnome ceremorph often carries a home-built device that functions as a [laser pistol](03.PlayerLog&Handouts/Mechanics/CLI/items/laser-pistol.md) (see ""Firearms"" in the "Dungeon Master's Guide"). This weapon is powered by an [energy cell](03.PlayerLog&Handouts/Mechanics/CLI/items/energy-cell.md), which enables the weapon to fire 50 shots. After its last shot is expended, the device becomes inoperable. The [energy cell](03.PlayerLog&Handouts/Mechanics/CLI/items/energy-cell.md) can't be removed without destroying the weapon.
...
"skillsaves":
  ...
  - "name": "[Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth)"
    "desc": "+5"
"gear":
  - "[laser pistol](03.PlayerLog&Handouts/Mechanics/CLI/items/laser-pistol.md)"
...
"actions":
  ...
  - "desc": "The ceremorph magically emits psychic energy in a 60-foot cone. Each\
      ...
      \ take 22 (4d8 + 4) psychic damage and be [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned)\
      \ for 1 minute. A creature can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success."
    "name": "Mind Blast (Recharge 5-6)"
"source":
  - "IDRotF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/token/gnome-ceremorph-idrotf.webp"
```
^statblock