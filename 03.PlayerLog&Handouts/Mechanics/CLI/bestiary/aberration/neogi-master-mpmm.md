...
---
# [Neogi Master](03 - Player Log & Handouts\Mechanics\CLI\bestiary\aberration/neogi-master-mpmm.md)
...
- "desc": "The neogi casts one of the following spells, using Charisma as the spellcasting\
  ...
  "name": "Spellcasting"
- "desc": "Magical darkness doesn't impede the neogi's [darkvision](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/senses.md#Darkvision)."
  "name": "Devil's Sight"
...
- "desc": "The neogi targets one creature it can see within 30 feet of it. The target\
    ...
    \ the target. The [charmed](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
    \ target obeys the neogi's commands and can't take reactions, and the neogi and\
    \ the target can communicate telepathically with each other at a distance of up\
    \ to 1 mile. Whenever the [charmed](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
...
- "MPMM"
- "VGM"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/aberration/token/neogi-master-mpmm.webp"
```
^statblock
