...
"traits":
  ...
  - "desc": "The quori can't be [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
...
"actions":
  ...
  - "desc": "The quori touches one humanoid, which must succeed on a DC 21 Intelligence\
      ...
      \ curse or [greater restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/greater-restoration.md)\
      \ spell.\n\nThe cursed target suffers 1 level of [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion)\
      \ every 24 hours, and finishing a long rest doesn't reduce its [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion).\
      \ If the cursed target reaches [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion)\
      \ level 6, it doesn't die; it instead becomes a thrall under the quori's control,\
      \ and all its [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion)\
      \ is removed. Only the [wish](03.PlayerLog&Handouts/Mechanics/CLI/spells/wish.md)\
  ...
  - "desc": "The quori creates a swarm of spectral eyes that fills a 30-foot-radius\
      ...
      \ takes 45 (10d8) psychic damage, and it is [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded)\
      ...
      \ A [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded)\
  ...
  - "desc": "One humanoid that the quori can see within 5 feet of it must succeed\
      ...
      \ Charisma, and immunity to being [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      ...
      \ or the quori is forced out by an effect like the [dispel evil and good](03.PlayerLog&Handouts/Mechanics/CLI/spells/dispel-evil-and-good.md)\
...
"source":
  - "ERLW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/token/kalaraq-quori-erlw.webp"
```
^statblock