...
"traits":
  - "desc": "The elder brain is aware of creatures within 5 miles of it that have\
      ...
      \ anything else about it. A creature protected by a [mind blank](03.PlayerLog&Handouts/Mechanics/CLI/spells/mind-blank.md)\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 30 ft., one target. *Hit:*\
      ...
      \ (escape DC 15) and takes 9 (1d8 + 5) psychic damage at the start of each\
...
"bonus_actions":
  - "desc": "The elder brain targets one [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
      ...
      \ mind once it is no longer [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated),\
...
"lair_actions":
  - "desc": "On initiative count 20 (losing initiative ties), an elder brain can take\
      ...
      \ 120 feet of it and anchors it by sheer force of will. The target must make\
      \ a DC 18 Charisma saving throw. On a failed save, its speed is reduced to 0,\
      \ and it can't teleport. It can repeat the saving throw at the end of each of\
...
"legendary_actions":
  - "desc": "The elder brain targets one creature within 120 feet of it with which\
      \ it has a psychic link. The elder brain breaks the creature's [concentration](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration)\
...
"source":
  - "MPMM"
  - "VGM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/token/elder-brain-mpmm.webp"
```
^statblock
