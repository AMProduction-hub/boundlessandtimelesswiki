...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +13 to hit, reach 10 ft., one target. Hit:\
      ...
      \ turn or regurgitate all swallowed creatures, which fall [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)\
...
"source":
  - "EGW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/token/core-spawn-worm-egw.webp"
```
^statblock