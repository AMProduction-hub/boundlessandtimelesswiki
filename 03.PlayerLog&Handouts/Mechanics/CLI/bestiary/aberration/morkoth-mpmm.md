...
The first morkoths arose in the Astral Plane when the [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified) body of a deity of greed and strife collided with a remnant of celestial matter imbued with life-giving magic. The collision released a storm of chaotic energy and sent countless islands spinning away into the void. Within some of them, bits of the god's [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified) flesh came back to life as morkoths: tentacled monstrosities brimming with malice and greed.
...
"actions":
  ...
  - "desc": "The morkoth projects a 30-foot cone of magical energy. Each creature\
      ...
      \ creature is [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ by the morkoth for 1 minute. While [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ in this way, the target tries to get as close to the morkoth as possible,\
      \ using its actions to [Dash](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Dash)\
      \ until it is within 5 feet of the morkoth. A [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
...
"source":
  - "MPMM"
  - "VGM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/token/morkoth-mpmm.webp"
```
^statblock
