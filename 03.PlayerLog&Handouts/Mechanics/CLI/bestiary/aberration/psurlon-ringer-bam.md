...
- Psurlon Ringer
---
# [Psurlon Ringer](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\aberration/psurlon-ringer-bam.md)
...
"actions":
  ...
  - "desc": "The psurlon casts one of the following spells, requiring no spell components\
      ...
      2/day: [mage armor](03.PlayerLog&Handouts/Mechanics/CLI/spells/mage-armor.md)\
      \ (self only)\n\n1/day: [suggestion](03.PlayerLog&Handouts/Mechanics/CLI/spells/suggestion.md)"
    "name": "Spellcasting (Psionics)"
"source":
  - "BAM"
  - "LoX"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/token/psurlon-ringer-bam.webp"
```
^statblock