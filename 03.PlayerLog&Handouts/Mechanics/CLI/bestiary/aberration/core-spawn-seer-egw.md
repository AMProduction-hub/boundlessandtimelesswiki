...
"actions":
  ...
  - "desc": "The seer hurls a glimmering orb at one creature it can see within 120\
      ...
      \ next turn. Roll a d6 for the condition: (1-2) [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded),\
      \ (3-4) [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened),\
      \ or (5-6) [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned)."
...
"reactions":
  - "desc": "When the seer is hit by an attack, it takes only half of the triggering\
      ...
      \ the target takes an extra d6 radiant damage."
    "name": "Fuse Damage"
"source":
  - "EGW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/token/core-spawn-seer-egw.webp"
```
^statblock