...
The curse that transformed it into an abomination can be undone only by a [remove curse](03.PlayerLog&Handouts/Mechanics/CLI/spells/remove-curse.md) spell or similar magic.
...
"source":
  - "EGW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/token/sharkbody-abomination-egw.webp"
```
^statblock