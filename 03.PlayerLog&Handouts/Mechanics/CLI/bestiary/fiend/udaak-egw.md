...
"actions":
  ...
  - "desc": "The udaak makes one bite attack against a Large or smaller target it\
      ...
      \ ends. A swallowed creature is [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded)\
...
"source":
  - "EGW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/token/udaak-egw.webp"
```
^statblock