...
- Space Clown
---
# [Space Clown](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\fiend/space-clown-bam.md)
...
"actions":
  ...
  - "desc": "Ranged Spell Attack: +5 to hit, range 120 ft., one creature. Hit:\
      ...
      \ and is [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
  ...
  - "desc": "The clown casts one of the following spells, requiring no material components\
      ...
      \n1/day each: [mirror image](03.PlayerLog&Handouts/Mechanics/CLI/spells/mirror-image.md),\
...
"bonus_actions":
  - "desc": "The clown veils itself and everything it is wearing and carrying in an\
      ...
      \ as a floating balloon). Maintaining this effect requires the clown's [concentration](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration)\
      ...
      \ 15 Wisdom ([Insight](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Insight))\
      \ check, piercing the illusion and discerning the clown's true form on a success."
    "name": "Phantasmal Form (3/Day)"
"source":
  - "BAM"
  - "LoX"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/token/space-clown-bam.webp"
```
^statblock