...
"traits":
  ...
  - "desc": "When the rakshasa hits a creature with a melee weapon attack, the attack\
      ...
      \ creature up to 10 feet away from it, knock the creature [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone),\
...
"source":
  - "ERLW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/token/zakya-rakshasa-erlw.webp"
```
^statblock