...
"actions":
  ...
  - "desc": "The oinoloth touches one willing creature within 5 feet of it. The target\
      ...
      \ on the target or remove one of the following conditions from it: [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded),\
      ...
      \ The target then gains 1 level of [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion),\
      ...
      \ or by casting [greater restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/greater-restoration.md)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/token/oinoloth-mpmm.webp"
```
^statblock
