...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 12\
    ...
    "name": "Claw"
  - "desc": "The maurezhi targets one dead ghoul or [ghast](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/ghast.md)\
      \ it can see within 30 feet of it. The target is revived with all its hit points."
    "name": "Raise Ghoul (Recharge 5-6)"
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/token/maurezhi-mpmm.webp"
```
^statblock
