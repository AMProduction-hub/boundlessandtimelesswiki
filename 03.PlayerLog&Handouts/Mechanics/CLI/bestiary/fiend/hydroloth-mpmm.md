...
"actions":
  ...
  - "desc": "The hydroloth targets one creature it can see within 60 feet of it. The\
      ...
      \ itself on a success. A [greater restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/greater-restoration.md)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/token/hydroloth-mpmm.webp"
```
^statblock