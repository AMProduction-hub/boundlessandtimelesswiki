...
"traits":
  ...
  - "desc": "Using a 10-minute long ritual, the titan can forge a magical bond with\
      ...
      \ titan chooses one spell from the necromancy or enchantment school that is\
      \ 8th level or lower. The bound creature can cast that spell using this pact,\
      ...
      \ which can't break the creature's [concentration](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration)\
...
"legendary_actions":
  ...
  - "desc": "The titan targets one creature it can see within 120 feet of itself.\
      ...
      \ takes 38 (7d10) psychic damage and is [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      ...
      \ and isn't [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened),\
      \ and the titan doesn't heal."
    "name": "Terrorize (Costs 3 Actions)"
"source":
  - "SCC"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/token/daemogoth-titan-scc.webp"
```
^statblock