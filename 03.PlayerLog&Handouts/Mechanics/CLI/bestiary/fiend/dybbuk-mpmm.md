...
"actions":
  ...
  - "desc": "The dybbuk casts one of the following spells, requiring no material components\
      ...
      \ will: [dimension door](03.PlayerLog&Handouts/Mechanics/CLI/spells/dimension-door.md)\n\
...
"bonus_actions":
  - "desc": "While Possess Corpse is active, the dybbuk makes the corpse do something\
      ...
      \ must succeed on a DC 12 Wisdom saving throw or become [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ of the dybbuk for 1 minute. The [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/token/dybbuk-mpmm.webp"
```
^statblock
