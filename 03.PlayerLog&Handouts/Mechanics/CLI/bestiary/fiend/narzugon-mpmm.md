...
Narzugons wield hell-forged lances that shunt the souls of any they killed to the River Styx for rebirth as [lemures](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/lemure.md). Every lance bears the marks of both a narzugon and its master.

Each narzugon claims a [nightmare](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/nightmare.md) as its mount. These steeds are bound by [infernal tack](03.PlayerLog&Handouts/Mechanics/CLI/items/infernal-tack-mtf.md) and must respond to the summons and commands of the spurs' wearer.
...
"cr": "13"
"traits":
  - "desc": "The narzugon wears spurs that are part of [infernal tack](03.PlayerLog&Handouts/Mechanics/CLI/items/infernal-tack-mtf.md),\
      \ which allow it to summon its [nightmare](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/nightmare.md)\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +10 to hit, reach 10 ft., one target. Hit:\
      ...
      \ kills a creature with a soul, the soul rises from the River Styx as a [lemure](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/lemure.md)\
      \ in Avernus in d4 hours. If the creature isn't revived before then, only\
      \ a [wish](03.PlayerLog&Handouts/Mechanics/CLI/spells/wish.md) spell or killing\
      \ the lemure and casting true resurrection on the creature's original body can\
      \ restore it to life. Constructs and devils are immune to this effect."
    "name": "Hellfire Lance"
  - "desc": "Each ally of the narzugon within 60 feet of it can't be [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
  ...
  - "desc": "Each creature within 60 feet of the narzugon that isn't a Fiend must\
      \ succeed on a DC 17 Charisma saving throw or become [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/token/narzugon-mpmm.webp"
```
^statblock