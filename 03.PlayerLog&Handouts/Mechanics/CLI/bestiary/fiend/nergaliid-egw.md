...
"actions":
  ...
  - "desc": "The nergaliid magically draws the life from a humanoid it can see within\
      \ 40 feet of it. The target must make a DC 15 Wisdom saving throw. An [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "EGW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/token/nergaliid-egw.webp"
```
^statblock