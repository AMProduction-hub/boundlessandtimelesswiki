...
- "Mister Threadneedle"
---
# [Mister Threadneedle](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/mister-threadneedle-toa.md)
...
"actions":
  ...
  - "desc": "Mister Threadneedle targets one creature it can see within 30 feet of\
      ...
      \ a DC 11 Wisdom saving throw or be magically [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ until the end of Mister Threadneedle's next turn. The [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ target is [paralyzed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Paralyzed)."
    "name": "Terrifying Glare"
"source":
  - "ToA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/mister-threadneedle-toa.webp"
```
^statblock