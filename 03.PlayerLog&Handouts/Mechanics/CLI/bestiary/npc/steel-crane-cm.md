...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit:\
      ...
      \ can release a creature [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
      \ by the whip (no action required)."
    "name": "Whip"
  - "desc": "Steel Crane regains 2d8 + 4 hit points, and all levels of [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion)\
      \ end on him."
...
"source":
  - "CM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/steel-crane-cm.webp"
```
^statblock