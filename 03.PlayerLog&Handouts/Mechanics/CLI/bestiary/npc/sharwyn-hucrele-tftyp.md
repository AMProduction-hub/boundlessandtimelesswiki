...
"traits":
  ...
  - "desc": "Sharwyn's AC can't be lower than 16."
    "name": "Barkskin"
  - "desc": "Sharwyn has a [spellbook](03.PlayerLog&Handouts/Mechanics/CLI/items/spellbook.md)\
      \ that contains the spells listed in her Spellcasting trait, plus [detect magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-magic.md)\
      \ and [silent image](03.PlayerLog&Handouts/Mechanics/CLI/spells/silent-image.md)."
...
"source":
  - "TftYP"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/sharwyn-hucrele-tftyp.webp"
```
^statblock