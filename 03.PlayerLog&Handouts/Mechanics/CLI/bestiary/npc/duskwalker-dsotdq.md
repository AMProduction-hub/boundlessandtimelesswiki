...
- "Duskwalker"
---
# [Duskwalker](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/duskwalker-dsotdq.md)
...
"actions":
  ...
  - "desc": "Duskwalker magically animates one or two trees it can see within 60 feet\
      ...
      \ Duskwalker dies or is more than 120 feet from the tree; or until Duskwalker\
      \ takes a bonus action to turn it back into an inanimate tree. The tree then\
      \ takes root if possible."
    "name": "Animate Trees (1/Day)"
"source":
  - "DSotDQ"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/duskwalker-dsotdq.webp"
```
^statblock