...
- "Rool"
---
# [Rool](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/rool-skt.md)
...
"cr": "8"
"traits":
  - "desc": "During its first turn, Rool has advantage on attack rolls against any\
      \ creature that hasn't taken a turn. Any hit Rool scores against a [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
      \ creature is a critical hit."
    "name": "Assassinate"
  - "desc": "If Rool is subjected to an effect that allows it to make a Dexterity\
      \ saving throw to take only half damage, Rool instead takes no damage if it\
  ...
  - "desc": "Rool deals an extra 14 (4d6) damage when it hits a target with a weapon\
      ...
      \ 5 feet of an ally of Rool that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "SKT"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/rool-skt.webp"
```
^statblock