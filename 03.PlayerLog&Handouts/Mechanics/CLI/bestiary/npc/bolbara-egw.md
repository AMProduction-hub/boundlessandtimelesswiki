...
"ac_class": "[leather armor](03.PlayerLog&Handouts/Mechanics/CLI/items/leather-armor.md);\
  \ 15 with [mage armor](03.PlayerLog&Handouts/Mechanics/CLI/spells/mage-armor.md)"
"hp": !!int "40"
"hit_dice": "9d6 + 9"
"modifier": !!int "2"
"stats":
...
"legendary_actions":
  ...
  - "desc": "A 15-foot-radius sphere of magical confusion extends from a point Bol'bara\
      ...
      \ starts its turn in that area is treated as if targeted by the [confusion](03.PlayerLog&Handouts/Mechanics/CLI/spells/confusion.md)\
      \ spell (save DC 12). The sphere lasts as long as Bol'bara maintains [concentration](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration),\
...
"source":
  - "EGW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/bolbara-egw.webp"
```
^statblock