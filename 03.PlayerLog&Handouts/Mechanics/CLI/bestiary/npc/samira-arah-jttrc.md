...
- "Samira Arah"
---
# [Samira Arah](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/samira-arah-jttrc.md)
...
"cr": "1"
"traits":
  - "desc": "On each of its turns, Samira can use a bonus action to take the [Dash](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Dash),\
  ...
  - "desc": "Samira deals an extra 7 (2d6) damage when it hits a target with a weapon\
      ...
      \ 5 feet of an ally of Samira that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "JttRC"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/samira-arah-jttrc.webp"
```
^statblock