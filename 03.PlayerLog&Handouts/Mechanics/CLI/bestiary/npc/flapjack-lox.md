...
"traits":
  - "desc": "Flapjack can perceive the content of any telepathic communication used\
      \ within 60 feet of it, and it can't be [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
      \ by creatures with any form of telepathy."
    "name": "Advanced Telepathy"
  - "desc": "If Flapjack is knocked [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone),\
      \ roll a die. On an odd result, Flapjack lands upside-down and is [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated).\
      \ At the end of each of its turns, Flapjack can make a DC 10 Dexterity saving\
      \ throw, righting itself and ending the [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "LoX"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/flapjack-lox.webp"
```
^statblock