...
"cr": "8"
"traits":
  - "desc": "The ettin has advantage on Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "The ettin's right head exhales fire in a 30-foot cone. Each creature\
      \ in that area must make a DC 14 Dexterity saving throw, taking 45 (10d8)\
  ...
  - "desc": "The ettin turns its magical gaze toward one creature that it can see\
      ...
      \ Unless the target is [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated),\
    ...
    "name": "Gaze"
  - "desc": "The target is [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned)\
      \ until the start of the ettin's next turn or until the ettin is no longer within\
      \ line of sight."
    "name": "Beguiling Gaze"
  - "desc": "The target is [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
    ...
    "name": "Hypnotic Gaze"
  - "desc": "The target suffers the effect of the [confusion](03.PlayerLog&Handouts/Mechanics/CLI/spells/confusion.md)\
...
"source":
  - "IMR"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/the-demogorgon-imr.webp"
```
^statblock