...
---
# [Thornboldt "Thorn" Durst](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/thornboldt-thorn-durst-cos.md)
...
"actions":
  ...
  - "desc": "One humanoid that Thorn can see within 5 feet of it must succeed on a\
      ...
      \ lasts until the body drops to 0 hit points, Thorn ends it as a bonus action,\
      \ or Thorn is turned or forced out by an effect like the [dispel evil and good](03.PlayerLog&Handouts/Mechanics/CLI/spells/dispel-evil-and-good.md)\
...
"source":
  - "CoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/thornboldt-thorn-durst-cos.webp"
```
^statblock