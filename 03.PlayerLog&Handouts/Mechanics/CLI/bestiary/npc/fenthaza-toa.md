...
"actions":
  ...
  - "desc": "Fenthaza taps into the nightmares of a creature it can see within 60\
      ...
      \ of the manifestation, believing it to be real. Fenthaza must concentrate to\
      \ maintain the illusion (as if [concentrating](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration)\
...
"source":
  - "ToA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/fenthaza-toa.webp"
```
^statblock