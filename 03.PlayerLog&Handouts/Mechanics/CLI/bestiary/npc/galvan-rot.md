...
"traits":
  - "desc": "While Galvan is not presented in an encounter in The Rise of Tiamat,\
      \ the [dragonsoul](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/dragonsoul-rot.md)\
      \ stat block has been provided here for ease of use, with optional alterations\
      \ for the [Blue Dragon Mask](03.PlayerLog&Handouts/Mechanics/CLI/items/blue-dragon-mask-rotos.md)."
    "name": "5etools Note"
  ...
  - "desc": "If Galvan fails a saving throw while wearing the Blue Dragon Mask, he\
      \ can choose to succeed instead."
    "name": "Legendary Resistance (1/Day)"
  - "desc": "Galvan has advantage on saving throws against being [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ or [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened).\
      \ While Galvan can see a dragon or higher-ranking Cult of the Dragon cultist\
      \ friendly to it, Galvan ignores the effects of being [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ or [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)."
    "name": "Dragon Fanatic"
  - "desc": "Once per turn, if Galvan makes a weapon attack with advantage on the\
      \ attack roll and hits, the target takes an extra 10 (3d6) damage."
    "name": "Fanatic Advantage"
  - "desc": "Galvan can use a bonus action to gain a flying speed of 30 feet until\
      \ the end of its turn."
    "name": "Limited Flight"
  - "desc": "Galvan has advantage on an attack roll against a creature if at least\
      \ one of Galvan's allies is within 5 feet of the creature and the ally isn't\
...
"source":
  - "RoT"
  - "ToD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/galvan-rot.webp"
```
^statblock