...
- "Stool"
---
# [Stool](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/stool-oota.md)
...
"cr": "0"
"traits":
  - "desc": "When Stool takes damage, all other myconids within 240 feet of it can\
      \ sense its pain."
...
"actions":
  ...
  - "desc": "A 10-foot radius of spores extends from Stool. These spores can go around\
      \ corners and affect only creatures with an Intelligence of 2 or higher that\
      \ aren't undead, constructs, or elementals. Affected creatures can communicate\
...
"source":
  - "OotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/stool-oota.webp"
```
^statblock