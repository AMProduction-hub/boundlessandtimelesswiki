...
"traits":
  - "desc": "Eliphas can use its action to polymorph into a Large bear-humanoid hybrid\
    ...
    "name": "Shapechanger"
  - "desc": "Eliphas has advantage on Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
...
"source":
  - "KftGV"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/eliphas-adulare-kftgv.webp"
```
^statblock