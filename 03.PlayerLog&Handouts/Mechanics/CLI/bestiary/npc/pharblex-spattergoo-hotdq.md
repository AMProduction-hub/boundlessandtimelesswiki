...
"traits":
  ...
  - "desc": "Pharblex can breathe air and water."
    "name": "Amphibious"
  - "desc": "Once per turn, when Pharblex hits with a melee attack, he can expend\
      \ a use of this trait to deal an extra 9 (2d8) poison damage."
  ...
  - "desc": "As part of his movement and without a running start, Pharblex can long\
    ...
    "name": "Standing Leap"
  - "desc": "Pharblex has advantage on Dexterity ([Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth))\
...
"source":
  - "HotDQ"
  - "ToD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/pharblex-spattergoo-hotdq.webp"
```
^statblock