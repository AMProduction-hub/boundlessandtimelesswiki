...
"traits":
  ...
  - "desc": "Baba Lysaga is shielded against divination magic, as though protected\
      \ by a [nondetection](03.PlayerLog&Handouts/Mechanics/CLI/spells/nondetection.md)\
      \ spell."
...
"source":
  - "CoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/baba-lysaga-cos.webp"
```
^statblock