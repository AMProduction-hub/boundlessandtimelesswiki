...
Eventually, a fallen paladin known as Kas the Bloody-Handed rose through the ranks of Vecna's vile minions to become the archlich's personal guard and regent over many of the kingdoms and cults Vecna established across the multiverse. As a symbol of Kas's authority, Vecna forged him a terrifying weapon, the blade now known as the [Sword of Kas](03.PlayerLog&Handouts/Mechanics/CLI/items/sword-of-kas.md). Later, Kas turned on Vecna and used the sword to sever the archlich's hand and put out his eye. No one knows why Kas betrayed Vecna. Some believe the mysterious voice that spoke to Vecna for eons grew to fear the archlich and began whispering to Kas instead.

After their clash, Kas and Vecna disappeared for ages. The former later emerged as the ruler of the wasteland domain of Tovag in the Shadowfell. The latter spent several centuries hopping from world to world, questing for his [severed hand](03.PlayerLog&Handouts/Mechanics/CLI/items/hand-of-vecna.md) and [eye](03.PlayerLog&Handouts/Mechanics/CLI/items/eye-of-vecna.md). More recently, Vecna decamped to the Outer Planes, where he grew so powerful that he became a god. He has many ardent worshipers, all hungry for a taste of his immense power.

The accompanying stat block depicts Vecna in his archlich form prior to Kas's betrayal. Because Vecna is said to have mastered magic allowing him to travel through time, he can appear in this form even on worlds where his [severed hand](03.PlayerLog&Handouts/Mechanics/CLI/items/hand-of-vecna.md) and [eye](03.PlayerLog&Handouts/Mechanics/CLI/items/eye-of-vecna.md) are already known artifacts.
...
> 
> ![](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/img/book-of-vile-darkness.webp#center)
...
"traits":
  ...
  - "desc": "If Vecna is slain, his soul refuses to accept its fate and lives on as\
      ...
      \ within 100 miles of where Vecna was slain."
    "name": "Undying"
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +13 to hit, reach 5 ft., one target. Hit:\
      ...
      \ on its turn, the target can make a DC 20 Constitution saving throw, ending\
  ...
  - "desc": "Vecna conjures a torrent of flying, spectral entities that fill a 120-foot\
      ...
      \ save, the creature takes 36 (8d8) necrotic damage and is [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ of Vecna for 1 minute. On a successful save, the creature takes half as much\
      \ damage and isn't [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened).\
      \ A [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
  ...
  - "desc": "Vecna causes necrotic magic to engulf one creature he can see within\
      ...
      \ on a successful one. A Humanoid killed by this magic rises as a [zombie](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/zombie.md)\
      \ at the start of Vecna's next turn and acts immediately after Vecna in the\
      \ initiative order. The [zombie](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/zombie.md)\
...
"reactions":
  ...
  - "desc": "Vecna utters a dread word to interrupt a creature he can see that is\
      ...
      \ Whatever the spell's level, the caster takes 10 (3d6) psychic damage if\
      \ the spell fails."
...
"source":
  - "VD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/vecna-the-archlich-vd.webp"
```
^statblock