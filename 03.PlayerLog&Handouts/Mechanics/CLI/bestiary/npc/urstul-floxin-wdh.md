...
- Urstul Floxin
---
# [Urstul Floxin](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\npc/urstul-floxin-wdh.md)
...
"traits":
  - "desc": "During its first turn, Urstul has advantage on attack rolls against any\
      \ creature that hasn't taken a turn. Any hit Urstul scores against a [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
  ...
  - "desc": "If Urstul is subjected to an effect that allows him to make a Dexterity\
    ...
    "name": "Evasion"
  - "desc": "Urstul deals an extra 14 (4d6) damage when he hits a target with a\
      \ weapon attack and has advantage on the attack roll, or when the target is\
      \ within 5 feet of an ally of Urstul that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "WDH"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/urstul-floxin-wdh.webp"
```
^statblock