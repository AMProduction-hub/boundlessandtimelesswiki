...
"actions":
  ...
  - "desc": "Five aarakocra within 30 feet of each other can magically summon an [air\
      ...
      \ to perform an aerial dance and must maintain [concentration](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration)\
...
"source":
  - "ToA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/asharra-toa.webp"
```
^statblock