...
"traits":
  ...
  - "desc": "Portia suffers from Shadowfell despair manifesting as unshakable dread.\
      ...
      \ the following flaw: \"I'm convinced that I'm going to die in Vanrakdoom.\"\
      \ Portia can attempt to end her despair each time she finishes a long rest,\
      \ doing so with a successful DC 15 Wisdom saving throw. A [calm emotions](03.PlayerLog&Handouts/Mechanics/CLI/spells/calm-emotions.md)\
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/portia-dzuth-wdmm.webp"
```
^statblock