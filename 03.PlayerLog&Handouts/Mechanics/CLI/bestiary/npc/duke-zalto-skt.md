...
"traits":
  - "desc": "Zalto deals double damage to objects and structures."
    "name": "Siege Monster"
  - "desc": "Zalto wears a [ring of lightning resistance](03.PlayerLog&Handouts/Mechanics/CLI/items/ring-of-lightning-resistance.md)."
    "name": "Special Equipment"
  - "desc": "When Zalto enters any enemy's space for the first time on a turn, the\
      \ enemy must succeed on a DC 19 Strength saving throw or be knocked [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)."
    "name": "Tackle"
"actions":
...
"source":
  - "SKT"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/duke-zalto-skt.webp"
```
^statblock