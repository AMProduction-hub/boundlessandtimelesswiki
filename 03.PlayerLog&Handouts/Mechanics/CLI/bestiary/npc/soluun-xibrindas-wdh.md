...
"traits":
  ...
  - "desc": "Soluun has advantage on saving throws against being [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed),\
  ...
  - "desc": "Whilst wearing these boots Soluun's steps make no sound and he has advantage\
      \ on any Dexterity ([Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth))\
...
"source":
  - "WDH"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/soluun-xibrindas-wdh.webp"
```
^statblock