...
---
# [Aribeth de Tylmarande](03 - Player Log & Handouts\Mechanics\CLI\bestiary\npc/aribeth-de-tylmarande-mabjov.md)
...
- "desc": "Aribeth casts one of the following spells, using Charisma as the spellcasting\
    \ ability (spell save DC 15):\n\n1/day: [dispel magic](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/dispel-magic.md)\n\
...
- "desc": "Aribeth is accompanied by a [nightmare](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/fiend/nightmare.md).\
...
- "desc": "Aribeth regains 20 hit points at the start of her turn. If Aribeth takes\
    ...
    \ doesn't regenerate."
  "name": "Regeneration"
- "desc": "Three [shadows](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/undead/shadow.md)\
    \ hide within the saddle of Aribeth's nightmare. These shadows only come out if\
    \ there is a creature within 30 feet that is at 0 hit points. When that happens,\
    \ a shadow emerges and attacks the creature in order to make it fail a death saving\
    \ throw. It continues to do so until the creature is dead."
  "name": "Shadows"
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 5 ft., one target. Hit: 7 (1d8\
    ...
    \ dealt by the sword Void dies and can't be revived by any means short of a [wish](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/wish.md)\
    \ spell."
  "name": "Void"
...
"source":
- "MaBJoV"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/npc/token/aribeth-de-tylmarande-mabjov.webp"
```
^statblock