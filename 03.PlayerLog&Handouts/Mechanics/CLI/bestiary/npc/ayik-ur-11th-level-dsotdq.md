...
- "Ayik Ur (11th Level)"
---
# [Ayik Ur (11th Level)](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/ayik-ur-11th-level-dsotdq.md)
*Source: Dragonlance: Shadow of the Dragon Queen p. 211*  

```statblock
"name": "Ayik Ur (11th Level) (DSotDQ)"
"size": "Medium"
"type": "humanoid"
"subtype": "human"
...
"traits":
  - "desc": "Ayik gains a +2 bonus to all attack rolls (included below)."
    "name": "Attacker"
  - "desc": "Ayik is proficient with simple and martial weapons, shields, and all\
      \ armor."
  ...
  - "desc": "Ayik can attack twice, instead of once, whenever he takes the [Attack](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Attack)\
      \ action on his turn."
    "name": "Extra Attack"
  - "desc": "Ayik has advantage on initiative rolls."
    "name": "Battle Readiness"
  - "desc": "Ayik's Armor Class increases by 1."
    "name": "Improved Defense"
  - "desc": "Ayik can reroll a saving throw that he fails, but he must use the new\
      \ roll. Once he uses this feature, he can't use it again until he finishes a\
      \ long rest."
    "name": "Indomitable"
"actions":
