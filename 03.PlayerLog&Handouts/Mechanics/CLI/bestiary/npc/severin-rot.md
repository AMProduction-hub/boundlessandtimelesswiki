...
"condition_immunities": "While wearing the mask of the Dragon Queen: [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed),\
...
"cr": "11"
"traits":
  - "desc": "Severin has the [Mask of the Dragon Queen](03.PlayerLog&Handouts/Mechanics/CLI/items/mask-of-the-dragon-queen-rot.md)."
...
"legendary_actions":
  ...
  - "desc": "Severin targets one creature he can see within 30 feet of him. The target\
      ...
      \ target takes 21 (6d6) fire damage at the start of each of its turns. At\
      \ the end of its turns, the target can make a DC 17 Strength saving throw, ending\
      \ the effect on itself on a success."
    "name": "Hellish Chains (Costs 3 Actions)"
"source":
  - "RoT"
  - "ToD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/severin-rot.webp"
```
^statblock