...
"cr": "3"
"traits":
  - "desc": "Naevys Tharesso has advantage on saving throws against being [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)."
    "name": "Brave"
"actions":
  ...
  - "desc": "Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit: 6\
      ...
      \ in a 40-foot radius and dim light for an additional 40 feet. While the sword\
      \ is ablaze, it deals an extra 2d6 fire damage to any target it hits. The flames\
  ...
  - "desc": "For 1 minute, Naevys Tharesso can utter a special command or warning\
      ...
      \ provided it can hear and understand Naevys Tharesso. A creature can benefit\
      \ from only one Leadership die at a time. This effect ends if Naevys Tharesso\
      \ is [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)."
    "name": "Leadership (Recharges after a Short or Long Rest)"
"reactions":
  - "desc": "Naevys Tharesso adds 2 to its AC against one melee attack that would\
      \ hit it. To do so, Naevys Tharesso must see the attacker and be wielding a\
      \ melee weapon."
    "name": "Parry"
"source":
  - "KftGV"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/naevys-tharesso-kftgv.webp"
```
^statblock