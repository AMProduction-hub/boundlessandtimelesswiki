...
"actions":
  ...
  - "desc": "Each non-undead creature within 60 feet of Leedara that can see her must\
      ...
      \ for the next 24 hours. The aging effect can be reversed with a [greater restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/greater-restoration.md)\
  ...
  - "desc": "One humanoid that the ghost can see within 5 feet of it must succeed\
      ...
      \ other effect, except ones that turn undead, and she retains her alignment,\
      ...
      \ She otherwise uses the possessed target's statistics, but doesn't gain access\
      \ to the target's knowledge, class features, or proficiencies.\n\nThe possession\
      \ lasts until the body drops to 0 hit points, Leedara ends it as a bonus action,\
      \ or Leedara is turned or forced out by an effect like the [dispel evil and\
...
"source":
  - "DSotDQ"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/leedara-dsotdq.webp"
```
^statblock