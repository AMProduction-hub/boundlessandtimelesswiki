...
"ac": !!int "24"
"ac_class": "[+3 leather armor](03.PlayerLog&Handouts/Mechanics/CLI/items/3-armor.md),\
  \ Suave Defense"
"hp": !!int "123"
"hit_dice": "19d8 + 38"
"modifier": !!int "6"
...
"traits":
  ...
  - "desc": "Jarlaxle wears [+3 leather armor](03.PlayerLog&Handouts/Mechanics/CLI/items/3-armor.md),\
      \ a [hat of disguise](03.PlayerLog&Handouts/Mechanics/CLI/items/hat-of-disguise.md),\
      \ a [bracer of flying daggers](03.PlayerLog&Handouts/Mechanics/CLI/items/bracer-of-flying-daggers-wdh.md),\
      \ a [cloak of invisibility](03.PlayerLog&Handouts/Mechanics/CLI/items/cloak-of-invisibility.md),\
      \ a [knave's eye patch](03.PlayerLog&Handouts/Mechanics/CLI/items/knaves-eye-patch-wdh.md),\
      \ and a [ring of truth telling](03.PlayerLog&Handouts/Mechanics/CLI/items/ring-of-truth-telling-wdh.md).\
      \ He wields a [+3 rapier](03.PlayerLog&Handouts/Mechanics/CLI/items/3-weapon.md)\
      \ and carries a [portable hole](03.PlayerLog&Handouts/Mechanics/CLI/items/portable-hole.md)\
      \ and a [wand of web](03.PlayerLog&Handouts/Mechanics/CLI/items/wand-of-web.md).\
      \ His hat is adorned with a [feather of diatryma summoning](03.PlayerLog&Handouts/Mechanics/CLI/items/feather-of-diatryma-summoning-wdh.md)."
  ...
  - "desc": "If he is subjected to an effect that allows him to make a Dexterity saving\
      ...
      \ if he's [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)."
    "name": "Evasion"
  - "desc": "Jarlaxle has advantage on saving throws against being [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed),\
  ...
  - "desc": "Jarlaxle deals an extra 24 (7d6) damage when he hits a target with\
      ...
      \ within 5 feet of an ally of Jarlaxle's that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
  ...
  - "desc": "When not wearing his knave's eye patch, Jarlaxle has disadvantage on\
      \ attack rolls, as well as on Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
...
"source":
  - "WDH"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/jarlaxle-baenre-wdh.webp"
```
^statblock