...
"reactions":
  - "desc": "Khaspere adds 2 to its AC against one melee attack that would hit it.\
      \ To do so, Khaspere must see the attacker and be wielding a melee weapon."
    "name": "Parry"
"source":
  - "SKT"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/khaspere-drylund-skt.webp"
```
^statblock