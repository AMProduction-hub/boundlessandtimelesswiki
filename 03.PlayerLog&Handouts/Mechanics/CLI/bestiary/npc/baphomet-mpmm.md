...
- Baphomet
---
# [Baphomet](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\npc/baphomet-mpmm.md)
...
Baphomet's lair is his palace, the Lyktion, which is on the layer of the Abyss called the Endless Maze. Nestled within the twisting passages of the plane-wide labyrinth, the Lyktion is immaculately maintained and surrounded by a moat constructed in the fashion of a three-dimensional maze. The palace is a towering structure whose interior is as labyrinthine as the plane on which it stands; it is populated by [minotaurs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/minotaur.md), [goristros](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/goristro.md), and [quasits](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/quasit.md).
...
"traits":
  - "desc": "Baphomet can perfectly recall any path he has traveled, and he is immune\
      \ to the [maze](03.PlayerLog&Handouts/Mechanics/CLI/spells/maze.md) spell."
...
"actions":
  ...
  - "desc": "Each creature of Baphomet's choice within 120 feet of him and aware of\
      \ him must succeed on a DC 18 Wisdom saving throw or become [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
  ...
  - "desc": "Baphomet casts one of the following spells, requiring no material components\
      ...
      \ [maze](03.PlayerLog&Handouts/Mechanics/CLI/spells/maze.md), [wall of stone](03.PlayerLog&Handouts/Mechanics/CLI/spells/wall-of-stone.md)\n\
...
"legendary_actions":
  ...
  - "desc": "Baphomet moves up to his speed without provoking [opportunity attacks](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Opportunity%20Attack),\
...
"regional_effects":
  ...
  - "desc": "- Beguiling Realm. Within 6 miles of the lair, all Charisma ([Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion))\
      ...
      \ lair become [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/baphomet-mpmm.webp"
```
^statblock