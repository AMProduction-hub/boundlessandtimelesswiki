...
---
# [Xzar the Chaos Clone](03 - Player Log & Handouts\Mechanics\CLI\bestiary\npc/xzar-the-chaos-clone-mabjov.md)
...
"ac": !!int "15"
"ac_class": "18 with [mage armor](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/mage-armor.md)"
"hp": !!int "121"
"hit_dice": "22d8 + 22"
"stats":
- !!int "12"
...
- "desc": "Xzar casts one of the following spells, requiring no material components\
    ...
    \n1/day each: [abi-dalzim's horrid wilting](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/abi-dalzims-horrid-wilting-xge.md),\
...
- "desc": "Since Xzar doesn't have a soul, resurrection magic is able to work upon\
    \ him no matter how much time has passed. For example, the [revivify](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/revivify.md)\
...
- "desc": "Negative energy erupts from Xzar, intensified by the Chaos Phage. Any creature\
    \ in a 60-foot-radius sphere around Xzar (but not including Xzar) must make a\
    \ DC 17 Constitution saving throw. A creature takes 36 (8d6) necrotic damage\
...
"source":
- "MaBJoV"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/npc/token/xzar-the-chaos-clone-mabjov.webp"
```
^statblock