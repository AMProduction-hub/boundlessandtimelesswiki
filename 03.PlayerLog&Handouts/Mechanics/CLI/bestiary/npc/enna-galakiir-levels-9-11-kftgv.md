...
---
# [Enna Galakiir (Levels 9-11)](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/enna-galakiir-levels-9-11-kftgv.md)
...
"traits":
  ...
  - "desc": "If Enna Galakiir is subjected to an effect that allows it to make a Dexterity\
    ...
    "name": "Evasion"
  - "desc": "Enna Galakiir deals an extra 14 (4d6) damage when it hits a target\
      \ with a weapon attack and has advantage on the attack roll, or when the target\
      \ is within 5 feet of an ally of Enna Galakiir that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "KftGV"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/enna-galakiir-levels-9-11-kftgv.webp"
```
^statblock