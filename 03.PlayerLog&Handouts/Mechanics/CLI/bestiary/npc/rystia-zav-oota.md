...
- "Rystia Zav"
---
# [Rystia Zav](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/rystia-zav-oota.md)
...
"cr": "1"
"traits":
  - "desc": "On each of its turns, Rystia can use a bonus action to take the [Dash](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Dash),\
  ...
  - "desc": "Rystia deals an extra 7 (2d6) damage when it hits a target with a weapon\
      ...
      \ 5 feet of an ally of Rystia that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "OotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/rystia-zav-oota.webp"
```
^statblock