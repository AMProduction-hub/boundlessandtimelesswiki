...
"traits":
  - "desc": "Narrak is a 5th-level spellcaster. His spellcasting ability is Charisma\
    ...
    "name": "Spellcasting"
  - "desc": "Narrak has advantage on saving throws against being [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
...
"source":
  - "OotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/narrak-oota.webp"
```
^statblock