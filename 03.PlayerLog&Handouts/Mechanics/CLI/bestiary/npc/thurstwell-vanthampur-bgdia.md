...
"traits":
  - "desc": "Thurstwell is a 2nd-level spellcaster. His spellcasting ability is Wisdom\
    ...
    "name": "Spellcasting"
  - "desc": "Thurstwell has advantage on saving throws against being [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
...
"source":
  - "BGDIA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/thurstwell-vanthampur-bgdia.webp"
```
^statblock