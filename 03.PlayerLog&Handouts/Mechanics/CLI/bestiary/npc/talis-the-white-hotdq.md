...
"ac": !!int "18"
"ac_class": "[+1 scale mail](03.PlayerLog&Handouts/Mechanics/CLI/items/1-armor.md),\
...
"traits":
  ...
  - "desc": "Talis has advantage on saving throws against being [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed),\
      \ and magic can't put her to sleep."
    "name": "Fey Ancestry"
  - "desc": "Once per turn, when Talis hits with a melee attack, she can expend a\
...
"source":
  - "HotDQ"
  - "ToD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/talis-the-white-hotdq.webp"
```
^statblock