...
- "Jarl Grugnur"
---
# [Jarl Grugnur](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarl-grugnur-tftyp.md)
...
"ac_class": "[chain mail](03.PlayerLog&Handouts/Mechanics/CLI/items/chain-mail.md),\
  \ [arrow-catching shield](03.PlayerLog&Handouts/Mechanics/CLI/items/arrow-catching-shield.md);\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +14 to hit, reach 10 ft., one target. *Hit:*\
      \ 23 (3d8 + 10) slashing damage, or 26 (3d10 + 10) slashing damage if used\
      \ with both hands."
    "name": "Longsword +2"
...
"source":
  - "TftYP"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/jarl-grugnur-tftyp.webp"
```
^statblock