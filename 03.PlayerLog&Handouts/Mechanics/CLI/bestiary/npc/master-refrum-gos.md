...
- "Master Refrum"
---
# [Master Refrum](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/master-refrum-gos.md)
...
"cr": "2"
"traits":
  - "desc": "Refrum is a 5th-level spellcaster. Its spellcasting ability is Wisdom\
      \ (spell save DC 13, +5 to hit with spell attacks). Refrum has the following\
    ...
    "name": "Spellcasting"
  - "desc": "As a bonus action, Refrum can expend a spell slot to cause its melee\
      \ weapon attacks to magically deal an extra 10 (3d6) radiant damage to a target\
      \ on a hit. This benefit lasts until the end of the turn. If Refrum expends\
...
"source":
  - "GoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/master-refrum-gos.webp"
```
^statblock