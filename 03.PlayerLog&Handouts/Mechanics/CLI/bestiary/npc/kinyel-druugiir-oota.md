...
- "Kinyel Druu'giir"
---
# [Kinyel Druu'giir](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kinyel-druugiir-oota.md)
...
"traits":
  ...
  - "desc": "During its first turn, Kinyel has advantage on attack rolls against any\
      \ creature that hasn't taken a turn. Any hit Kinyel scores against a [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
  ...
  - "desc": "Kinyel deals an extra 14 (4d6) damage when it hits a target with a\
      ...
      \ within 5 feet of an ally of Kinyel that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "OotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/kinyel-druugiir-oota.webp"
```
^statblock