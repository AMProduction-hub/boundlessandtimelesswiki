...
- ttrpg-cli/monster/type/humanoid/mulan-human
statblock: inline
statblock-link: "#^statblock"
aliases:
- "Kaevja Cynavern"
---
# [Kaevja Cynavern](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kaevja-cynavern-wdh.md)
...
"cr": "6"
"traits":
  - "desc": "Kaevja is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
      \ (spell save DC 14, +6 to hit with spell attacks). Kaevja has the following\
      ...
      **3rd level (3 slots):** [counterspell](03.PlayerLog&Handouts/Mechanics/CLI/spells/counterspell.md),\
      \ [fireball](03.PlayerLog&Handouts/Mechanics/CLI/spells/fireball.md), [sending](03.PlayerLog&Handouts/Mechanics/CLI/spells/sending.md)\n\
    ...
    "name": "Spellcasting"
  - "desc": "Kaevja carries a yellow [elemental gem](03.PlayerLog&Handouts/Mechanics/CLI/items/elemental-gem.md).\
      \ As an action she can break the gem releasing an earth elemental under her\
      \ command."
...
"source":
  - "WDH"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/kaevja-cynavern-wdh.webp"
```
^statblock