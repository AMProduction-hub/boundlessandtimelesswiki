...
- "Arrigal"
---
# [Arrigal](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/arrigal-cos.md)
...
"traits":
  - "desc": "During its first turn, Arrigal has advantage on attack rolls against\
      \ any creature that hasn't taken a turn. Any hit Arrigal scores against a [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
  ...
  - "desc": "Arrigal deals an extra 14 (4d6) damage when it hits a target with a\
      ...
      \ within 5 feet of an ally of Arrigal that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "CoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/arrigal-cos.webp"
```
^statblock