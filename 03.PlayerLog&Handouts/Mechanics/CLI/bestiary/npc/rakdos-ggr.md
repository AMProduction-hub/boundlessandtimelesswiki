...
"traits":
  - "desc": "Rakdos's spellcasting ability is Charisma (spell save DC 25). He can\
      \ innately cast [hellish rebuke](03.PlayerLog&Handouts/Mechanics/CLI/spells/hellish-rebuke.md)\
  ...
  - "desc": "Any creature that starts its turn within 30 feet of Rakdos must make\
      \ a DC 25 Wisdom saving throw. On a failed save, the creature becomes [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
...
"legendary_actions":
  ...
  - "desc": "Rakdos makes a claw attack against one creature within 10 feet of him.\
      \ The target must succeed on a DC 25 Constitution saving throw or be [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned)\
      \ for 1 minute. While [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned)\
      \ in this way, the creature can't maintain [concentration](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration)\
      \ on a spell or any other effect that requires [concentration](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration).\
...
"source":
  - "GGR"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/rakdos-ggr.webp"
```
^statblock