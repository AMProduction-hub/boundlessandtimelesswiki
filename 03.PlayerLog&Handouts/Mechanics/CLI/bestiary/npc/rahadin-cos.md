...
"traits":
  ...
  - "desc": "Any creature within 10 feet of Rahadin that isn't protected by a [mind\
      \ blank](03.PlayerLog&Handouts/Mechanics/CLI/spells/mind-blank.md) spell hears\
      \ in its mind the screams of the thousands of people Rahadin has killed. As\
      \ a bonus action, Rahadin can force all creatures that can hear the screams\
      \ to make a DC 16 Wisdom saving throw. Each creature takes 16 (3d10) psychic\
      \ damage on a failed save, or half as much damage on a successful one."
    "name": "Deathly Choir"
  - "desc": "Rahadin has advantage on saving throws against being [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed),\
...
"source":
  - "CoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/rahadin-cos.webp"
```
^statblock