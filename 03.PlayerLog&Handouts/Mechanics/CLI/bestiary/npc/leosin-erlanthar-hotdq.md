...
"traits":
  - "desc": "Leosin Erlanthar is presented in Hoard of the Dragon Queen as a half-elf\
      \ monk. The [martial arts adept](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/martial-arts-adept-mpmm.md)\
...
"source":
  - "HotDQ"
  - "ToD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/leosin-erlanthar-hotdq.webp"
```
^statblock