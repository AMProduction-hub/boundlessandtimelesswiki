...
"actions":
  ...
  - "desc": "Moloch exhales in a 30-foot cube. Each creature in that area must succeed\
      ...
      \ it is holding, and become [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ of Moloch for 1 minute. While [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ in this way, a creature must take the [Dash](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Dash)\
      ...
      \ If the creature ends its turn in a location where it doesn't have line of\
      \ sight to Moloch, the creature can repeat the saving throw, ending the effect\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/moloch-mpmm.webp"
```
^statblock