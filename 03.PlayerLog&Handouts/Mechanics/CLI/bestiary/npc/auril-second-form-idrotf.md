...
- Auril instantly knows the locations and health of all other creatures on the island. She knows how much damage each of these creatures has taken, how many levels of [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion) they have, and what conditions are affecting them currently.  
...
"cr": "10"
"traits":
  - "desc": "Auril can't be [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
  ...
  - "desc": "When Auril drops to 0 hit points, her body collapses into shards of ice,\
      \ whereupon Auril instantly reappears in her [third form](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/auril-third-form-idrotf.md),\
  ...
  - "desc": "Auril has advantage on saving throws against spells and other magical\
      \ effects."
...
"actions":
  ...
  - "desc": "Auril causes a magical blast of cold air to erupt from her hand. Each\
      ...
      \ 36 (8d8) cold damage on a failed save, or half as much damage on a successful\
      \ one."
  ...
  - "desc": "Auril breaks off an icicle from her body and hurls it into an unoccupied\
      ...
      \ an [ice mephit](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/ice-mephit.md)\
      \ (see its entry in the Monster Manual). The mephit acts immediately after Auril\
      \ in the initiative order and obeys her commands."
    "name": "Create Ice Mephit (3/Day)"
  - "desc": "Auril magically creates a gem-sized ice crystal that hovers in a space\
      \ within 5 feet of her. Auril then targets a creature she can see within 60\
      ...
      \ in the crystal is [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned),\
...
"legendary_actions":
  ...
  - "desc": "Auril uses Create Ice Mephit or causes one to ice mephit she can see\
      ...
      \ not use its Death Burst. Instead, each creature within 10 feet of the exploding\
      \ mephit must succeed on a DC 21 Dexterity saving throw, taking 13 (3d8) piercing\
      \ damage on a failed saving throw, and half as much damage on a successful one."
    "name": "Splinter (Costs 3 Actions)"
"source":
  - "IDRotF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/auril-second-form-idrotf.webp"
```
^statblock