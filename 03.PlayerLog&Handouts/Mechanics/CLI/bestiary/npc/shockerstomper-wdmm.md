...
"traits":
  ...
  - "desc": "A creature atop or above Shockerstomper's platform can locate its control\
      \ module with a successful DC 15 Intelligence ([Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation))\
      \ check or Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
      \ check. As an action, a character can try to open the control module's access\
      \ panel, either by tearing it off with a successful DC 25 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics))\
  ...
  - "desc": "A character can try to plug the nozzle of a lightning turret with a 10-pound\
      \ rock or similar object, doing so with a successful DC 15 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics))\
      ...
      \ check. Shockerstomper has no ability to clear an obstruction itself."
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/shockerstomper-wdmm.webp"
```
^statblock