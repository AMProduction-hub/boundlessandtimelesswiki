...
"traits":
  - "desc": "Mobar can use its action to polymorph into a Medium bat-humanoid hybrid,\
      ...
      \ it dies."
    "name": "Shapechanger"
  - "desc": "Mobar has blindsight out to a range of 60 feet as long as it's not [deafened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Deafened)."
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/mobar-wdmm.webp"
```
^statblock