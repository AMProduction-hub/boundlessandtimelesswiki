...
"actions":
  ...
  - "desc": "Beledros exhales decaying energy in a 90-foot cone. Each creature in\
      \ that area must make a DC 23 Constitution saving throw, taking 39 (6d12)\
      \ necrotic damage and 39 (6d12) poison damage on a failed save, or half as\
      \ much damage on a successful one. A creature that takes damage from the breath\
      \ can't regain hit points until the start of Beledros's next turn."
...
"legendary_actions":
  ...
  - "desc": "Beledros magically summons d4 [pest mascots](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/pest-mascot-scc.md)\
      ...
      \ feet of one or more of these pests. When one of these pests drops to 0 hit\
      \ points, Beledros regains 9 hit points. These pests disappear after 10 minutes,\
      \ when Beledros dies, or when she uses this action again."
    "name": "Teeming with Life (Costs 3 Actions)"
"source":
  - "SCC"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/beledros-witherbloom-scc.webp"
```
^statblock