...
"traits":
  ...
  - "desc": "Drannin can reroll a saving throw that he fails. He must use the new\
      \ roll."
  ...
  - "desc": "Drannin wears a control amulet for his [shield guardian](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/shield-guardian.md)\
      \ (see the Monster Manual) and a [ring of cold resistance](03.PlayerLog&Handouts/Mechanics/CLI/items/ring-of-cold-resistance.md).\
      \ He also carries a [potion of frost giant strength](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-frost-giant-strength.md)."
...
"source":
  - "PotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/drannin-splithelm-pota.webp"
```
^statblock