...
Avarice has a pair of loyal [gargoyles](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/gargoyle.md) named Gargle and Gurgle who serve her as bodyguards and scouts. Avarice uses her [Rary's telepathic bond](03.PlayerLog&Handouts/Mechanics/CLI/spells/rarys-telepathic-bond.md) spell to stay in telepathic contact with her gargoyles before sending them off on any mission. Avarice also has the support of the Knights of the Black Sword, if she needs to call on their talents.

## Familiar

Avarice's familiar throughout the adventure is a squawking raven named Skelm. It uses the [raven](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/raven.md) stat block in the "Monster Manual" but is a fiend instead of a beast.

## Spellbook

Avarice's spellbook has white leather covers and vellum pages. The tiefling's personal sigil is burned into the front cover. The book contains the spells Avarice has prepared plus the following additional spells: [burning hands](03.PlayerLog&Handouts/Mechanics/CLI/spells/burning-hands.md), [cone of cold](03.PlayerLog&Handouts/Mechanics/CLI/spells/cone-of-cold.md), [find familiar](03.PlayerLog&Handouts/Mechanics/CLI/spells/find-familiar.md), [ice storm](03.PlayerLog&Handouts/Mechanics/CLI/spells/ice-storm.md), [lightning bolt](03.PlayerLog&Handouts/Mechanics/CLI/spells/lightning-bolt.md), [rope trick](03.PlayerLog&Handouts/Mechanics/CLI/spells/rope-trick.md), [thunderwave](03.PlayerLog&Handouts/Mechanics/CLI/spells/thunderwave.md), [tongues](03.PlayerLog&Handouts/Mechanics/CLI/spells/tongues.md), [wall of fire](03.PlayerLog&Handouts/Mechanics/CLI/spells/wall-of-fire.md), and [wall of force](03.PlayerLog&Handouts/Mechanics/CLI/spells/wall-of-force.md).
...
"traits":
  ...
  - "desc": "When Avarice dies, her corpse freezes for 9 days, during which time it\
    ...
    "name": "Icy Doom"
  - "desc": "Avarice wields a [staff of frost](03.PlayerLog&Handouts/Mechanics/CLI/items/staff-of-frost.md)\
...
"actions":
  ...
  - "desc": "While holding this staff, Avarice can expend 1 or more of its charges\
      \ to cast one of the following spells from it (spell save DC 14): [cone of cold](03.PlayerLog&Handouts/Mechanics/CLI/spells/cone-of-cold.md)\
      \ (5 charges), [fog cloud](03.PlayerLog&Handouts/Mechanics/CLI/spells/fog-cloud.md)\
      \ (1 charge), [ice storm](03.PlayerLog&Handouts/Mechanics/CLI/spells/ice-storm.md)\
      \ (4 charges), or [wall of ice](03.PlayerLog&Handouts/Mechanics/CLI/spells/wall-of-ice.md)\
      \ (4 charges). The staff regains 1d6 + 4 charges daily at dawn. If its last\
      \ charge is expended, roll a d20; on a 1, the staff turns to water and is\
      \ destroyed."
    "name": "Staff of Frost"
"reactions":
...
"source":
  - "IDRotF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/avarice-idrotf.webp"
```
^statblock