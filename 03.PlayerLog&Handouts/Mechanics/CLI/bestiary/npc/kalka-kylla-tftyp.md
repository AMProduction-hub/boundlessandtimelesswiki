...
- "Kalka-Kylla"
---
# [Kalka-Kylla](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kalka-kylla-tftyp.md)
...
"traits":
  ...
  - "desc": "Kalka-Kylla can use a bonus action to retract into or emerge from its\
      \ shell. While retracted, Kalka-Kylla gains a +4 bonus to AC, and it has a speed\
      \ of 0 and can't benefit from bonuses to speed."
    "name": "Shell"
"actions":
...
"source":
  - "TftYP"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/kalka-kylla-tftyp.webp"
```
^statblock