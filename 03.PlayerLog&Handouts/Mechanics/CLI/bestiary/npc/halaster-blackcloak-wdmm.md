...
"ac": !!int "14"
"ac_class": "17 with [mage armor](03.PlayerLog&Handouts/Mechanics/CLI/spells/mage-armor.md)"
"hp": !!int "246"
"hit_dice": "29d8 + 116"
"modifier": !!int "4"
"stats":
...
"traits":
  - "desc": "Halaster is a 20th-level spellcaster. His spellcasting ability is Intelligence\
      \ (spell save DC 22, +14 to hit with spell attacks). He can cast [disguise\
      ...
      \ at will. He can cast [fly](03.PlayerLog&Handouts/Mechanics/CLI/spells/fly.md)\
  ...
  - "desc": "Halaster wears a [robe of eyes](03.PlayerLog&Handouts/Mechanics/CLI/items/robe-of-eyes.md)\
      ...
      \ 120 feet, grants advantage on Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
      \ checks that rely on sight, and allows him to see [invisible](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Invisible)\
      \ creatures and objects, as well as into the Ethereal Plane, out to a range\
      \ of 120 feet.\n\nHalaster wields a [blast scepter](03.PlayerLog&Handouts/Mechanics/CLI/items/blast-scepter-wdmm.md)\
      ...
      \ lightning damage and can, as an action, use it to cast [thunderwave](03.PlayerLog&Handouts/Mechanics/CLI/spells/thunderwave.md)\
  ...
  - "desc": "If Halaster dies in Undermountain, he revives after d10 days, with\
    ...
    "name": "Rejuvenation"
"actions":
  - "desc": "Halaster uses his blast scepter to cast [thunderwave](03.PlayerLog&Handouts/Mechanics/CLI/spells/thunderwave.md)\
...
"regional_effects":
  ...
  - "desc": "- A magical scrying sensor appears, taking the form of a ghostly, 1-foot-diameter\
      ...
      \ but it winks out within an [antimagic field](03.PlayerLog&Handouts/Mechanics/CLI/spells/antimagic-field.md).\
      ...
      \ illusion](03.PlayerLog&Handouts/Mechanics/CLI/spells/minor-illusion.md) in\
      \ an area. Common illusions include the echo of rattling chains, the distant\
      \ sound of explosive spells being cast, a dusty cloak or a rusty helm floating\
      \ as though worn by an [invisible](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Invisible)\
