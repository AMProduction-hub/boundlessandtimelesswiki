...
"actions":
  - "desc": "Melee  or Ranged Weapon Attack: +9 to hit, reach 5 ft. or range 20/60\
    ...
    "name": "Windvane"
"lair_actions":
  - "desc": "If Aerisi is in the air node while [Yan-C-Bin](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/yan-c-bin-pota.md)\
...
"source":
  - "PotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/aerisi-kalinoth-pota.webp"
```
^statblock