...
"traits":
  - "desc": "During its first turn, Ghald has advantage on attack rolls against any\
      \ creature that hasn't taken a turn. Any hit Ghald scores against a [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
  ...
  - "desc": "Ghald can magically command any shark within 120 feet of him, using a\
      \ limited telepathy."
  ...
  - "desc": "Ghald deals an extra 14 (4d6) damage when he hits a target with a weapon\
      ...
      \ 5 feet of an ally of Ghald's that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "PotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/ghald-pota.webp"
```
^statblock