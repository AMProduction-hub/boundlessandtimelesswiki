...
"traits":
  - "desc": "Darz deals an extra 7 (2d6) damage when he hits a target with a weapon\
      ...
      \ 5 feet of an ally of Darz that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "SKT"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/darz-helgar-skt.webp"
```
^statblock