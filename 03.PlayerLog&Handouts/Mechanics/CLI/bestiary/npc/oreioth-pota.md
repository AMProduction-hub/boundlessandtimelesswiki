...
"traits":
  ...
  - "desc": "When a living Medium or Small humanoid within 30 feet of Oreioth dies,\
      \ he can use an action on his next turn to cast [animate dead](03.PlayerLog&Handouts/Mechanics/CLI/spells/animate-dead.md)\
...
"source":
  - "PotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/oreioth-pota.webp"
```
^statblock