...
- "Preeta Kreepa"
---
# [Preeta Kreepa](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/preeta-kreepa-wdmm.md)
...
"reactions":
  - "desc": "As a bonus action or a reaction, Preeta can shoot one of the following\
      ...
      \ The target must succeed on a DC 15 Wisdom saving throw or be [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success.  \n- **Paralyzing Ray.**\
      \ The target must succeed on a DC 15 Constitution saving throw or be [paralyzed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Paralyzed)\
      \ for 1 minute. The target can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success.  "
    "name": "Eye Rays"
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/preeta-kreepa-wdmm.webp"
```
^statblock