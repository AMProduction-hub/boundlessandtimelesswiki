...
"traits":
  - "desc": "Dragonbait is immune to disease."
    "name": "Divine Health"
  - "desc": "While holding his [holy avenger longsword](03.PlayerLog&Handouts/Mechanics/CLI/items/holy-avenger.md),\
...
"source":
  - "ToA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/dragonbait-toa.webp"
```
^statblock