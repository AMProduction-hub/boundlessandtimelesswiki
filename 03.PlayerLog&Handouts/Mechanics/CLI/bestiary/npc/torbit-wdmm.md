...
- "Torbit"
---
# [Torbit](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/torbit-wdmm.md)
...
"traits":
  - "desc": "During its first turn, Torbit has advantage on attack rolls against any\
      \ creature that hasn't taken a turn. Any hit Torbit scores against a [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
  ...
  - "desc": "If Torbit is subjected to an effect that allows it to make a Dexterity\
    ...
    "name": "Evasion"
  - "desc": "Torbit deals an extra 14 (4d6) damage when it hits a target with a\
      \ weapon attack and has advantage on the attack roll, or when the target is\
      \ within 5 feet of an ally of Torbit that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/torbit-wdmm.webp"
```
^statblock