...
"actions":
  ...
  - "desc": "Belephaion magically transforms into an [eagle](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/eagle.md)\
      \ or a [priest](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/priest.md),\
      \ while retaining his alignment, damage immunities, hit points, Hit Dice, and\
      \ Intelligence, Wisdom, and Charisma scores. This transformation ends if he\
      \ is reduced to 0 hit points or uses a bonus action to end it."
    "name": "Alter Shape"
"source":
  - "DSotDQ"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/belephaion-dsotdq.webp"
```
^statblock