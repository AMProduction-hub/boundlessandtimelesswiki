...
- "Xanathar"
---
# [Xanathar](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/xanathar-wdh.md)
...
Xanathar is extremely fond of gold. A few years ago, its spies stole the [Stone of Golorr](03.PlayerLog&Handouts/Mechanics/CLI/items/stone-of-golorr-wdh.md), which contained information that led to the discovery of a dwarven vault under Waterdeep. Xanathar was able to open the vault, but was forced out by the dragon inside the place. Recently, someone stole the [Stone of Golorr](03.PlayerLog&Handouts/Mechanics/CLI/items/stone-of-golorr-wdh.md) from where it was hidden inside its lair, and the beholder is convinced that the Black Network is behind the theft.
...
"cr": "13"
"traits":
  - "desc": "Xanathar wears a [ring of invisibility](03.PlayerLog&Handouts/Mechanics/CLI/items/ring-of-invisibility.md),\
      \ a [ring of mind shielding](03.PlayerLog&Handouts/Mechanics/CLI/items/ring-of-mind-shielding.md),\
      \ and a [ring of resistance (force)](03.PlayerLog&Handouts/Mechanics/CLI/items/ring-of-force-resistance.md)."
  ...
  - "desc": "Xanathar's central eye creates an area of antimagic, as in the [antimagic\
      ...
      \ in a 150-foot cone. At the start of each of its turns, Xanathar decides which\
      \ way the cone faces and whether the cone is active. The area works against\
      \ Xanathar's own eye rays."
    "name": "Antimagic Cone"
"actions":
  ...
  - "desc": "Xanathar shoots three of the following magical eye rays at random (reroll\
      ...
      \ by Xanathar for 1 hour, or until Xanathar harms the creature.  \n- **2. Paralyzing\
      ...
      \ 30 feet in any direction. It is [restrained](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Restrained)\
      \ by the ray's telekinetic grip until the start of Xanathar's next turn or until\
      \ Xanathar is [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated).\
...
"lair_actions":
  - "desc": "When fighting inside its lair, a beholder can invoke the ambient magic\
      ...
      \ a DC 15 Dexterity saving throw or be [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled).\
      \ Escaping requires a successful DC 15 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics))\
...
"regional_effects":
  - "desc": "A region containing a beholder's lair is warped by the creature's unnatural\
    ...
    "name": ""
"legendary_description": "Xanathar can take 3 legendary actions, using the Eye Ray\
  \ option below. It can take only one legendary action at a time and only at the\
  \ end of another creature's turn. Xanathar regains spent legendary actions at the\
  \ start of its turn."
"legendary_actions":
...
"source":
  - "WDH"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/xanathar-wdh.webp"
```
^statblock