...
"traits":
  ...
  - "desc": "Murgaxor wears an Oriq mask. While wearing the mask, Murgaxor can't be\
      ...
      \ and he adds double his proficiency bonus to Charisma ([Deception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Deception))\
      \ checks (included above)."
    "name": "Oriq Mask"
  - "desc": "While Murgaxor isn't [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded),\
...
"source":
  - "SCC"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/murgaxor-scc.webp"
```
^statblock