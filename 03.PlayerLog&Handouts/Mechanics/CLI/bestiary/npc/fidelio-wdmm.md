...
"actions":
  ...
  - "desc": "One humanoid that Fidelio can see within 5 feet of it must succeed on\
      \ a DC 13 Charisma saving throw or be possessed by Fidelio; Fidelio then disappears,\
      ...
      \ lasts until the body drops to 0 hit points, Fidelio ends it as a bonus action,\
      \ or Fidelio is turned or forced out by an effect like the [dispel evil and\
      \ good](03.PlayerLog&Handouts/Mechanics/CLI/spells/dispel-evil-and-good.md)\
      \ spell. When the possession ends, Fidelio reappears in an unoccupied space\
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/fidelio-wdmm.webp"
```
^statblock