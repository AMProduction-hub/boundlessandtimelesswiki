...
"traits":
  - "desc": "Zuleika can use its action to polymorph into a wolf-humanoid hybrid or\
    ...
    "name": "Shapechanger"
  - "desc": "Zuleika has advantage on Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
...
"source":
  - "CoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/zuleika-toranescu-cos.webp"
```
^statblock