...
- "Valin Sarnaster"
---
# [Valin Sarnaster](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/valin-sarnaster-cm.md)
...
"traits":
  - "desc": "Valin Sarnaster is a 10th-level spellcaster. Her spellcasting ability\
      ...
      **3rd level (3 slots):** [clairvoyance](03.PlayerLog&Handouts/Mechanics/CLI/spells/clairvoyance.md),\
      ...
      \ level (1 slots):** [harm](03.PlayerLog&Handouts/Mechanics/CLI/spells/harm.md)"
    "name": "Spellcasting"
...
"actions":
  ...
  - "desc": "Valin targets one creature she can see within 60 feet of her. If the\
      ...
      \ this magic or become [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ until the end of Valin's next turn. If the target fails the saving throw by\
      \ 5 or more, it is also [paralyzed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Paralyzed)\
...
"regional_effects":
  - "desc": "Valin's tomb is warped in any of the following ways by the creature's\
      ...
      \ chance to provide misleading results, as determined by the DM. If a [divination](03.PlayerLog&Handouts/Mechanics/CLI/spells/divination.md)\
      ...
      \ spell or other magic.  \n\nIf Valin is destroyed, these regional effects end\
      \ immediately."
    "name": ""
...
"legendary_actions":
  ...
  - "desc": "Blinding dust and sand swirls magically around Valin. Each creature within\
      \ 5 feet of Valin must succeed on a DC 16 Constitution saving throw or be [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded)\
  ...
  - "desc": "Valin magically transforms into a whirlwind of sand, moves up to 60 feet,\
      ...
      \ all damage, and it can't be [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled),\
...
"source":
  - "CM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/valin-sarnaster-cm.webp"
```
^statblock