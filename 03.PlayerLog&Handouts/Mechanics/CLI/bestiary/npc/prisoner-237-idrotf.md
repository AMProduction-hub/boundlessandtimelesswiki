...
Gant has neither a spellbook nor material components for spellcasting, and he can't avail himself of his magic while locked in his cell due to the [antimagic field](03.PlayerLog&Handouts/Mechanics/CLI/spells/antimagic-field.md) that encompasses it.
...
"source":
  - "IDRotF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/prisoner-237-idrotf.webp"
```
^statblock