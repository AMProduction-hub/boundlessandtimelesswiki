...
- "Kella Darkhope"
---
# [Kella Darkhope](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kella-darkhope-skt.md)
...
"cr": "1"
"traits":
  - "desc": "On each of its turns, Kella can use a bonus action to take the [Dash](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Dash),\
  ...
  - "desc": "Kella deals an extra 7 (2d6) damage when it hits a target with a weapon\
      ...
      \ 5 feet of an ally of Kella that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "SKT"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/kella-darkhope-skt.webp"
```
^statblock