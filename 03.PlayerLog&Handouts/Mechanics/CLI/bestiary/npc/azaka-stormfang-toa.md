...
"traits":
  - "desc": "The Azaka can use its action to polymorph into a tiger-humanoid hybrid\
    ...
    "name": "Shapechanger"
  - "desc": "The Azaka has advantage on Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
...
"source":
  - "ToA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/azaka-stormfang-toa.webp"
```
^statblock