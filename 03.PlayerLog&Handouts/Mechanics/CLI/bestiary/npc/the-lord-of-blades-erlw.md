...
"traits":
  ...
  - "desc": "A creature that grapples the Lord of Blades or is [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
      \ by him takes 13 (3d8) slashing damage. A creature takes 13 (3d8) slashing\
      \ damage if it starts its turn grappling or being [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
  ...
  - "desc": "If the Lord of Blades moves at least 10 feet straight toward a target\
    ...
    "name": "Charge"
  - "desc": "The Lord of Blades has advantage on saving throws against being [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned),\
...
"source":
  - "ERLW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/the-lord-of-blades-erlw.webp"
```
^statblock