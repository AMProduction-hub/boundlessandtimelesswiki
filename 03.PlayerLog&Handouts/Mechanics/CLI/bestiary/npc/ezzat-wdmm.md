...
"traits":
  - "desc": "Ezzat is an 18th-level spellcaster. His spellcasting ability is Intelligence\
      ...
      \ level (1 slots):** [dominate monster](03.PlayerLog&Handouts/Mechanics/CLI/spells/dominate-monster.md),\
    ...
    "name": "Spellcasting"
  - "desc": "Ezzat wears an [amulet of proof against detection and location](03.PlayerLog&Handouts/Mechanics/CLI/items/amulet-of-proof-against-detection-and-location.md)."
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/ezzat-wdmm.webp"
```
^statblock