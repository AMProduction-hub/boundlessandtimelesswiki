...
- "Princess Xedalli"
---
# [Princess Xedalli](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/princess-xedalli-lox.md)
...
"cr": "8"
"traits":
  - "desc": "Xedalli has advantage on saving throws it makes to avoid or end the [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ condition on itself, and magic can't put it to sleep."
    "name": "Fey Ancestry"
  - "desc": "Xedalli wears a suit of [elven chain](03.PlayerLog&Handouts/Mechanics/CLI/items/elven-chain.md)."
...
"source":
  - "LoX"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/princess-xedalli-lox.webp"
```
^statblock