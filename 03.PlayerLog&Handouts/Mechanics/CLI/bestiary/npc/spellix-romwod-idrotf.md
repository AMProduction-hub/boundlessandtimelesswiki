...
- Spellix Romwod
---
# [Spellix Romwod](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\npc/spellix-romwod-idrotf.md)
...
"actions":
  - "desc": "Melee Spell Attack: +5 to hit (with advantage on the attack roll\
      ...
      \ Hit: 4 (d8) lightning damage, and the target can't take reactions until\
      \ the start of its next turn."
    "name": "Shocking Grasp (Cantrip)"
  - "desc": "Ranged Spell Attack: +5 to hit, range 120 ft., one target. Hit:\
      \ 5 (d10) fire damage. A flammable object hit by this spell ignites if it\
