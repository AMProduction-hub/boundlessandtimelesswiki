...
- "Rilago"
---
# [Rilago](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/rilago-kftgv.md)
...
"actions":
  ...
  - "desc": "One humanoid that Rilago can see within 5 feet of it must succeed on\
      \ a DC 13 Charisma saving throw or be possessed by Rilago; Rilago then disappears,\
      \ and the target is [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
      \ and loses control of its body. Rilago now controls the body but doesn't deprive\
      \ the target of awareness. Rilago can't be targeted by any attack, spell, or\
      ...
      \ lasts until the body drops to 0 hit points, Rilago ends it as a bonus action,\
      \ or Rilago is turned or forced out by an effect like the [dispel evil and good](03.PlayerLog&Handouts/Mechanics/CLI/spells/dispel-evil-and-good.md)\
...
"source":
  - "KftGV"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/rilago-kftgv.webp"
```
^statblock