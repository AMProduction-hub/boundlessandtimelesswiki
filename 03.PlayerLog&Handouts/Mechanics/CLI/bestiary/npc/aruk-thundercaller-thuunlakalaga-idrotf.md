...
"traits":
  - "desc": "Aruk is acclimated to high altitude, including elevations above 20,000\
      \ feet."
    "name": "Mountain Born"
  - "desc": "Aruk counts as one size larger when determining its carrying capacity\
...
"source":
  - "IDRotF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/aruk-thundercaller-thuunlakalaga-idrotf.webp"
```
^statblock