...
- "Paloma"
---
# [Paloma](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/paloma-jttrc.md)
...
"traits":
  - "desc": "During its first turn, Paloma has advantage on attack rolls against any\
      \ creature that hasn't taken a turn. Any hit Paloma scores against a [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
  ...
  - "desc": "If Paloma is subjected to an effect that allows it to make a Dexterity\
    ...
    "name": "Evasion"
  - "desc": "Paloma deals an extra 14 (4d6) damage when it hits a target with a\
      \ weapon attack and has advantage on the attack roll, or when the target is\
      \ within 5 feet of an ally of Paloma that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "JttRC"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/paloma-jttrc.webp"
```
^statblock