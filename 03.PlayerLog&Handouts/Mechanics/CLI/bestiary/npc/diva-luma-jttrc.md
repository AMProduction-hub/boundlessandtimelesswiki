...
"traits":
  - "desc": "During its first turn, Diva Luma has advantage on attack rolls against\
      ...
      \ [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
  ...
  - "desc": "Diva Luma deals an extra 14 (4d6) damage when it hits a target with\
      ...
      \ within 5 feet of an ally of Diva Luma that isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
...
"source":
  - "JttRC"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/diva-luma-jttrc.webp"
```
^statblock