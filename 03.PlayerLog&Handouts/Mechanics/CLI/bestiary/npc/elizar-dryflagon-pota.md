...
"traits":
  ...
  - "desc": "By puffing on his pipe, Elizar can use an action to cast [conjure minor\
      \ elementals](03.PlayerLog&Handouts/Mechanics/CLI/spells/conjure-minor-elementals.md).\
...
"source":
  - "PotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/elizar-dryflagon-pota.webp"
```
^statblock