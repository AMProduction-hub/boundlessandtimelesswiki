...
- Gunvald Halraggson
---
# [Gunvald Halraggson](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\npc/gunvald-halraggson-idrotf.md)
...
"traits":
  ...
  - "desc": "Gunvald deals an extra 6 (d12) damage when he hits a target with a\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one target. Hit: 9\
      ...
      \ with two hands, plus 6 (d12) slashing damage if Gunvald uses Menacing Blows."
    "name": "Battleaxe"
  - "desc": "Melee  or Ranged Weapon Attack: +8 to hit, range 30/120 ft., one\
      \ target. Hit: 8 (1d6 + 5) piercing damage, plus 6 (d12) piercing damage\
      \ if Gunvald uses Menacing Blows."
    "name": "Javelin"
"source":
  - "IDRotF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/gunvald-halraggson-idrotf.webp"
```
^statblock