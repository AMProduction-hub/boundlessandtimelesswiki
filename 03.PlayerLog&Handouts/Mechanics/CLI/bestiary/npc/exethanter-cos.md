...
"legendary_actions":
  ...
  - "desc": "Exethanter fixes its gaze on one creature it can see within 10 feet of\
      ...
      \ or the effect ends for it, the target is immune to Exethanter's gaze for the\
      \ next 24 hours."
...
"source":
  - "CoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/exethanter-cos.webp"
```
^statblock