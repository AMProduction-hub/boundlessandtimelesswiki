...
Vellynne brought a family heirloom with her to Icewind Dale: a [professor orb](03.PlayerLog&Handouts/Mechanics/CLI/items/professor-orb-wdmm.md) (see appendix D) that she refers to by its proper name, [Professor Skant](03.PlayerLog&Handouts/Mechanics/CLI/items/professor-skant-idrotf.md). This orb has knowledge about Netheril that could be important if Vellynne locates the lost Netherese city buried under the Reghed Glacier. The orb was recently stolen by Nass Lantomir, one of Vellynne's rivals in the Arcane Brotherhood. Vellynne intends to get it back before resuming her quest to find Ythryn.

## Companions

Since arriving in Icewind Dale, Vellynne has secured the services of six [Icewind kobolds](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/icewind-kobold-idrotf.md) that act as her valets and guides. Two of them were killed by a [Melf's acid arrow](03.PlayerLog&Handouts/Mechanics/CLI/spells/melfs-acid-arrow.md) spell (cast by Vellynne's rival, Nass Lantomir), but Vellynne animated their corpses, turning them into zombies.

If she is wounded, Vellynne can cast [vampiric touch](03.PlayerLog&Handouts/Mechanics/CLI/spells/vampiric-touch.md) and use the spell to regain hit points at the kobolds' expense.

## Familiar

Vellynne's familiar is a snowy owl, which the wizard uses as a scout. It uses the [owl](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/owl.md) stat block in the "Monster Manual" but is a celestial instead of a beast.

## Spellbook

Vellynne's spellbook has black leather covers around pages of ragged parchment, all wrapped in a crimson sash. The necromancer's personal sigil is written in goat's blood on the title page. The tome contains the spells Vellynne has prepared plus the following additional spells: [bestow curse](03.PlayerLog&Handouts/Mechanics/CLI/spells/bestow-curse.md), [blindness/deafness](03.PlayerLog&Handouts/Mechanics/CLI/spells/blindness-deafness.md), [false life](03.PlayerLog&Handouts/Mechanics/CLI/spells/false-life.md), [find familiar](03.PlayerLog&Handouts/Mechanics/CLI/spells/find-familiar.md), [magic weapon](03.PlayerLog&Handouts/Mechanics/CLI/spells/magic-weapon.md), [polymorph](03.PlayerLog&Handouts/Mechanics/CLI/spells/polymorph.md), [protection from evil and good](03.PlayerLog&Handouts/Mechanics/CLI/spells/protection-from-evil-and-good.md), [remove curse](03.PlayerLog&Handouts/Mechanics/CLI/spells/remove-curse.md), [shield](03.PlayerLog&Handouts/Mechanics/CLI/spells/shield.md), and [Tenser's floating disk](03.PlayerLog&Handouts/Mechanics/CLI/spells/tensers-floating-disk.md).
...
"alignment": "Neutral"
"ac": !!int "13"
"ac_class": "[bracers of defense](03.PlayerLog&Handouts/Mechanics/CLI/items/bracers-of-defense.md)"
"hp": !!int "67"
"hit_dice": "9d8 + 27"
"modifier": !!int "1"
"stats":
...
"traits":
  ...
  - "desc": "Vellynne wears [bracers of defense](03.PlayerLog&Handouts/Mechanics/CLI/items/bracers-of-defense.md)\
      \ and carries a [wand of magic missiles](03.PlayerLog&Handouts/Mechanics/CLI/items/wand-of-magic-missiles.md)\
      \ (see \"Actions\" below)."
...
"actions":
  ...
  - "desc": "While holding this wand, Vellynne can expend 1 or more of its 7 charges\
      \ to cast the [magic missile](03.PlayerLog&Handouts/Mechanics/CLI/spells/magic-missile.md)\
      \ spell from it. She can expend 1 charge to cast the 1st-level version of the\
      \ spell. She can increase the spell slot level by one for each additional charge\
      \ she expends. The wand regains 1d6 + 1 expended charges daily at dawn. If\
      \ the wand's last charge is expended, roll a d20; on a 1, the wand crumbles\
      \ into ashes and is destroyed."
    "name": "Wand of Magic Missiles"
"source":
  - "IDRotF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/vellynne-harpell-idrotf.webp"
```
^statblock