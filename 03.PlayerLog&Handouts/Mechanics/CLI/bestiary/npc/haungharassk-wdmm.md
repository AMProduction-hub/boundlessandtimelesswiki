...
"traits":
  ...
  - "desc": "A creature that uses an action to touch the living snail gains 6 temporary\
      ...
      \ living snail also gains the benefit of a [remove curse](03.PlayerLog&Handouts/Mechanics/CLI/spells/remove-curse.md)\
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/haungharassk-wdmm.webp"
```
^statblock