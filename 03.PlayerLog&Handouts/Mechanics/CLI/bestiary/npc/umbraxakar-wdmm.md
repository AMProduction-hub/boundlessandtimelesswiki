...
- "Umbraxakar"
---
# [Umbraxakar](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/umbraxakar-wdmm.md)
...
"cr": "15"
"traits":
  - "desc": "Umbraxakar can breathe air and water."
    "name": "Amphibious"
  - "desc": "If Umbraxakar fails a saving throw, it can choose to succeed instead."
...
"actions":
  - "desc": "Umbraxakar can use its Frightful Presence. It then makes three attacks:\
  ...
  - "desc": "*Melee Weapon Attack:* +12 to hit, reach 15 ft., one target. *Hit:*\
    ...
    "name": "Tail"
  - "desc": "Each creature of Umbraxakar's choice that is within 120 feet of Umbraxakar\
      \ and aware of it must succeed on a DC 17 Wisdom saving throw or become [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ for 1 minute. A creature can repeat the saving throw at the end of each of\
      \ its turns, ending the effect on itself on a success. If a creature's saving\
      \ throw is successful or the effect ends for it, the creature is immune to Umbraxakar's\
      \ Frightful Presence for the next 24 hours."
    "name": "Frightful Presence"
  - "desc": "Umbraxakar uses one of the following breath weapons.\n\n- **Shadow Breath.**\
      \ Umbraxakar exhales necrotic in a 90-foot line that is 5 feet wide. Each creature\
      \ in that line must make a DC 19 Dexterity saving throw, taking 66 (12d10)\
      \ necrotic damage on a failed save, or half as much damage on a successful one.\
      \  \n- **Repulsion Breath.** Umbraxakar exhales repulsion energy in a 30-foot\
      \ cone. Each creature in that area must succeed on a DC 19 Strength saving throw.\
      \ On a failed save, the creature is pushed 60 feet away from Umbraxakar.  "
    "name": "Breath Weapons (Recharge 5-6)"
  - "desc": "Umbraxakar magically polymorphs into a humanoid or beast that has a challenge\
      ...
      \ or borne by the new form (Umbraxakar's choice).\n\nIn a new form, Umbraxakar\
...
"legendary_description": "Legendary Action Uses: 3. Immediately after another creature's\
  \ turn, Umbraxakar can expend a use to take one of the following actions. Umbraxakar\
  \ regains all expended uses at the start of each of their turns."
"legendary_actions":
  - "desc": "Umbraxakar makes a Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
      \ check."
    "name": "Detect"
  - "desc": "Umbraxakar makes a tail attack."
    "name": "Tail Attack"
  - "desc": "Umbraxakar beats its wings. Each creature within 10 feet of Umbraxakar\
      ...
      \ Umbraxakar can then fly up to half its flying speed."
    "name": "Wing Attack (Costs 2 Actions)"
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/umbraxakar-wdmm.webp"
```
^statblock