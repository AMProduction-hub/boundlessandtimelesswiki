...
- "Kurr"
---
# [Kurr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kurr-oota.md)
...
"traits":
  - "desc": "When Kurr reduces a creature to 0 hit points with a melee attack on its\
      \ turn, Kurr can take a bonus action to move up to half its speed and make a\
      \ bite attack."
    "name": "Rampage"
"actions":
...
"source":
  - "OotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/kurr-oota.webp"
```
^statblock