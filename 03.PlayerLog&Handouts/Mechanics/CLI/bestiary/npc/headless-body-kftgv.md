...
"cr": "3"
"traits":
  - "desc": "The headless body has advantage on saving throws against being [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)."
    "name": "Brave"
"actions":
  ...
  - "desc": "For 1 minute, the headless body can utter a special command or warning\
      ...
      \ provided it can hear and understand the headless body. A creature can benefit\
      \ from only one Leadership die at a time. This effect ends if the headless body\
...
"reactions":
  - "desc": "The headless body adds 2 to its AC against one melee attack that would\
      \ hit it. To do so, the headless body must see the attacker and be wielding\
      \ a melee weapon."
    "name": "Parry"
"source":
  - "KftGV"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/headless-body-kftgv.webp"
```
^statblock