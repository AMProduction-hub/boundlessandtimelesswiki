...
---
# [Rosavalda "Rose" Durst](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/rosavalda-rose-durst-cos.md)
...
"actions":
  ...
  - "desc": "One humanoid that Rose can see within 5 feet of it must succeed on a\
      ...
      \ Wisdom, Charisma, and immunity to being [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      ...
      \ lasts until the body drops to 0 hit points, Rose ends it as a bonus action,\
      \ or Rose is turned or forced out by an effect like the [dispel evil and good](03.PlayerLog&Handouts/Mechanics/CLI/spells/dispel-evil-and-good.md)\
...
"source":
  - "CoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/rosavalda-rose-durst-cos.webp"
```
^statblock