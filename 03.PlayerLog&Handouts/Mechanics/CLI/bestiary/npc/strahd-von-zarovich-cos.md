...
| 13–15 | `1d4 + 1` [vampire spawn](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire-spawn.md) |
...
"traits":
  ...
  - "desc": "When Strahd drops to 0 hit points outside his coffin, he transforms into\
      \ a cloud of mist (as in the Shapechanger trait) instead of falling [unconscious](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Unconscious),\
      ...
      \ Once in his coffin, he reverts to his vampire form. He is then [paralyzed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Paralyzed)\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature,\
      ...
      \ rises the following night as a [vampire spawn](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire-spawn.md)\
  ...
  - "desc": "Strahd targets one humanoid he can see within 30 feet of him. If the\
      ...
      \ against this magic or be [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed).\
      \ The [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ target regards Strahd as a trusted friend to be heeded and protected. The\
      \ target isn't under Strahd's control, but it takes Strahd's requests and actions\
      \ in the most favorable way and lets Strahd bite it.\n\nEach time Strahd or\
      \ his companions do anything harmful to the target, it can repeat the saving\
      \ throw, ending the effect on itself on a success. Otherwise, the effect lasts\
      \ 24 hours or until Strahd is destroyed, is on a different plane of existence\
...
"lair_actions":
  ...
  - "desc": "- Until initiative count 20 of the next round, Strahd can pass through\
      ...
      \ becomes a [shadow](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/shadow.md)\
      \ that obeys Strahd's commands, acting on initiative count 20. A [greater restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/greater-restoration.md)\
      \ spell or a [remove curse](03.PlayerLog&Handouts/Mechanics/CLI/spells/remove-curse.md)\
