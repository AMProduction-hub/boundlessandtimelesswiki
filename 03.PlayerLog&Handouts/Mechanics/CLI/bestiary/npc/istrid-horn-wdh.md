...
"traits":
  - "desc": "Istrid is a 9th-level spellcaster. Her spellcasting ability is Wisdom\
    ...
    "name": "Spellcasting"
  - "desc": "Istrid has advantage on saving throws against being [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned)."
...
"source":
  - "WDH"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/istrid-horn-wdh.webp"
```
^statblock