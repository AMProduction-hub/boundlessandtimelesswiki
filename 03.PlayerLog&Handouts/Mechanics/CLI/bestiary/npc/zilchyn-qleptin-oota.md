...
"traits":
  ...
  - "desc": "Zilchyn has advantage on saving throws against being [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed),\
      \ and magic can't put Zilchyn to sleep."
    "name": "Fey Ancestry"
  - "desc": "While in sunlight, Zilchyn has disadvantage on attack rolls, as well\
...
"source":
  - "OotA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/zilchyn-qleptin-oota.webp"
```
^statblock