...
"actions":
  ...
  - "desc": "Krull withdraws into his shell. Until he emerges as a bonus action, he\
      ...
      \ throws. While in his shell, Krull is [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone),\
      \ his speed is 0 and can't increase, he has disadvantage on Dexterity saving\
      \ throws, he can't take reactions, and the only action he can take is to emerge\
      \ from his shell."
    "name": "Shell Defense"
"source":
  - "BGDIA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/token/krull-bgdia.webp"
```
^statblock