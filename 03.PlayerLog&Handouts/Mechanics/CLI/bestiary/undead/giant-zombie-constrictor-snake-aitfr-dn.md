...
"traits":
  - "desc": "While in sunlight, the snake has disadvantage on attack rolls and on\
      ...
      \ checks that rely on sight. When the snake begins its turn in sunlight, it\
      \ immediately suffers 10 radiant damage."
...
"source":
  - "AitFR-DN"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/giant-zombie-constrictor-snake-aitfr-dn.webp"
```
^statblock