...
The dracolich can't be [charmed](conditions.md#Charmed), [frightened](conditions.md#Frightened), [paralyzed](conditions.md#Paralyzed), or [poisoned](conditions.md#Poisoned). It also doesn't suffer from [exhaustion](conditions.md#Exhaustion).
