...
Vampiric mists, sometimes called crimson mists, are all that remain of [vampires](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire.md) who couldn't return to their burial places after being defeated or suffering some mishap. Denied the restorative power of these places, the [vampires'](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire.md) bodies dissolve into mist. The transformation strips the intelligence and personality from them until only an unholy, insatiable thirst for blood remains.
