...
"actions":
  ...
  - "desc": "The behir makes one bite attack against a Medium or smaller target it\
      ...
      \ A behir can have only one creature swallowed at a time.\n\nAny creature swallowed\
      \ by a parasite-infested behir must succeed on a DC 19 Constitution saving throw\
...
"source":
  - "CM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/parasite-infested-behir-cm.webp"
```
^statblock