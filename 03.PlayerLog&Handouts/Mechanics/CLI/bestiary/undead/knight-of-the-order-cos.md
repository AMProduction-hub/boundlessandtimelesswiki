...
- Knight of the Order
---
# [Knight of the Order](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\undead/knight-of-the-order-cos.md)
...
"actions":
  ...
  - "desc": "The knight targets one creature it can see within 30 feet of it and against\
      ...
      \ On a failure, the target is [paralyzed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Paralyzed)\
      \ until the knight deals damage to it, or until the end of the knight's next\
      \ turn. When the paralysis ends, the target is [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ of the knight for 1 minute. The [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ target can repeat the saving throw at the end of each of its turns, with disadvantage\
      \ if it can see the knight, ending the [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ condition on itself on a success."
    "name": "Vengeful Glare"
"source":
  - "CoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/knight-of-the-order-cos.webp"
```
^statblock