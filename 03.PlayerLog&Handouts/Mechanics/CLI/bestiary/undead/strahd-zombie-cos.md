...
- Strahd Zombie
---
# [Strahd Zombie](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\undead/strahd-zombie-cos.md)
...
"traits":
  - "desc": "Whenever the zombie takes at least 5 bludgeoning or slashing damage at\
      ...
      \ its bite attack and its body is [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded)\
      ...
      \ speed is halved if it's missing a leg. If it loses both legs, it falls [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone).\
...
"source":
  - "CoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/strahd-zombie-cos.webp"
```
^statblock