...
*Source: Monster Manual p. 297, Curse of Strahd, Storm King's Thunder, Tales from the Yawning Portal, Waterdeep: Dungeon of the Mad Mage, Ghosts of Saltmarsh, Baldur's Gate: Descent Into Avernus, Explorer's Guide to Wildemount, Tasha's Cauldron of Everything, Candlekeep Mysteries, Dragonlance: Shadow of the Dragon Queen. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
> 
> The game statistics of a player character transformed into a vampire spawn and then a vampire don't change, except that the character's Strength, Dexterity, and Constitution scores become 18 if they aren't higher. In addition, the character gains the vampire's damage resistances, [darkvision](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Darkvision), traits, and actions. Attack and damage rolls for the vampire's attacks are based on Strength.
> 
...
"traits":
  ...
  - "desc": "When it drops to 0 hit points outside its resting place, the vampire\
      ...
      \ falling [unconscious](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Unconscious),\
      ...
      \ is then [paralyzed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Paralyzed)\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature,\
      ...
      \ buried in the ground rises the following night as a [vampire spawn](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire-spawn.md)\
  ...
  - "desc": "The vampire targets one humanoid it can see within 30 feet of it. If\
      ...
      \ saving throw against this magic or be [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ by the vampire. The [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
    ...
    "name": "Charm"
  - "desc": "The vampire magically calls 2d4 swarms of [bats](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/swarm-of-bats.md)\
...
"source":
  ...
  - "CM"
  - "DSotDQ"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/vampire.webp"
```
^statblock
