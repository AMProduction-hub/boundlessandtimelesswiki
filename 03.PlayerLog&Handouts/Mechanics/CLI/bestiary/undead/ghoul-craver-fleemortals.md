...
"actions":
  - "desc": "*Melee Weapon Attack:* +4 to hit, reach 10 ft., one target. *Hit:*\
      \ 1 slashing damage, and the next non-minion ghoul who attacks that target before\
      \ the start of the craver's next turn gains a bonus to the attack roll equal\
      \ to the number of cravers who joined the attack."
