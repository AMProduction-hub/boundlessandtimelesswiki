...
- Vampirate Captain
---
# [Vampirate Captain](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\undead/vampirate-captain-bam.md)
...
"actions":
  ...
  - "desc": "A ship upon which the captain stands, along with all creatures and objects\
      \ aboard it, becomes [invisible](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Invisible)\
      \ to creatures not aboard the ship. The captain must concentrate on this magical\
      \ effect to maintain it (as if [concentrating](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration)\
...
"source":
  - "BAM"
  - "LoX"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/vampirate-captain-bam.webp"
```
^statblock