...
"actions":
  ...
  - "desc": "If the commander has taken damage during this combat, it gives itself\
      ...
      \ wraith warriors](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/sword-wraith-warrior-mpmm.md)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/sword-wraith-commander-mpmm.webp"
```
^statblock
