...
"cr": "8"
"traits":
  - "desc": "As a bonus action, the tyrannosaurus zombie can disgorge a normal [zombie](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/zombie.md),\
      \ which appears in an unoccupied space within 10 feet of it. The disgorged [zombie](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/zombie.md)\
      ...
      \ dies, d4 normal zombies erupt from its corpse at the start of its next turn.\
...
"source":
  - "ToA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/tyrannosaurus-zombie-toa.webp"
```
^statblock