...
A flameskull's shattered fragments reform unless they are splashed with holy water or subjected to a [dispel magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/dispel-magic.md) or [remove curse](03.PlayerLog&Handouts/Mechanics/CLI/spells/remove-curse.md) spell. If it can no longer fulfill its intended purpose, the re-formed flameskull is beholden to no one and becomes autonomous.
