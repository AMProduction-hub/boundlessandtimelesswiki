...
"actions":
  ...
  - "desc": "The devourer chooses a living Humanoid with 0 hit points that it can\
      ...
      \ or fewer Hit Dice, it becomes a [zombie](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/zombie.md).\
      \ If it had 3 to 5 Hit Dice, it becomes a [ghoul](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/ghoul.md).\
      \ Otherwise, it becomes a [wight](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/wight.md).\
...
"source":
  - "MPMM"
  - "VGM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/devourer-mpmm.webp"
```
^statblock
