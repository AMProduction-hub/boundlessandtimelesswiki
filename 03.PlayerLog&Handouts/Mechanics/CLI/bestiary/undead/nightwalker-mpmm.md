...
"traits":
  ...
  - "desc": "A creature dies if reduced to 0 hit points by the nightwalker and can't\
      \ be revived except by a [wish](03.PlayerLog&Handouts/Mechanics/CLI/spells/wish.md)\
      \ spell."
    "name": "Life Eater"
...
"actions":
  ...
  - "desc": "The nightwalker points at one creature it can see within 300 feet of\
      ...
      \ necrotic damage and become [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ until the end of the nightwalker's next turn. While [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ in this way, the creature is also [paralyzed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Paralyzed).\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/nightwalker-mpmm.webp"
```
^statblock
