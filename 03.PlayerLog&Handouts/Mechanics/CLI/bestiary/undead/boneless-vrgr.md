...
"actions":
  ...
  - "desc": "The boneless wraps its body around a Large or smaller creature [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
      \ by it. While the boneless is attached, the target is [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded)\
...
"source":
  - "VRGR"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/boneless-vrgr.webp"
```
^statblock