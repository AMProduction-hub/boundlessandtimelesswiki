...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one target. Hit: 14\
      ...
      \ curse](03.PlayerLog&Handouts/Mechanics/CLI/spells/remove-curse.md) spell or\
      \ other magic."
    "name": "Rotting Fist"
  - "desc": "The fungal servant targets one creature it can see within 60 feet of\
      ...
      \ saving throw against this magic or become [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ until the end of the fungal servant's next turn. If the target fails the saving\
      \ throw by 5 or more, it is also [paralyzed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Paralyzed)\
...
"legendary_actions":
  ...
  - "desc": "The fungal servant utters a blasphemous word. Each non-undead creature\
      ...
      \ succeed on a DC 16 Constitution saving throw or be [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned)\
  ...
  - "desc": "The fungal servant magically transforms into a whirlwind of spores, moves\
      ...
      \ fungal servant is immune to all damage, and it can't be [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled),\
...
"source":
  - "CM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/fungal-servant-cm.webp"
```
^statblock