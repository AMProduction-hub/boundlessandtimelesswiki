...
"bonus_actions":
  - "desc": "While in dim light or darkness, the boneclaw takes the [Hide](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Hide)\
      \ action."
    "name": "Shadow Stealth"
"reactions":
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/boneclaw-mpmm.webp"
```
^statblock
