...
"traits":
  ...
  - "desc": "When the eidolon moves into a space occupied by a [sacred statue](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/sacred-statue-mpmm.md),\
      ...
      \ eidolon's control. The eidolon uses the [sacred statue's stat block](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/sacred-statue-mpmm.md)\
      \ in place of its own."
...
"actions":
  - "desc": "Each creature within 60 feet of the eidolon that can see it must succeed\
      ...
      \ of it for 1 minute. While [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
      \ in this way, the creature must take the [Dash](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Dash)\
      ...
      \ case the creature also becomes [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned)\
      \ until it can move again. A [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
...
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/eidolon-mpmm.webp"
```
^statblock
