...
"traits":
  - "desc": "When a creature that can see the bodak's eyes starts its turn within\
      ...
      \ saving throw if the bodak isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
      \ and can see the creature. If the saving throw fails by 5 or more, the creature\
      \ is reduced to 0 hit points unless it is immune to the [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
...
"source":
  - "MPMM"
  - "VGM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/bodak-mpmm.webp"
```
^statblock
