...
- Vampirate Mage
---
# [Vampirate Mage](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\undead/vampirate-mage-bam.md)
...
"actions":
  ...
  - "desc": "The mage casts one of the following spells, using Charisma as the spellcasting\
      ...
      \ [darkness](03.PlayerLog&Handouts/Mechanics/CLI/spells/darkness.md), [dimension\
      \ door](03.PlayerLog&Handouts/Mechanics/CLI/spells/dimension-door.md), [fly](03.PlayerLog&Handouts/Mechanics/CLI/spells/fly.md),\
      \ [hypnotic pattern](03.PlayerLog&Handouts/Mechanics/CLI/spells/hypnotic-pattern.md)"
    "name": "Spellcasting"
"source":
  - "BAM"
  - "LoX"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/vampirate-mage-bam.webp"
```
^statblock