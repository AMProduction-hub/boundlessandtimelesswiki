...
"cr": "8"
"traits":
  - "desc": "The vampire has advantage on Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
  ...
  - "desc": "If the vampire isn't in sunlight, it can use its action to polymorph\
      ...
      \nWhile in hyena form, the vampire can't speak, and its walking speed is 50\
      \ feet. Its statistics, other than its size and speed, are unchanged. Anything\
      ...
      \ stop there. In addition, if air can pass through a space, the mist can do\
      \ so without squeezing, and it can't pass through water. It has advantage on\
      \ Strength, Dexterity, and Constitution saving throws, and it is immune to all\
...
"actions":
  ...
  - "desc": "The vampire emits a bone-chilling cackle. Each creature of the vampire's\
      ...
      \ succeed on a DC 15 Wisdom saving throw or become [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
  ...
  - "desc": "The vampire targets one humanoid it can see within 30 feet of it. If\
      ...
      \ saving throw against this magic or be [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned)\
...
"source":
  - "IDRotF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/gnoll-vampire-idrotf.webp"
```
^statblock