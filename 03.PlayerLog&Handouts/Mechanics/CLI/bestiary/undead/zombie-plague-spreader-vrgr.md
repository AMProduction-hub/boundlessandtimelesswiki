...
| dice: d4 | Zombie Plot |
|----------|-------------|
| 1 | A twisted wish causes those affected by healing magic and [potions of healing](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-healing.md) to rise as zombies. |
| 2 | Overwhelming magic reanimates zombies again and again as [swarms of zombie limbs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/swarm-of-zombie-limbs-vrgr.md). |
| 3 | The githyanki unleash [zombie plague spreaders](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/zombie-plague-spreader-vrgr.md) to scour mind flayers from a world. |
| 4 | The seals containing an underground zombie horde fail, releasing ancient [zombie clots](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/zombie-clot-vrgr.md). |
^zombie-apocalypses
...
"traits":
  ...
  - "desc": "Any creature that starts its turn within 10 feet of the plague spreader\
      ...
      \ and can't regain hit points until the end of its next turn. On a successful\
      \ save, the creature is immune to this plague spreader's Viral Aura for 24 hours."
    "name": "Viral Aura"
"actions":
...
"source":
  - "VRGR"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/zombie-plague-spreader-vrgr.webp"
```
^statblock