...
"traits":
  ...
  - "desc": "If damage reduces the drowned master to 0 hit points, it must make a\
      ...
      \ is radiant or from a critical hit. On a success, the drowned master drops\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +7 to hit, reach 15 ft., one target. Hit:\
      ...
      \ save, the target also contracts bluerot (see the \"Bluerot\" in notes)."
  ...
  - "desc": "The drowned master discharges foul ink in front of itself in a 30-foot\
      ...
      \ damage on a successful one. A creature that fails this saving throw is [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded)\
      \ until the end of its next turn and contracts bluerot (see the \"Bluerot\"\
      \ in notes)."
    "name": "Necrotic Ink (Recharge 5-6)"
"source":
  - "GoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/token/drowned-master-gos.webp"
```
^statblock