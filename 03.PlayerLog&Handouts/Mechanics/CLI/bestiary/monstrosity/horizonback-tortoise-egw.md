...
"traits":
  ...
  - "desc": "The tortoise can carry up to 20,000 pounds of weight atop its shell,\
      ...
      \ creatures can move underneath the tortoise while it's not [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone).\n\
      \nAny creature under the tortoise when it falls [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)\
...
"actions":
  - "desc": "Melee Weapon Attack: +12 to hit, reach 10 ft., one target. Hit:\
    ...
    "name": "Bite"
  - "desc": "The tortoise withdraws into its shell, falls [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone),\
      ...
      \ whereupon it is no longer [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)."
    "name": "Shell Defense (Recharge 4-6)"
"source":
  - "EGW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/horizonback-tortoise-egw.webp"
```
^statblock