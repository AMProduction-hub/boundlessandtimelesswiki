...
Some alchemists are said to know how to process the basilisk's gullet and the fluids contained within. Properly handled, the gullet produces an oil that can return [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified) creatures to flesh and life. Unfortunately for such a victim, any parts lost in stone form remain absent if the creature revives. Revivification using the oil is impossible if a vital part of the [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified) creature, such as its head, is detached.
...
"traits":
  - "desc": "If a creature starts its turn within 30 feet of the basilisk and the\
      ...
      \ a DC 12 Constitution saving throw if the basilisk isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated).\
      \ On a failed save, the creature magically begins to turn to stone and is [restrained](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Restrained).\
      ...
      \ spell or other magic.\n\nA creature that isn't [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised)\
