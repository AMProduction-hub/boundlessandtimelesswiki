...
"cr": "1/4"
"traits":
  - "desc": "The bone whelk can cause Medium or smaller objects to adhere to it. A\
      \ Medium or smaller creature that touches the bone whelk is [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
      \ by it (escape DC 10)."
    "name": "Adhesive"
  - "desc": "When the bone whelk dies, it emits a blood-curdling shriek than can be\
    ...
    "name": "Death Scream"
  - "desc": "The bone whelk can climb difficult surfaces, including upside down on\
...
"source":
  - "BGDIA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/bone-whelk-bgdia.webp"
```
^statblock