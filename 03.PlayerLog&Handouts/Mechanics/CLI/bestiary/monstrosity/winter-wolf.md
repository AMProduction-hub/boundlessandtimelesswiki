...
*Source: Monster Manual p. 340, Storm King's Thunder, Tales from the Yawning Portal, Tomb of Annihilation, Icewind Dale: Rime of the Frostmaiden, Keys from the Golden Vault. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
"traits":
  ...
  - "desc": "The wolf has advantage on an attack roll against a creature if at least\
    ...
    "name": "Pack Tactics"
  - "desc": "The wolf has advantage on Dexterity ([Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth))\
...
"source":
  ...
  - "IDRotF"
  - "KftGV"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/winter-wolf.webp"
```
^statblock
