...
"actions":
  ...
  - "desc": "A kraken speaks through the priest with a thunderous voice audible within\
      ...
      \ of the priest for 1 minute. A [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened)\
...
"source":
  - "MPMM"
  - "VGM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/kraken-priest-mpmm.webp"
```
^statblock
