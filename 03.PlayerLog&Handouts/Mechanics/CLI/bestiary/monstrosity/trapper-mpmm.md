...
"traits":
  - "desc": "If the trapper is motionless on a floor, wall, or ceiling at the start\
      ...
      \ 18 Intelligence ([Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation))\
...
"source":
  - "MPMM"
  - "VGM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/trapper-mpmm.webp"
```
^statblock
