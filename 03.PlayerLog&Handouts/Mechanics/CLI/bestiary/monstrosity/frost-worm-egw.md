...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +15 to hit, reach 10 ft., one target. Hit:\
      ...
      \ 10 (3d6) acid damage and 10 (3d6) cold damage at the start of each of\
      \ the worm's turns.\n\nIf the worm takes 30 damage or more on a single turn\
      \ from a creature inside it, the worm must succeed on a DC 20 Constitution saving\
...
"source":
  - "EGW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/frost-worm-egw.webp"
```
^statblock