...
"traits":
  - "desc": "When the draconian is reduced to 0 hit points, its magical essence lashes\
      ...
      \ takes 9 (2d8) lightning damage and is [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned)\
      \ until the end of its next turn. On a successful save, the creature takes half\
      \ as much damage and isn't [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned)."
    "name": "Death Throes"
"actions":
  ...
  - "desc": "The draconian exhales a 15-foot cone of noxious gas. Each creature in\
      ...
      \ creature takes 21 (6d6) poison damage and gains 1 level of [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion).\
  ...
  - "desc": "The draconian casts one of the following spells, requiring no material\
    ...
    "name": "Spellcasting"
"reactions":
  - "desc": "When the draconian is hit by an attack roll, it can create an [invisible](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Invisible)\
...
"source":
  - "FTD"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/draconian-mastermind-ftd.webp"
```
^statblock