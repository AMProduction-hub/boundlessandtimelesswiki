...
"cr": "15"
"traits":
  - "desc": "The typhon has advantage on Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))\
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +12 to hit, reach 15 ft., one Large or smaller\
      \ creature. Hit: 17 (3d6 + 7) bludgeoning damage, and the target is [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
...
"source":
  - "MOT"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/typhon-mot.webp"
```
^statblock