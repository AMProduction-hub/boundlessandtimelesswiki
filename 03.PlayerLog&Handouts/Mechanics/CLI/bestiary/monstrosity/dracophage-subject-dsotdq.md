...
"traits":
  - "desc": "When the subject is reduced to 0 hit points, it dissolves into acid that\
    ...
    "name": "Death Throes"
  - "desc": "When the subject falls and isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated),\
...
"source":
  - "DSotDQ"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/dracophage-subject-dsotdq.webp"
```
^statblock