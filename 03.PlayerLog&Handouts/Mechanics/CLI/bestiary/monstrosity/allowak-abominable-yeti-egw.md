...
"actions":
  ...
  - "desc": "The yeti targets one creature it can see within 30 feet of it. If the\
      ...
      \ throw against this magic or take 21 (6d6) cold damage and then be [paralyzed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Paralyzed)\
...
"source":
  - "EGW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/allowak-abominable-yeti-egw.webp"
```
^statblock