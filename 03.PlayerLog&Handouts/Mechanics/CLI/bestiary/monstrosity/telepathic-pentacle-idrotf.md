...
"traits":
  ...
  - "desc": "The Telepathic Pentacle has five heads. While it has more than one head,\
      \ the Telepathic Pentacle has advantage on saving throws against being [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded),\
...
"source":
  - "IDRotF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/telepathic-pentacle-idrotf.webp"
```
^statblock