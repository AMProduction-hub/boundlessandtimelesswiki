...
"traits":
  ...
  - "desc": "During the first round of combat, the medusa has advantage on attack\
      \ rolls against any creature that is [surprised](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Surprised),\
...
"actions":
  ...
  - "desc": "The medusa fixes its gaze on one creature within 60 feet of it that it\
      ...
      \ the creature is freed by a [greater restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/greater-restoration.md)\
      \ spell or similar magic."
    "name": "Petrifying Gaze"
"source":
  - "GGR"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/undercity-medusa-ggr.webp"
```
^statblock