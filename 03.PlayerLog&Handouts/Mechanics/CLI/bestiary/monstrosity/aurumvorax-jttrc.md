...
- Aurumvorax
---
# [Aurumvorax](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\monstrosity/aurumvorax-jttrc.md)
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +5 to hit, reach 5 ft., one target. Hit: 5\
      ...
      \ (escape DC 12). Until this grapple ends, the aurumvorax can't use its Claw\
      \ attack on another target, and when it moves, it can drag the [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
      \ creature with it, without the aurumvorax's speed being halved."
    "name": "Claw"
"source":
  - "JttRC"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/aurumvorax-jttrc.webp"
```
^statblock