...
"cr": "8"
"traits":
  - "desc": "The reverser has advantage on saving throws against spells and other\
      \ magical effects."
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +8 to hit, range 5 ft., one creature. Hit:\
      \ 11 (1d12 + 5) piercing damage plus 6 (d12) force damage."
    "name": "Bite"
...
"reactions":
  - "desc": "When a creature the reverser can see within 30 feet of it regains hit\
      \ points, the reverser reduces the number of hit points regained to 0, and the\
      \ reverser deals 13 (3d8) force damage to the creature."
    "name": "Reversal"
"source":
  - "EGW"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/aeorian-reverser-egw.webp"
```
^statblock