...
- Category 3 Krasis
---
# [Category 3 Krasis](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\monstrosity/category-3-krasis-ggr.md)
...
![Major Adaptations](03.PlayerLog&Handouts/Mechanics/CLI/tables/major-adaptations-ggr.md)

![Minor Adaptations](03.PlayerLog&Handouts/Mechanics/CLI/tables/minor-adaptations-ggr.md)
...
"actions":
  ...
  - "desc": "Melee Weapon Attack: +11 to hit, reach 15 ft., one target. Hit:\
      ...
      \ on a DC 19 Strength saving throw or be knocked [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)."
    "name": "Tail"
"source":
  - "GGR"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/category-3-krasis-ggr.webp"
```
^statblock