...
"actions":
  ...
  - "desc": "The cerberus exhales a 30-foot cone of molten rock. Each creature in\
      ...
      \ by the hardening rock. A creature can make a DC 15 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics))\
...
"source":
  - "MOT"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/underworld-cerberus-mot.webp"
```
^statblock