...
"actions":
  ...
  - "desc": "The meazel, any equipment it is wearing or carrying, and any creature\
      ...
      \ becomes cursed for 1 hour or until the curse is ended by [remove curse](03.PlayerLog&Handouts/Mechanics/CLI/spells/remove-curse.md)\
      \ or [greater restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/greater-restoration.md).\
...
"bonus_actions":
  - "desc": "While in dim light or darkness, the meazel takes the [Hide](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Hide)\
      \ action."
    "name": "Shadow Stealth"
"source":
  - "MPMM"
  - "MTF"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/meazel-mpmm.webp"
```
^statblock
