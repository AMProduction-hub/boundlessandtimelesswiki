...
"actions":
  ...
  - "desc": "The matriarch sings a magical melody. Every humanoid and giant within\
      ...
      \ if the matriarch is [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated).\n\
      \nWhile [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      \ by the matriarch, a target is [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated)\
      \ and ignores the songs of other harpies. If the [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
      ...
      \ other than the matriarch, the target can repeat the saving throw. A [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed)\
  ...
  - "desc": "The matriarch projects a vision into the minds of creatures within 30\
      ...
      \ saving throw or drop whatever it is holding and become [paralyzed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Paralyzed)\
      \ until the end of its next turn."
    "name": "Visage of Desire (1/Day)"
"source":
  - "GoS"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/harpy-matriarch-gos.webp"
```
^statblock