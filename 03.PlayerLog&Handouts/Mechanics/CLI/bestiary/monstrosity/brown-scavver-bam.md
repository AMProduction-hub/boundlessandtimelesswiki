...
- Brown Scavver
---
# [Brown Scavver](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\monstrosity/brown-scavver-bam.md)
...
"actions":
  - "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 11\
      ...
      \ the swallowed creature, which falls [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)\
...
"source":
  - "BAM"
  - "LoX"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/brown-scavver-bam.webp"
```
^statblock