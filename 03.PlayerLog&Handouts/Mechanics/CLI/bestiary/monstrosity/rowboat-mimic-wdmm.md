...
- Rowboat Mimic
---
# [Rowboat Mimic](03.PlayerLog&Handouts\Mechanics\CLI\bestiary\monstrosity/rowboat-mimic-wdmm.md)
...
"traits":
  ...
  - "desc": "The mimic adheres to anything that touches it. A Huge or smaller creature\
      \ adhered to the mimic is also [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
  ...
  - "desc": "The mimic has advantage on attack rolls against any creature [grappled](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
      \ by it."
    "name": "Grappler"
"actions":
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/rowboat-mimic-wdmm.webp"
```
^statblock