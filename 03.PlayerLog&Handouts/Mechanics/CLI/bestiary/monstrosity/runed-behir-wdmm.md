...
"actions":
  ...
  - "desc": "The behir makes one bite attack against a Medium or smaller target it\
      ...
      \ ends. While swallowed, the target is [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded)\
      ...
      \ or regurgitate the creature, which falls [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)\
...
"source":
  - "WDMM"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/runed-behir-wdmm.webp"
```
^statblock