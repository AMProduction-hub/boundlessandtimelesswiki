...
"traits":
  ...
  - "desc": "If a creature starts its turn within 30 feet of the basilisk and the\
      ...
      \ a DC 10 Constitution saving throw if the basilisk isn't [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated).\
...
"source":
  - "TftYP"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/reduced-threat-basilisk-tftyp.webp"
```
^statblock