...
"traits":
  ...
  - "desc": "When a creature that can see the medusa's eyes starts its turn within\
      ...
      \ Otherwise, a creature that fails the save begins to turn to metal, wood, or\
      \ porcelain (the medusa's choice) and is [restrained](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Restrained).\
...
"source":
  - "IMR"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/token/enhanced-medusa-imr.webp"
```
^statblock