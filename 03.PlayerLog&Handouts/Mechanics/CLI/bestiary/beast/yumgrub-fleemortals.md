...
"traits":
  ...
  - "desc": "A Small or larger creature can use an action to consume a living yumgrub\
      ...
      \ speed is doubled and they gain a +4 bonus to their Strength score and a +2\
      \ bonus to AC. When the effect ends, the creature gains two levels of [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion)."
    "name": "Yum"
"actions":
...
"source":
  - "FleeMortals"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/token/yumgrub-fleemortals.png"
```
^statblock