...
"traits":
  - "desc": "If the wildcat hits a Large or smaller target and had advantage on the\
      ...
      \ (escape DC 13). While grappling the target in this way, the wildcat can't\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 7\
      \ (1d8 + 3) piercing damage, plus an extra 3 (1d6) piercing damage if the\
    ...
    "name": "Bite"
  - "desc": "*Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 7\
      \ (1d8 + 3) slashing damage, plus an extra 3 (1d6) slashing damage if the\
...
"source":
  - "FleeMortals"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/token/wildcat-fleemortals.png"
```
^statblock