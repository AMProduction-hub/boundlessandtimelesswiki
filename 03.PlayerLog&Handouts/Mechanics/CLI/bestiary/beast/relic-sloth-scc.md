...
"reactions":
  - "desc": "When the relic sloth is subjected to an effect that would move it out\
      \ of its current space or knock it [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone),\
      \ it is neither moved nor knocked [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone)."
    "name": "Slow but Sturdy"
"source":
  - "SCC"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/token/relic-sloth-scc.webp"
```
^statblock