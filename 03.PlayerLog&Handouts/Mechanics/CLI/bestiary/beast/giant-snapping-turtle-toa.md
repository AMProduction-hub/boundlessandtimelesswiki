...
"traits":
  - "desc": "The turtle can breathe air and water."
    "name": "Amphibious"
  - "desc": "Whenever an effect knocks the turtle [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone),\
      \ it can make a DC 10 Constitution saving throw to avoid being knocked [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone).\
      \ A [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone) turtle\
      \ is upside down. To stand up, it must succeed on a DC 10 Dexterity check on\
...
"source":
  - "ToA"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/token/giant-snapping-turtle-toa.webp"
```
^statblock