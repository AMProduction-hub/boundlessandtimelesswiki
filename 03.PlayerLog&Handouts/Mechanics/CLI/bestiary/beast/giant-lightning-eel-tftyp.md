...
"actions":
  ...
  - "desc": "One creature the eel touches within 5 feet of it outside water, or each\
      ...
      \ If the target takes any of this damage, the target is [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned)\
...
"source":
  - "TftYP"
"image": "03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/token/giant-lightning-eel-tftyp.webp"
```
^statblock