...
You can use this trait to take the [Help](03.PlayerLog&Handouts/Mechanics/CLI/rules/actions.md#Help) action as a bonus action, and you can do so a number of times equal to your proficiency bonus. You regain all expended uses when you finish a long rest.
