...
- **Skill Proficiencies.** [Insight](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Insight), [Intimidation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Intimidation)  
- **Languages.** Two of your choice  
- **Equipment.** An Azorius insignia, a scroll containing the text of a law important to you, a [bottle of blue ink](03.PlayerLog&Handouts/Mechanics/CLI/items/ink-1-ounce-bottle.md), a [pen](03.PlayerLog&Handouts/Mechanics/CLI/items/ink-pen.md), a set of [fine clothes](03.PlayerLog&Handouts/Mechanics/CLI/items/fine-clothes.md), and a belt [pouch](03.PlayerLog&Handouts/Mechanics/CLI/items/pouch.md) containing 10 gp (Azorius-minted 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [friends](03.PlayerLog&Handouts/Mechanics/CLI/spells/friends.md), [message](03.PlayerLog&Handouts/Mechanics/CLI/spells/message.md) |
| 1st | [command](03.PlayerLog&Handouts/Mechanics/CLI/spells/command.md), [ensnaring strike](03.PlayerLog&Handouts/Mechanics/CLI/spells/ensnaring-strike.md) |
| 2nd | [arcane lock](03.PlayerLog&Handouts/Mechanics/CLI/spells/arcane-lock.md), [calm emotions](03.PlayerLog&Handouts/Mechanics/CLI/spells/calm-emotions.md), [hold person](03.PlayerLog&Handouts/Mechanics/CLI/spells/hold-person.md) |
| 3rd | [clairvoyance](03.PlayerLog&Handouts/Mechanics/CLI/spells/clairvoyance.md), [counterspell](03.PlayerLog&Handouts/Mechanics/CLI/spells/counterspell.md) |
| 4th | [compulsion](03.PlayerLog&Handouts/Mechanics/CLI/spells/compulsion.md), [divination](03.PlayerLog&Handouts/Mechanics/CLI/spells/divination.md) |
| 5th | [dominate person](03.PlayerLog&Handouts/Mechanics/CLI/spells/dominate-person.md) |
^azorius-guild-spells

Your magic often takes the form of blue or golden runes floating and glowing in the air in circular patterns or of shimmering azure barriers of magical energy. If you cast [ensnaring strike](03.PlayerLog&Handouts/Mechanics/CLI/spells/ensnaring-strike.md), for example, the vines created by the spell might appear as rune-inscribed glowing bands that wrap around the target and hold it in place.
