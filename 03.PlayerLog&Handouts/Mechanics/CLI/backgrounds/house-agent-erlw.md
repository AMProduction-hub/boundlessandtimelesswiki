...
- **Skill Proficiencies.** [Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation), [Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion)  
- **Tool Proficiencies.** Two proficiencies from the House Tool Proficiencies table  
- **Equipment.** A set of [fine clothes](03.PlayerLog&Handouts/Mechanics/CLI/items/fine-clothes.md), house [signet ring](03.PlayerLog&Handouts/Mechanics/CLI/items/signet-ring.md), identification papers, and a purse containing 20 gp.  

**House Tool Proficiencies**

| Your House | Proficiencies |
|------------|---------------|
| Cannith | [Alchemist's supplies](03.PlayerLog&Handouts/Mechanics/CLI/items/alchemists-supplies.md) and [tinker's tools](03.PlayerLog&Handouts/Mechanics/CLI/items/tinkers-tools.md) |
| Deneith | One gaming set and vehicles (land) |
| Ghallanda | [Brewer's supplies](03.PlayerLog&Handouts/Mechanics/CLI/items/brewers-supplies.md) and [cook's utensils](03.PlayerLog&Handouts/Mechanics/CLI/items/cooks-utensils.md) |
| Jorasco | [Alchemist's supplies](03.PlayerLog&Handouts/Mechanics/CLI/items/alchemists-supplies.md) and [herbalism kit](03.PlayerLog&Handouts/Mechanics/CLI/items/herbalism-kit.md) |
| Kundarak | [Thieves' tools](03.PlayerLog&Handouts/Mechanics/CLI/items/thieves-tools.md) and [tinker's tools](03.PlayerLog&Handouts/Mechanics/CLI/items/tinkers-tools.md) |
| Lyrandar | [Navigator's tools](03.PlayerLog&Handouts/Mechanics/CLI/items/navigators-tools.md) and vehicles (sea and air) |
| Medani | [Disguise kit](03.PlayerLog&Handouts/Mechanics/CLI/items/disguise-kit.md) and [thieves' tools](03.PlayerLog&Handouts/Mechanics/CLI/items/thieves-tools.md) |
| Orien | One gaming set and vehicles (land) |
| Phiarlan | [Disguise kit](03.PlayerLog&Handouts/Mechanics/CLI/items/disguise-kit.md) and one musical instrument |
| Sivis | [Calligrapher's supplies](03.PlayerLog&Handouts/Mechanics/CLI/items/calligraphers-supplies.md) and [forgery kit](03.PlayerLog&Handouts/Mechanics/CLI/items/forgery-kit.md) |
| Tharashk | One gaming set and [thieves' tools](03.PlayerLog&Handouts/Mechanics/CLI/items/thieves-tools.md) |
| Thuranni | One musical instrument and [poisoner's kit](03.PlayerLog&Handouts/Mechanics/CLI/items/poisoners-kit.md) |
| Vadalis | [herbalism kit](03.PlayerLog&Handouts/Mechanics/CLI/items/herbalism-kit.md) and vehicles (land) |
^house-tool-proficiencies
