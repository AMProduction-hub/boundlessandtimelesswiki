...
- **Skill Proficiencies.** [Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana), [Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation)  
- **Tool Proficiencies.** One type of artisan's tools  
- **Languages.** Choose one of Draconic, Goblin, or Vedalken  
- **Equipment.** An Izzet insignia, one set of artisan's tools, the charred and twisted remains of a failed experiment, a [hammer](03.PlayerLog&Handouts/Mechanics/CLI/items/hammer.md), a [block and tackle](03.PlayerLog&Handouts/Mechanics/CLI/items/block-and-tackle.md), a set of [common clothes](03.PlayerLog&Handouts/Mechanics/CLI/items/common-clothes.md), and a belt [pouch](03.PlayerLog&Handouts/Mechanics/CLI/items/pouch.md) containing 5 gp (Azorius 1-zino coins)  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [produce flame](03.PlayerLog&Handouts/Mechanics/CLI/spells/produce-flame.md), [shocking grasp](03.PlayerLog&Handouts/Mechanics/CLI/spells/shocking-grasp.md) |
| 1st | [chaos bolt](03.PlayerLog&Handouts/Mechanics/CLI/spells/chaos-bolt-xge.md), [create or destroy water](03.PlayerLog&Handouts/Mechanics/CLI/spells/create-or-destroy-water.md), [unseen servant](03.PlayerLog&Handouts/Mechanics/CLI/spells/unseen-servant.md) |
| 2nd | [heat metal](03.PlayerLog&Handouts/Mechanics/CLI/spells/heat-metal.md), [rope trick](03.PlayerLog&Handouts/Mechanics/CLI/spells/rope-trick.md) |
| 3rd | [call lightning](03.PlayerLog&Handouts/Mechanics/CLI/spells/call-lightning.md), [elemental weapon](03.PlayerLog&Handouts/Mechanics/CLI/spells/elemental-weapon.md), [glyph of warding](03.PlayerLog&Handouts/Mechanics/CLI/spells/glyph-of-warding.md) |
| 4th | [conjure minor elementals](03.PlayerLog&Handouts/Mechanics/CLI/spells/conjure-minor-elementals.md), [divination](03.PlayerLog&Handouts/Mechanics/CLI/spells/divination.md), [Otiluke's resilient sphere](03.PlayerLog&Handouts/Mechanics/CLI/spells/otilukes-resilient-sphere.md) |
| 5th | [animate objects](03.PlayerLog&Handouts/Mechanics/CLI/spells/animate-objects.md), [conjure elemental](03.PlayerLog&Handouts/Mechanics/CLI/spells/conjure-elemental.md) |
^izzet-guild-spells

Your spells tend to be loud, flashy, or explosive, even when the effect is unremarkable. For example, when you open the portal of a [rope trick](03.PlayerLog&Handouts/Mechanics/CLI/spells/rope-trick.md) spell, the portal might be outlined by harmless, showy sparkles.

If you use an arcane focus, it probably takes the form of an intricate device that could include metal gauntlets, glass canisters, copper tubing, and leather straps attaching it to your body. The [mizzium apparatus](03.PlayerLog&Handouts/Mechanics/CLI/items/mizzium-apparatus-ggr.md) described in "chapter 5" is a magical version of this gear.

The [chaos bolt](03.PlayerLog&Handouts/Mechanics/CLI/spells/chaos-bolt-xge.md) spell is a favorite of Izzet spellcasters because of its unpredictable nature.
