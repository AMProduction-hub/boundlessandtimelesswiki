...
- **Equipment.** A Dimir insignia, three small knives, a set of dark-colored [common clothes](03.PlayerLog&Handouts/Mechanics/CLI/items/common-clothes.md), and the starting equipment of the background described in this chapter for your secondary guild  
...
| Spell Level | Spells |
|-------------|--------|
| Cantrip | [encode thoughts](03.PlayerLog&Handouts/Mechanics/CLI/spells/encode-thoughts-ggr.md), [mage hand](03.PlayerLog&Handouts/Mechanics/CLI/spells/mage-hand.md) |
| 1st | [disguise self](03.PlayerLog&Handouts/Mechanics/CLI/spells/disguise-self.md), [sleep](03.PlayerLog&Handouts/Mechanics/CLI/spells/sleep.md) |
| 2nd | [detect thoughts](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-thoughts.md), [pass without trace](03.PlayerLog&Handouts/Mechanics/CLI/spells/pass-without-trace.md) |
| 3rd | [gaseous form](03.PlayerLog&Handouts/Mechanics/CLI/spells/gaseous-form.md), [meld into stone](03.PlayerLog&Handouts/Mechanics/CLI/spells/meld-into-stone.md), [nondetection](03.PlayerLog&Handouts/Mechanics/CLI/spells/nondetection.md) |
| 4th | [arcane eye](03.PlayerLog&Handouts/Mechanics/CLI/spells/arcane-eye.md), [freedom of movement](03.PlayerLog&Handouts/Mechanics/CLI/spells/freedom-of-movement.md) |
| 5th | [modify memory](03.PlayerLog&Handouts/Mechanics/CLI/spells/modify-memory.md) |
^dimir-guild-spells

Your magic is meant to be subtle and undetectable, but it might pull shadows or clouds of mist around you as you cast your spells. Using the [encode thoughts](03.PlayerLog&Handouts/Mechanics/CLI/spells/encode-thoughts-ggr.md) cantrip described below, you can turn a creature's thoughts (including your own) into a thought strand that others can potentially read, share, or steal. These thought strands are treated as valuable currency among the Dimir.
