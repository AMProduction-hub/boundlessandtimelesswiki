...
| dice: d6 | Effect |
|----------|--------|
| 1 | Every spell cast in the area triggers a wild magic surge. (Roll on the [Wild Magic Surge](03.PlayerLog&Handouts/Mechanics/CLI/tables/wild-magic-surge-phb.md) table in the "Sorcerer" section of the *Player's Handbook*.) |
...
| 3 | The area is affected by a [guards and wards](03.PlayerLog&Handouts/Mechanics/CLI/spells/guards-and-wards.md)*spell*. |
...
| 6 | Random sections of the area are affected by an [antimagic field](03.PlayerLog&Handouts/Mechanics/CLI/spells/antimagic-field.md) spell. |
^bizarre-magical-effects