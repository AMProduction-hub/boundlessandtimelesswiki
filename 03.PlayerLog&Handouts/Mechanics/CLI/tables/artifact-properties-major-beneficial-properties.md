...
| 21-30 | While attuned to the artifact, you regain `d6` hit points at the start of your turn if you have at least 1 hit point. |
| 31-40 | When you hit with a weapon attack while attuned to the artifact, the target takes an extra `d6` damage of the weapon's type. |
...
| 91-00 | While attuned to the artifact, you can't be [blinded](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Blinded), [deafened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Deafened), [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified), or [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned). |
^major-beneficial-properties