...
- **Mangonel.** Sailing ships have one [mangonel](03.PlayerLog&Handouts/Mechanics/CLI/objects/mangonel.md) (DMG, ch. 8) attached to the deck. Each weapon has 10 mangonel stones stacked and secured near it.  
...
```ad-statblock
title: Sailing Ship
![](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/token/sailing-ship.webp#token)
...
- **Fire Ballista.** The ship can fire its [ballista](03.PlayerLog&Handouts/Mechanics/CLI/objects/ballista.md) (DMG, ch. 8).  
- **Fire Mangonel.** The ship can fire its [mangonel](03.PlayerLog&Handouts/Mechanics/CLI/objects/mangonel.md) (DMG, ch. 8).  
