...
- One captain ([bandit captain](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit-captain.md))  
- Four other officers: a first mate, a bosun, a quartermaster, and a cook ([nobles](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/noble.md))  
- Twenty-five sailors ([commoners](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/commoner.md))  

A warship typically includes the following additional crew to augment its fighting ability:

- Forty soldiers ([guards](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/guard.md))  
- Eight siege engineers ([guards](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/guard.md))  
- One [priest](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/priest.md) (the ship's surgeon)  

## 1. Main Deck

The main deck of the ship has the following features:

- **Mangonel.** Sailing ships have one [mangonel](03.PlayerLog&Handouts/Mechanics/CLI/objects/mangonel.md) (DMG, ch. 8) attached to the deck. Warships have two mangonels (DMG, ch. 8). Each weapon has 10 mangonel stones stacked and secured near it.  
...
- **Rowboats.** Four [rowboats](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/rowboat.md) are stacked on top of each other on this deck. Ropes and pulleys can hoist these boats in and out of the water.  
...
- **Ballista.** A [ballista](03.PlayerLog&Handouts/Mechanics/CLI/objects/ballista.md) (DMG, ch. 8) is attached to the deck. Ten ballista arrows are stacked and secured nearby.  
...
- **Ballista.** On a warship, a [ballista](03.PlayerLog&Handouts/Mechanics/CLI/objects/ballista.md) (DMG, ch. 8) is attached to the deck. Ten ballista arrows are stacked and secured nearby.  
...
This cabin is meant for guests and visiting high-ranking officials along for the journey. Since warships often have a greater need to house prisoners rather than guests, each bed aboard such a vessel also has a set of [manacles](03.PlayerLog&Handouts/Mechanics/CLI/items/manacles.md) (see chapter 5 in the Player's Handbook) attached to its frame.
...
```ad-statblock
title: Warship
![](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/token/warship.webp#token)
...
- **Fire Ballistas.** The warship can fire its [ballistas](03.PlayerLog&Handouts/Mechanics/CLI/objects/ballista.md) (DMG, ch. 8).  
- **Fire Mangonels.** The warship can fire its [mangonels](03.PlayerLog&Handouts/Mechanics/CLI/objects/mangonel.md) (DMG, ch. 8).  
