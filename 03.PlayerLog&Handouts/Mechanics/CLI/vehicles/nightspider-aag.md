...
Neogi terrorize Wildspace in ships of their own construction, which others call nightspiders. These vessels often wait in ambush for other ships. Once a target ship is identified, the neogi try to steal its [spelljamming helm](spelljamming-helm-aag.md) and capture its crew.

A nightspider's crew usually consists of nineteen neogi and up to a half-dozen [umber hulks](umber-hulk.md), which the neogi use as shock troops.
...
```ad-statblock
title: Nightspider
![](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/vehicles/token/nightspider-aag.webp#token)
