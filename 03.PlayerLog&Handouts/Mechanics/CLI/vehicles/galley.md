...
- Five other officers: a first mate, a bosun, a quartermaster, a surgeon, and a cook ([scouts](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/scout.md))  
- Forty-two sailors ([commoners](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/commoner.md))  
- Twelve siege engineers ([guards](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/guard.md))  
- Twenty [guards](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/guard.md)  
...
```ad-statblock
title: Galley
![](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/token/galley.webp#token)
...
- **Fire Ballistas.** The galley can fire its [ballistas](03.PlayerLog&Handouts/Mechanics/CLI/objects/ballista.md) (DMG, ch. 8).  
- **Fire Mangonels.** The galley can fire its [mangonels](03.PlayerLog&Handouts/Mechanics/CLI/objects/mangonel.md) (DMG, ch. 8).  
