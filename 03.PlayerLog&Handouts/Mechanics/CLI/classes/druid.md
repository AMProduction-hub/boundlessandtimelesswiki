...
You know Druidic, the secret language of druids. You can speak the language and use it to leave hidden messages. You and others who know this language automatically spot such a message. Others spot the message's presence with a successful DC 15 Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) check but can't decipher it without magic.
...
**Spellcasting Focus.** You can use a [druidic focus](03.PlayerLog&Handouts/Mechanics/CLI/items/druidic-focus.md) as a spellcasting focus for your druid spells.
