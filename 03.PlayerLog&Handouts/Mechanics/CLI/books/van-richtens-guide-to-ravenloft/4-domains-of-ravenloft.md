...
- A creature that starts its turn in the Mists must succeed on a DC 20 Constitution saving throw or gain 1 level of [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion). This [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion) can't be removed while the creature is in the Mists.  
...
The Dark Powers influence magical effects, imparting them with sinister qualities. How these changes manifest are for you to decide and can shift from domain to domain. Do summoned creatures appear undead in one domain or violently mutated in another? Do divination spells rasp in the voices of otherworldly ancients? Do the effects of drinking a [potion of healing](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-healing.md) feel like grubs weaving wounds shut from within? Magic looks menacing in the Domains of Dread, but descriptive embellishments shouldn't change the actual effects of spells or magic items.
...
When a creature with a soul dies among the Domains of Dread, its spirit becomes caught in the Mists and can't travel to the afterlife. If a creature who has been dead for at least 24 hours returns to life by way of a spell or other supernatural means, it realizes that its spirit is trapped within the Mists, likely forever. Using the rules for "[Fear and Stress](03.PlayerLog&Handouts/Mechanics/CLI/rules/variant-rules/fear-and-stress-vrgr.md)" from "chapter 4", the creature gains a new Seed of Fear.
...
Each domain is its own demiplane, isolated from all other planes including the Material Plane. No spell—not even [wish](03.PlayerLog&Handouts/Mechanics/CLI/spells/wish.md)—allows escape from the Domains of Dread. Spells such as [astral projection](03.PlayerLog&Handouts/Mechanics/CLI/spells/astral-projection.md), [plane shift](03.PlayerLog&Handouts/Mechanics/CLI/spells/plane-shift.md), [teleport](03.PlayerLog&Handouts/Mechanics/CLI/spells/teleport.md), and similar magic cast for the purpose of escaping a domain simply fail, as do effects that banish a creature to another plane. These restrictions apply to all other effects, including magic items and artifacts that transport or banish creatures to other planes. Magic that allows transit to the Border Ethereal, such as the [etherealness](03.PlayerLog&Handouts/Mechanics/CLI/spells/etherealness.md) spell and the Etherealness feature of ghosts, is the exception to this rule. A creature that enters the Border Ethereal from a domain is pulled back into the domain it left upon leaving the Ethereal.

For the purpose of spells whose effects change across or are blocked by planar boundaries (such as [sending](03.PlayerLog&Handouts/Mechanics/CLI/spells/sending.md)), each domain is considered its own plane. Magic that summons creatures or objects from other planes functions normally, as does magic that involves an extradimensional space. Spells cast within an extradimensional space (such as that created by [Mordenkainen's magnificent mansion](03.PlayerLog&Handouts/Mechanics/CLI/spells/mordenkainens-magnificent-mansion.md)) are subject to the same restrictions as magic cast within a domain.
...
> [!gallery]
> ![Map 3.1: Barovia](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/040-map-3-1-barovia.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/041-map-3-1-barovia-player.webp#gallery)
...
Little is known of the origins of the Domains of Dread, but what's certain is that they began here. Strahd's villainy, his connection to his land, and his entanglement with the sinister [priests of Osybus](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/priest-of-osybus-vrgr.md) (detailed in "chapter 5") drew all of Barovia into the Shadowfell. This began a succession of torments that haunt the Count still and spill forth to drag others into the Land of the Mists.

#### Strahd's Powers and Dominion

Strahd is a patient and dramatic mastermind. His statistics are similar to those of a [vampire](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire.md) and his spellcasting prowess is formidable, enabling him to face most threats directly. Strahd ever seeks to escape his boredom and draws challenges out for as long as it entertains him. However, if insulted, the Darklord can turn all of Barovia against his foes.
...
![Barovia Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/barovia-adventures-vrgr.md)
...
![Who Is Tatyana?; Tatyana's Incarnation](03.PlayerLog&Handouts/Mechanics/CLI/tables/who-is-tatyana-tatyanas-incarnation-vrgr.md)
...
![Connection to Strahd; Avoiding Strahd](03.PlayerLog&Handouts/Mechanics/CLI/tables/connection-to-strahd-avoiding-strahd-vrgr.md)

![Connection to Strahd; Hunting Strahd](03.PlayerLog&Handouts/Mechanics/CLI/tables/connection-to-strahd-hunting-strahd-vrgr.md)
...
The God-Brain commands untold numbers of [mind flayers](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/mind-flayer.md), [intellect devourers](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/intellect-devourer.md), and other creatures. Within Bluetspur, it is constantly telepathically linked with all its servants and knows anything that they know. The God-Brain delegates broad goals to its most effective servants, encouraging them to indulge all manner of radical experiments.
...
The illithids of Bluetspur toil to save their elder brain through all manner of outlandish scientific and medical means. Among the most bizarre of these schemes is the God-Brain's own: the creation of degenerate servants that hunt for balms for its affliction. These [vampiric mind flayers](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampiric-mind-flayer-vrgr.md) (see "chapter 5") slip from Bluetspur to prey upon Humanoids. They then return to the God-Brain, bloated with cerebrospinal fluid to momentarily dull its suffering.

##### Closing the Borders

When the God-Brain closes Bluetspur's borders, the surface of the domain is wracked by extreme electrical storms, and alien vapors rise at the domain's distant edges and within its hidden tunnels. Rather than barring creatures' escape, these Mists repress memories. Any non-Aberration who leaves Bluetspur is transported to a familiar place where they soon wake up, even if they weren't previously asleep. Their time in Bluetspur is repressed, altered as if by the [modify memory](03.PlayerLog&Handouts/Mechanics/CLI/spells/modify-memory.md) spell. See ""Recovering Memories"" below for more details.
...
![Bluetspur Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/bluetspur-adventures-vrgr.md)
...
Both the mind flayers of Bluetspur and the Mists surrounding the domain employ methods similar to the [modify memory](03.PlayerLog&Handouts/Mechanics/CLI/spells/modify-memory.md) spell to obscure victims' memories of their abduction, replacing them with hazy events or gaps of missing time. A character's true memories can be restored by a [remove curse](03.PlayerLog&Handouts/Mechanics/CLI/spells/remove-curse.md) or [greater restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/greater-restoration.md) spell. A victim of the mind flayers might have endured dozens of memory modifications, each requiring its own magical removal, resulting in the recovery of a few traumatic memories at a time.
...
![Alien Artifacts; Aberrant Evidence](03.PlayerLog&Handouts/Mechanics/CLI/tables/alien-artifacts-aberrant-evidence-vrgr.md)
...
> [!gallery]
> ![Map 3.2: Borca](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/045-map-3-2-borca.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/046-map-3-2-borca-player.webp#gallery)
...
![Misericordia and Other Noble Estates; Noble Families and Estates](03.PlayerLog&Handouts/Mechanics/CLI/tables/misericordia-and-other-noble-estates-noble-families-and-estates-vrgr.md)
...
Ivana appears to be a young human woman with statistics similar to a [spy](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/spy.md). Since her arrival in the Land of the Mists, her blood has been tainted with poison, and angry red-and-black veins visibly show through her pale skin. While this discoloration is unignorable, the toxins grant her immunity to poison damage and being [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned). Her genius and ambition define her manipulations.
...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/048-03-006.webp#center)
...
![Ivan Dilisnya in his favorite clockwork pram](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/049-03-008-ivan-dilisnya.webp#center)

#### Ivan's Powers and Dominion

Ivan isn't a physically or magically powerful Darklord. He's an extremely old man, but supernaturally he remains as physically fit as he was in the prime of life and has the statistics of a human [noble](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/noble.md). His menace manifests in the form of psychological manipulation, making others doubt reality, and causing victims to overestimate his control.
...
![Borca Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/borca-adventures-vrgr.md)
...
![Ignoble Bonds; Ignoble Request](03.PlayerLog&Handouts/Mechanics/CLI/tables/ignoble-bonds-ignoble-request-vrgr.md)
...
![Lethal Leverage](03.PlayerLog&Handouts/Mechanics/CLI/tables/lethal-leverage-vrgr.md)
...
> 
> **How did you join the Carnival?** Did you run away to join? Were you an outcast who found a home with the Carnival? Did [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) or a trouper save you from danger?
^carnival-characters
...
- **Tindal the Barker.** Tindal, the Carnival's cynical, fast-talking lead barker ([mage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/mage.md)), tours the grounds with visitors. At their last stop, he reveals his own uniqueness as the Amazing Soul-less Man: he casts no reflection and claims to lack a soul.  
- **Alti the Werehare.** A quick-tongued rapper and dancer, Alti ([wererat](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/wererat.md)) is a bombastic performer who turns into a rabbit on nights of the full moon.  
- **Amelia the Vampire.** Amelia ([scout](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/scout.md) with a flying speed of 30 feet) is a cheery acrobat aided in her performances by a pair of leathery wings that allows her to fly. Before stepping on stage, she powders her face, affects a somber accent, and pretends to be undead.  
- **Charlotte the Fire Eater.** This juggling daredevil ([veteran](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/veteran.md)) performs with a dizzying array of flaming knives and other deadly objects. She claims that her blood is flammable and that she's burned the hair off eighteen hecklers.  
- **The Organ Grinder.** This somber clown grinds an ornate barrel organ ([scout](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/scout.md)). An attendant group of mischievous, half-trained, not-quite-identifiable animals caper to this music. The clown never speaks but allows visitors to guess at the animals' nature for a copper piece.  
- **Silessa the Snake.** A dancer and animal tamer, Silessa ([druid](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/druid.md)) performs with a collection of rare serpents. She claims she was born a snake and magically transformed into an elf.  

#### Hall of Horrors

A severe, bespectacled academic, Professor Pacali runs the Carnival's Hall of Horrors. This sizable, sinister tent contains a maze of taxidermic creatures, cabinets of curiosity, peculiar specimens in jars, and the occasional true wonder. Pacali hides a personal unsettling secret. During his time as a researcher at the Brautslava Institute in Darkon, Pacali was cursed: his worst impulses now grow from his body as terrible creatures. He bottles these murderous homunculi and touts them as "Professor Pacali's Pickled Punks," but every now and then one "escapes." Pacali persistently criticizes Hermos and [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md), but rarely acts against them directly.
...
[Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md), the Carnival's leader, is an eladrin (an elf native to the Feywild). She is a Fey who otherwise uses the [cambion](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/cambion.md) stat block. She is never seen without her [holy avenger](03.PlayerLog&Handouts/Mechanics/CLI/items/holy-avenger.md) longsword, [Nepenthe](03.PlayerLog&Handouts/Mechanics/CLI/items/nepenthe-vrgr.md), which glows red with hate. Nepenthe, not [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md), is the Carnival's Darklord.

#### Isolde

![Isolde with the sword Nepenthe](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/051-03-010-isolde-with-the-sword-nepenthe.webp#center)

[Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) was a holy warrior devoted to a pantheon of elven deities called the Seldarine. In this role, she defended the Feywild against dragons, demons, and other threats. In time, her heroics caught the eye of an archfey named Zybilna, who had forged secret pacts with some of the fiends [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) and her companions had slain. Rather than be angry at [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md), Zybilna was impressed by her. She enlisted a powerful fiend known only as "the Caller" to corrupt and slay all of [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md)'s companions, leaving [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) alone, bitter, and vulnerable. The insidious archfey then befriended [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) and offered to help her forget her terrible losses. [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) became the master of a traveling fey carnival that served as a gateway to Zybilna's domain. The carnival did what Zybilna hoped it would do: it brought comfort to [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) and quelled her thirst for vengeance.

Zybilna and [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) enjoyed a strong partnership for years, but as time wore on, they grew distant until their relationship finally soured. Eladrin crave change, yet [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) felt like she was frozen in time. She wished to leave the fey carnival and pursue other dreams, but Zybilna wouldn't hear of it and secretly used [wish](03.PlayerLog&Handouts/Mechanics/CLI/spells/wish.md) spells to make [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) place her devotion to the carnival above her desire to leave it.

When [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md)'s fey carnival crossed paths with another carnival from the Shadowfell, the eladrin found the escape she longed for. [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) orchestrated a trade with the other carnival's owners, a pair of shadar-kai (elves native to the Shadowfell). [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) would become the master of their carnival, and they would become the masters of hers. To appease Zybilna, this arrangement would remain in place only until the two carnivals crossed paths again.

Zybilna was intrigued enough by the shadar-kai to let [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) go, but not without casting a spell that made [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) forget about Zybilna and her Feywild domain, thus preventing the eladrin from divulging the archfey's secrets. As a further punishment, Zybilna sent malevolent fey creatures to hound [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) and her Shadowfell carnival. [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) doesn't know who is behind this petty torment, nor does she care. Her hunt for the Caller and her thirst for vengeance have become all-consuming.

#### Nepenthe

The [holy avenger](03.PlayerLog&Handouts/Mechanics/CLI/items/holy-avenger.md) named [Nepenthe](03.PlayerLog&Handouts/Mechanics/CLI/items/nepenthe-vrgr.md) was crafted by shadar-kai to mete out justice as an executioner's weapon. In its lifetime, the sword has beheaded thousands of criminals, not all of whom were guilty of the crimes for which they were convicted. The sword cannot distinguish the guilty from the innocent. With each beheading, it hungers for more justice and blood.

Nepenthe came to the Carnival in the hands of a retired half-ogre who moonlighted as a sword-swallower. When the half-ogre died of old age, the sword was deemed the property of the Carnival. It was given to [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) by the Carnival's previous owners, who claimed that the sword would help her protect the Carnival against any threat.

In [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md), the sword found a partner who shared its blind malice toward the guilty. [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) uses Nepenthe to behead anyone found guilty of stealing from the Carnival or inflicting harm upon it.

As soon as [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) took up the blade, it rekindled the grief and fury she had suppressed for so long, awakening the desire to avenge her long-dead companions by slaying the fiend she knows as "the Caller" (see ""Mist Wanderers"" later in this chapter for details). [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) always chooses the Carnival's stops based on her predictions of the Caller's next steps, and if her pursuit forces the Carnival into danger, so be it. Only by ridding [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) of Nepenthe can she truly escape the Dark Powers' clutches. But [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) will never part with the blade willingly, and if it is taken from the Carnival, the sword will always find its way back.

In addition to having the properties of a [holy avenger](03.PlayerLog&Handouts/Mechanics/CLI/items/holy-avenger.md), Nepenthe is a sentient, neutral evil weapon with an Intelligence of 10, a Wisdom of 8, and a Charisma of 18. It has hearing and [darkvision](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Darkvision) out to a range of 60 feet. It can read and understand Elvish. It can also speak Elvish, but only through the voice of its wielder, with whom the sword can communicate telepathically. When using its telepathy to speak to [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md), the sword can mimic the voices of [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md)'s fallen companions as it drives her to catch their fiendish killer. Unlike [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md), whose motives are good, the sword is corrupt and irredeemable.

#### Freedom of the Mists

The Carnival travels through the Mists and between other Domains of Dread as [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) pleases—though the Dark Powers occasionally send it off course. The Carnival provides one of the few means of escaping from another Darklord's domain, since it ignores the closed borders of other domains. Other Darklords cannot travel with the Carnival to escape their own domains, however.

#### Closing the Borders

Nepenthe can close the borders of its domain, as detailed in ""The Mists"" at the start of this chapter. With the sword's consent, [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) can do the same. When the Carnival's borders close, the Mists are filled with eerie, colorful lights and distant music, echoing memories of past carnivals.

#### Isolde's Torment

[Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) is both protector and prisoner of the Carnival.

The following truths endlessly weigh upon her:

- The Carnival constantly grows, bringing additional souls dependent on [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md)'s guardianship. She's tortured by her obligation toward the Carnival's troupers and her vow to avenge her murdered companions.  
...
- [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) dreads the day when the Carnival crosses paths with its fey counterpart for a second time. Were that to happen, [Isolde](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/isolde-vrgr.md) would be forced to relinquish the Carnival to its true shadar-kai masters, and Nepenthe along with it.  
...
> [!gallery]
> ![Map 3.3: Darkon](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/052-map-3-3-darkon.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/053-map-3-3-darkon-player.webp#gallery)
...
![Alcio &quot;Baron&quot; Metus](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/054-03-011-alcid.webp#center)
...
Alcio is a flashy, passionate, and fantastically violent [vampire](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire.md). As the head of the Kargat and the region's criminal operations, she rules the Jagged Coast using information and intimidation. She's quick to punish incompetence and quicker to reward daring, but she reserves her greatest rewards for those who further her plots for revenge against Rudolph van Richten.
...
Darcalus Rex is a [necrichor](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/necrichor-vrgr.md) (see "chapter 5") who cares little for the survival of Darkon—and might not even be the ancient ruler. The elf [archmage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/archmage.md) Cardinna Artazas desperately believes she's doing what must be done—including corrupting her order—to save her homeland.
...
![Darkon Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/darkon-adventures-vrgr.md)
...
![Darkon's Salvation](03.PlayerLog&Handouts/Mechanics/CLI/tables/darkons-salvation-vrgr.md)

![Means to Save Darkon](03.PlayerLog&Handouts/Mechanics/CLI/tables/means-to-save-darkon-vrgr.md)
...
![Darkon Allies](03.PlayerLog&Handouts/Mechanics/CLI/tables/darkon-allies-vrgr.md)

![Darkon Rivals](03.PlayerLog&Handouts/Mechanics/CLI/tables/darkon-rivals-vrgr.md)
...
![Dread in Darkon](03.PlayerLog&Handouts/Mechanics/CLI/tables/dread-in-darkon-vrgr.md)
...
![Darkon Finale](03.PlayerLog&Handouts/Mechanics/CLI/tables/darkon-finale-vrgr.md)
...
> [!gallery]
> ![Map 3.4: Dementlieu](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/056-map-3-4-dementlieu.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/057-map-3-4-dementlieu-player.webp#gallery)
...
![Dementlieu Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/dementlieu-adventures-vrgr.md)
...
![The Grand Masquerade; Grand Masquerade Objectives](03.PlayerLog&Handouts/Mechanics/CLI/tables/the-grand-masquerade-grand-masquerade-objectives-vrgr.md)
...
- Characters can keep a close eye on how other people behave and mimic that behavior. Use Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) checks to measure how keenly they observe the partygoers' deportment, and Intelligence ([Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation)) checks to deduce the right behavior for a particular situation.  
- Characters can apply magic or intuition to discern the response or behavior that a questioner expects. Use Wisdom ([Insight](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Insight)) checks unless characters have access to mind-reading spells such as [detect thoughts](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-thoughts.md) or similar magic.  
- Characters can fake it 'til they make it. Use Charisma ([Deception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Deception)) checks extensively as characters work their way through the ball. Failed checks draw increased attention; on successful checks, the questioners lose interest.  
- Characters can distract watchers to shift attention if things go badly. Use Charisma ([Deception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Deception)) or Dexterity ([Sleight of Hand](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) checks (or any other reasonable skill checks the players suggest) to determine whether they turn the focus away from their errors.  
...
![Random Complications; Grand Masquerade Complications](03.PlayerLog&Handouts/Mechanics/CLI/tables/random-complications-grand-masquerade-complications-vrgr.md)
...
> [!gallery]
> ![Map 3.5: Falkovnia](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/059-map-3-5-falkovnia.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/060-map-3-5-falkovnia-player.webp#gallery)
...
Vladeska Drakov is an experienced military commander with statistics similar to those of a [knight](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/knight.md). While her martial skill is considerable, her true might comes in the form of the obedient army that unquestioningly enacts her every whim.

##### The Falcon's Talons

Vladeska's military forces are both completely overwhelming and entirely outnumbered. As an occupying force, the Talons are terrifying. Their numbers are relatively few, but they're organized enough to oppress Lekar's ragged survivors and enforce Drakov's totalitarian laws. In the face of zombie hordes, though, they're fighting a losing battle against foes whose numbers only grow. And every time a Talon falls, Lekar's final defeat grows closer. Talon soldiers use the [guard](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/guard.md) stat block, while commanders are [veterans](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/veteran.md).
...
When creating zombie encounters, consider the average level of your group and what threats you want to represent. The ""Zombie"" entry in "chapter 5" presents a variety of zombie types to complement the shambling [zombie](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/zombie.md) of the "Monster Manual", posing greater threats or terrifying surprises. The horde can also include other corporeal Undead such as [skeletons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/skeleton.md), [ghouls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/ghoul.md), or [wights](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/wight.md). Alternatively, the "zombies" might not be Undead at all but another group attempting to lay claim to Falkovnia—perhaps a forgotten human culture or relentless giants.
...
![Falkovnia Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/falkovnia-adventures-vrgr.md)
...
- **Mindtaker Mists.** The Mists deposit the characters' consciousnesses into soldiers, Talon officers, or unprepared peasants preparing for the siege. Consult the "[Survivors](03.PlayerLog&Handouts/Mechanics/CLI/rules/variant-rules/survivors-vrgr.md)" section of "chapter 4" for suggestions on how to represent soldiers bound to face the horde.  

#### Before the Siege

However the characters become enlisted in Lekar's defense, they face a hopeless battle. They join hundreds of unprepared defenders, including [commoners](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/commoner.md) holding clubs or longbows for the first time.
...
Stairways within Lekar's 40-foot-high towers grant access to the 30-foot-high walls. Parapets guard both, providing defenders with three-quarters cover from those outside the walls. Fortifications around the gates hold controls for massive barred doors and portcullises. Both towers and gates contain [suspended cauldrons](03.PlayerLog&Handouts/Mechanics/CLI/objects/suspended-cauldron.md) (detailed in the "Dungeon Master's Guide").

##### Streets

The streets are packed with poorly armed commoners and cruel Talon soldiers. Any character who succeeds on a DC 16 Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) check finds useful materials among the carts and cargo cleared from the streets—weapons, a variety of adventuring gear, or the resources to approximate one [gunpowder keg explosive](03.PlayerLog&Handouts/Mechanics/CLI/items/gunpowder-keg.md) (described in the "Dungeon Master's Guide").
...
![During the Siege; Zombie Siege Encounters](03.PlayerLog&Handouts/Mechanics/CLI/tables/during-the-siege-zombie-siege-encounters-vrgr.md)
...
![Concluding the Siege; Zombie Siege Climax](03.PlayerLog&Handouts/Mechanics/CLI/tables/concluding-the-siege-zombie-siege-climax-vrgr.md)

Drakov's scheme might be even more alarming, involving magical or monstrous secret weapons.

Once you've determined how the siege will unfold, start foreshadowing Drakov's scheme, giving the characters the opportunity to aid it, enact a less destructive plan, or save innocents. Use missives intercepted from messengers or a [sending stone](03.PlayerLog&Handouts/Mechanics/CLI/items/sending-stones.md) taken from a fallen Talon officer to clue the party in on Drakov's strategy.
...
> [!gallery]
> ![Map 3.6: Har'Akir](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/062-map-3-6-har-akir.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/063-map-3-6-har-akir-player.webp#gallery)
...
![Pharaoh Ankhtepot envisions his missing ka](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/064-03-015-pharaoh.webp#center)
...
A fantastically ancient Undead, Ankhtepot has statistics similar to a [mummy lord](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/mummy-lord.md). Beyond this, he rules as pharaoh, national leader, and voice of the gods. None in Har'Akir, among the living or the dead, denies his will, but the Darklord's wishes are few. He cares only for order and to find his lost ka.

##### Children of Ankhtepot

The Darklord is served by many of the same priests who died alongside him in ages past. He resurrected these [mummies](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/mummy.md) and [mummy lords](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/mummy-lord.md) with the heads of animals, painting them as spirits and harbingers of his fictitious gods of Har'Akir. As Ankhtepot has grown bored with mortal concerns, the Children of Ankhtepot have pursued their own vices. Many dream and despair in their crypts. Others foment small cults of their own. And still others seek to undermine the pharaoh and claim his position—including the treacherous [mummy lord](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/mummy-lord.md) Senmet.
...
![Har'Akir Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/harakir-adventures-vrgr.md)
...
![The Soul's Shape; Ankhtepot's Soul](03.PlayerLog&Handouts/Mechanics/CLI/tables/the-souls-shape-ankhtepots-soul-vrgr.md)
...
![The Hunters' Role; Hunt for the Ka](03.PlayerLog&Handouts/Mechanics/CLI/tables/the-hunters-role-hunt-for-the-ka-vrgr.md)
...
![The Pharaoh's Return; Ankhtepot Reborn](03.PlayerLog&Handouts/Mechanics/CLI/tables/the-pharaohs-return-ankhtepot-reborn-vrgr.md)
...
- Creatures warped by magical experiments infest the domain, including magic-hungry [gremishkas](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/gremishka-vrgr.md) (see "chapter 5") and ravenous [purple worms](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/purple-worm.md).  
...
> [!gallery]
> ![Map 3.7: Hazlan](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/065-map-3-7-hazlan.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/066-map-3-7-hazlan-player.webp#gallery)
...
![Hazlik](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/067-03-016-hazlik.webp#center)
...
Hazlik is a vain, egotistical overlord, convinced he is the supreme being in his domain. His statistics echo those of an [archmage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/archmage.md), but he favors using an array of magic items rather than his own spells.
...
![Hazlan Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/hazlan-adventures-vrgr.md)
...
![Hazlan Wild Magic](03.PlayerLog&Handouts/Mechanics/CLI/tables/hazlan-wild-magic-vrgr.md)
...
- At any time, Hazlik can use any Eye of Hazlik in his domain as a stationary eye created by the [arcane eye](03.PlayerLog&Handouts/Mechanics/CLI/spells/arcane-eye.md) spell. He can spy through the eye whenever and for as long as he pleases. The eye radiates magic while Hazlik spies through it.  
...
- [Jiangshi](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/jiangshi-vrgr.md) haunt the streets of I'Cath, tearing down whole districts and rebuilding them.  
...
![Tsien Chiang](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/069-03-018-tsien-chiang.webp#center)
...
Tsien Chiang's statistics are similar to those of a [mage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/mage.md) with access to a variety of magic items—her favorite being an ornate robe that functions similarly to a [Heward's handy haversack](03.PlayerLog&Handouts/Mechanics/CLI/items/hewards-handy-haversack.md) and [wings of flying](03.PlayerLog&Handouts/Mechanics/CLI/items/wings-of-flying.md). She uses this robe to store scrolls detailing her most recent plans for I'Cath's renovation. Additionally, Tsien Chiang enforces her will upon her domain in a variety of other ways.
...
![I'Cath Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/icath-adventures-vrgr.md)
...
- **Tsien Lei-An.** Voiceless Tsien Lei-An is made entirely of eyes and has the statistics of a [scarecrow](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/scarecrow.md). She wishes for a robe of ghost hair silk or a jiangshi's slippers. She spends much of her time wandering the Mansions, rooting through the possessions of sleeping city-dwellers.  
- **Tsien Man-Yi.** Made of pale wood, Tsien Man-Yi must remain near the willow tree in the courtyard of the Palace of Bones, and has the statistics of a [dryad](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/dryad.md). She wishes for flowers from the Gemstone Garden or for a friend to fall asleep under her tree's boughs.  
- **Tsien Seu-Mei.** Voiceless Tsien Seu-Mei is made entirely of teeth and has the statistics of a [ghoul](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/ghoul.md). She wishes to eat a delicious dessert or care for one of the fish of the Gemstone Gardens. She often wanders the stalls of Gwai-Huit Center.  
- **Tsien Wai-Ching.** Made of living fog, Tsien Wai-Ching is the youngest daughter and has the statistics of a [specter](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/specter.md). She wishes to help a spirit from Ping'On Tower find its family or to play with an incorporeal toy. She regularly explores the memorials in the Gemstone Gardens.  

![A resident of I'Cath attempts to flee a jiangshi](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/070-03-019-resident.webp#center)
...
> [!gallery]
> ![Map 3.8: Kalakeri](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/071-map-3-8-kalakeri.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/072-map-3-8-kalakeri-player.webp#gallery)
...
Kalakeri's most fearsome predators inhabit the Backwaters, including [basilisks](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/basilisk.md), [hydras](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/hydra.md), [stone giants](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/stone-giant.md), and [cloud giants](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/cloud-giant.md).
...
![Maharani Ramya Vasavadan](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/073-03-020-maharani-ramya-vasavadan.webp#center)
...
Kalakeri's armies and the guards of the Cerulean Citadel obey Ramya without question, despite thousands of them having died in her service. These soldiers' loyalty follows them into death. Any living soldier who dies in Ramya's service returns to life as an Undead warrior—a [skeleton](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/skeleton.md) or [wight](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/wight.md)—on the night of the next new moon and rejoins the maharani's army. Ramya's living followers consider this deathless state an honor and the ultimate mark of loyalty.
...
![Kalakeri Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/kalakeri-adventures-vrgr.md)
...
![Renown in Kalakeri](03.PlayerLog&Handouts/Mechanics/CLI/tables/renown-in-kalakeri-vrgr.md)
...
![Benefits of Renown; Loyalist Benefits](03.PlayerLog&Handouts/Mechanics/CLI/tables/benefits-of-renown-loyalist-benefits-vrgr.md)
...
![Benefits of Renown; Rebel Benefits](03.PlayerLog&Handouts/Mechanics/CLI/tables/benefits-of-renown-rebel-benefits-vrgr.md)
...
> [!gallery]
> ![Map 3.9: Kartakass](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/076-map-3-9-kartakass.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/077-map-3-9-kartakass-player.webp#gallery)
...
![Harkon Lukas](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/078-03-022-harkon-lukas.webp#center)
...
![Kartakass Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/kartakass-adventures-vrgr.md)
...
> [!gallery]
> ![Map 3.10: Lamordia](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/080-map-3-10-lamordia.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/081-map-3-10-lamordia-player.webp#gallery)
...
- [Elise](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/elise-vrgr.md) evades Mordenheim's attempts to find her.  
...
![Lamordia Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/lamordia-adventures-vrgr.md)

### Mordenheim's Monsters

The horror at Lamordia's heart is Dr. Mordenheim's bizarre experiments and ceaseless search for [Elise](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/elise-vrgr.md).

#### Elise and the Unbreakable Heart

Above all else, Dr. Mordenheim's objectives are finding [Elise](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/elise-vrgr.md) and recovering or re-creating the Unbreakable Heart.

##### Elise

Dr. Mordenheim's supposed beloved and greatest achievement, [Elise](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/elise-vrgr.md) is a confused, frustrated soul who never wished for her current circumstances. She's now a [flesh golem](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/flesh-golem.md) with the following adjustments:

- [Elise](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/elise-vrgr.md) does not have the Berserk or Aversion of Fire traits.  
- She has immunity to cold damage.  

[Elise](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/elise-vrgr.md)'s heart has been replaced with the Unbreakable Heart. If this device is removed, [Elise](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/elise-vrgr.md) dies, even if it is replaced with another heart. [Elise](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/elise-vrgr.md) is horrified by what Dr. Mordenheim did to her and tries to avoid the doctor and all strangers, fearing they might kill her to learn the Unbreakable Heart's secrets. She roams without destination but keeps a hidden sanctuary at Hope's Heart on the Isles of Agony. Although she has tried to leave Lamordia, the Mists prevent her from doing so.
...
![Mordenheim's Designs; Serving Dr. Mordenheim](03.PlayerLog&Handouts/Mechanics/CLI/tables/mordenheims-designs-serving-dr-mordenheim-vrgr.md)
...
> [!gallery]
> ![Map 3.11: Mordent](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/084-map-3-11-mordent.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/085-map-3-11-mordent-player.webp#gallery)
...
![Van Richten's Herbalist Shop in Mordentshire](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/086-03-027-van-richten.webp#center)
...
![Mordent Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/mordent-adventures-vrgr.md)
...
![Ghost's History](03.PlayerLog&Handouts/Mechanics/CLI/tables/ghosts-history-vrgr.md)
...
![Tragedy; Tragic Elements](03.PlayerLog&Handouts/Mechanics/CLI/tables/tragedy-tragic-elements-vrgr.md)
...
> [!gallery]
> ![Map 3.12: Richemulot](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/088-map-3-12-richemulot.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/089-map-3-12-richemulot-player.webp#gallery)
...
![Jacqueline Renier](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/090-03-029-jacqueline-renier.webp#center)
...
Finding like-minded souls took Renier years, but she finally became aware of the mysterious Trueblood Council, a secret society of Richemulot's eldest and most esteemed families. Expending a fortune, Renier aggressively pursued membership. Finally she was granted an invitation to join the society's members at their meeting place hidden among the sewers of Pont-a-Museau. But when Renier arrived, she found a throng of filthy commoners, not the dramatic masterminds she'd expected. As she cursed them and set off to fetch the guards, the council members revealed their true [wererat](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/wererat.md) forms. That night, she was inducted into their ranks.
...
Although Jacqueline Renier has statistics similar to those of a [wererat](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/wererat.md), she assumes her hybrid or rat form only when forced to defend herself or when pushed to the brink of rage. She is rarely without guards, be they members of the Casques Silencieux, wererat bodyguards, or hidden swarms of rats.

##### Casques Silencieux

The Darklord's silent state police guard Chateau Delanuit and enforce her quarantines across Richemulot. Rather than the soldiers they appear to be, these troops are [animated armor](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/animated-armor.md) filled with rats that mindlessly and mercilessly enact Jacqueline Renier's will. If a guard is defeated, the armor collapses, releasing a [swarm of rats](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/swarm-of-rats.md).
...
When Jacqueline Renier wishes to close her domain's borders, the Mists rise at the edge of the lands, as detailed in ""The Mists"" at the start of this chapter. Additionally, the Mists are filled with [swarms of rats](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/swarm-of-rats.md); endless waves of them attack any creatures that enter the Mists.
...
![Richemulot Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/richemulot-adventures-vrgr.md)
...
The Gnaws is spread when a creature is bitten by a [rat](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/rat.md), [giant rat](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-rat.md), [swarm of rats](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/swarm-of-rats.md), or [wererat](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/wererat.md) that carries the disease, or by coming into physical contact with an infected creature.
...
At the end of each long rest, an infected creature must make a DC 10 Constitution saving throw. On a failed save, the creature gains 1 level of [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion). On a successful save, the creature's [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion) level decreases by 1. If a successful saving throw reduces the infected creature's level of [exhaustion](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion) below 1, the creature recovers from the disease.
...
![Stage Two: Outbreak; Stage Two Encounters](03.PlayerLog&Handouts/Mechanics/CLI/tables/stage-two-outbreak-stage-two-encounters-vrgr.md)
...
![Stage Three: Illness; Stage Three Encounters](03.PlayerLog&Handouts/Mechanics/CLI/tables/stage-three-illness-stage-three-encounters-vrgr.md)
...
![Stage Four: Pestilence; Stage Four Encounters](03.PlayerLog&Handouts/Mechanics/CLI/tables/stage-four-pestilence-stage-four-encounters-vrgr.md)
...
> [!gallery]
> ![Map 3.13: Tepest](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/092-map-3-13-tepest.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/093-map-3-13-tepest-player.webp#gallery)
...
![Mother Lorinda](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/094-03-031-mother-lorinda.webp#center)
...
Lorinda is a [green hag](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/green-hag.md) of extreme age. In her true form, she carries her darling family—three grim dolls she calls Laveeda, Leticia, and Laoirse. When dealing with the residents of Viktal, she takes on her benevolent illusory guise as Mother.
...
![Tepest Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/tepest-adventures-vrgr.md)
...
![Tithe Events](03.PlayerLog&Handouts/Mechanics/CLI/tables/tithe-events-vrgr.md)
...
![Mother's Blessing; Lorinda's Daughter](03.PlayerLog&Handouts/Mechanics/CLI/tables/mothers-blessing-lorindas-daughter-vrgr.md)
...
- Packs of displacer beasts roam the jungle, led by Yana, a preternaturally cunning [displacer beast](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/displacer-beast.md) that serves Chakuna.  
...
> [!gallery]
> ![Map 3.14: Valachan](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/096-map-3-14-valachan.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/097-map-3-14-valachan-player.webp#gallery)

#### Eirubamba River

Wildflowers, enticing fruits, and medicinal herbs grow in the forests and upon the shorelines around the Eirubamba River. Most rain forest predators won't approach the river, though, fearing the territorial [giant wasps](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-wasp.md) that swarm among the rare plants.
...
Chakuna gained her status as a Darklord when she defeated Urik von Kharkov. In so doing, though, she discovered a terrible truth about the nature of Valachan, and she now lives to maintain the domain and the cycle of predator and prey. Chakuna has statistics similar to a [weretiger](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/weretiger.md), but her animal and hybrid forms have the appearance of a panther.
...
The Trial of Hearts anchors the terror in Valachan, but the domain's dangerous wilderness threatens anyone who explores the land. In addition to natural rain-forest predators, dinosaurs and [displacer beasts](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/displacer-beast.md) roam the domain. Its varied Plant creatures include wicked [twig blights](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/twig-blight.md), cruel [treants](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/treant.md), and manipulative [dryads](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/dryad.md) all expressing the land's underlying blood thirst. The people of the land—the werepanthers of Oselo, the Shuaran, and remote groups of lizardfolk—might provide assistance to outsiders, but they don't tolerate those who insult their ways or bring Chakuna's wrath upon them. Parties without experience exploring dangerous wilds can enlist a guide to aid them, a service that the Oselo are particularly willing to provide.
...
![Valachan Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/valachan-adventures-vrgr.md)
...
- **Mindtaker Mists.** The Mists deposit the consciousnesses of each of the characters into guests at Pantara Lodge. Whether the guests are recreational hunters, unsuspecting foreign nobles, or skilled local warriors, they soon discover that Chakuna's hospitality has a deadly ulterior motive. Consult the "[Survivors](03.PlayerLog&Handouts/Mechanics/CLI/rules/variant-rules/survivors-vrgr.md)" section of "chapter 4" for options to represent those destined to become prey.  

![Chakuna corners her prey in the heart of Valachan](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/098-03-033-chakuna.webp#center)
...
Characters able to fly find their flight slowed by strong winds (effectively difficult terrain), and might face deadly airborne creatures such as [chimeras](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/chimera.md), [harpies](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/harpy.md), and [pteranodons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/pteranodon.md). Chakuna might also add rules to the Trial of Hearts that deem flight and magical travel off limits. If she does, the Mists aid in enforcing these rules.
...
![Valachan Hunt Complications](03.PlayerLog&Handouts/Mechanics/CLI/tables/valachan-hunt-complications-vrgr.md)
...
![Domains of Ravenloft](03.PlayerLog&Handouts/Mechanics/CLI/tables/domains-of-ravenloft-vrgr.md)
...
![Pietra van Riese](03.PlayerLog&Handouts/Mechanics/CLI/books/van-richtens-guide-to-ravenloft/img/101-03-036-pietra-van-riese.webp#center)
...
Each day, the city of Paridon in Zherisia erupts in riots over food scarcity, taxation, and citizens who go missing by the dozens every night. At least one murderer stalks Paridon: the ancient [doppelganger](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/doppelganger.md) Sodo, who has impersonated so many people that it now finds it impossible to hold a form for more than a few days at a time. As Sodo's flesh runs like hot wax, it staves off dissolution by consuming the organs of humanoids. Paridon's streets serve as the doppelganger's hunting ground, and those who enter the sewers risk attracting the notice of countless [carrion stalkers](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/carrion-stalker-vrgr.md) (see "chapter 5") and their monstrous Hive Queen.
...
![Travelers in the Mists; Strangers in the Mists](03.PlayerLog&Handouts/Mechanics/CLI/tables/travelers-in-the-mists-strangers-in-the-mists-vrgr.md)
...
![Keeper Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/keeper-adventures-vrgr.md)
...
- **Mother Luba.** The halfling Mother Luba is known for putting unquiet spirits to rest and transporting wayward souls through the Mists to their rightful homes. Those wicked spirits beyond her aid she trapped within her [tarokka deck](03.PlayerLog&Handouts/Mechanics/CLI/decks/tarokka-deck-cos.md), which became known as [Luba's Tarokka of Souls](03.PlayerLog&Handouts/Mechanics/CLI/items/lubas-tarokka-of-souls-tce.md) (detailed in "Tasha's Cauldron of Everything").  
...
Alanik Ray is an exceptional investigator with an uncanny ability to notice detail and make deductive leaps. Despite his experience with the paranormal, he relies on his husband Arthur to keep him out of true supernatural peril. Still, the detectives manage to find trouble wherever they go. Use the statistics of [spies](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/spy.md) to approximate both Alanik Ray and Arthur Sedgwick. Consider the following plots when featuring the detectives in your adventures:
...
The Caller uses statistics similar to a [succubus](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/succubus.md)/ [incubus](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/incubus.md), and no matter how many times it's defeated, it always returns. Use the Caller to create adventures involving secret histories, domain-spanning conspiracies, and truths hinting at the nature of the Dark Powers. Consider the following plots when featuring the Caller in an adventure:
...
Erasmus is a [ghost](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/ghost.md) and the heart of the van Richten family. Consider the following plots when featuring Erasmus in an adventure:

- Erasmus understands the unquiet dead. Through devices such as [tarokka decks](03.PlayerLog&Handouts/Mechanics/CLI/decks/tarokka-deck-cos.md) and spirit boards, he reveals the histories and intentions of spirits.  
...
Use the statistics of an [assassin](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/assassin.md) to represent Ez, or you can use her [stat block](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/ezmerelda-davenir-cos.md) from Curse of Strahd. Consider the following plots when featuring Ez in an adventure:
...
Firan Zal'honan is an arrogant, pragmatic, amoral genius. Furthering his schemes or adopting him as a patron can draw a party into conflict with the most prominent villains in the Domains of Dread. Use the statistics of a human [archmage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/archmage.md) to represent Firan. He is accompanied by an [imp](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/imp.md) named Skeever, who appears as a piebald raven. Consider the following plots when featuring Firan in an adventure:
...
Jander Sunstar is a [vampire](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire.md) and one of Ravenloft's foremost experts on vampirism. He aids characters hunting vampires and recruits allies to protect him from others of his kind. Consider the following plots when featuring Jander Sunstar in an adventure:
...
Van Richten readily provides mentorship to characters devoted to fighting the creatures of the night. To represent him, use the stat block for a [priest](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/priest.md) from the "Monster Manual" or [Rictavio](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/rictavio-cos.md) from Curse of Strahd. Consider the following plots when featuring van Richten in an adventure:
...
Gennifer and Laurie are skilled and well-prepared adventurers who have the statistics of a [druid](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/druid.md) and a [veteran](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/veteran.md), respectively. Consider the following plots when featuring the twins in an adventure:
