...
![Planar adventurers flee Me...](002-01-001-splash.webp#center "Planar adventurers flee Mercykiller enforcers over the roofs of Sigil")

## Backgrounds

This section presents two backgrounds for 1st-level characters with strong ties to Sigil, the Outlands, or both: the [Gate Warden](gate-warden-sato.md) and the [Planar Philosopher](planar-philosopher-sato.md).
...
![In the struggle between ch...](005-01-004-chaos-and-order.webp#center "In the struggle between chaos and order, two gith warriors battle slaadi on the plane of Limbo")
