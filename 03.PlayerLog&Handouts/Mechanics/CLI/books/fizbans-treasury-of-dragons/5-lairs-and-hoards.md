...
![Dragon Lairs; Lair Location](03.PlayerLog&Handouts/Mechanics/CLI/tables/dragon-lairs-lair-location-ftd.md)
...
**Exposing Terrain**. The terrain within 6 miles of the lair actively works to foil stealth, giving creatures other than the dragon disadvantage on Dexterity ([Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth)) checks. Leaves change color to contrast with those trying to hide among them, branches move to reveal creatures, fog clears, and so on.
...
**Draconic Blessing**. Bahamut or Tiamat has placed the lair under the effect of a [hallow](03.PlayerLog&Handouts/Mechanics/CLI/spells/hallow.md) spell.
...
![Linking Hoards; Hoard Linking Items](03.PlayerLog&Handouts/Mechanics/CLI/tables/linking-hoards-hoard-linking-items-ftd.md)
...
It's not unusual for one or more items in a dragon's hoard to be haunted. Restless spirits might haunt objects that held special significance to them in life, and the death of the dragon who stole those items might be an opportunity for such spirits to find rest at last. A haunting spirit might fully manifest as a [ghost](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/ghost.md), a [specter](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/specter.md), a [wraith](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/wraith.md), or a similar creature, or it might give the haunted item the characteristics of a sentient magic item.
...
![Haunted Hoards; Unfinished Business](03.PlayerLog&Handouts/Mechanics/CLI/tables/haunted-hoards-unfinished-business-ftd.md)
...
![A Dragon's Curse; Hoard Curse Effects](03.PlayerLog&Handouts/Mechanics/CLI/tables/a-dragons-curse-hoard-curse-effects-ftd.md)

In general, ending the curse on a dragon's hoard is not as simple as casting a single spell. Magic can offer temporary respite, though. A [remove curse](03.PlayerLog&Handouts/Mechanics/CLI/spells/remove-curse.md) spell cast on any affected character suppresses the effect of the curse for 1 hour, while a [greater restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/greater-restoration.md) spell suppresses the curse until the victim finishes a long rest.
...
![A Dragon's Curse; Breaking a Hoard Curse](03.PlayerLog&Handouts/Mechanics/CLI/tables/a-dragons-curse-breaking-a-hoard-curse-ftd.md)
...
![Coins; Coin Origins](03.PlayerLog&Handouts/Mechanics/CLI/tables/coins-coin-origins-ftd.md)
...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/fizbans-treasury-of-dragons/img/037-04-005-gold-coins.webp#center)
...
![Creating a Hoard; Hoard Art Objects](03.PlayerLog&Handouts/Mechanics/CLI/tables/creating-a-hoard-hoard-art-objects-ftd.md)

![Creating a Hoard; Hoard Magic Items](03.PlayerLog&Handouts/Mechanics/CLI/tables/creating-a-hoard-hoard-magic-items-ftd.md)