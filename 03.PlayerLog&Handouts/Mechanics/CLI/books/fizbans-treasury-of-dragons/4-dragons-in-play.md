...
![Dragon Characters; Dragon Bonds](03.PlayerLog&Handouts/Mechanics/CLI/tables/dragon-characters-dragon-bonds-ftd.md)

![](03.PlayerLog&Handouts/Mechanics/CLI/books/fizbans-treasury-of-dragons/img/015-03-003.webp#center)

![Dragon Characters; Dragon Flaws and Secrets](03.PlayerLog&Handouts/Mechanics/CLI/tables/dragon-characters-dragon-flaws-and-secrets-ftd.md)
...
![How to Name Your Dragon; Dragon Name Elements](03.PlayerLog&Handouts/Mechanics/CLI/tables/how-to-name-your-dragon-dragon-name-elements-ftd.md)
...
Most dragons are proficient in the [Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception) and [Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth) skills, and many dragons have additional skill proficiencies. As with languages, you can customize a dragon's skill list (even doubling their proficiency bonus with certain skills) to reflect particular interests and activities. You can also give a dragon tool proficiencies, particularly if the dragon spends time in Humanoid form.
...
- **Damage Absorption.** You might decide that a red or gold dragon is not only unharmed by fire damage, but actually healed by it. (See the [flesh golem](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/flesh-golem.md) in the "Monster Manual".)  
- **Flyby.** The dragon is an agile flier, quick to fly out of enemies' reach. (See the [peryton](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/peryton.md) in the "Monster Manual".)  
- **Mimicry.** Impersonating characters or their allies could be a fun trick for a crafty dragon. (See the [kenku](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/kenku.md) in the "Monster Manual".)  
- **Rejuvenation.** You might decide that dragons in your campaign, being an essential part of the Material Plane, are nearly impossible to destroy. A dragon's life essence might be preserved in the egg from which it first emerged, in its hoard, or in a cavernous hall at the center of the world, just as a lich's essence is hidden in a phylactery. (See the [lich](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/lich.md) in the "Monster Manual".)  
- **Special Senses.** Most dragons have [blindsight](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Blindsight) and [darkvision](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Darkvision). You might upgrade [blindsight](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Blindsight) to [truesight](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Truesight), or you could give a dragon with a burrowing speed [tremorsense](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Tremorsense). (See the "introduction" to the "Monster Manual".)  
- **Tunneler.** Any dragon with a burrowing speed could have this trait, moving through solid rock and leaving a tunnel in its wake. (See the [umber hulk](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/umber-hulk.md) in the "Monster Manual".)  
...
![Blue Wyrmling](03.PlayerLog&Handouts/Mechanics/CLI/books/fizbans-treasury-of-dragons/img/017-03-005-blue-wyrmling.webp#center)
...
![Wyrmlings; Wyrmling Goals](03.PlayerLog&Handouts/Mechanics/CLI/tables/wyrmlings-wyrmling-goals-ftd.md)
...
![Young blue dragon](03.PlayerLog&Handouts/Mechanics/CLI/books/fizbans-treasury-of-dragons/img/018-03-006-young-blue-dragon.webp#center)
...
![Young Dragons; Young Dragon Goals](03.PlayerLog&Handouts/Mechanics/CLI/tables/young-dragons-young-dragon-goals-ftd.md)
...
![Adult blue dragon](03.PlayerLog&Handouts/Mechanics/CLI/books/fizbans-treasury-of-dragons/img/019-03-007-adult-blue-dragon.webp#center)

![Adult Dragons; Adult Dragon Goals](03.PlayerLog&Handouts/Mechanics/CLI/tables/adult-dragons-adult-dragon-goals-ftd.md)
...
![Ancient blue dragon](03.PlayerLog&Handouts/Mechanics/CLI/books/fizbans-treasury-of-dragons/img/020-03-008-ancient-blue-dragon.webp#center)
...
![Greatwyrms; Ancient Dragon Goals](03.PlayerLog&Handouts/Mechanics/CLI/tables/greatwyrms-ancient-dragon-goals-ftd.md)
...
![Reproduction; Origin of Dragon Eggs](03.PlayerLog&Handouts/Mechanics/CLI/tables/reproduction-origin-of-dragon-eggs-ftd.md)
...
![Miners discover an amethyst dragon egg](03.PlayerLog&Handouts/Mechanics/CLI/books/fizbans-treasury-of-dragons/img/021-03-009-miners-discover.webp#center)
...
![Half-Dragons; Half-Dragon Origin](03.PlayerLog&Handouts/Mechanics/CLI/tables/half-dragons-half-dragon-origin-ftd.md)
...
![Death of a Dragon; Dragon Death Throes](03.PlayerLog&Handouts/Mechanics/CLI/tables/death-of-a-dragon-dragon-death-throes-ftd.md)
...
"Chapter 6" details three additional kinds of draconic Undead. A [hollow dragon](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/hollow-dragon-ftd.md) comes into being when a metallic dragon gives up mortal life so a fragment of life essence can linger as an eternal guardian of a precious treasure or knowledge. [Draconic shards](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/draconic-shard-ftd.md) are lingering psychic projections of psionic gem dragons. And dragons can also linger after death as [ghost dragons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/ghost-dragon-ftd.md).
...
![Echoes across the Worlds; Dragon Echo Characteristics](03.PlayerLog&Handouts/Mechanics/CLI/tables/echoes-across-the-worlds-dragon-echo-characteristics-ftd.md)
...
Most metallic and gem dragons can change shape to take on a Humanoid or Beast form by the time they reach adulthood or ancient age. A few other Dragon varieties possess similar abilities (including deep dragons, described in "chapter 6"), and you can give any dragon the Change Shape action of an adult or ancient dragon without affecting the dragon's challenge rating (as noted under ""Customizing Dragons"" earlier in this chapter). Likewise, if you use the "Monster Manual" variant rule to make dragons innate spellcasters, you could give any adult or older dragon the [polymorph](03.PlayerLog&Handouts/Mechanics/CLI/spells/polymorph.md) spell to take on an alternate form.
...
![Chamber Adventure Hooks](03.PlayerLog&Handouts/Mechanics/CLI/tables/chamber-adventure-hooks-ftd.md)
...
![Common Purpose; Lauth Goals](03.PlayerLog&Handouts/Mechanics/CLI/tables/common-purpose-lauth-goals-ftd.md)
...
![Hidecarved Dragons Adventure Hooks](03.PlayerLog&Handouts/Mechanics/CLI/tables/hidecarved-dragons-adventure-hooks-ftd.md)
...
![Inheritors of the First World Adventure Hooks](03.PlayerLog&Handouts/Mechanics/CLI/tables/inheritors-of-the-first-world-adventure-hooks-ftd.md)
...
![Warlord; Relationships and Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/warlord-relationships-and-adventures-ftd.md)
...
![Sometimes the only solution is to slay the dragon](03.PlayerLog&Handouts/Mechanics/CLI/books/fizbans-treasury-of-dragons/img/028-03-016-sometimes-the-only-solution.webp#center)
...
![Dragon as Schemer; Cross-Purposes](03.PlayerLog&Handouts/Mechanics/CLI/tables/dragon-as-schemer-cross-purposes-ftd.md)
