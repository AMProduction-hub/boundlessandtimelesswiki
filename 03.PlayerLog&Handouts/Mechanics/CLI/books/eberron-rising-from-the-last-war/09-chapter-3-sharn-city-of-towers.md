...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/097-3-02.webp#center)
...
Those who can afford it usually carry a [feather token](03.PlayerLog&Handouts/Mechanics/CLI/items/feather-token-erlw.md) as insurance. No token? Don't panic! Because of the maze of bridges and spans connecting the towers, there's an excellent chance that you won't fall more than a hundred feet before impacting on a lower bridge. Though this alone might seem like small comfort, it's also true that the major bridges in the upper and middle wards are enchanted with [feather fall](03.PlayerLog&Handouts/Mechanics/CLI/spells/feather-fall.md) effects that trigger automatically, keeping you from crushing an innocent passerby in your descent.

Many different outcomes could follow a lengthy fall. The Falling in Sharn table presents a few possibilities.

![Watch Your Step!; Falling in Sharn](03.PlayerLog&Handouts/Mechanics/CLI/tables/watch-your-step-falling-in-sharn-erlw.md)

### Communication Services

Need to get a message to someone? If you're not in a hurry, the Orien post has boxes throughout the city; you can mail a letter for 1 cp. Hiring a courier generally costs between 5 cp and 5 gp, depending on the size of the package and where you need it delivered. You can find Sivis message stations in almost every upper and middle ward, and if you absolutely have to contact someone instantly, the Sivis enclave in the Dragon Towers district (Middle Central) can perform a [sending](03.PlayerLog&Handouts/Mechanics/CLI/spells/sending.md) spell for 200 gp.

House Tharashk has brought an innovation to message delivery in Sharn: the use of [gargoyles](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/gargoyle.md). Tharashk has several of these creatures in its employ, and these flying couriers are a quick way to get a message across the city. If you spot a gargoyle without a burden, you can flag it down, and it costs 5 gp to deliver a letter or a small package.
...
![Spellcasting Services; Magewright Casting Fees](03.PlayerLog&Handouts/Mechanics/CLI/tables/spellcasting-services-magewright-casting-fees-erlw.md)
...
The Panaceum has an altar that can be used to perform [raise dead](03.PlayerLog&Handouts/Mechanics/CLI/spells/raise-dead.md), but this service isn't without its risks. Sometimes the wrong spirit returns to a body, or malevolent ghosts or wraiths might escape from the netherworld along with the person being raised. Before the healers take gold to perform a resurrection, a Jorasco adept will first cast [augury](03.PlayerLog&Handouts/Mechanics/CLI/spells/augury.md). If this divination indicates looming disaster, the adept will reject the request.
...
> 
> The beasts of Lower Dura are more infamous than reliable. The Griffon flies for Precarious and Oldkeep, and its colors are brown and red. It has never won the race, but there's gold to be made betting on which opponent it will bring down. The Glidewing represents Gate of Gold and The Stores, and its supporters wear green and gray; many believe that the Boromar Clan pays for the upkeep of the mount and its rider. Malleon's Gate used to be represented by the Bat, but twelve years ago they exchanged that mascot for the Gargoyle, whose colors are black and gray. The current [Gargoyle](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/gargoyle.md) is a stone-faced fellow named Carralag, and his supporters are quite passionate about their winged champion.
...
A Droaam tradition brought to Sharn by immigrants, six stones is a game for seven competitors, who each pay a base stake. The seven are then sealed in a large chamber with a [cockatrice](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/cockatrice.md). The match ends when six of the players have been turned to stone, at which point the survivor is awarded all the stakes (except for a share set aside for the organizers). A [medusa](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/medusa.md) handler monitors the competition to ensure that rules are followed. Contestants carry no arms or armor, and no magic or supernatural abilities may be used. Additionally, no one is allowed to attack the cockatrice. The challenge lies in outlasting the other contestants and luring them or pushing them into the path of the cockatrice. The battleground might be barren or littered with rubble and cover; it might be lit, or it could be be pitch black.
...
![City Government; Sharn Councilors](03.PlayerLog&Handouts/Mechanics/CLI/tables/city-government-sharn-councilors-erlw.md)
...
- While in the hall, you have advantage on Intelligence ([Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana)) checks, as well as any ability checks involving arcane research.  
...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/098-3-03.webp#center)
...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/099-3-04.webp#center)
...
For a speedier journey through the streets, House Orien manages a system of carriages for hire. Taking an Orien carriage cuts travel time in half and costs 2 cp per ward traveled. Flight is, of course, the fastest way to get around in Sharn, cutting travel time down to one-sixth of the walking pace (5 minutes per ward). It's also more expensive, at 2 sp per ward. The most common form of aerial transport is the skycoach, but many flying mounts, including [hippogriffs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/hippogriff.md), [griffons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/griffon.md), [pteranodons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/pteranodon.md), and [giant owls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-owl.md), can be found for hire around the city.

#### Central Plateau: Important Districts

![Central Plateau: Important Districts](03.PlayerLog&Handouts/Mechanics/CLI/tables/central-plateau-important-districts-erlw.md)

#### Dura Quarter: Important Districts

![Dura Quarter: Important Districts](03.PlayerLog&Handouts/Mechanics/CLI/tables/dura-quarter-important-districts-erlw.md)

#### Menthis Plateau: Important Districts

![Menthis Plateau: Important Districts](03.PlayerLog&Handouts/Mechanics/CLI/tables/menthis-plateau-important-districts-erlw.md)

#### Northedge Quarter: Important Districts

![Northedge Quarter: Important Districts](03.PlayerLog&Handouts/Mechanics/CLI/tables/northedge-quarter-important-districts-erlw.md)

#### Tavick's Landing: Important Districts

![Tavick's Landing: Important Districts](03.PlayerLog&Handouts/Mechanics/CLI/tables/tavicks-landing-important-districts-erlw.md)
...
![Central Plateau: Noteworthy Locations](03.PlayerLog&Handouts/Mechanics/CLI/tables/central-plateau-noteworthy-locations-erlw.md)
...
![Dura Quarter: Noteworthy Locations](03.PlayerLog&Handouts/Mechanics/CLI/tables/dura-quarter-noteworthy-locations-erlw.md)
...
![The Drunken Dragon in Upper Dura](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/100-3-05.webp#center)
...
![Middle Dura; Bazaar Merchants](03.PlayerLog&Handouts/Mechanics/CLI/tables/middle-dura-bazaar-merchants-erlw.md)
...
![Menthis Plateau: Noteworthy Locations](03.PlayerLog&Handouts/Mechanics/CLI/tables/menthis-plateau-noteworthy-locations-erlw.md)
...
![What's on the Bill?; Shows in Menthis](03.PlayerLog&Handouts/Mechanics/CLI/tables/whats-on-the-bill-shows-in-menthis-erlw.md)
...
![Northedge Quarter: Noteworthy Locations](03.PlayerLog&Handouts/Mechanics/CLI/tables/northedge-quarter-noteworthy-locations-erlw.md)
...
![Tavick's Landing: Noteworthy Locations](03.PlayerLog&Handouts/Mechanics/CLI/tables/tavicks-landing-noteworthy-locations-erlw.md)
...
![Above and Below Sharn: Noteworthy Locations](03.PlayerLog&Handouts/Mechanics/CLI/tables/above-and-below-sharn-noteworthy-locations-erlw.md)

### Skyway

![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/102-3-07.webp#center)
...
![The Boromar Clan; Boromar Contacts](03.PlayerLog&Handouts/Mechanics/CLI/tables/the-boromar-clan-boromar-contacts-erlw.md)
...
![Daask Contacts](03.PlayerLog&Handouts/Mechanics/CLI/tables/daask-contacts-erlw.md)
...
![House Tarkanan; Tarkanan Contacts](03.PlayerLog&Handouts/Mechanics/CLI/tables/house-tarkanan-tarkanan-contacts-erlw.md)
...
![The Tyrants; Tyrants Contacts](03.PlayerLog&Handouts/Mechanics/CLI/tables/the-tyrants-tyrants-contacts-erlw.md)
