...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/149-5-02.webp#center)
...
- [Arcane Propulsion Arm](03.PlayerLog&Handouts/Mechanics/CLI/items/arcane-propulsion-arm-erlw.md)  
- [Armblade](03.PlayerLog&Handouts/Mechanics/CLI/items/armblade-erlw.md)  
- [Belashyrra's Beholder Crown](03.PlayerLog&Handouts/Mechanics/CLI/items/belashyrras-beholder-crown-erlw.md)  
- [Cleansing Stone](03.PlayerLog&Handouts/Mechanics/CLI/items/cleansing-stone-erlw.md)  
- [Docent](03.PlayerLog&Handouts/Mechanics/CLI/items/docent-erlw.md)  
- [Dyrrn's Tentacle Whip](03.PlayerLog&Handouts/Mechanics/CLI/items/dyrrns-tentacle-whip-erlw.md)  
- [Earworm](03.PlayerLog&Handouts/Mechanics/CLI/items/earworm-erlw.md)  
- [Everbright Lantern](03.PlayerLog&Handouts/Mechanics/CLI/items/everbright-lantern-erlw.md)  
- [Feather Token](03.PlayerLog&Handouts/Mechanics/CLI/items/feather-token-erlw.md)  
- [Finder's Goggles](03.PlayerLog&Handouts/Mechanics/CLI/items/finders-goggles-erlw.md)  
- [Glamerweave](03.PlayerLog&Handouts/Mechanics/CLI/items/glamerweave-erlw.md)  
- [Imbued Wood Focus](03.PlayerLog&Handouts/Mechanics/CLI/items/imbued-wood-focus-erlw.md)  
- [Keycharm](03.PlayerLog&Handouts/Mechanics/CLI/items/keycharm-erlw.md)  
- [Kyrzin's Ooze](03.PlayerLog&Handouts/Mechanics/CLI/items/kyrzins-ooze-erlw.md)  
- [Living Armor](03.PlayerLog&Handouts/Mechanics/CLI/items/living-armor-erlw.md)  
- [Living Gloves](03.PlayerLog&Handouts/Mechanics/CLI/items/living-gloves-erlw.md)  
- [Orb of Shielding](03.PlayerLog&Handouts/Mechanics/CLI/items/orb-of-shielding-erlw.md)  
- [Prosthetic Limb](03.PlayerLog&Handouts/Mechanics/CLI/items/prosthetic-limb-tce.md)  
- [Scribe's Pen](03.PlayerLog&Handouts/Mechanics/CLI/items/scribes-pen-erlw.md)  
- [Shiftweave](03.PlayerLog&Handouts/Mechanics/CLI/items/shiftweave-erlw.md)  
- [Speaking Stone](03.PlayerLog&Handouts/Mechanics/CLI/items/speaking-stone-erlw.md)  
- [Spellshard](03.PlayerLog&Handouts/Mechanics/CLI/items/spellshard-erlw.md)  
- [Ventilating Lungs](03.PlayerLog&Handouts/Mechanics/CLI/items/ventilating-lungs-erlw.md)  
- [Wand Sheath](03.PlayerLog&Handouts/Mechanics/CLI/items/wand-sheath-erlw.md)  
- [Wheel of Wind and Water](03.PlayerLog&Handouts/Mechanics/CLI/items/wheel-of-wind-and-water-erlw.md)  
...
![Storm Spire](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/151-5-04.webp#center)
...
This device emanates an antimagic field (same effects as the [antimagic field](03.PlayerLog&Handouts/Mechanics/CLI/spells/antimagic-field.md) spell) in a radius of 1 to 3 miles. The field can be activated or deactivated as an action with a touch by its controller.
...
In Eberron, common magic items can be found for sale in most communities. The DM determines the stock that is available, or the DM has the shoppers make a group Intelligence ([Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation)) check to find a shop or peddler that has the desired item in stock. The DC for this check is 10 in a city, 15 in a town, and 20 in a village. If the check fails, at least 24 hours must pass before looking for the same item in that community.
...
To create such an item with a dragonshard, a character must have proficiency in the tools used to create a nonmagical version of the item or proficiency in the [Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana) skill. For example, a [potion of healing](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-healing.md) can be created by a character who has proficiency with the herbalism kit. A spellcaster can scribe a [spell scroll](03.PlayerLog&Handouts/Mechanics/CLI/items/spell-scroll.md) of a spell they know if they have proficiency in the [Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana) skill, and they must provide all material components required for the spell. A cantrip scribed onto a scroll works as if the caster were 1st level.
...
![Creating Common Magic Items](03.PlayerLog&Handouts/Mechanics/CLI/tables/creating-common-magic-items-erlw.md)
...
![Eberron Crafting Complications](03.PlayerLog&Handouts/Mechanics/CLI/tables/eberron-crafting-complications-erlw.md)