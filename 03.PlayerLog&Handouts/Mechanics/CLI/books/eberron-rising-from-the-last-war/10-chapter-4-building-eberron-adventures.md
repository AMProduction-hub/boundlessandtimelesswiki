...
**NPC Stat Blocks**. Some of the stat blocks in the "Monster Manual" can reflect the same character at different stages of advancement. For example, the adventurers might confront a villain who uses the stat block of a [mage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/mage.md) (9th-level wizard) and then returns later as an [archmage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/archmage.md) (18th-level wizard). You could also use stat blocks in other sources to add to the sequence, so the characters could even meet this aspiring villain as an [apprentice wizard](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/apprentice-wizard-mpmm.md) and later as an [evoker](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/evoker-wizard-mpmm.md) (both in "Volo's Guide to Monsters").
...
![Shades of Evil; Morally Ambiguous Villains](03.PlayerLog&Handouts/Mechanics/CLI/tables/shades-of-evil-morally-ambiguous-villains-erlw.md)
...
![The Villain You Know; Villain You Know](03.PlayerLog&Handouts/Mechanics/CLI/tables/the-villain-you-know-villain-you-know-erlw.md)

#### The Mysterious Villain

![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/105-4-02.webp#center)
...
![Driving Forces; Villain You Don't Understand](03.PlayerLog&Handouts/Mechanics/CLI/tables/driving-forces-villain-you-dont-understand-erlw.md)
...
![Kicking Off the Action; Story Kickoff](03.PlayerLog&Handouts/Mechanics/CLI/tables/kicking-off-the-action-story-kickoff-erlw.md)
...
![Keeping the Action Going; New Development](03.PlayerLog&Handouts/Mechanics/CLI/tables/keeping-the-action-going-new-development-erlw.md)
...
![Setting the Stage; Story Opening](03.PlayerLog&Handouts/Mechanics/CLI/tables/setting-the-stage-story-opening-erlw.md)
...
![The Plot Thickens](03.PlayerLog&Handouts/Mechanics/CLI/tables/the-plot-thickens-erlw.md)
...
![Aurum NPCs](03.PlayerLog&Handouts/Mechanics/CLI/tables/aurum-npcs-erlw.md)
...
![Aurum Missions](03.PlayerLog&Handouts/Mechanics/CLI/tables/aurum-missions-erlw.md)
...
![Cults of the Dragon Below NPCs; Cult NPCs](03.PlayerLog&Handouts/Mechanics/CLI/tables/cults-of-the-dragon-below-npcs-cult-npcs-erlw.md)
...
![Cult Adventures; Cult Adventure Hooks](03.PlayerLog&Handouts/Mechanics/CLI/tables/cult-adventures-cult-adventure-hooks-erlw.md)
...
> [!gallery]
> ![Map 4.1: Arcane Workshop](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/106-map41_arcaneworkshop.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/107-map41_arcaneworkshop-player.webp#gallery)

![Arcane Workshop Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/arcane-workshop-adventures-erlw.md)
...
![Dragonmarked NPCs](03.PlayerLog&Handouts/Mechanics/CLI/tables/dragonmarked-npcs-erlw.md)
...
![Dragonmarked House Adventure Hooks](03.PlayerLog&Handouts/Mechanics/CLI/tables/dragonmarked-house-adventure-hooks-erlw.md)
...
> [!gallery]
> ![Map 4.2: Planar Observatory](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/108-map42_planarobservatory.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/109-map42_planarobservatory-player.webp#gallery)

![Planar Observatory Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/planar-observatory-adventures-erlw.md)
...
![Chamber NPCs](03.PlayerLog&Handouts/Mechanics/CLI/tables/chamber-npcs-erlw.md)
...
![Chamber Missions](03.PlayerLog&Handouts/Mechanics/CLI/tables/chamber-missions-erlw.md)
...
All dreams occur in the plane of Dal Quor. When mortals sleep, their minds touch the plane and shape a shard of it. Normally, a dream is shaped by the memories and emotions of the dreamer. But the [dream](03.PlayerLog&Handouts/Mechanics/CLI/spells/dream.md) spell and similar effects (such as a night hag's Nightmare Haunting) can influence a dream from the outside, to a specific and often sinister purpose. The quori are masters of using the [dream](03.PlayerLog&Handouts/Mechanics/CLI/spells/dream.md) spell as a weapon to terrorize their foes.
...
![The Role of Dreams; Dream Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/the-role-of-dreams-dream-adventures-erlw.md)
...
Agents of the Dreaming Dark are insidious villains that can appear anywhere, in almost any context. They receive orders from a cabal of powerful quori. The leader of the organization, known as the Devourer of Dreams, communes with the nightmare spirit of Dal Quor itself. The Dark's chief agent in Eberron is a [kalaraq quori](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/kalaraq-quori-erlw.md) (see "chapter 6") named Tirashana, who has planted mind seeds—mental copies of herself—across Khorvaire.

The Dreaming Dark has Inspired agents and [kalaraq quori](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/kalaraq-quori-erlw.md) mind seeds (see "chapter 6") scattered across Khorvaire, hidden within the membership of dragonmarked houses, noble families, and other driving forces. Because Dreaming Dark agents can communicate and coordinate with one another in dreams, they never have to risk losing their cover to receive assignments or transmit information.

![Dreaming Dark NPCs](03.PlayerLog&Handouts/Mechanics/CLI/tables/dreaming-dark-npcs-erlw.md)
...
![Dreaming Dark Adventure Hooks](03.PlayerLog&Handouts/Mechanics/CLI/tables/dreaming-dark-adventure-hooks-erlw.md)
...
**Rhesh Turakbar**. The minotaur warlord Rhesh Turakbar has united the small clans of his people into a deadly force. His fortress is on the eastern edge of Droaam, and he often leads raiding parties into Breland in the name of his fiendish patron, the Horned Prince—also known as [Rak Tulkhesh](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/rak-tulkhesh-erlw.md) (see "chapter 6").
...
> [!gallery]
> ![Map 4.3: Ruined Dhakaani Fort](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/110-map43_ruindhakaanifort.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/111-map43_ruindhakaanifort-player.webp#gallery)

#### Ruined Dhakaani Fort Adventures

The Ruined Fort Adventures table offers some ideas for drawing a party to the location.

![Ruined Dhakaani Fort Adventures; Ruined Fort Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/ruined-dhakaani-fort-adventures-ruined-fort-adventures-erlw.md)
...
![Droaam Adventure Hooks](03.PlayerLog&Handouts/Mechanics/CLI/tables/droaam-adventure-hooks-erlw.md)
...
> [!gallery]
> ![Map 4.4: Gatekeeper Seal](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/112-map44_gatekeeperseal.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/113-map44_gatekeeperseal-player.webp#gallery)
...
![Gatekeeper Seal Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/gatekeeper-seal-adventures-erlw.md)
...
![Gatekeeper NPCs](03.PlayerLog&Handouts/Mechanics/CLI/tables/gatekeeper-npcs-erlw.md)
...
![Gatekeeper Adventure Hooks](03.PlayerLog&Handouts/Mechanics/CLI/tables/gatekeeper-adventure-hooks-erlw.md)
...
![Dhakaani Fort Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/dhakaani-fort-adventures-erlw.md)
...
![Goblinoid NPCs](03.PlayerLog&Handouts/Mechanics/CLI/tables/goblinoid-npcs-erlw.md)
...
![Heirs of Dhakaan Adventure Hooks](03.PlayerLog&Handouts/Mechanics/CLI/tables/heirs-of-dhakaan-adventure-hooks-erlw.md)