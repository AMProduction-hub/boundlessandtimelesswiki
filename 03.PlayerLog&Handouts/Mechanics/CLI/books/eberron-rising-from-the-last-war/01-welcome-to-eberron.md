...
![Standard Languages of Eberron](03.PlayerLog&Handouts/Mechanics/CLI/tables/standard-languages-of-eberron-erlw.md)

![Exotic Languages of Eberron](03.PlayerLog&Handouts/Mechanics/CLI/tables/exotic-languages-of-eberron-erlw.md)
...
![Calendar; Eberron Months](03.PlayerLog&Handouts/Mechanics/CLI/tables/calendar-eberron-months-erlw.md)
...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/000-0-01.webp#center)
...
![Everyone Has Regrets; Regrets](03.PlayerLog&Handouts/Mechanics/CLI/tables/everyone-has-regrets-regrets-erlw.md)
...
![Why Do You Need 200 Gold Pieces?; Debts](03.PlayerLog&Handouts/Mechanics/CLI/tables/why-do-you-need-200-gold-pieces-debts-erlw.md)
...
Artisans called magewrights provide much of this magic. Compared to a wizard or an artificer, a magewright's knowledge of magic is narrow: a locksmith might master the [arcane lock](03.PlayerLog&Handouts/Mechanics/CLI/spells/arcane-lock.md) and [knock](03.PlayerLog&Handouts/Mechanics/CLI/spells/knock.md) spells to supplement the use of physical tools; a magewright healer could cast [lesser restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/lesser-restoration.md) and [cure wounds](03.PlayerLog&Handouts/Mechanics/CLI/spells/cure-wounds.md) in addition to using healer's kits and the [Medicine](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Medicine) skill. A magewright's casting is also slow and expensive: they typically cast their spells as rituals. They are artisans, not adventurers, and the prosperity of the Five Nations was built on their foundation.
...
If security is particularly important, House Sivis can protect written messages using magic, such as the [illusory script](03.PlayerLog&Handouts/Mechanics/CLI/spells/illusory-script.md) spell, and House Kundarak can secure packages with the [glyph of warding](03.PlayerLog&Handouts/Mechanics/CLI/spells/glyph-of-warding.md) spell.

The gnomes of House Sivis also maintain a network of [speaking stones](03.PlayerLog&Handouts/Mechanics/CLI/items/speaking-stone-erlw.md) (described in "chapter 5") to facilitate instantaneous communication across long distances. Short messages pass from one stone to another one within a network of message stations.

The Communication and Security Services table shows typical prices.

![Communication and Security Services](03.PlayerLog&Handouts/Mechanics/CLI/tables/communication-and-security-services-erlw.md)

### Convenience

In the cities of Khorvaire, magic provides a host of minor conveniences. [Everbright lanterns](03.PlayerLog&Handouts/Mechanics/CLI/items/everbright-lantern-erlw.md) (described in "chapter 5") light the streets. A chef heats a pot of stew with a whispered incantation, while magic amplifies a town crier's voice. The various effects produced by [prestidigitation](03.PlayerLog&Handouts/Mechanics/CLI/spells/prestidigitation.md)—heating, cooling, cleaning, and minor illusion—all enhance daily life in the cities.
...
Those with the inclination to display their wealth wear [glamerweave](03.PlayerLog&Handouts/Mechanics/CLI/items/glamerweave-erlw.md), clothing imbued with illusion (presented in chapter 5). This can involve moving images, such as a cloak lined with glittering stars or a gown with a pattern of flames; the wearer might even adjust the intensity of these flames with a word. Expensive [glamerweave](03.PlayerLog&Handouts/Mechanics/CLI/items/glamerweave-erlw.md) can produce more elaborate effects, such as a gown that appears to be made of blooming flowers. [Glamerweave](03.PlayerLog&Handouts/Mechanics/CLI/items/glamerweave-erlw.md) can also create abstract effects that slowly shift colors or shimmer with a subtle glow.

### Medicine

The dragonmarked House Jorasco maintains houses of healing across Khorvaire. The simplest service is the expert application of the [Medicine](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Medicine) skill. For those with desperate need and gold to pay, most Jorasco outposts can provide [lesser restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/lesser-restoration.md); the best healers can also provide [greater restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/greater-restoration.md). In the finest Jorasco enclaves, it's even possible to raise the dead.

The Healing Services table summarizes typical prices for the services provided by House Jorasco.

![Medicine; Healing Services](03.PlayerLog&Handouts/Mechanics/CLI/tables/medicine-healing-services-erlw.md)

### Transportation

![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/001-0-02.webp#center)
...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/002-0-03.webp#center)
...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/003-0-04.webp#center)
