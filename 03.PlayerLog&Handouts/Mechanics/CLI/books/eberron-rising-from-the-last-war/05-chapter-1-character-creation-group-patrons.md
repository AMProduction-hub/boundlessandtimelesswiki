...
![Patrons in Eberron; Patrons](03.PlayerLog&Handouts/Mechanics/CLI/tables/patrons-in-eberron-patrons-erlw.md)
...
**Storage**. The guild will store items for its members. The Clifftop guild has an account with House Kundarak banks that allow its members to store valuables in secure vaults. Some guilds have access to items such as a [bag of holding](03.PlayerLog&Handouts/Mechanics/CLI/items/bag-of-holding.md) or a safe that opens into a similar extradimensional space. In the worst case, an item can be hidden in a guildhall's basement for a time.
...
![Adventurers' Guild Contacts; Guild Contacts](03.PlayerLog&Handouts/Mechanics/CLI/tables/adventurers-guild-contacts-guild-contacts-erlw.md)

![Headquarters of the Clifftop Adventurers' Guild](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/057-1-42.webp#center)
...
![Guild Adventures](03.PlayerLog&Handouts/Mechanics/CLI/tables/guild-adventures-erlw.md)
...
![Types of Crime; Syndicate Crimes](03.PlayerLog&Handouts/Mechanics/CLI/tables/types-of-crime-syndicate-crimes-erlw.md)
...
![Group Infamy](03.PlayerLog&Handouts/Mechanics/CLI/tables/group-infamy-erlw.md)
...
![Rival Outfit; Group Rivals](03.PlayerLog&Handouts/Mechanics/CLI/tables/rival-outfit-group-rivals-erlw.md)

![Boromar Clan Nightclub](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/058-1-43.webp#center)
...
![Crime Syndicate Contacts; Syndicate Contact](03.PlayerLog&Handouts/Mechanics/CLI/tables/crime-syndicate-contacts-syndicate-contact-erlw.md)
...
![General House Missions](03.PlayerLog&Handouts/Mechanics/CLI/tables/general-house-missions-erlw.md)

![House Missions](03.PlayerLog&Handouts/Mechanics/CLI/tables/house-missions-erlw.md)
...
![House Status; Group Status](03.PlayerLog&Handouts/Mechanics/CLI/tables/house-status-group-status-erlw.md)
...
![Dragonmarked House Contacts; House Contacts](03.PlayerLog&Handouts/Mechanics/CLI/tables/dragonmarked-house-contacts-house-contacts-erlw.md)
...
![Headquarters of the Twelve](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/059-1-44.webp#center)
...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/060-1-45.webp#center)
...
**Confiscator**. Sometimes an espionage agency needs something stolen—a document that incriminates a public figure to a prototype war machine. The Confiscator has the key skills for such jobs. A good Dexterity score proves helpful in undertaking such tasks, especially if it's enhanced with proficiency with thieves' tools and the [Sleight of Hand](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand) and [Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth) skills. Confiscators are often rogues, and many have a history of stealing for profit rather than national interest.

**Hunter**. The Hunter stalks humanoid prey, for purposes of assassination, abduction, or gathering information. A combination of combat prowess with stealth and interaction skills makes for well-prepared Hunters. Rangers and rogues prove particularly adept at this role, as might anyone with proficiency in the [Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation), [Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception) and [Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth) skills. A high Charisma and proficiency in [Deception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Deception), [Intimidation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Intimidation), and [Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion) skills can also be useful. Hunters often come from backgrounds such as outlander or urchin.

**Investigator**. The Investigator is the archetypal spy, a master of deductive reasoning and suave interaction. Naturally, [Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation) can be a crucial skill, which many characters in this role combine with magical means of scrying to learn about their enemies and objectives. Bards and wizards make natural Investigators, especially if they can acquire one or more skills from among [Deception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Deception), [Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception), [Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion), and [Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth). Investigators come from backgrounds as varied as charlatans, nobles, sages, and urchins.

**Operator**. An Operator leads or organizes a team of agents in the field. Like a military officer, the Operator issues orders and bears responsibility for the agents on the team. High Charisma and Intelligence scores help make the Operator a strong leader, especially in conjunction with skill proficiencies such as [Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion) and [Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation). The wide array of skills used by other agents are also valuable to the Operator, who might end up stepping into a different role when the need arises. The Operator is often a bard and might come from a soldier or noble background (being accustomed to leadership in one form or another).

**Saboteur**. The Saboteur interferes with the functioning of enemy assets. More than a reckless bomber, they combine a willingness to destroy with a knack for infiltration. Proficiency with thieves' tools and in skills such as [Deception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Deception), [Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation), and [Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth) often serve the work of sabotage. The Saboteur benefits from an understanding of craft and magic items, making artificers particularly skilled in this role. Guild artisans might also disguise tools of destruction as mundane objects or works of art. Many Saboteurs come from backgrounds such as charlatans or soldiers.
...
![Types of Espionage; Espionage Missions](03.PlayerLog&Handouts/Mechanics/CLI/tables/types-of-espionage-espionage-missions-erlw.md)
...
![Secrets](03.PlayerLog&Handouts/Mechanics/CLI/tables/secrets-erlw.md)
...
![Memorable Mission](03.PlayerLog&Handouts/Mechanics/CLI/tables/memorable-mission-erlw.md)
...
![Espionage Agency Contacts; Agency Contacts](03.PlayerLog&Handouts/Mechanics/CLI/tables/espionage-agency-contacts-agency-contacts-erlw.md)
...
![National Affairs; Cyran Affairs](03.PlayerLog&Handouts/Mechanics/CLI/tables/national-affairs-cyran-affairs-erlw.md)
...
![Official Status; State Status](03.PlayerLog&Handouts/Mechanics/CLI/tables/official-status-state-status-erlw.md)
...
![Head of State Contacts; State Contacts](03.PlayerLog&Handouts/Mechanics/CLI/tables/head-of-state-contacts-state-contacts-erlw.md)
...
![Other Heads of State; Heads of State](03.PlayerLog&Handouts/Mechanics/CLI/tables/other-heads-of-state-heads-of-state-erlw.md)
...
![Sora Kell and a Dreamer](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/062-1-47.webp#center)
...
![Serving an Immortal; Immortal Missions](03.PlayerLog&Handouts/Mechanics/CLI/tables/serving-an-immortal-immortal-missions-erlw.md)
...
![Immortal Contacts; Immortal Communication](03.PlayerLog&Handouts/Mechanics/CLI/tables/immortal-contacts-immortal-communication-erlw.md)
...
![Patron Benefits; Contacts](03.PlayerLog&Handouts/Mechanics/CLI/tables/patron-benefits-contacts-erlw.md)
...
![Types of Inquisitive Work; Investigative Expertise](03.PlayerLog&Handouts/Mechanics/CLI/tables/types-of-inquisitive-work-investigative-expertise-erlw.md)
...
![Signature Case](03.PlayerLog&Handouts/Mechanics/CLI/tables/signature-case-erlw.md)
...
![Clientele](03.PlayerLog&Handouts/Mechanics/CLI/tables/clientele-erlw.md)
...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/064-1-49.webp#center)
...
**Commander**. Every band of infantry has its leader, even if that person isn't a officer. The Commander earns that position through some combination of high Charisma and Intelligence—the ability to inspire and the capacity to plan. Proficiency in skills such as [Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion) and [History](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#History) can be helpful as well. The Commander might be a career soldier (with that background) or someone from a noble background placed in command by virtue of birth. A Commander might be a fighter, bard, cleric, paladin, or even wizard—as magic proves valuable in military engagements.

**Medic**. Keeping soldiers alive is essential to military success, and that's the Medic's job. In an elite unit of adventurers, the Medic is often a cleric or has another class with healing ability, but these characters are also often proficient in the [Medicine](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Medicine) skill or use of a [herbalism kit](03.PlayerLog&Handouts/Mechanics/CLI/items/herbalism-kit.md). A Medic can be a soldier who demonstrated aptitude in healing and got moved into this position, or a character from a different background (such as acolyte, sage, or even hermit) who decided to put medical expertise to military use.

**Scout**. Trained in navigating the wilderness and laying ambushes for enemy soldiers, the Scout melds the combat skill of a fighter with the skills of a ranger or rogue. High Dexterity and Wisdom scores, combined with proficiency in the [Nature](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Nature), [Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception), [Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth), and [Survival](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Survival) skills, support this character's core capabilities. Scouts are often recruited from people who are more familiar with the wilds than with city streets, including folk heroes, hermits, and outlanders.
...
![Military Missions](03.PlayerLog&Handouts/Mechanics/CLI/tables/military-missions-erlw.md)
...
![Defining Mission](03.PlayerLog&Handouts/Mechanics/CLI/tables/defining-mission-erlw.md)
...
![Nemesis](03.PlayerLog&Handouts/Mechanics/CLI/tables/nemesis-erlw.md)
...
![Military Contacts; Commanding Officer](03.PlayerLog&Handouts/Mechanics/CLI/tables/military-contacts-commanding-officer-erlw.md)
...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/065-1-50.webp#center)
...
**Face**. Typically gifted with a high Charisma score and skilled in a combination of [Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion), [Intimidation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Intimidation), and [Insight](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Insight), the Face takes the lead in conducting interviews or talking the group's way past obstacles. A character with access to enchantment magic (such as a bard or sorcerer) can supplement natural Charisma with magical persuasion. A character with the charlatan background, proficiency in [Deception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Deception), or proficiency with a Disguise kit might also fill this role.
...
**Snoop**. A Snoop pries into secrets and pieces together the clues behind a sensational story. High Intelligence and proficiency in [Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation) often aids the core work of the Snoop, and knowledge of [Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana), [History](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#History), or [Religion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Religion) can be helpful for background research. Divination magic can also prove useful (perhaps in the hands of a wizard or a cleric), while a character with the sage background might have a knack for research.
...
![Types of Reporting; Journalistic Focus](03.PlayerLog&Handouts/Mechanics/CLI/tables/types-of-reporting-journalistic-focus-erlw.md)
...
![Famous Story](03.PlayerLog&Handouts/Mechanics/CLI/tables/famous-story-erlw.md)
...
![Reporting Repercussions; Story Aftermath](03.PlayerLog&Handouts/Mechanics/CLI/tables/reporting-repercussions-story-aftermath-erlw.md)
...
![Newspaper Contact](03.PlayerLog&Handouts/Mechanics/CLI/tables/newspaper-contact-erlw.md)
...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/066-1-51.webp#center)
...
**Proficiencies**. Each member of your party gains proficiency in the [Religion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Religion) skill, if the character doesn't already have it.
...
![Serving the Order; Religious Service](03.PlayerLog&Handouts/Mechanics/CLI/tables/serving-the-order-religious-service-erlw.md)
...
![Hierarchy; Order Reputation](03.PlayerLog&Handouts/Mechanics/CLI/tables/hierarchy-order-reputation-erlw.md)
...
![Religious Order Contacts; Order Contact](03.PlayerLog&Handouts/Mechanics/CLI/tables/religious-order-contacts-order-contact-erlw.md)
...
![Morgrave University](03.PlayerLog&Handouts/Mechanics/CLI/books/eberron-rising-from-the-last-war/img/067-1-52.webp#center)

**Financier**. Whether they're hunting for grants or seeking donations from wealthy philanthropists, the Financier seeks the funds to pay for academic expeditions. Such characters might know their ways around ballrooms, boardrooms, and seedy taverns, willing to do whats necessary to get what they need. Those in this role often exude Charisma and might be adept with the [Deception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Deception), [Intimidation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Intimidation), and [Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion) skills. Bards and rogues make natural academic Financiers, as do those with the charlatan and noble backgrounds.
...
![Scholarly Missions](03.PlayerLog&Handouts/Mechanics/CLI/tables/scholarly-missions-erlw.md)
...
![Scholarly Standing](03.PlayerLog&Handouts/Mechanics/CLI/tables/scholarly-standing-erlw.md)
...
![University Contact](03.PlayerLog&Handouts/Mechanics/CLI/tables/university-contact-erlw.md)
