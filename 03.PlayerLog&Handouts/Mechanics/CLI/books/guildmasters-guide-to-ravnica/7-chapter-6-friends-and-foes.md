...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/guildmasters-guide-to-ravnica/img/122-601.webp#center)
...
Azorius sphinxes, known as sphinxes of judgment, wield hieromancy—the power of law magic—with the force of a judge's gavel to imprison criminals and compel truth from them. A [sphinx of judgment](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/sphinx-of-judgment-ggr.md) is a gynosphinx, as described in the "Monster Manual", but it is an Azorius spellcaster with the following wizard spells prepared:

- Cantrips (at will): [friends](03.PlayerLog&Handouts/Mechanics/CLI/spells/friends.md), [mage hand](03.PlayerLog&Handouts/Mechanics/CLI/spells/mage-hand.md), [message](03.PlayerLog&Handouts/Mechanics/CLI/spells/message.md)  
- 1st level (4 slots): [command](03.PlayerLog&Handouts/Mechanics/CLI/spells/command.md), [ensnaring strike](03.PlayerLog&Handouts/Mechanics/CLI/spells/ensnaring-strike.md), [shield](03.PlayerLog&Handouts/Mechanics/CLI/spells/shield.md)  
- 2nd level (3 slots): [calm emotions](03.PlayerLog&Handouts/Mechanics/CLI/spells/calm-emotions.md), [hold person](03.PlayerLog&Handouts/Mechanics/CLI/spells/hold-person.md), [suggestion](03.PlayerLog&Handouts/Mechanics/CLI/spells/suggestion.md)  
- 3rd level (3 slots): [clairvoyance](03.PlayerLog&Handouts/Mechanics/CLI/spells/clairvoyance.md), [counterspell](03.PlayerLog&Handouts/Mechanics/CLI/spells/counterspell.md), [dispel magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/dispel-magic.md)  
- 4th level (3 slots): [banishment](03.PlayerLog&Handouts/Mechanics/CLI/spells/banishment.md), [divination](03.PlayerLog&Handouts/Mechanics/CLI/spells/divination.md)  
- 5th level (1 slot): [dominate person](03.PlayerLog&Handouts/Mechanics/CLI/spells/dominate-person.md)  

![Azorius Creatures](03.PlayerLog&Handouts/Mechanics/CLI/tables/azorius-creatures-ggr.md)
...
![Boros Creatures](03.PlayerLog&Handouts/Mechanics/CLI/tables/boros-creatures-ggr.md)
...
![Dimir Creatures](03.PlayerLog&Handouts/Mechanics/CLI/tables/dimir-creatures-ggr.md)
...
Piranha beetles (best represented as a [swarm of insects](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/swarm-of-insects.md), from the "Monster Manual") burrow through the soft earth and gather into swarms to overtake their victims and strip the flesh from them. Skein spiders (as giant spiders, from the "Monster Manual") are an important part of Golgari reclamation work: fungus grows rapidly along the silken spiderwebs, expanding to engulf architecture and hasten the Golgari annexation process.
...
![Golgari Creatures](03.PlayerLog&Handouts/Mechanics/CLI/tables/golgari-creatures-ggr.md)
...
![Gruul Creatures](03.PlayerLog&Handouts/Mechanics/CLI/tables/gruul-creatures-ggr.md)
...
![Izzet Creatures](03.PlayerLog&Handouts/Mechanics/CLI/tables/izzet-creatures-ggr.md)
...
![Orzhov Creatures](03.PlayerLog&Handouts/Mechanics/CLI/tables/orzhov-creatures-ggr.md)

### Rakdos Creatures

All sorts of savage, howling beasts accompany [Rakdos](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/rakdos-ggr.md) cultists. Hell hounds, nightmares, and magmins might perform alongside the other entertainers or accompany notable members of the cult as guardians and companions. [Rakdos](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/rakdos-ggr.md) giants, along with ogres draped in hooked chains and spikes, carry and set up tents and stages—and cause utter mayhem when blood lust seizes them.

![Rakdos Creatures](03.PlayerLog&Handouts/Mechanics/CLI/tables/rakdos-creatures-ggr.md)

![](03.PlayerLog&Handouts/Mechanics/CLI/books/guildmasters-guide-to-ravnica/img/123-602.webp#center)
...
![Selesnya Creatures](03.PlayerLog&Handouts/Mechanics/CLI/tables/selesnya-creatures-ggr.md)
...
![Simic Creatures](03.PlayerLog&Handouts/Mechanics/CLI/tables/simic-creatures-ggr.md)
...
![](03.PlayerLog&Handouts/Mechanics/CLI/books/guildmasters-guide-to-ravnica/img/124-603.webp#center)
...
The most common drakes, called wind drakes, are about the size of a human and use the statistics of a [pteranodon](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/pteranodon.md). The smallest drakes are the size of a bird of prey and use the statistics of an [eagle](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/eagle.md); larger ones have the statistics of a [giant eagle](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-eagle.md).
...
![Pack Beasts](03.PlayerLog&Handouts/Mechanics/CLI/tables/pack-beasts-ggr.md)