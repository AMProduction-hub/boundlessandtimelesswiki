...
Many citizens in Precinct Two work for the Azorius, but others feel stifled by the guild's intrusive presence under the shadow of New Prahv. Most residents respect order, but some rely more on Orzhov protection than on Azorius law. Almost everyone here knows someone who is trained in the use of weapons. The typical response to a reported crime is about `2d6` minutes, and the squad consists of two Azorius [soldiers](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/soldier-ggr.md) or `d6` Orzhov [thugs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/thug.md) (from the "Monster Manual").
...
The typical response to a reported crime here is `d12` minutes, and the force consists of two Azorius arresters (use the [veteran](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/veteran.md) stat block in the "Monster Manual").
...
The folk of Precinct Six are pragmatic, not overly concerned with the welfare of others, and thus often willing to disregard minor crimes. Arresters from the Azorius Senate can often be found on patrol in and around the warehouses. Soldiers from the Boros Legion are common near the warehouses and in the Smelting Quarter. The typical response time to a reported crime in these areas is `2d10` minutes, and the squad consists of two Boros [soldiers](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/soldier-ggr.md). At night or in the Smelting Quarter, a response to an attack might instead consist of `d4` Boros [soldiers](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/soldier-ggr.md) led by a sergeant (use the [knight](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/knight.md) stat block in the "Monster Manual").
