...
# The Codicil of White
*Wondrous item*  
![](03.PlayerLog&Handouts/Mechanics/CLI/items/img/the-codicil-of-white.webp#right)
...
The codicil was written by followers of Auril as a primer on her worship. The first page is a title page with the snowflake symbol of Auril on it. The remaining pages describe various priestly rituals and ceremonies in chilling detail. Nestled among these descriptions is a spell that wizards can learn ([frost fingers](03.PlayerLog&Handouts/Mechanics/CLI/spells/frost-fingers-idrotf.md)), and a poem called "Rime of the Frostmaiden" (see appendix E). The poem is an incantation, the power of which can be used to split a glacier (see chapter 6). The poem might have other capabilities, at your discretion
