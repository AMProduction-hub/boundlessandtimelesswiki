...
Whenever you end your turn with 0 hit points, the docent can make a Wisdom ([Medicine](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Medicine)) check with a +6 bonus. If this check succeeds, the docent stabilizes you.
...
**Spells**. The docent knows one of the following spells and can cast it at will, requiring no components (roll a `d6`): (1–2) [detect evil and good](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-evil-and-good.md) or (3–6) [detect magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-magic.md). The docent decides when to cast the spell.
