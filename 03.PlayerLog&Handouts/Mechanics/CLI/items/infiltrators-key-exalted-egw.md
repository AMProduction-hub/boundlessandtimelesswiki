...
![](03.PlayerLog&Handouts/Mechanics/CLI/items/img/infiltrators-key.webp#right)
...
- The key can be used as [thieves' tools](03.PlayerLog&Handouts/Mechanics/CLI/items/thieves-tools.md) for the purpose of opening locks. When using the key, you are considered proficient in [thieves' tools](03.PlayerLog&Handouts/Mechanics/CLI/items/thieves-tools.md) and you have advantage on ability checks made to open locks.  
- While holding the key, your steps are muffled, giving you advantage on Dexterity ([Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth)) checks made to move silently.  
...
- While holding the key, you can use an action to cast one of the following spells from it: [alter self](03.PlayerLog&Handouts/Mechanics/CLI/spells/alter-self.md), [invisibility](03.PlayerLog&Handouts/Mechanics/CLI/spells/invisibility.md), [knock](03.PlayerLog&Handouts/Mechanics/CLI/spells/knock.md), or [pass without trace](03.PlayerLog&Handouts/Mechanics/CLI/spells/pass-without-trace.md). Once a spell has been cast using the key, it can't be used to cast that spell again until the next dawn.  
...
- While holding the key, you can use an action to cast one of the following spells from it: [dimension door](03.PlayerLog&Handouts/Mechanics/CLI/spells/dimension-door.md), [gaseous form](03.PlayerLog&Handouts/Mechanics/CLI/spells/gaseous-form.md), or [mislead](03.PlayerLog&Handouts/Mechanics/CLI/spells/mislead.md). Once a spell has been cast using the key, it can't be used to cast that spell again until the next dawn.  
