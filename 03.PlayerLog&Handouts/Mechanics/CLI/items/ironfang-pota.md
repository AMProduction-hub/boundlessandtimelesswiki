...
---
# Ironfang
*Weapon ([war pick](03.PlayerLog&Handouts/Mechanics/CLI/items/war-pick.md)), legendary (requires attunement)*  
![](03.PlayerLog&Handouts/Mechanics/CLI/items/img/ironfang.webp#right)
...
- You have [tremorsense](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Tremorsense) out to a range of 60 feet.  
- You can sense the presence of precious metals and stones within 60 feet of you, but not their exact location.  
- You can cast [dominate monster](03.PlayerLog&Handouts/Mechanics/CLI/spells/dominate-monster.md) (save DC 17) on an [earth elemental](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/earth-elemental.md). Once you have done so, Ironfang can't be used this way again until the next dawn.  
...
While inside an earth node, you can perform a ritual called the Rumbling, using Ironfang to create a [devastation orb of earth](03.PlayerLog&Handouts/Mechanics/CLI/items/devastation-orb-of-earth-pota.md). Once you perform the ritual, Ironfang can't be used to perform the ritual again until the next dawn.
