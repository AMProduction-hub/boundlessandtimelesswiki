...
---
# Mace of the Black Crown (Exalted)
*Weapon ([mace](03.PlayerLog&Handouts/Mechanics/CLI/items/mace.md)), artifact (requires attunement)*  
...
- The weapon's Summon Devil feature can also be used to summon a [bearded devil](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/bearded-devil.md).  
...
- The weapon's Summon Devil feature can also be used to summon a [barbed devil](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/barbed-devil.md).  
