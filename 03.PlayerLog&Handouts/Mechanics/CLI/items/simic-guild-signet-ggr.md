...
![](03.PlayerLog&Handouts/Mechanics/CLI/items/img/simic-guild-signet.webp#right)


This ring, adorned with the symbol of Simic, allows you to cast [expeditious retreat](03.PlayerLog&Handouts/Mechanics/CLI/spells/expeditious-retreat.md). A guild signet is sometimes awarded to a guild member whose renown score in that guild is 5 or higher, as a reward for performing special services for the guild. Aside from its magical properties, the ring is also an indicator of Simic's recognition and favor.
