...
A character can bind multiple pouches of blasting powder together so they explode at the same time. Each additional pouch increases the damage by `d6` (maximum of `10d6`) and the blast radius by 5 feet (maximum of 20 feet).
