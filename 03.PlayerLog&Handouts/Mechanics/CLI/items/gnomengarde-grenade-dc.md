...
- Each creature must make a DC 15 Constitution saving throw. On a failed save, it takes 28 (`8d6`) thunder damage and is [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned) until the end of its next turn. On a successful save, it takes half as much thunder damage and is not [stunned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Stunned).  
- The wielder rolls on the chart* for the [wand of wonder](03.PlayerLog&Handouts/Mechanics/CLI/items/wand-of-wonder.md) three times, rerolling any duplicate results. Any effects that specify a target affect all creatures in range of the grenade when it explodes. Any effects that would affect the wielder of the wand instead affect the closest creature to the grenade when it goes off.  
