...
---
# Black Crystal Tablet
*Wondrous item, legendary (requires attunement by a creature that has proficiency in the [Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana) skill)*  
...
As an action, a creature attuned to the Black Crystal Tablet can use it to cast [eyebite](03.PlayerLog&Handouts/Mechanics/CLI/spells/eyebite.md) or [gate](03.PlayerLog&Handouts/Mechanics/CLI/spells/gate.md) (the portal created by this spell links to the Far Realm only). After the tablet is used to cast a spell, it cannot be used again until the next dawn.
