...
![](03.PlayerLog&Handouts/Mechanics/CLI/items/img/gruul-guild-signet.webp#right)


This ring, adorned with the symbol of Gruul, allows you to cast [compelled duel](03.PlayerLog&Handouts/Mechanics/CLI/spells/compelled-duel.md). A guild signet is sometimes awarded to a guild member whose renown score in that guild is 5 or higher, as a reward for performing special services for the guild. Aside from its magical properties, the ring is also an indicator of Gruul's recognition and favor.
