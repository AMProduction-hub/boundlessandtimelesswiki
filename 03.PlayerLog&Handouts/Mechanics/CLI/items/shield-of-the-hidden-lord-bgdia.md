...
---
# Shield of the Hidden Lord
*Armor ([shield](03.PlayerLog&Handouts/Mechanics/CLI/items/shield.md)), legendary (requires attunement)*  
![](03.PlayerLog&Handouts/Mechanics/CLI/items/img/shield-of-the-hidden-lord.webp#right)
...
- The shield has an Intelligence of 22, a Wisdom of 18, and a Charisma of 24, as well as hearing and [truesight](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Truesight) out to a range of 120 feet.  
...
- The shield has 3 charges. You can use an action to expend 1 charge to cast [fireball](03.PlayerLog&Handouts/Mechanics/CLI/spells/fireball.md) or 2 charges to cast [wall of fire](03.PlayerLog&Handouts/Mechanics/CLI/spells/wall-of-fire.md) from the shield (save DC 21 for each). The [wall of fire](03.PlayerLog&Handouts/Mechanics/CLI/spells/wall-of-fire.md) spell lasts for 1 minute (no [concentration](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration) required). The shield regains all expended charges daily at dawn.  
- Anytime during your turn, the shield can choose to radiate an aura of dread for 1 minute. (This is not a power of the shield that you control.) Any creature hostile to you that starts its turn within 20 feet of the shield must make a DC 18 Wisdom saving throw. On a failed save, the creature is [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened) until the start of its next turn. On a successful save, the creature is immune to this power of the shield for the next 24 hours. Once the shield uses this power, it can't use it again until the next dawn.  
...
Casting [dispel evil and good](03.PlayerLog&Handouts/Mechanics/CLI/spells/dispel-evil-and-good.md) on the shield has a 1 percent chance of freeing the pit fiend, or automatically succeeds if the spell is cast by a [solar](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/celestial/solar.md), a [planetar](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/celestial/planetar.md), or an archdevil. A god can release the pit fiend by touching the shield and speaking Gargauth's name. When released, Gargauth appears in a random, unoccupied space as close to the shield as possible.
