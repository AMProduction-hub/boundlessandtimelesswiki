...
- You can cast the [control weather](03.PlayerLog&Handouts/Mechanics/CLI/spells/control-weather.md) spell from the girdle. This property can't be used again until the next dawn.  
