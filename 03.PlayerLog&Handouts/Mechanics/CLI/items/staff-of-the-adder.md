...
![](03.PlayerLog&Handouts/Mechanics/CLI/items/img/staff-of-the-adder.webp#right)
...
You can make a melee attack using the snake head, which has a reach of 5 feet. Your proficiency bonus applies to the attack roll. On a hit, the target takes `d6` piercing damage and must succeed on a DC 15 Constitution saving throw or take `3d6` poison damage.
