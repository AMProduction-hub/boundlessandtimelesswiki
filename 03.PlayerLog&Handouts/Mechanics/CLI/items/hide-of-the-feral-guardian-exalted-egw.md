...
---
# Hide of the Feral Guardian (Exalted)
*Light armor ([studded leather armor](03.PlayerLog&Handouts/Mechanics/CLI/items/studded-leather-armor.md)), legendary (requires attunement)*  
...
- As an action, you can use the armor to cast [polymorph](03.PlayerLog&Handouts/Mechanics/CLI/spells/polymorph.md) on yourself, transforming into a [giant owl](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-owl.md) while retaining your Intelligence, Wisdom, and Charisma scores. This property can't be used again until the next dawn.  
...
- When you cast the [polymorph](03.PlayerLog&Handouts/Mechanics/CLI/spells/polymorph.md) spell using this armor, you can transform into a [cave bear](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/cave-bear.md).  
...
- When you cast the [polymorph](03.PlayerLog&Handouts/Mechanics/CLI/spells/polymorph.md) spell using this armor, you can transform into a [guardian wolf](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/guardian-wolf-egw.md).  
