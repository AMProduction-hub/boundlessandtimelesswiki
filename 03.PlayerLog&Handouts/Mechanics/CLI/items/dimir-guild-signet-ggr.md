...
![](03.PlayerLog&Handouts/Mechanics/CLI/items/img/dimir-guild-signet.webp#right)


This ring, adorned with the symbol of Dimir, allows you to cast [disguise self](03.PlayerLog&Handouts/Mechanics/CLI/spells/disguise-self.md). A guild signet is sometimes awarded to a guild member whose renown score in that guild is 5 or higher, as a reward for performing special services for the guild. Aside from its magical properties, the ring is also an indicator of Dimir's recognition and favor.
