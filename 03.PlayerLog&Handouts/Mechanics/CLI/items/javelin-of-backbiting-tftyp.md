...
---
# Javelin of Backbiting
*Weapon ([javelin](03.PlayerLog&Handouts/Mechanics/CLI/items/javelin.md)), cursed item, very rare (requires attunement)*  


- **Damage**: 1d6 piercing
- **Range**: 60/150
- **Properties**: [Cursed](03.PlayerLog&Handouts/Mechanics/CLI/rules/item-properties.md#Cursed%20Items), [Thrown](03.PlayerLog&Handouts/Mechanics/CLI/rules/item-properties.md#Thrown)
- **Weight**: 2.0 lbs.
...
This weapon is cursed, and becoming attuned to it extends the curse to you. Until the curse is broken with [remove curse](03.PlayerLog&Handouts/Mechanics/CLI/spells/remove-curse.md) or similar magic, you are unwilling to part with the weapon, keeping it within reach at all times. In addition, you have disadvantage on attack rolls made with weapons other than this one.
