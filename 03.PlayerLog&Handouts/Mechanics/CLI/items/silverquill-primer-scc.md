...
The Silverquill Primer is a magic textbook created at Strixhaven's Silverquill College. The primer has 3 charges, and it regains `d3` expended charges daily at dawn. If you make a Charisma ([Intimidation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Intimidation)) or a Charisma ([Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion)) check while holding the primer, you can expend 1 charge to give yourself a `d4` bonus to the check, immediately after you roll the `d20`.
