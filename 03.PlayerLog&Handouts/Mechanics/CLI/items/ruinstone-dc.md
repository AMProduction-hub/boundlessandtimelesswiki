...
If a creature bound its soul to the ruinstone in the "Thalivar's Beacon" quest, the artifact explodes when used and the creature who is bound to it disintegrates, disappearing from reality and can only be brought back with a [wish](03.PlayerLog&Handouts/Mechanics/CLI/spells/wish.md) spell, or similar magic.
