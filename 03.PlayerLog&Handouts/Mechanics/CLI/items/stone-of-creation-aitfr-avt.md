...
While attuned to the Stone of Creation, you are proficient with [mason's tools](03.PlayerLog&Handouts/Mechanics/CLI/items/masons-tools.md) and can use them to cut pieces from the Stone's slab, thereby creating lesser artifacts.
...
You can cut pieces in two general sizes: a [chip of creation](03.PlayerLog&Handouts/Mechanics/CLI/items/chip-of-creation-aitfr-avt.md) or a [keystone of creation](03.PlayerLog&Handouts/Mechanics/CLI/items/keystone-of-creation-aitfr-avt.md). These lesser artifacts require their own attunement.
...
The Stone of Creation is destroyed if it reaches the Elemental Chaos or is struck with a forked metal rod attuned to the Elemental Chaos (as per the [plane shift](03.PlayerLog&Handouts/Mechanics/CLI/spells/plane-shift.md) spell). The Stone then shatters into harmless, inert shards of rock. Places created by the slab's chips and keystones crumble, decay, or fade away to nothing after the Stone of Creation is destroyed. Whether the Stone of Creation is itself a piece of a larger artifact remains unknown.
