...
This backpack contains the spirit of an [air elemental](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/air-elemental.md) and a compact leather balloon. While you're wearing the backpack, you can deploy the balloon as an action and gain the effect of the [levitate](03.PlayerLog&Handouts/Mechanics/CLI/spells/levitate.md) spell for 10 minutes, targeting yourself and requiring no [concentration](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Concentration). Alternatively, you can use a reaction to deploy the balloon when you're falling and gain the effect of the [feather fall](03.PlayerLog&Handouts/Mechanics/CLI/spells/feather-fall.md) spell for yourself.
