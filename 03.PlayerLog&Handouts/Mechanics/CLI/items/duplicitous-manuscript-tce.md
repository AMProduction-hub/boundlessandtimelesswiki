...
When found, the book contains the following spells: [hallucinatory terrain](hallucinatory-terrain.md), [major image](major-image.md), [mirror image](mirror-image.md), [mislead](mislead.md), [Nystul's magic aura](nystuls-magic-aura.md), [phantasmal force](phantasmal-force.md), and [silent image](silent-image.md). It functions as a spellbook for you.
