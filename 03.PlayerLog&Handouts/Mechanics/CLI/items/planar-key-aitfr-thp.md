...
While touching the key, you can use your action to expend 1 charge and have the key cast [plane shift](03.PlayerLog&Handouts/Mechanics/CLI/spells/plane-shift.md) limited to the key's predefined destination only. Each planar key links to a single destination defined when the key is made.
