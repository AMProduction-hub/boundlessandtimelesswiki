...
After visiting the Tomb of Horrors or the Temple of Moloch (or both), the characters should have recovered some of the missing components of the *Infernal Machine*. Whenever they return to their original time, Lynx and [Sir Ursas](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/sir-ursas-imr.md) both make a play for the components, desiring to use them to complete and control the *Infernal Machine of Lum the Mad*.
...
When the components the characters collected are presented, the agent's assistants (six [cultists](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/cultist.md) in official-looking white lab coats) work quickly to install those components into the *Infernal Machine*. The mechanical guide that's accompanied the characters attaches itself to the machine, allowing it to serve as a command unit.

Another six [cultists](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/cultist.md) then appear with the agent's secret prisoner to finalize the programming.
...
The other agent arrives with a full complement of a dozen servants (use the [cultist](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/cultist.md) stat block).
...
During the fight, both agents shout out accusations that reveal the other's true natures. Those natures are then confirmed by the agents themselves. Any injury dealt to [Lynx Creatlach](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/lynx-creatlach-imr.md) shows the unnatural construction of her undead flesh and the rune-scribed skeleton beneath it. Any injury dealt to [Sir Ursas](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/sir-ursas-imr.md) causes him to shout out in rage, swearing vengeance "in the name of my unholy patron, Bel!"

If either agent gains control of the *Infernal Machine*, they immediately use it to attempt to defeat their rival. (The machine has all its normal functions except its [wish](03.PlayerLog&Handouts/Mechanics/CLI/spells/wish.md) ability, which will require additional programming.) If confronted by the characters, the agent turns the *Infernal Machine* against them. If the characters leave the agent in control of the machine, the agent departs with it to the Nine Hells when their rival has been dealt with.
...
| 16–30 | `2d8` secret operatives of the city guard (use the [spy](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/spy.md) stat block) have been watching one or both agents, and show up to attempt to stop the fight. |
...
| 66–70 | A spellcaster fighting for Lynx casts a [lightning bolt](03.PlayerLog&Handouts/Mechanics/CLI/spells/lightning-bolt.md) that streaks across the battlefield to strike targets as you determine. |
| 71–75 | A spellcaster fighting for [Sir Ursas](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/sir-ursas-imr.md) casts a [fireball](03.PlayerLog&Handouts/Mechanics/CLI/spells/fireball.md) that explodes at a location of your determination. |
| 76–80 | Lynx slays [Sir Ursas](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/sir-ursas-imr.md). She cuts off his bear paw, promising to turn it into her personal backscratcher. |
| 81–85 | [Sir Ursas](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/sir-ursas-imr.md) slays Lynx. He tears her flesh golem suit away to reveal the skeleton within, which he then shatters. Lynx's skull might still remain animated and conversational. |
| 86–90 | Both Lynx and [Sir Ursas](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/sir-ursas-imr.md) manage to slay one another simultaneously. |
| 91–00 | Both Lynx and [Sir Ursas](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/sir-ursas-imr.md) decide that events have grown too heated and escape into the city. High bounties are set for their capture. |
^machine-fight-complications
...
> 
> If the characters plan on keeping the missing *Infernal Machine* components for themselves, for delivery to another patron (such as Kwalish), or simply to keep them out of the hands of the agents, both Lynx and [Sir Ursas](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/sir-ursas-imr.md) launch separate attacks to recover them. These attacks can either be spaced out to avoid overwhelming the characters, or you can have both agents attack at the same time and largely concentrate on each other.
^finders-keepers

### Our Infernal Machine

If one or both of Lynx and [Sir Ursas](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/sir-ursas-imr.md) are defeated, the characters might end up in possession of the *Infernal Machine*. If you opt to keep this powerful artifact in your campaign, see appendix C for its statistics. Otherwise, you can decide that the machine has been fatally programmed to disperse its components to all-new locations—but only after the characters have had a bit of time to experiment with it.
...
Because this adventure traverses both time and space, you might decide that actions carried out by the characters in the past of chapters 3 and 4 create changes in the present of the campaign world when they return. For example, the construction of the Tomb of Horrors might be disrupted, in which case it holds less prominence in later times. If [Thessalar](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/thessalar-imr.md) regains his missing sculptors, he might complete his stone golem and send it out to destroy [Moghadam](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/moghadam-imr.md) and demolish the tomb while it's under construction. [Thessalar](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/thessalar-imr.md) might also create more monsters than he is already known for, which can spread throughout the world.
