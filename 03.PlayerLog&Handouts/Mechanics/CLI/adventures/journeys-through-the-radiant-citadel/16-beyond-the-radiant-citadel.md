...
| dice: d4 | Adventure |
|----------|-----------|
| 1 | An alliance of nobles and pre-empire royalty pays the adventurers to seek their families' lost treasures within Churapoor's [nothic](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/nothic.md)-infested ruins. |
| 2 | [Jackalweres](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/jackalwere.md) are spotted outside a town before an Iwahhid holiday. The local emir asks the characters to drive them off, but the town priest believes the jackalweres merely want to join the celebrations. |
| 3 | Emir Nur, Master Architect of Bijabad, accidentally unearths a trapped [efreeti](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/efreeti.md) during a building project. Nur hires the characters to convince it to leave quietly. |
| 4 | The empress hosts a wyvern hunt, promising fabulous rewards to whoever tames the largest [wyvern](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/wyvern.md). |
^tayyib-empire-adventures
...
| dice: d4 | Adventure |
|----------|-----------|
| 1 | A scholar in the Radiant Citadel believes the Shrine of Storms holds secrets to understanding the Keening Gloom, the cyclone threatening the Radiant Citadel. She sends the characters to gather information as pirates ([bandits](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md)) prepare to plunder the temple. |
| 2 | Daimyo Hogishi recruits the characters to help defend the city from theft during the Demon Festival, but this year, the priests' taunts provoke [shadow demons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/shadow-demon.md) intent on taking lives, not property. |
| 3 | Rurapo and the fishers of Umizu blame each other for a dying reef, leaving the characters to uncover the real culprits: a trio of [oni](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/oni.md). |
| 4 | The Southwest Whaling Concern begins operating near the lair of a slumbering [dragon turtle](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/dragon-turtle.md). A carp that benefits from a druid's [awaken](03.PlayerLog&Handouts/Mechanics/CLI/spells/awaken.md) spell warns the characters that the dragon turtle could cause a tsunami if disturbed. |
^umizu-adventures