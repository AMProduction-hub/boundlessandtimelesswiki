...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/ghosts-of-saltmarsh/img/000-01-01-chapter-1.webp#center)
...
Eda (CG female human [noble](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/noble.md)) is the current senior member of the town council, as well as the owner of three large fishing boats. She has lived in Saltmarsh all her life and has been elected to the council three times. She is a gruff, pragmatic woman whose graying hair is cut short and whose face bears the marks of a life lived outdoors. Eda is keenly interested in expanding Saltmarsh's fishing industry, her sights set on a wild section of the coast where she hopes to build a new dock. She is suspicious of the dwarves' mining enterprise and doubts it will amount to much.
...
Gellan (NE male human [noble](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/noble.md)) is a well-spoken, dapper older gentleman with a neatly trimmed beard and a fancy wardrobe. With his cunning instincts, he has positioned his family to become the most prominent merchants in town, but he now faces an intractable problem. Gellan made his fortune through smuggling, his textile and lumber exports serving as a cover for his illegal activities. When Saltmarsh was a sleepy backwater, he could operate with impunity. Now that Saltmarsh has attracted attention from the outside world, he sees business growing more difficult and less profitable.
...
The leader of the newly established mining operation in Saltmarsh is an iron-willed dwarven woman named Manistrad (LN female dwarf [veteran](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/veteran.md)). She runs the mining outfit from a small office near the edge of town. Manistrad is a competent leader, as well as a savvy miner with a knack for pulling off impossible jobs. She's convinced that the veins of silver found in the cliffs near Saltmarsh are indicative of more valuable stones deeper in the rock. She was once a fearsome warrior, and she's not above delivering a few well-placed blows to ensure her orders are followed.
...
Young Anders (LG male human [noble](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/noble.md)) recently inherited his family's fleet of fishing boats after the untimely death of his mother, Petra. He's the youngest person ever to be elected to the council. Brash and inexperienced, Anders is a slight man with sharp features and a toothy smile. His recent forays into trade have made him a local celebrity. Since Anders owns both a fishing fleet and several trading vessels, he can sell his catch at a highly competitive price. And he can offer better prices for the other fishers in town to sell to him, since his catch brings in so much more profit.
...
Skerrin (LE male human [assassin](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/assassin.md)) is secretly the head Brotherhood agent in town. Tall, lean, tan, with short silver hair, he speaks in precise, measured statements of a man who has a keen eye for detail. He is dispassionate and takes a protective stance toward Anders. To observers, he is nothing more than a faithful and trusted butler.
...
Armed assault, defined as any nonfatal attack made with a weapon, along with any other assault or property crimes that cause more than 50 gp in damages, but less than 250 gp, are minor crimes. The perpetrator must pay a fine of 100 gp and serve `d4` years in prison or at forced labor.
...
> [!gallery]
> ![Map 1.1: Village of Saltmarsh](03.PlayerLog&Handouts/Mechanics/CLI/adventures/ghosts-of-saltmarsh/img/002-01-dm.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/adventures/ghosts-of-saltmarsh/img/003-01-pc.webp#gallery)
...
Built on a low hill, the Saltmarsh barracks are also its jail. It is one of the few structures in Saltmarsh with an underground level. The jailer, Kraddok Stonehorn (LG male human [gladiator](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/gladiator.md)), is an old comrade of Eliander. He is a stickler for the rules, and Eliander trusts him with his life.
...
Rumors abound of a vault hidden beneath the building. In the cellar, the dwarves have dug a chamber in the earth that is sealed with a heavy iron door and a fine lock (requiring a successful DC 25 Dexterity check with thieves' tools to pick). The dwarves keep their funds here—about 1,000 gp in coins and gems, guarded by four suits of [animated armor](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/animated-armor.md) and a [rug of smothering](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/rug-of-smothering.md) left in the vault. The constructs do not attack dwarves and can be disabled for 10 minutes if the command word "Tatalot" is spoken to them. Manistrad and her close advisors know the command word.

#### 6. Keledek Tower

This three-story tower is home to the town's resident sage and wizard, Keledek the Unspoken (LE male human [mage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/mage.md)). Keledek's dusky skin, bald head, and bright red silk turban—not to mention his height of nearly 7 feet—make him an unmistakable figure in town.

Keledek came to town years ago from Ket, a distant kingdom held in a mix of contempt, mistrust, and fear by the locals. Rumor around town claims that speaking his name aloud allows Keledek to eavesdrop on a conversation for a short time. In truth, Keledek relies on his familiar, an [imp](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/imp.md) named Zivmal, to spy on the townsfolk.
...
A trade delegation led by [Captain Xendros](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/captain-xendros-gos.md) (CE female tiefling [priest](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/priest.md)) has come to Saltmarsh to acquire large quantities of fish (salted and preserved for transport) in the name of Iuz, a mighty cambion and demigod who rules much of the distant north. Iuz's realm does not produce enough food to feed all its citizens, so it relies on imports for the rest, and Saltmarsh is one of its major suppliers.
...
Kiorna Kester (LN female human [commoner](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/commoner.md)) runs this tannery, where she produces smooth, colorful leather for every purpose and sells both the cured hides and items she fashions from it. Kiorna is keenly interested in acquiring hides from exotic creatures to craft into expensive leather. She pays a fee in gold pieces equal to 100 times a creature's challenge rating for the intact hide of any beast or monstrosity of challenge rating 3 or higher. Harvesting the hide from such a creature requires an intact carcass, an hour of work, and a successful DC 15 Dexterity ([Sleight of Hand](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) or Wisdom ([Survival](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Survival)) check to preserve it in top condition for Kiorna's purposes. On a failed check, the hide does not meet Kiorna's standards but can still be sold for a lesser price.
...
The Snapping Line is run by a young woman named Hanna Rist (NG female human [commoner](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/commoner.md)), who comes from a family of well-known lobster catchers. The Rist family also makes a spirit from lobster meat and potatoes called claw wine; it is, to put it mildly, an acquired taste. Hanna employs several former dockhands to keep peace in her bar.
...
The blacksmith's forge has a single anvil with a clear sign of dwarven origins, and a backlog of orders ten miles long. The human smiths make hooks, nails, harpoons, knives, fishing weights, and much more all day. Their master smith is an elderly, dark-skinned woman named Mafera (LG female human [commoner](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/commoner.md)); her son, Jasker (LG male human [commoner](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/commoner.md)), is her best journeyman. A small shrine to Moradin can be found under the eaves as well, though it is somewhat neglected.
...
The Solmor family maintains a cadre of a dozen [guards](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/guard.md) led by four [veterans](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/veteran.md) (all LE humans). These mercenaries report to Skerrin, and though they outwardly serve the Solmors, their loyalty is to the Scarlet Brotherhood.
...
Services at this long-standing sea god's temple are well attended. The congregation is led by a one-legged former whaler: Wellgar Brinehanded (CG male human [priest](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/priest.md)), an older human man with a sharp memory for every storm, lost ship, and enormous catch ever brought into Saltmarsh harbor. He knows many fanciful stories of shipwrecks, lucky escapes, and famous captains. Matters ashore rarely interest him, but the temple and its bell tower are also served by a half-dozen novitiates and laypeople who keep things running smoothly.

Wellgar uses the blessings of Procan to seek out shipwrecks in order to recover the remains of sailors for a proper burial. He is willing to trade cleric spells of up to 5th level, including [raise dead](03.PlayerLog&Handouts/Mechanics/CLI/spells/raise-dead.md), in return for recovery of the remains he seeks.
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/ghosts-of-saltmarsh/img/004-01-04.webp#center)

[Captain Xendros](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/captain-xendros-gos.md) of the Faithful Quartermasters of Iuz has magic items for sale and can also broker the sale of magic items. Any such item comes with a mild curse, however. Anyone attuned to the item can be targeted by a [detect thoughts](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-thoughts.md) spell cast by Xendros, with no limit on range; any saving throws triggered by the spell automatically fail; and the target has no knowledge of the casting. This curse can be detected by casting an [identify](03.PlayerLog&Handouts/Mechanics/CLI/spells/identify.md) spell on the item and succeeding on a DC 25 Intelligence ([Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana)) check. The check can be attempted once per casting.
...
> [!gallery]
> ![Map 1.2: The Saltmarsh Environs](03.PlayerLog&Handouts/Mechanics/CLI/adventures/ghosts-of-saltmarsh/img/005-02-dm.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/adventures/ghosts-of-saltmarsh/img/006-02-pc.webp#gallery)

### Roads and Pathways

The roads around Saltmarsh are heavily patrolled, part of the crown's effort to make its influence felt in the region. Travel along these thoroughfares is usually safe, with most encounters involving merchant caravans, guard patrols, and fellow travelers. Small farms and manors cluster near the roads, relying on passing guard patrols for their safety. Where these settlements grow more widely spaced, bandit raids become more likely. Travelers on the road meet `d4` caravans per day and have a 5 percent chance of being the target of an ambush by `2d4` [bandits](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md) led by a [bandit captain](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit-captain.md). In addition, each day on the road a party passes `d3` small villages or manors. There is a 25 percent chance that any such location is inhabited by halflings. Otherwise, the location is a human enclave.
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/ghosts-of-saltmarsh/img/007-01-05.webp#center)
...
This lair is an underwater stronghold maintained by the sahuagin. From here, they prey on passing ships and plot to grow in strength to the point that they can lay waste to Saltmarsh. A total of thirty [sahuagin](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/sahuagin.md), a [sahuagin priestess](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/sahuagin-priestess.md), and a [sahuagin baron](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/sahuagin-baron.md) lair here.
...
Since then, the ruins have been largely forgotten. The exception is Keledek the Unspoken, the town wizard, who used magic to open the cellar door and found that the passages led to a hidden sea cave. He uses the cave as a meeting point for smugglers. He has recruited several [goblins](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/goblin.md) to keep watch over the place, along with a trained [giant constrictor snake](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-constrictor-snake.md) he raised from a hatchling. The goblins barricaded several passages leading deeper into the dungeons after losing several of their number to [ghouls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/ghoul.md) and [giant rats](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-rat.md) that emerged from the depths.
...
One of the Dreadwood's most powerful denizens is a truly ancient [night hag](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/night-hag.md) named Granny Nightshade, who dwells in the deepest depths of the forest. She commands magic as well as a mighty wizard does and has struck bargains with several dukes of the Nine Hells. Her twisted fortress, Castle Spiral, stands at the nexus point between the Shadowfell and Oerth, and from its gates emerge [skeletons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/skeleton.md), [zombies](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/zombie.md), [shadows](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/shadow.md), and other horrors to threaten the land.

Granny Nightshade counts [jackalweres](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/jackalwere.md) as her foremost minions, and she has also acquired the services of [goblins](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/goblin.md), [orcs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/orc.md), [hobgoblins](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/hobgoblin.md), [ogres](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/ogre.md), and [trolls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/troll.md) over the years. [Green hags](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/green-hag.md) bound to her service act as baronesses who enforce her will over their section of the forest, and an elite guard of twenty-three [oni](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/oni.md) acts as her personal messengers and enforcers. She keeps three consorts, powerful [vampires](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire.md) that struggle among themselves for her favor.

##### Outer Fringe

The outermost reaches of the Dreadwood are as lightly wooded as those of any other forest and extend five to ten miles into the woods. This part of the forest is as safe as any other woodland, thanks to frequent ranger and elf patrols that keep the denizens of the deeper forest at bay if they try to encroach here. [Owlbears](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/owlbear.md), [wolves](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/wolf.md), and a few [bandit](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md) gangs that elude the notice of the patrols represent the most common threats to explorers or travelers.
...
In the heart of the forest, natural light is unknown. Each step a traveler takes when moving through the middle reaches toward the center seems to dim the sun's light a little more, until one enters the dreaded deeps, where the forest growth is so heavy that it blots out the sky. Sources of bright light shine out to only a 10-foot radius, with any normally bright illumination beyond that turned to dim light and dim light made dark. Even [darkvision](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Darkvision) suffers, since it functions here at a maximum range of 30 feet.
...
|-----------|--------------|----------------|---------------|
| 1–3 | `2d6` [goblins](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/goblin.md) | `2d6` [skeletons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/skeleton.md) | `4d6` [skeletons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/skeleton.md) |
| 4–5 | `2d6` elf [veterans](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/veteran.md) | `d10` [zombies](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/zombie.md) | `3d10` [zombies](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/zombie.md) |
| 6–7 | `3d6` [bandits](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md) | `2d6` [hobgoblins](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/hobgoblin.md) | `3d4` [ghouls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/ghoul.md) |
| 8–9 | `2d4` [jackalweres](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/jackalwere.md) | `d6` [bugbears](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bugbear.md) | `2d6` [specters](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/specter.md) |
| 10 | `3d6` [stirges](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/stirge.md) | `2d4` [ghouls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/ghoul.md) | `2d4` [wights](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/wight.md) |
| 11 | `d3` [vine blights](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/vine-blight.md) | `d6` [specters](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/specter.md) | `d6` [vampire spawn](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire-spawn.md) |
| 12 | `2d4` [hobgoblins](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/hobgoblin.md) | `d4` [green hags](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/green-hag.md) | `d6` [wraiths](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/wraith.md) |
| 13 | `d3` [dire wolves](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/dire-wolf.md) | 1 [banshee](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/banshee.md) | `2d6` [mummies](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/mummy.md) |
| 14 | `d4` [green hags](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/green-hag.md) | 1 [night hag](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/night-hag.md) | `2d4 + 2` [shadows](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/shadow.md) |
| 15 | `d3` [treants](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/treant.md) | 1 [lamia](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/lamia.md) | `d3` [vampires](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire.md) |
| 16 | `2d4` [kobolds](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/kobold.md) | `d3` [wraiths](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/wraith.md) | `d3` [night hags](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/night-hag.md) |
| 17 | 1 [unicorn](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/celestial/unicorn.md) | `d3` [gorgons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/gorgon.md) | `2d4` [shambling mounds](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/shambling-mound.md) |
| 18 | 1 [troll](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/troll.md) | `d3` [mummies](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/mummy.md) | `d4` [oni](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/oni.md) |
| 19 | `2d6` [hobgoblins](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/hobgoblin.md) | `1d4 + 1` [shadows](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/shadow.md) | 1 [adult green dragon](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/adult-green-dragon.md) |
| 20 | `d3` [ogres](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/ogre.md) | 1 [vampire](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire.md) | 1 [death knight](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/death-knight.md) |
^dreadwood-random-encounters

#### Drowned Forest

Perched at the edge of the Hool Marshes, the Drowned Forest was once a verdant region. A few decades ago, the marsh began to encroach on this area. As the water level rose, the forest was transformed into a more foreboding place. [Shambling mounds](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/shambling-mound.md) and **blights** appeared in the forest in increasing numbers while the water rotted away the trees themselves. In time, strange mushrooms and fungus sprouted throughout the woods.
...
The Drowned Forest is the site of an ongoing Abyssal assault. Years ago, a group of cultists dedicated to Zuggtmoy shambled into the forest. They had long ago succumbed to the fungal spores that made them into thralls, and Zuggtmoy had a plan in mind for them. The cultists possessed a twisted [decanter of endless water](03.PlayerLog&Handouts/Mechanics/CLI/items/decanter-of-endless-water.md) that tapped into the seas of the Abyss. By shattering the vessel, they created an unstable portal to that awful realm. Luckily for the folk of the region, Zuggtmoy was imprisoned in the ruins of the Temple of Elemental Evil before her plan was complete. Without their mistress's direction, the cultists fell to infighting. Today, Abyssal portals still sometimes draw demons to the world, and the fungal spores spread by the cult have transformed the forest into a deadly realm.
...
A variety of strange, twisted fungi grow among the rotting trees of this region. If a fight breaks out, roll a `d20`. On a 15 or higher, `d6` [violet fungi](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/violet-fungus.md) erupt from where they are hidden around the area among debris and mundane plants and mushrooms. The perpetually soggy fungi tend to attack the loudest interlopers.

##### Shriekers' Call

It's difficult to travel unnoticed in this place because of [shriekers](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/shrieker.md) that are found throughout the forest. Rather than check for random encounters as normal, once per day have each character make their choice of a Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) or Intelligence ([Nature](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Nature)) check. If any character's check total is 20 or higher, the group's journey passes safely. Otherwise, if more of the party's check totals are less than 10 than greater than 10, the party accidentally stumbles across and awakens a stand of shriekers. Their keening wail draws monsters to the area.
...
| dice: d10 | Encounter |
|-----------|-----------|
| 1 | A human [zombie](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/zombie.md) is chained to a wooden stake driven into the ground. The remains of many other zombies lie nearby. A successful DC 10 Intelligence ([Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation)) or Wisdom ([Survival](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Survival)) check reveals evidence that the zombie is being used as target practice. |
...
| 7 | An abandoned carriage is home to a [black pudding](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/ooze/black-pudding.md). A variety of fancy but acid-scorched clothing lies gummed within the cab. |
| 8 | An intact [sailing ship](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/sailing-ship.md) sits in the branches of a low-growing grove of trees. The branches move in the wind and emulate the motion of the sea. |
| 9 | A 40-foot-tall sculpture of a toad made from animal waste emits a foul smell discernible from up to a mile away. Five [swarms of insects](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/swarm-of-insects.md) gather around it. |
...
| dice: d20 | Encounter |
|-----------|-----------|
| 1–3 | `d4` [awakened trees](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/awakened-tree.md) |
| 4–5 | `2d6` [zombies](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/zombie.md) |
| 6–7 | `d3` [shambling mounds](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/shambling-mound.md) |
| 8–9 | `2d4` [myconid adults](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/myconid-adult.md) and 1 [myconid sovereign](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/myconid-sovereign.md) |
| 10 | `3d6` [stirges](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/stirge.md) |
| 11 | `d3` [trolls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/troll.md) |
| 12 | `2d4` [gnolls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/gnoll.md) and 1 [gnoll pack lord](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/gnoll-pack-lord.md) |
| 13 | 1 [water elemental](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/water-elemental.md) |
| 14 | 1 [vrock](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/vrock.md) |
| 15 | `2d6` [manes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/manes.md) |
| 16 | `2d4` [dretches](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/dretch.md) |
| 17 | `d8` [bullywugs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bullywug.md) |
| 18 | `d4` [vine blights](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/vine-blight.md) |
| 19 | `2d8` [twig blights](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/twig-blight.md) |
| 20 | `2d4` [needle blights](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/needle-blight.md) |
^drowned-forest-random-encounters
...
| dice: d20 | Result |
|-----------|--------|
| 1–3 | `2d10` [bullywugs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bullywug.md) |
| 4–5 | `2d6` [bandits](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md) |
| 6–7 | `2d4` [vine blights](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/vine-blight.md) with `d6` [needle blights](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/needle-blight.md) |
| 8–9 | `d4` [poisonous snakes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/poisonous-snake.md) |
| 10 | `3d6` [rats](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/rat.md) |
| 11 | `d6` [giant toads](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-toad.md) |
| 12 | `d4` [crocodiles](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/crocodile.md) |
| 13 | `2d6` [kobolds](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/kobold.md) |
| 14 | `2d6` [lizardfolk](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/lizardfolk.md) |
| 15 | 1 [hydra](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/hydra.md) |
| 16 | 1 [shambling mound](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/shambling-mound.md) |
| 17 | 1 [green hag](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/green-hag.md) and `d3` [will-o'-wisps](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/will-o-wisp.md) |
| 18 | `d3` [trolls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/troll.md) |
| 19 | `d4` [ochre jellies](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/ooze/ochre-jelly.md) |
| 20 | 1 [young black dragon](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/young-black-dragon.md) |
^hool-marshes-random-encounters
...
| dice: d20 | Result |
|-----------|--------|
| 1–3 | `2d6` [bandits](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md) |
| 4 | `d4` [gray oozes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/ooze/gray-ooze.md) |
| 5 | `d6` [ogres](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/ogre.md) |
| 6–7 | `d3` [crocodiles](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/crocodile.md) |
| 8–10 | `2d6` [bullywugs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bullywug.md) |
| 11–12 | 1 [black pudding](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/ooze/black-pudding.md) |
| 13 | 1 [gelatinous cube](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/ooze/gelatinous-cube.md) |
| 14–15 | `2d4` [lizardfolk](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/lizardfolk.md) |
| 16 | 1 [shambling mound](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/shambling-mound.md) |
| 17–19 | `d3` [ochre jellies](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/ooze/ochre-jelly.md) |
| 20 | 1 [young black dragon](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/young-black-dragon.md) |
^dunwater-river-random-encounters
...
Located in just 15 feet of water, this small fishing boat is named for the exquisite, silvered fishing pole its prior owner once possessed. The fishing pole, worth 200 gp, rests with the wreck. Unfortunately for treasure seekers, a [giant crab](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-crab.md) makes its lair in the boat's remains.

##### Escape

This [sailing ship](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/sailing-ship.md) was a renowned blockade runner before it was run down and destroyed by ships of the Sea Princes. Its wreckage is scattered at a depth of 30 feet. A waterproofed treasure chest inside the broken hull bears the lion rampant emblem of Keoland and holds 500 gp. Two [swarms of quippers](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/swarm-of-quippers.md) prowl the area in search of a meal.

##### Curiosity

This galleon belonged to the mage Mordenkainen, who dispatched it to a distant shore in search of treasure. The ship sank in a mysterious and especially ferocious storm. A convincingly crab-like [apparatus of Kwalish](03.PlayerLog&Handouts/Mechanics/CLI/items/apparatus-of-kwalish.md) being transported in its hold remains at the sea bottom, but a [marilith](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/marilith.md) bound to guard it remains and attempts to slay anyone other than Mordenkainen who lays a hand on it. The ship sits approximately 100 feet below the waves.
...
| dice: d20 | Result |
|-----------|--------|
| 1–3 | `2d6` [blood hawks](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/blood-hawk.md) |
| 4 | `2d6` [stirges](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/stirge.md) |
| 5 | `d6` [giant crabs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-crab.md) |
| 6–7 | `d3` [perytons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/peryton.md) |
| 8–10 | `d3` [giant lizards](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-lizard.md) |
| 11–12 | `2d8` [giant rats](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-rat.md) |
| 13 | `2d6` [sahuagin](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/sahuagin.md) |
| 14–15 | `2d4` [lizardfolk](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/lizardfolk.md) |
| 16 | `d3` [merrow](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/merrow.md) |
| 17–19 | 1 [cyclops](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/cyclops.md) |
| 20 | `d3` [chuuls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/chuul.md) |
^coast-random-encounters
...
| dice: d20 | Result |
|-----------|--------|
| 1–2 | `d3` [giant octopi](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-octopus.md) |
| 3–4 | 1 [plesiosaurus](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/plesiosaurus.md) |
| 5–6 | `d3` [perytons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/peryton.md) |
| 7 | `d3` [water elementals](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/water-elemental.md) |
| 8–10 | `2d4` [reef sharks](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/reef-shark.md) |
| 11–12 | `2d8` [sahuagin](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/sahuagin.md) |
| 13 | `1d4+1` [merrow](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/merrow.md) |
| 14–15 | `2d6` [pteranodons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/pteranodon.md) |
| 16 | 1 [adult bronze dragon](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/adult-bronze-dragon.md) |
| 17 | Pirate ship, [Gnasher](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) |
| 18 | Pirate ship, [Pale Prow](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) |
| 19 | Pirate ship, *Salted Glade* |
| 20 | Pirate ship, [Dreadnaught](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) |
^azure-sea-random-encounters

#### Gnasher

Thereax Guldeer (LE [half-red dragon veteran](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/half-red-dragon-veteran.md)) took command of the [warship](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md), [Gnasher](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md), several years ago when her father was slain in a duel with an admiral in the Keoland Navy. The young half-dragon is merciless, and her greed is as strong as that of any red dragon. She alone can sound the dragon's horn, a monstrous instrument mounted to the prow of her ship. When blown, it roars like a massive dragon.

[Gnasher](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) is crewed by uncouth humanoids who fear and admire Thereax, amounting to twenty-three [orcs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/orc.md), forty [goblins](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/goblin.md), four [hobgoblins](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/hobgoblin.md), twelve [kobolds](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/kobold.md), and two [bugbears](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bugbear.md). An [ogre](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/ogre.md) named Yem serves as the ship's first mate, and Yem's method of discipline tends to be fatal. A red dragon's wing emblazoned on a black background flies from the mast of [Gnasher](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md).

#### Pale Prow

An old ship whose faded hull and rat-gnawed sails belie its speed and the ferocity of its crew, [Pale Prow](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) is a ramshackle [warship](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) with an ornate rudder made from bone and wood. The rudder is not attached to the ship's wheel and is instead operated by a team of six [vampire spawn](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire-spawn.md), who turn it at the command of its dread captain. [Pale Prow](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) doesn't sail under the sun, and its appearance is always preceded by a heavy fog that appears without warning. It is said that [Pale Prow](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) has never been touched by a shipwright, despite its many injuries. By what means the ship is repaired, none can say.

[Pale Prow](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) is commanded by Captain Ineca Sufocan (LE male elf [vampire](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/vampire.md)), who sails from an island hidden by fog, where his harbor and mansion have fallen into disrepair. Ineca searches for a heart made of pearl, which contains drops of dried blood from his true love. This pearl heart has exchanged hands for decades, and the undead captain desires it above all things.

The remainder of the crew of [Pale Prow](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) is composed of undead servants, both corporeal and ghostly. Necromancers are drawn to [Pale Prow](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) whenever it nears land, and it is common for them to take up residence in the dark cabins below deck. A [specter](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/specter.md) serves as lookout in the crow's nest.

A silver skull embroidered on a white field and trimmed with silver fangs flies from the tall mast of [Pale Prow](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md).

#### Salted Glade

The Salted Glade is a galleon made from the base of a massive, buoyant tree. A grove of smaller trees grows from its deck, their boughs catching the winds to propel the ship. From a distance, the two [treants](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/treant.md) who serve as the ship's main artillery are visible moving on deck.

The Salted Glade is captained by Mithina Greyheart (NE half-elf female [druid](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/druid.md)), whose grove was destroyed by a massive tidal wave nearly twenty years ago. Mithina's heart sank with her grove, and her mind turned to vengeance. She has since turned to piracy to fund her search for a legendary island known as Procan's Bloom, where she hopes to chastise the god Ehlonna for the destruction of her home. Aiding her is the corrupted [dryad](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/dryad.md) Filios, who dwells in a shriveled oak growing from the ship's center.

A black leafless branch stitched on a field of blue flaps from the highest boughs of the Salted Glade.

#### Dreadnaught

[Dreadnaught](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) is a heavy [warship](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) covered in scorched iron plates laid over coal-colored wood. No portholes or oar slits mar the perfect surface of its riveted hull; no mast can be seen to rise from its sooty deck. A cabin, reinforced with steel bars, sits toward the aft, a dull red glow pulsing from within.

[Dreadnaught's](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) captain is a mad tinkerer and wizard named Vigr Thrass (CE male human [mage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/mage.md)). Vigr's madness arose from his discovery of a dark tome that described rituals used to animate constructs. The wizard now sails the Azure Sea, stealing wealth and arms from merchant and navy vessels alike. Vigr wears a suit of magic plate armor, granting him supernatural strength and speed while allowing him to cast his spells unhindered. He is known to mingle in the seaside communities, where he pretends to be a kind-hearted merchant in need of a few crew members. In reality, the captain is looking for suitable slaves to clean and repair his magic automatons.

[Dreadnaught's](03.PlayerLog&Handouts/Mechanics/CLI/vehicles/warship.md) crew includes twelve automatons ([animated armor](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/animated-armor.md)) brought to life by Vigr's magic. Various tools, weapons, and implements ([flying swords](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/flying-sword.md)) flit about the ship performing tasks. A dozen humanoid slaves are kept aboard to accomplish the tasks Vigr's automatons cannot perform.
...
If you revere a different deity, you own a small building in Saltmarsh and have been charged by the elders of your faith with establishing a shrine here. You live in the building and have a staff of `d4` locals who have already been recruited to your faith. Your Shelter of the Faithful feature applies to a temple located in Seaton, the provincial capital east of Saltmarsh.
...
See the [fisher](03.PlayerLog&Handouts/Mechanics/CLI/backgrounds/fisher-gos.md) entry for the full description of this background.
...
See the [marine](03.PlayerLog&Handouts/Mechanics/CLI/backgrounds/marine-gos.md) entry for the full description of this background.
...
See the [shipwright](03.PlayerLog&Handouts/Mechanics/CLI/backgrounds/shipwright-gos.md) entry for the full description of this background.
...
See the [smuggler](03.PlayerLog&Handouts/Mechanics/CLI/backgrounds/smuggler-gos.md) entry for the full description of this background.
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/ghosts-of-saltmarsh/img/008-01-07.webp#center)