...
If the characters kill the merrow and fulfill the ghost's request to lay the missionaries to rest (see "Ghosts" in area M9), the ghosts reward the characters with a [charm of heroism](03.PlayerLog&Handouts/Mechanics/CLI/rewards/charm-of-heroism.md) as they depart (see ""Charms"" in chapter 7 of the "Dungeon Master's Guide").
...
The 2-foot-diameter portal is located on the sea floor just outside area W7. Every `1d6` hours, a [mud mephit](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/mud-mephit.md) emerges from the portal and swims for the surface. If the green conch shell is destroyed, the portal closes.
