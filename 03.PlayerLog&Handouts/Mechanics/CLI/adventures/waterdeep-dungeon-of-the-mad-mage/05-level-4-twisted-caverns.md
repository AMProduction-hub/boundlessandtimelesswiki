...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/waterdeep-dungeon-of-the-mad-mage/img/011-401.webp#center)
...
Known as "devil's mushroom," a timmask is a 2-foot-tall toadstool with orange and red stripes across its beige cap. Uprooting or destroying a timmask causes it to expel a 15-foot-radius cloud of poisonous spores. Creatures in the area must succeed on a DC 14 Constitution saving throw or be [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned). While [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned) in this way, a creature is under the effect of a [confusion](03.PlayerLog&Handouts/Mechanics/CLI/spells/confusion.md) spell with a duration of 1 minute. When the spell effect ends, the [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned) condition also ends.
...
> [!gallery]
> ![Map 4](03.PlayerLog&Handouts/Mechanics/CLI/adventures/waterdeep-dungeon-of-the-mad-mage/img/012-402.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/adventures/waterdeep-dungeon-of-the-mad-mage/img/013-403.webp#gallery)

Unless otherwise noted, all tunnels on this level are 20 feet high, and caverns are 30 to 50 feet high. Most of the floors on this level are uneven and covered in dirt and bat guano. Because of this soft ground, Wisdom ([Survival](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Survival)) checks made to track creatures on this level are made with advantage.
...
Characters who search for tracks and succeed on a DC 10 Wisdom ([Survival](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Survival)) check find several large, bare footprints made by the ettin who regularly feeds on the mushrooms in this cavern.

### 2. Jibber-Jabber

> [!note] 
> 
> **Ettin**. An [ettin](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/ettin.md) inhabits this dripping cave.
> 
...
- The water in the river has started to taste bad. (The ettin has not yet been [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned) by the water, which the aboleth has tainted with its presence.)  
...
> 
> **Piercers**. Stalactites cover the ceiling of the wide tunnel that leads south (to area 5). Eight [piercers](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/piercer.md) lurk among them.
^244

Any character who searches for tracks along a path can make a Wisdom ([Survival](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Survival)) check. On a check total of 20 or higher, the character finds the back-and-forth tracks of several bugbears, a troll, and a hook horror.

Characters who have [darkvision](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Darkvision) or light sources bright enough to illuminate the ceiling can avoid piercer drops by steering clear of the stalactite formations, and attempts to do so are automatically successful. If no such attempts are made, a single piercer drops on the first light-carrying creature to cross the cavern. Whether it hits or misses, this piercer can't attack again until it makes the long, slow climb back to the cavern ceiling. After the first piercer drops, avoiding the cavern's stalactite formations becomes a simple matter.

### 4. The Alchemist

In this cavern, a [green slaad](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/green-slaad.md) posing as a human alchemist makes its home. Its lair has the following features:
...
The Alchemist is happy to trade potions for supplies. For one potion, it demands 20 pounds of edible fungi and five tongues of madness (which characters can harvest from the surrounding caves), plus 50 gp worth of adventuring gear. The Alchemist has no use for coins, gemstones, art objects, or magic items. Each time the characters pay the Alchemist a visit, it has one of each of the potions described below available to trade. Each potion is a common magic item. It keeps these potions on its person, and a sneaky character can try to pilfer one with a successful Dexterity ([Sleight of Hand](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) check contested by the slaad's Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) check.

##### Potion of Comprehension

When you drink this potion, you gain the effect of a [comprehend languages](03.PlayerLog&Handouts/Mechanics/CLI/spells/comprehend-languages.md) spell for 1 hour. This liquid is a clear concoction with bits of salt and soot swirling in it.
...
> [!note] 
> 
> **Xorn**. Three [xorn](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/xorn.md) feast on crystals near the western edge of the cavern, while harmless bats flutter below the 30-foot-high ceiling.
> 
...
> [!note] 
> 
> **Ropers**. This 30-foot-high cave holds a forest of stalagmites, some of which are broken. Two [ropers](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/roper.md) lurk among them and ambush anyone who happens by.
> 
...
> 
> **Mage**. Near the north wall, a slight woman wearing tattered gray robes over black pants sits on a 2-foot-tall toadstool. Her long black hair is tied back with a swatch of gray cloth that matches her robe. A [quasit](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/quasit.md) in toad form sits on her knee.
^251
...
Darribeth's memory is fuzzy on where and when she met her talking toad during her Underdark exploits. The quasit, which Darribeth calls Teeha, has not revealed its true form to her. In the form of a toad, it torments her with false hopes of escape before dashing them. It has told Darribeth, for instance, that hezrou demons are nearby to keep her from leaving this cavern. If attacked or exposed, the quasit turns [invisible](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Invisible) and flees.

#### Treasure

Darribeth's spellbook contains the following spells: [cone of cold](03.PlayerLog&Handouts/Mechanics/CLI/spells/cone-of-cold.md), [counterspell](03.PlayerLog&Handouts/Mechanics/CLI/spells/counterspell.md), [darkvision](03.PlayerLog&Handouts/Mechanics/CLI/spells/darkvision.md), [detect magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-magic.md), [fireball](03.PlayerLog&Handouts/Mechanics/CLI/spells/fireball.md), [fly](03.PlayerLog&Handouts/Mechanics/CLI/spells/fly.md), [greater invisibility](03.PlayerLog&Handouts/Mechanics/CLI/spells/greater-invisibility.md), [ice storm](03.PlayerLog&Handouts/Mechanics/CLI/spells/ice-storm.md), [jump](03.PlayerLog&Handouts/Mechanics/CLI/spells/jump.md), [mage armor](03.PlayerLog&Handouts/Mechanics/CLI/spells/mage-armor.md), [magic missile](03.PlayerLog&Handouts/Mechanics/CLI/spells/magic-missile.md), [misty step](03.PlayerLog&Handouts/Mechanics/CLI/spells/misty-step.md), [shield](03.PlayerLog&Handouts/Mechanics/CLI/spells/shield.md), [suggestion](03.PlayerLog&Handouts/Mechanics/CLI/spells/suggestion.md), [tongues](03.PlayerLog&Handouts/Mechanics/CLI/spells/tongues.md), and [water breathing](03.PlayerLog&Handouts/Mechanics/CLI/spells/water-breathing.md).

In addition to her spellbook, Darribeth carries a backpack missing a strap, within which she keeps material components for her spells, a pouch containing 11 gp, a dagger, a canteen, and a worn blanket. Fastened to the backpack is a coiled [rope of climbing](03.PlayerLog&Handouts/Mechanics/CLI/items/rope-of-climbing.md).
...
If you want to expand the dungeon north or east of here, assume that the tunnel in the north wall is hidden behind a 1-foot-thick wall of rocks held in place by web netting and clay mortar; characters can detect the false wall with a successful DC 10 Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) check and break through it with ease.

### 10. Drider Lair

> [!note] 
> 
> **Driders and Spiders**. The northern half of the cave is home to two [driders](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/drider.md) and five [giant spiders](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-spider.md). The driders hide in the natural alcove north of the entrance, while the spiders crawl amid thick webs that fill the top 10 feet beneath the 30-foot-high ceiling.
> 
...
A character entering the cave through the arch gate automatically becomes stuck in the [webs](03.PlayerLog&Handouts/Mechanics/CLI/traps-hazards/webs.md) (see ""Dungeon Hazards"" in chapter 5 of the "Dungeon Master's Guide").
...
> [!note] 
> 
> **Drow**. Two male [drow](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/drow.md) (Altonrel and Rezz) and a female [drow elite warrior](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/drow-elite-warrior.md) (Balryn) stand watch atop a ridge of natural rock in the middle of this 30-foot-high cave.
> 
...
If the characters enter in a nonthreatening manner, the guards are cautious but willing to summon their leaders to speak on their behalf. If greeted with hostility, the drow elite warrior sounds the alarm with a single whistle, bringing reinforcements from areas 11b and 11c. If the battle is not going their way, a second whistle brings the [quaggoths](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/quaggoth.md) from area 12b.
...
> [!note] 
> 
> **Drow**. Melith, a [drow priestess of Lolth](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/drow-priestess-of-lolth.md) and the leader of this outpost, meditates and prays before a shrine of Lolth while her consort, the [drow mage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/drow-mage.md) Thirza, sits at a zurkhwood desk reading her spellbook.
> 
...
Though she has great affection for Melith, Thirza sees any alliance with the characters as an opportunity to elevate herself in the eyes of Melith's mother, Vlonwelv. After Melith concludes her business with the characters, Thirza prepares and casts a [sending](03.PlayerLog&Handouts/Mechanics/CLI/spells/sending.md) spell to contact Vlonwelv. She warns Vlonwelv that Melith has released a group of adventurers from her custody instead of killing them. After thanking Thirza for the information, Vlonwelv curses her daughter's foolishness and awaits the adventurers' arrival.

##### Treasure

The drow priestess wears two silver bracelets set with onyx (25 gp each). She carries a flask of wine and the key to the room's zurkhwood chest, which contains 500 gp. The lock on the chest can be picked with a successful DC 15 Dexterity check using thieves' tools, or opened with a [knock](03.PlayerLog&Handouts/Mechanics/CLI/spells/knock.md) spell or similar magic. Melith's shrine contains a 1-pound obsidian figurine of the demon goddess Lolth in spider form (25 gp) and eight sticks of incense (5 gp each). Each stick burns for up to 8 hours and emits a sickly odor.

Thirza carries a [spell scroll](03.PlayerLog&Handouts/Mechanics/CLI/items/spell-scroll.md) of [gaseous form](03.PlayerLog&Handouts/Mechanics/CLI/spells/gaseous-form.md) in a waterproof zurkhwood tube, 25 pp in a spider silk pouch, and her spellbook, which has black leather covers traced with webs of gold. The book contains the following spells: [alter self](03.PlayerLog&Handouts/Mechanics/CLI/spells/alter-self.md), [cloudkill](03.PlayerLog&Handouts/Mechanics/CLI/spells/cloudkill.md), [Evard's black tentacles](03.PlayerLog&Handouts/Mechanics/CLI/spells/evards-black-tentacles.md), [fly](03.PlayerLog&Handouts/Mechanics/CLI/spells/fly.md), [greater invisibility](03.PlayerLog&Handouts/Mechanics/CLI/spells/greater-invisibility.md), [lightning bolt](03.PlayerLog&Handouts/Mechanics/CLI/spells/lightning-bolt.md), [mage armor](03.PlayerLog&Handouts/Mechanics/CLI/spells/mage-armor.md), [magic missile](03.PlayerLog&Handouts/Mechanics/CLI/spells/magic-missile.md), [misty step](03.PlayerLog&Handouts/Mechanics/CLI/spells/misty-step.md), [sending](03.PlayerLog&Handouts/Mechanics/CLI/spells/sending.md), [shield](03.PlayerLog&Handouts/Mechanics/CLI/spells/shield.md), [sleep](03.PlayerLog&Handouts/Mechanics/CLI/spells/sleep.md), [spider climb](03.PlayerLog&Handouts/Mechanics/CLI/spells/spider-climb.md), [web](03.PlayerLog&Handouts/Mechanics/CLI/spells/web.md), and [witch bolt](03.PlayerLog&Handouts/Mechanics/CLI/spells/witch-bolt.md).

#### 11c. Arch Gate to Level 2

> [!note] 
> 
> **Drow**. Two male [drow](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/drow.md) (Kalanszar and Tsabalin) and a female [drow elite warrior](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/drow-elite-warrior.md) (Talafaere) rest here.
> 
...
> 
> **Drow**. Natural shelves and narrow ledges line the walls, ranging in height from 10 to 30 feet. Hiding in the shadows atop 10-foot-high ledges are two male [drow elite warriors](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/drow-elite-warrior.md) (Ryld and Llauzdrar).
> 
...
> 
> **Quaggoths**. Living on natural stone shelves inside the crevasse are eight [quaggoths](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/quaggoth.md) that serve the drow.
^26c

The quaggoths can climb the crevasse without having to make an ability check, as can other creatures with a natural climbing speed. A successful DC 10 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) check is needed otherwise.

Moving across the trunk without slipping or falling requires a successful DC 10 Dexterity ([Acrobatics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Acrobatics)) check. On a failed check, the creature slips and falls [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone) on the makeshift bridge—but on a check that fails by 5 or more, the creature plunges into the crevasse.
...
A thorough search of the grove accompanied by a successful DC 15 Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception) or [Survival](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Survival)) check reveals the gnome druid's old hovel: an igloo-like mound of hardened bat guano. Inside, characters find a ratty old blanket hiding two [potions of healing](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-healing.md) in stoppered gourds. The awakened zurkhwoods attack characters who loot the druid's abandoned home.

### 14. Drow Rafts

> [!note] 
> 
> **Darkmantles**. Stalactites hang from the 30-foot-high ceiling. Two [darkmantles](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/darkmantle.md) disguised as stalactites remain motionless until they attack.
> 
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/waterdeep-dungeon-of-the-mad-mage/img/014-404.webp#center)
...
If the characters seem adamant about pressing deeper into the aboleth's lair, Illuun telepathically commands the eighteen [troglodytes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/troglodyte.md) in area 24 to circle around behind the characters (using the passage that enters area 15 from the south) while it keeps the characters engaged in conversation. At the same time, it calls the three [chuuls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/chuul.md) from area 16 to come at the characters from the west, trapping them in the tunnel. As soon as the chuuls and the troglodytes arrive and begin their attack, the aboleth projection disappears.
...
The water varies in depth from 20 to 50 feet, and the cavern's domed ceiling is 30 feet higher than the water's surface. The walls are coated with slime but have abundant handholds. A successful DC 15 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) check is required to climb them.
...
> [!note] 
> 
> **Chuul**. Circling the island's perimeter is a [chuul](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/chuul.md) that attacks anyone who sets foot on the island.
> 
> **Petrified Otyugh**. In the middle of the island, wearing a crude net as a cloak, is a [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified) otyugh that the kuo-toa adopted as a god and named Bulba-Slopp. Treasure has been piled around the statue's three stumpy legs.
^276

Before the kuo-toa arrived, this island was inhabited by an otyugh. Halaster turned it to stone and lured kuo-toa to the grotto, knowing that the insane fish folk would come to worship the [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified) otyugh as a god. The kuo-toa named it Bulba-Slopp, and it served as their god until the aboleth came on the scene. After Bulba-Slopp failed to protect the kuo-toa, the archpriest Noolgaloop set out to craft a new god, and Bulba-Slopp was worshiped no more.

##### Treasure

Piled around the [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified) otyugh's feet are 3,300 cp, 670 sp, and 350 gp.

The net draped over the otyugh is woven with worthless shells and bones. Tied to the net are two trinkets (roll twice on the [Trinkets](03.PlayerLog&Handouts/Mechanics/CLI/items/trinket.md) table in chapter 5 of the "Player's Handbook"), a rusty gauntlet, a leather boot, and an amulet made of composite wood and iron. The boot and the amulet are both magical:

- The boot is one of two [boots of elvenkind](03.PlayerLog&Handouts/Mechanics/CLI/items/boots-of-elvenkind.md). A single boot is useless without its companion. The matching boot was swept downriver and eventually found by a goblin werebat named Vool (see level 5, area 17).  
...
> [!note] 
> 
> **Monsters**. Illuun the [aboleth](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/aboleth.md) and two [chuuls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/chuul.md) lurk in the water, which is dark, slimy, and fouled by the aboleth's presence.
> 
...
> 
> **Chuuls**. Two [chuuls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/chuul.md) hide in the murky water. If the chuuls are defeated, an aboleth enters the cavern from the northeast passage. This aboleth is a magical projection created by Illuun to frighten away invaders. (This projection is like the one in area 15.)
> 
...
The miner's pick can be pried loose with a successful DC 13 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) check. It has no special properties and is in poor condition.
...
> 
> **Damaged Rowboat**. At the back of the alcove is a rowboat with a 1-foot-diameter hole in its hull. (A [mending](03.PlayerLog&Handouts/Mechanics/CLI/spells/mending.md) cantrip can repair the boat, which is large enough to hold four characters and their gear. The boat's oars are missing, however.)
^27f
...
> 
> **Kuo-toa**. Two [kuo-toa whips](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/kuo-toa-whip.md), twenty adult [kuo-toa](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/kuo-toa.md), and ten young kuo-toa (Small noncombatants) reside here. One whip stands watch by the river while the others rest on pallets. All the kuo-toa are [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned) from eating bad fish.
> 
...
The presence of the aboleth has tainted the underground river and [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned) its fish. Lacking an alternative food source, the kuo-toa have been eating the fish out of necessity, which has [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned) them. In their condition, the kuo-toa fight only in self-defense.
...
> [!note] 
> 
> **Kuo-toa**. Noolgaloop, a [kuo-toa archpriest](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/kuo-toa-archpriest.md), is building a statue in the middle of this 30-foot-high cave while two [kuo-toa whips](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/kuo-toa-whip.md) stand perplexed.
> 
> **Rotting Corpses**. Mutilated monster carcasses piled around the room's perimeter exude a putrid stench.
^285

Noolgaloop is unwaveringly committed to reclaiming its holy shrine (area 16), when the wiser course of action would be to lead its fellow kuo-toa to a new home far away from the aboleth and its servants. If the characters try to speak with the archpriest in a language other than Undercommon, Noolgaloop casts the [tongues](03.PlayerLog&Handouts/Mechanics/CLI/spells/tongues.md) spell so they can converse. It demands that the characters help it complete the statue by retrieving the following items:
...
> 
> **Kuo-toa**. Four [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned) [kuo-toa](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/kuo-toa.md) guard this area. Two of them are using spears to cut the head and claws off a dead chuul. The other two are feasting on the corpse of a dead kuo-toa (a former companion).
> 
...
The kuo-toa are hostile to strangers. If two or more of them are killed or [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated), the survivors retreat to area 21a.

At the start of each turn, any creature not immune to the stench of troglodytes must succeed on a DC 12 Constitution saving throw or be [poisoned](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Poisoned) until the start of its next turn. A [gust of wind](03.PlayerLog&Handouts/Mechanics/CLI/spells/gust-of-wind.md) spell or similar magic can clear the air in the cave for 1 minute, while removing the troglodyte carcasses clears the air for good.
...
> 
> **Noise**. Eerie clicking sounds betray the presence of seven [hook horrors](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/hook-horror.md).
^28b
...
> [!note] 
> 
> **Ambush**. A [hook horror](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/hook-horror.md) clings to a 15-foot high ledge, waiting to ambush any who enter. The ledge is set into the western wall, between the two tunnel entrances.
> 
...
Three enslaved [troglodytes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/troglodyte.md) guard this 30-foot-high cave. Shattered shields, broken spears, and torn nets (trophies taken from the kuo-toa) lie heaped against the walls. None of this gear is salvageable.
...
> [!note] 
> 
> **Troglodytes**. Unless they've been drawn elsewhere, twelve enslaved [troglodytes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/troglodyte.md) rest atop sawed-off stalagmites in the middle of this 40-foot-high cave.
> 
...
The underground river is loudest here. Three enslaved [troglodytes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/troglodyte.md) guard this 30-foot-high cave.
