...
Little Lockford is situated in the Underdark, but the tunnels leading to the settlement are well traveled and relatively easy to navigate. Stone signs illuminated by [continual flame](03.PlayerLog&Handouts/Mechanics/CLI/spells/continual-flame.md) spells can be found at every junction, pointing the way to the settlement.
...
| dice: d12 | Encounter |
|-----------|-----------|
| 1 | Two [grells](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/grell.md) drop on the characters from above. |
| 2 | The characters hear the clicks and clacks of three [hook horrors](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/hook-horror.md) several minutes before these predators appear and attack. |
| 3 | A [galeb duhr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/galeb-duhr.md) reveals itself and tries to converse with the characters in Terran. The creature is bored and eager to strike up a conversation, if only to ask about the weather. |
| 4 | A [black pudding](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/ooze/black-pudding.md) oozes from a hole in the wall and attacks. |
...
- Four [potions of healing](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-healing.md)  
- A packet of [dust of disappearance](03.PlayerLog&Handouts/Mechanics/CLI/items/dust-of-disappearance.md)  
- Two [flasks of alchemist's fire](03.PlayerLog&Handouts/Mechanics/CLI/items/alchemists-fire-flask.md)  

![Map 5.1: Players' Map](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/038-05-003-players-map.webp#center)

## Planning the Heist

![Tixie Tockworth](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/039-05-004-tixie-tockworth.webp#center)
...
- [Driftglobe](03.PlayerLog&Handouts/Mechanics/CLI/items/driftglobe.md)  
- [Stone of good luck](03.PlayerLog&Handouts/Mechanics/CLI/items/stone-of-good-luck.md)  
...
- **Healing Aids.** The sergeant recalls that [potions of healing](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-healing.md) and [healer's kits](03.PlayerLog&Handouts/Mechanics/CLI/items/healers-kit.md) can be found in the city infirmary in Turbine Heights.  
...
Most of Little Lockford's buildings are single-story stone structures (about 12 feet high) with stone doors that are 5 feet high and 3 feet wide. Building interiors tend to be unlit (which is of little concern to deep gnomes, who have [darkvision](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Darkvision)), and they contain furnishings sized for gnomes.
...
|----------|------------------------|---------------------|
| 1 | 2 [darkmantles](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/darkmantle.md) following 1 [grick](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/grick.md) | 3 [clockwork defenders](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/clockwork-defender-kftgv.md) |
| 2–3 | 2 [gricks](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/grick.md) | 2 [clockwork defenders](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/clockwork-defender-kftgv.md) |
| 4–6 | 1 [shambling mound](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/shambling-mound.md) made of fungi | 1 [clockwork observer](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/clockwork-observer-kftgv.md) |
^wandering-monsters
...
> [!gallery]
> ![Map 5.2: DM's map](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/040-map-5-02-dms-map.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/041-map-5-02-dms-map-player.webp#gallery)
...
The outer gates lock automatically when they close. The two gnome mages on duty have prepared [knock](03.PlayerLog&Handouts/Mechanics/CLI/spells/knock.md) spells, which they use to circumvent the gates' complex locking mechanisms. It takes two [knock](03.PlayerLog&Handouts/Mechanics/CLI/spells/knock.md) spells to open the gates.
...
From Mayor Broadfoot's office, characters can retrieve four [potions of healing](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-healing.md), two [flasks of alchemist's fire](03.PlayerLog&Handouts/Mechanics/CLI/items/alchemists-fire-flask.md), and one use of [dust of disappearance](03.PlayerLog&Handouts/Mechanics/CLI/items/dust-of-disappearance.md) in a small packet. These items are kept in an unlocked footlocker under the mayor's desk. On the desk is a [calligraphy set](03.PlayerLog&Handouts/Mechanics/CLI/items/calligraphers-supplies.md).
...
A character who examines the golden pick and succeeds on a DC 13 Intelligence ([Religion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Religion)) check recognizes it as the symbol of the Deep Brother, Callarduran Smoothhands, a god worshiped by svirfneblin (particularly miners and stone carvers).
...
The largest room in the abbey, directly across from the entrance, serves as a place of worship. Low benches face the middle of the domed chamber, where every word spoken—even a whisper—can be heard throughout the space. Skulking in the dark corners of this room are two prisoners who escaped the custody of their guards as they were being led from the jail (area L5) during the evacuation of Little Lockford. The two prisoners—a [goblin boss](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/goblin-boss.md) named Slonk and a [bugbear](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bugbear.md) named Yuzzik—have manacles on their wrists and carry no weapons. Slonk was the leader of a gang of goblin brigands that preyed on travelers in the tunnels near Little Lockford. Yuzzik is Slonk's sole surviving bodyguard. Both are unscrupulous and will do almost anything to survive, short of betraying each other.
...
The abbot [Kavoda](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kavoda-kftgv.md) tried to flee Little Lockford with his fellow monks, but he didn't get far before one of Tockworth's automatons chased him back to the abbey. Minutes after [Kavoda](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kavoda-kftgv.md) returned to the abbey, Slonk and Yuzzik showed up. [Kavoda](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kavoda-kftgv.md) avoided them by casting [meld into stone](03.PlayerLog&Handouts/Mechanics/CLI/spells/meld-into-stone.md). He has been using [meld into stone](03.PlayerLog&Handouts/Mechanics/CLI/spells/meld-into-stone.md) spells to hide ever since. As the characters explore the abbey, [Kavoda](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kavoda-kftgv.md) hears one of them and emerges from a nearby wall when he thinks it's safe to do so.

[Kavoda](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kavoda-kftgv.md) is a chaotic good [deep gnome](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/deep-gnome-svirfneblin.md) who speaks Common, Gnomish, Terran, and Undercommon. His Innate Spellcasting trait includes the ability to cast [meld into stone](03.PlayerLog&Handouts/Mechanics/CLI/spells/meld-into-stone.md) three times per day. He wears a gray robe instead of armor (AC 12) and carries a [spell scroll](03.PlayerLog&Handouts/Mechanics/CLI/items/spell-scroll.md) of [magic weapon](03.PlayerLog&Handouts/Mechanics/CLI/spells/magic-weapon.md) and a [potion of giant strength (hill)](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-hill-giant-strength.md).

[Kavoda](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kavoda-kftgv.md) doesn't want to stay in Little Lockford any longer. Desperate and hungry, he begs the characters to escort him safely to Little Lockford's outer gates (area L1), offering his magic items if they accept the quest. He insists they deliver him to the gates by the most direct route without delay, and he protests loudly if they dawdle or deviate from this course of action. If he is separated from the characters or wounded, [Kavoda](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kavoda-kftgv.md) runs back to the abbey, crying "Callarduran, protect me!" all the way.
...
Characters who loot the storage rooms find six [healer's kits](03.PlayerLog&Handouts/Mechanics/CLI/items/healers-kit.md) and six [potions of healing](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-healing.md).
...
Characters who loot the foundry find three sets of [smith's tools](03.PlayerLog&Handouts/Mechanics/CLI/items/smiths-tools.md) and two sets of [tinker's tools](03.PlayerLog&Handouts/Mechanics/CLI/items/tinkers-tools.md).
...
The taproom contains seating areas, including a row of stools next to a low bar made of carved basalt. Hanging above the bar are two soot-stained lanterns with [continual flame](03.PlayerLog&Handouts/Mechanics/CLI/spells/continual-flame.md) spells cast inside them. Half-drunk flagons of flat mushroom beer rest on the bar and on the tables, abandoned by patrons in their haste to evacuate Little Lockford.

##### Tixie Tockworth

Unless she was defeated elsewhere, [Tixie Tockworth](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/tixie-tockworth-kftgv.md) (see her description and stat block at the end of the adventure) sits on the barstool farthest from the entrance, cradling an empty flagon while mumbling to herself.

The presence of intruders confuses, disturbs, and annoys Tockworth. If she is confronted by the characters here or if the [alarm](03.PlayerLog&Handouts/Mechanics/CLI/spells/alarm.md) spell triggers on the safe in area L9b, she casts [dimension door](03.PlayerLog&Handouts/Mechanics/CLI/spells/dimension-door.md) and steps through the spell's magical doorway into area L9b. As she leaves, she says, "Break time's over, Poots!" (The characters have no way to know this, but Poots is the name of an imaginary friend Tockworth invented in her childhood. This long-lost imaginary friend has resurfaced recently in response to Tockworth's mounting loneliness.)
...
This workshop is where Tockworth creates her clockwork automatons. Two suits of [animated armor](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/animated-armor.md) named Rack and Pinion serve as her assistants and perform most of the hands-on work. These Constructs attack intruders on sight.

The workshop contains a smelter used to fabricate parts and tools. There are enough tools here to assemble one set of [smith's tools](03.PlayerLog&Handouts/Mechanics/CLI/items/smiths-tools.md) and one set of [tinker's tools](03.PlayerLog&Handouts/Mechanics/CLI/items/tinkers-tools.md).

The trapdoor in the ceiling opens into area L9b.

##### Geometric Design

A [detect magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-magic.md) spell reveals an aura of abjuration magic around the complex geometric symbol inscribed on the floor. When a creature other than Tockworth enters the space above the symbol for the first time on a turn or starts its turn there, that creature becomes the target of a [crown of madness](03.PlayerLog&Handouts/Mechanics/CLI/spells/crown-of-madness.md) spell (save DC 15) that has a duration of 1 minute.

##### Fail-Safe Device

If Tockworth's security key is inserted into the metal box embedded in the floor and turned counterclockwise, Little Lockford's clockwork defenders and clockwork observers are rendered [unconscious](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Unconscious) indefinitely. Turning the key clockwise deactivates the magic of the geometric design on the floor and ends any ongoing effects of its magic. The security key is kept in Tockworth's safe (in area L9b).
...
The safe can't be moved, and a [detect magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-magic.md) spell reveals an aura of abjuration magic around it.

A character equipped with thieves' tools can spend 1 minute trying to crack open the safe door, doing so with a successful DC 20 Dexterity check. Alternatively, a character can spend 1 minute pressing their ear to the safe's door while trying to delicately pick its combination lock, opening the door with a successful DC 16 Dexterity ([Sleight of Hand](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) or Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) check. The safe door also opens when the proper command word ("Poots") is spoken within 5 feet of it. A [knock](03.PlayerLog&Handouts/Mechanics/CLI/spells/knock.md) spell or similar magic also opens the safe.

##### Tixie Tockworth

If the safe door is opened by any means other than speaking the proper command word, a mental [alarm](03.PlayerLog&Handouts/Mechanics/CLI/spells/alarm.md) spell alerts [Tixie Tockworth](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/tixie-tockworth-kftgv.md) (see her description and stat block at the end of the adventure). Unless she was defeated in area L8, Tockworth uses a [dimension door](03.PlayerLog&Handouts/Mechanics/CLI/spells/dimension-door.md) spell to appear in the middle of the room and attacks any burglars she sees.

If Tockworth is reduced to 40 hit points or fewer, she uses her next action to cast [dimension door](03.PlayerLog&Handouts/Mechanics/CLI/spells/dimension-door.md) again, then steps through the doorway into area L12.
...
- Zircon ring (60 gp)  
- Three [amethysts](03.PlayerLog&Handouts/Mechanics/CLI/items/amethyst.md) (100 gp each)  
...
A thorough search of the building reveals the corpse of a robed deep gnome named Schnella Deepdelve, the master of the town's miners' guild. Schnella refused to leave and died fending off Tockworth's clockwork defenders. Her restless soul lurks in this building, manifesting as a troublesome [specter](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/specter.md) known as a [poltergeist](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/poltergeist.md) (see the "Variant: Poltergeist" sidebar in the "Specter" entry of the "Monster Manual").

Characters who disturb the body or spend more than 1 minute in the guildhall anger the poltergeist, which hurls picks and iron spikes at them until they leave or until the poltergeist is destroyed. The poltergeist is [invisible](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Invisible) and can't speak.
...
The dead gnomes are two [mimics](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/mimic.md) that attack anyone who touches or otherwise disturbs them. The mimics are working with a [psychic gray ooze](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/ooze/gray-ooze.md) (see the "Variant: Psychic Gray Ooze" sidebar in the "Oozes" entry of the "Monster Manual")—the "puddle of oil" mentioned above. The gray ooze and the mimics recently crept into the warehouse and are waiting for food to come to them.

##### Contraption

The vehicle in the warehouse is a Large, magical drilling machine used by the miners of Little Lockford to burrow new tunnels. The vehicle has the properties of an [apparatus of Kwalish](03.PlayerLog&Handouts/Mechanics/CLI/items/apparatus-of-kwalish.md), with these changes:
...
An inventor named Ignus Flint (lawful neutral, deep gnome [mage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/mage.md) who speaks Common, Gnomish, Terran, and Undercommon) built the contraption and recently locked himself inside it with enough food and water to keep himself alive for 1 week. A metal hatch at the back of the vehicle is the only entrance, and Ignus used a [spell scroll](03.PlayerLog&Handouts/Mechanics/CLI/items/spell-scroll.md) of [arcane lock](03.PlayerLog&Handouts/Mechanics/CLI/spells/arcane-lock.md) to seal it. A character can use an action to try to pull open the magically sealed hatch, doing so with a successful DC 25 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) check. If the characters knock on the contraption, they hear Ignus's muffled voice shout, "Go away!" in Gnomish. Ignus attacks anyone who breaks into his contraption but surrenders if reduced to 10 hit points or fewer.
...
- **Who Is Poots?.** When Tockworth is upset, she speaks to an imaginary friend named Poots—as if Poots were standing right next to her. (Ignus doesn't know that "Poots" is also the command word to bypass the [alarm](03.PlayerLog&Handouts/Mechanics/CLI/spells/alarm.md) spell on Tockworth's safe.)  
...
The cavern is home to six [giant lizards](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/giant-lizard.md) and hundreds of ordinary [lizards](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/lizard.md), all of which are docile but skittish. The giant ones are trained to serve the svirfneblin as pack animals. A character who approaches a giant lizard can use an action to try to keep it from running away, doing so with a successful DC 13 Wisdom ([Animal Handling](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Animal%20Handling)) check. A giant lizard that doesn't run away can be used by that character as a mount.
