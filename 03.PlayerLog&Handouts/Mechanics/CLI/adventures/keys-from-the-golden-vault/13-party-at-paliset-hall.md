...
> [!readaloud] 
> 
> "Greetings, operatives. A magical diamond called a shard solitaire is known to contain an unstable extradimensional rift. Its owner, [Zorhanna Adulare](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/zorhanna-adulare-kftgv.md), is a retired adventurer. Her husband, Eliphas, used to work for the Golden Vault. He suspects that an evil force has somehow entered the stone and is using it to control Zorhanna. He has asked the Golden Vault to steal the stone from Paliset Hall, where he and Zorhanna host their annual gala celebrating the winter solstice.
> 
...
The adventure begins in earnest when the characters meet Fifel, a [satyr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/satyr.md) who works for [Eliphas Adulare](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/eliphas-adulare-kftgv.md). Where Fifel appears is up to you. You can use the following boxed text to describe what he looks like:
...
Fifel carries a [Heward's handy haversack](03.PlayerLog&Handouts/Mechanics/CLI/items/hewards-handy-haversack.md), in which he stores various documents. The satyr is a bit scatterbrained, but Eliphas trusts him to run errands and deliver important messages.
...
> [!readaloud] 
> 
> Zorhanna and [Eliphas Adulare](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/eliphas-adulare-kftgv.md) request the pleasure of your company at Paliset Hall to celebrate the arrival of the winter solstice. Come to Loch Wynnis no earlier than three days before the winter solstice, then take the crossing there to the Feywild at sundown. The many splendors of Paliset Hall await you on the other side! Formal attire is expected but not required.
^458

A [detect magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-magic.md) spell reveals an invisible watermark on the back of each invitation, which is used to verify its authenticity.
...
> [!readaloud] 
> 
> "I, [Eliphas Adulare](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/eliphas-adulare-kftgv.md), have sent my esteemed messenger, Fifel Amberhoof, to lead you to the shores of Loch Wynnis, so that you may cross into the Feywild with great haste. The winter solstice is nearly upon us, and I fear evil forces are as well.
> 
...
- [Rust-colored bag of tricks](03.PlayerLog&Handouts/Mechanics/CLI/items/bag-of-tricks-rust.md)  
- [Figurine of wondrous power (serpentine owl)](03.PlayerLog&Handouts/Mechanics/CLI/items/figurine-of-wondrous-power-serpentine-owl.md)  
- [Gauntlets of ogre power](03.PlayerLog&Handouts/Mechanics/CLI/items/gauntlets-of-ogre-power.md) or [quiver of Ehlonna](03.PlayerLog&Handouts/Mechanics/CLI/items/quiver-of-ehlonna.md) (characters' choice)  
...
As they travel to Loch Wynnis in the company of Fifel, the characters can ask the satyr for information about the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md), the Adulares, the winter solstice gala, and Paliset Hall.

### Shard Solitaire Lore

Fifel knows the following information about the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md):

- **Origin Story.** Fifel thinks the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md) formed when someone dropped a [Heward's handy haversack](03.PlayerLog&Handouts/Mechanics/CLI/items/hewards-handy-haversack.md) full of jewels into a [bag of holding](03.PlayerLog&Handouts/Mechanics/CLI/items/bag-of-holding.md), creating an explosive portal to the Astral Plane. One of the jewels absorbed some of the portal's volatile energy to become the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md). (See "Secrets of the Shard Solitaire" at the end of the adventure for what really happened.)  
- **Previous Owners.** When she was an adventurer many years ago, Zorhanna stole the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md) from a trio of night hags known as the Crestfall Coven. She never encountered the hags again, to the best of Fifel's knowledge.  
...
Fifel knows the following information about Zorhanna and [Eliphas Adulare](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/eliphas-adulare-kftgv.md):
...
![Map 12.1: Players' Map](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/091-12-003-player-map.webp#center)
...
| 2 | Verano Honeywell is a halfling [spy](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/spy.md) employed by a big-city broadsheet to attend the gala and write a story about the goings-on in Paliset Hall. |
| 3 | Lycoris, a [dryad](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/dryad.md), was Paliset Hall's head of staff until she retired six years ago. She comes to the gala every year to see her old friends, and she knows Paliset Hall's features and staff supremely well. |
| 4 | Berengar is a [werebear](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/werebear.md) and [Eliphas Adulare](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/eliphas-adulare-kftgv.md)'s longtime friend. Eliphas is the only other person at the gala who knows Berengar is a werebear. Berengar likewise knows that Eliphas is a werebear. |
| 5 | Nix, a gnome [mage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/mage.md), was Zorhanna's apprentice for several years. Nix has agreed to look after Paliset Hall once the gala ends and the Adulares return to the Material Plane. Nix plans to stay until the next winter solstice. |
| 6 | Eggsy, a gnome [bandit](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md), plans to pick some pockets at the gala. He attends under a false name ("Dworp Q. Guzzler, Esq., Gnome Adventurer") and has altered his appearance using a disguise kit. His disguise includes a curly wig, a more pronounced chin, copper-wired spectacles, and a fake beard. His invitation is a well-crafted forgery, including a fake invisible watermark on the back. Exposing it as a forgery requires a successful DC 17 Intelligence ([Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana) or [Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation)) check. |
| 7 | Yalara is an elf [commoner](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/commoner.md) and singer whose music troupe was invited to perform at the gala. The other two members of her troupe were unable to make it to Loch Wynnis in time. |
| 8 | Mettle, an unarmed tiefling [scout](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/scout.md) with horn-rimmed spectacles, pretends to be a noble named Adira and secretly works for the hags of the Crestfall Coven (see "The Crestfall Coven" later in the adventure). Upon arriving in the Feywild, Mettle slips a copper ring onto the third finger of her left hand. Affixed to the ring is a hag eye, a varnished eyeball that enables the hags to see what's happening at the gala (see the "Hag Covens" sidebar in the "Monster Manual" for details about this item). |
^gala-guests
...
Eliphas gave Fifel strict orders not to return to Paliset Hall (for the satyr's safety) until the matter concerning the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md) necklace is resolved. When the characters are ready to head to the lake, Fifel says the following:
...
The two [winter wolves](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/winter-wolf.md) inspect every guest's invitation but are fooled by well-crafted forgeries. Each wolf can cast [see invisibility](03.PlayerLog&Handouts/Mechanics/CLI/spells/see-invisibility.md) on itself once per day, enabling it to see the invisible watermarks on the guests' invitations as well as to detect [invisible](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Invisible) party-crashers.
...
Paliset Hall is the winter palace of Zorhanna and [Eliphas Adulare](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/eliphas-adulare-kftgv.md). It is situated in a peaceful meadow between snow-covered mountains and a mist-shrouded forest of evergreen trees. Winter's cool touch greets new arrivals, but there's no harsh wind.
...
- **Lighting.** The rooms of the manor are brightly lit with [continual flame](03.PlayerLog&Handouts/Mechanics/CLI/spells/continual-flame.md) spells spaced evenly along the walls.  
...
[Zorhanna Adulare](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/zorhanna-adulare-kftgv.md)'s simulacrum appears identical to Zorhanna: a tall elf with purple skin and long, pale hair. The simulacrum wears a silvery gown embroidered with crystalline ferns and carnelian holly berries. It proudly shows off the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md) it's wearing to guests. Any character who observes the simulacrum for 1 minute can discern its cold indifference with a successful DC 10 Wisdom ([Insight](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Insight)) check.

Abilities such as [truesight](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Truesight) and magic that detects illusions reveal the true nature of the simulacrum: an elf made entirely of magical snow.

The [simulacrum](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/zorhannas-simulacrum-kftgv.md) uses the [archmage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/archmage.md) stat block, with these changes:
...
- If the simulacrum drops to 0 hit points, it turns to snow and melts away, and the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md) necklace teleports to the safe in Zorhanna's vault tower (area P12).  

#### Simulacrum's Location

To determine the location of [Zorhanna's simulacrum](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/zorhannas-simulacrum-kftgv.md) when the characters first arrive at Paliset Hall, or anytime the characters lose track of it and need to find it, roll a `d4` and consult the Simulacrum's Location table, or choose an option you like.
...
As an action, a character can try to steal the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md) necklace with a successful DC 20 Dexterity ([Sleight of Hand](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand)) check, or a character can use a [suggestion](03.PlayerLog&Handouts/Mechanics/CLI/spells/suggestion.md) spell or similar magic to try to make the simulacrum relinquish the necklace. (Even though the simulacrum is a Construct, it can be [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed).) The simulacrum becomes hostile toward anyone who tries to take the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md). The simulacrum doesn't care about collateral damage to Paliset Hall, its staff, or its guests.
...
> [!gallery]
> ![Map 12.2: DM's Map](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/092-map-12-02-dms-map.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/093-map-12-02-dms-map-player.webp#gallery)
...
The gala attracts not only folk from the Material Plane but guests from the Feywild as well. These guests (all of whom are dressed in fantastic, winter-themed outfits) arrive in coaches drawn by [unicorns](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/celestial/unicorn.md) and driven by [satyrs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/satyr.md). Characters who linger on the patio might see one or more of these coaches arrive and deposit their guests.
...
Six [ice mephits](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/ice-mephit.md) are disguised as ice decorations along the perimeter of the room. The mephits attack anyone who starts a fight in this area. Only Zorhanna, her simulacrum, and Eliphas can command the mephits to stop attacking and return to their posts.
...
Guests can entrust their coats to the manor's head of staff, a gray-haired, upbeat [satyr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/satyr.md) named Oren. He carefully hangs the coats on hooks that line the west and east walls of this area between the foyer and the ballroom.
...
At any given time during the gala, `2d6 × 2` [nobles](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/noble.md) dance here. You can add a named guest to the ballroom by rolling once on the Gala Guests table.
...
- [Quiver of Ehlonna](03.PlayerLog&Handouts/Mechanics/CLI/items/quiver-of-ehlonna.md)  
...
The two [sprites](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/sprite.md) are named Sysie and Val. Any character who converses with them and succeeds on a DC 10 Wisdom ([Insight](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Insight)) check notices they are both uneasy. They sense something is amiss with Zorhanna, but neither sprite dares speak out for fear of inviting the Adulares' wrath or a stern lecture from Oren, the satyr head of staff. A character can convince either sprite to share their concerns by succeeding on a DC 13 Charisma ([Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion)) check, but this check is made with disadvantage if Zorhanna is within the sprite's line of sight.

##### Guests

At any given time during the gala, `1d6 + 2` [nobles](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/noble.md) enjoy food and refreshments here. You can add a named guest by rolling once on the Gala Guests table.
...
Two [satyrs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/satyr.md) and three [pixies](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/pixie.md) busy themselves with cooking tasks. The dour [dryad](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fey/dryad.md) head chef, Anisetta, lords over the kitchen and barks out orders. Anisetta also carries a key for the storage closets in the cellar (area P18) but doesn't recall anything important being stored in them.
...
Characters who search the room find a [potion of healing (superior)](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-superior-healing.md) and four bottles of scented bath oil (25 gp each) atop the table farthest from the bathtub.
...
The Elvish rune for "winter" is inscribed on the wall opposite the stairs. A character who examines that wall and succeeds on a DC 20 Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) check spots the rune, which can also be found with a [detect magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-magic.md) spell. Pressing the rune's tile opens hidden pipes at the bottom of the pool and drains it completely in 1 minute. The pool remains empty for 10 minutes, after which it automatically refills with frigid water.
...
The garments stored here are exquisite. The dresser's drawers contain enough materials (wigs, cosmetics, and whatnot) to assemble one [disguise kit](03.PlayerLog&Handouts/Mechanics/CLI/items/disguise-kit.md).
...
[Eliphas](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/eliphas-adulare-kftgv.md) is a neutral good, human [werebear](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/werebear.md) who can adopt the form of a polar bear. He has an Intelligence score of 18 and the following additional action option:
...
> 
> At will: [light](03.PlayerLog&Handouts/Mechanics/CLI/spells/light.md), [minor illusion](03.PlayerLog&Handouts/Mechanics/CLI/spells/minor-illusion.md), [prestidigitation](03.PlayerLog&Handouts/Mechanics/CLI/spells/prestidigitation.md)
> 
> 2/day each: [detect magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-magic.md), [fog cloud](03.PlayerLog&Handouts/Mechanics/CLI/spells/fog-cloud.md)
> 
> 1/day each: [phantasmal force](03.PlayerLog&Handouts/Mechanics/CLI/spells/phantasmal-force.md), [shatter](03.PlayerLog&Handouts/Mechanics/CLI/spells/shatter.md)
^4a1
...
An [arcane lock](03.PlayerLog&Handouts/Mechanics/CLI/spells/arcane-lock.md) spell has been cast on the door to this room. Zorhanna, her simulacrum, and Eliphas treat the door as though it were unlocked.

As an action, a character can try to open the magically locked door using thieves' tools, doing so with a successful DC 22 Dexterity check, or try to force it open, doing so with a successful DC 22 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) check. A [knock](03.PlayerLog&Handouts/Mechanics/CLI/spells/knock.md) spell or similar magic also opens the door.
...
Any character who spends 1 hour examining the books on the shelves can, at the end of that hour, make a DC 20 Intelligence ([Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation)) check. If the check is successful, the character finds a rare book worth 250 gp to a collector. Only four such books can be found here.

The fur-covered book on the desk is Zorhanna's [spellbook](03.PlayerLog&Handouts/Mechanics/CLI/items/spellbook.md), which contains the following spells: [arcane lock](03.PlayerLog&Handouts/Mechanics/CLI/spells/arcane-lock.md), [banishment](03.PlayerLog&Handouts/Mechanics/CLI/spells/banishment.md), [cone of cold](03.PlayerLog&Handouts/Mechanics/CLI/spells/cone-of-cold.md), [counterspell](03.PlayerLog&Handouts/Mechanics/CLI/spells/counterspell.md), [detect magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-magic.md), [detect thoughts](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-thoughts.md), [fire shield](03.PlayerLog&Handouts/Mechanics/CLI/spells/fire-shield.md), [fly](03.PlayerLog&Handouts/Mechanics/CLI/spells/fly.md), [globe of invulnerability](03.PlayerLog&Handouts/Mechanics/CLI/spells/globe-of-invulnerability.md), [ice storm](03.PlayerLog&Handouts/Mechanics/CLI/spells/ice-storm.md), [identify](03.PlayerLog&Handouts/Mechanics/CLI/spells/identify.md), [knock](03.PlayerLog&Handouts/Mechanics/CLI/spells/knock.md), [legend lore](03.PlayerLog&Handouts/Mechanics/CLI/spells/legend-lore.md), [lightning bolt](03.PlayerLog&Handouts/Mechanics/CLI/spells/lightning-bolt.md), [mage armor](03.PlayerLog&Handouts/Mechanics/CLI/spells/mage-armor.md), [magic missile](03.PlayerLog&Handouts/Mechanics/CLI/spells/magic-missile.md), [mind blank](03.PlayerLog&Handouts/Mechanics/CLI/spells/mind-blank.md), [mirror image](03.PlayerLog&Handouts/Mechanics/CLI/spells/mirror-image.md), [misty step](03.PlayerLog&Handouts/Mechanics/CLI/spells/misty-step.md), [plane shift](03.PlayerLog&Handouts/Mechanics/CLI/spells/plane-shift.md), [polymorph](03.PlayerLog&Handouts/Mechanics/CLI/spells/polymorph.md), [remove curse](03.PlayerLog&Handouts/Mechanics/CLI/spells/remove-curse.md), [scrying](03.PlayerLog&Handouts/Mechanics/CLI/spells/scrying.md), [sending](03.PlayerLog&Handouts/Mechanics/CLI/spells/sending.md), [stoneskin](03.PlayerLog&Handouts/Mechanics/CLI/spells/stoneskin.md), [teleport](03.PlayerLog&Handouts/Mechanics/CLI/spells/teleport.md), [time stop](03.PlayerLog&Handouts/Mechanics/CLI/spells/time-stop.md), [true seeing](03.PlayerLog&Handouts/Mechanics/CLI/spells/true-seeing.md), and [wall of force](03.PlayerLog&Handouts/Mechanics/CLI/spells/wall-of-force.md).

The crystal ball on the desk is nonmagical but worth 1,000 gp. It can be used as a focus for the [scrying](03.PlayerLog&Handouts/Mechanics/CLI/spells/scrying.md) spell.

Inside one of the desk drawers is a set of [tinker's tools](03.PlayerLog&Handouts/Mechanics/CLI/items/tinkers-tools.md) and a partially dismantled (and nonfunctional) music box similar in design to the ones used by the Golden Vault. Inside another desk drawer is a set of [calligrapher's tools](03.PlayerLog&Handouts/Mechanics/CLI/items/calligraphers-supplies.md), three blank invitations to the winter solstice gala, some envelopes, a wax seal, and a silk [pouch](03.PlayerLog&Handouts/Mechanics/CLI/items/pouch.md) containing 50 pp.
...
Both storage closets are locked. Oren (see area P3) and Anisetta (see area P8) carry keys to these closets. As an action, a character can use thieves' tools to try to open a locked door, doing so with a successful DC 11 Dexterity check, or try to force open the door, doing so with a successful DC 15 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) check. A [knock](03.PlayerLog&Handouts/Mechanics/CLI/spells/knock.md) spell or similar magic also opens the door.
...
> 
> Zorhanna points at you and laughs. "The shapeless evil finally appears! Whatever you are, you can't fool me! Prepare to face the wrath of [Zorhanna Adulare](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/zorhanna-adulare-kftgv.md)!"
^4b0

[Zorhanna Adulare](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/zorhanna-adulare-kftgv.md) stands in the middle of the largest floating rock (marked C on map 12.2). She is a chaotic good, elf [archmage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/archmage.md) who speaks Auran, Common, Draconic, Elvish, and Sylvan. She has expended all her 6th-level and higher spell slots trying to escape from the [shard solitaire's](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md) extradimensional space, to no avail.

Zorhanna's sense of reality has been warped by prolonged contact with the shapeless Far Realm entity that haunts the extradimensional space. She is convinced that the characters were conjured by this entity to harm her, so she attacks them. She casts [cone of cold](03.PlayerLog&Handouts/Mechanics/CLI/spells/cone-of-cold.md) or [lightning bolt](03.PlayerLog&Handouts/Mechanics/CLI/spells/lightning-bolt.md) every round on her turn for as long as she is able to do so. If one or more characters close to melee distance, she casts [shocking grasp](03.PlayerLog&Handouts/Mechanics/CLI/spells/shocking-grasp.md) and [misty step](03.PlayerLog&Handouts/Mechanics/CLI/spells/misty-step.md) on her next turn, using the latter spell to teleport to another rock.

As an action, a character can make a DC 17 Charisma ([Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion)) check while trying to convince Zorhanna that the party is not her enemy. If the check is successful, Zorhanna does nothing on her next turn except mutter to herself as she ponders what the character said. If the check fails, Zorhanna continues her attack. Once three such checks succeed, Zorhanna concludes that the characters are not her enemies and calls for an end to hostilities. She then screams into the void, "You almost had me! Nice try, whatever you are!"

The characters can also convince Zorhanna to stop attacking them by returning her spellbook to her. The spellbook (found in area P16) excites her because it contains the [plane shift](03.PlayerLog&Handouts/Mechanics/CLI/spells/plane-shift.md) spell—her ticket to freedom (see "Escaping the Rift" below).
...
If the characters crave more combat or if you think they've had too easy a time so far, the entity manifests three [invisible stalkers](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/invisible-stalker.md) that are hostile toward the characters. When a stalker drops to 0 hit points, it lets out a terrible howl as it disperses. Creating these stalkers takes energy the entity needs to free itself from the extradimensional rift, so it won't create more than three of them.

##### Escaping the Rift

A creature can't simply teleport from the [shard solitaire's](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md) extradimensional space. A [plane shift](03.PlayerLog&Handouts/Mechanics/CLI/spells/plane-shift.md) spell or similar magic is required.

If Zorhanna obtains her spellbook, she can use it to prepare the [plane shift](03.PlayerLog&Handouts/Mechanics/CLI/spells/plane-shift.md) spell, but only after finishing a 4-hour trance (the equivalent of a long rest for her). If the characters escape with Zorhanna before the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md) cracks, she admits that the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-kftgv.md) is too dangerous to keep in Paliset Hall and does everything in her power to make sure the characters leave with it. She also suggests the characters place it inside a [bag of holding](03.PlayerLog&Handouts/Mechanics/CLI/items/bag-of-holding.md) or some other item that contains extradimensional storage space, in case the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-kftgv.md) explodes.
...
The extradimensional energy released from the stone has the same effect as a [staff of power's](03.PlayerLog&Handouts/Mechanics/CLI/items/staff-of-power.md) Retributive Strike property, centered on the stone itself. The explosion occurs a split second before creatures trapped inside the stone are released, sparing them from the effect.

If the characters placed the uncracked stone in the extradimensional space of a magic item such as a [bag of holding](03.PlayerLog&Handouts/Mechanics/CLI/items/bag-of-holding.md) or Fifel's [haversack](03.PlayerLog&Handouts/Mechanics/CLI/items/hewards-handy-haversack.md), the explosion is confined to that item's extradimensional space, doing no harm to the container; a split second later, creatures released from the stone appear in unoccupied spaces within 30 feet of that container, rather than inside its extradimensional space near the stone itself.

## Conclusion

After the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md) cracks, assuming they survive, the characters can take stock of their triumphs or failures.
...
When the characters return to Loch Wynnis, Fifel greets them and asks about their visit to the Feywild. If they need to borrow his [Heward's handy haversack](03.PlayerLog&Handouts/Mechanics/CLI/items/hewards-handy-haversack.md) to safely contain and transport the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md), he empties it and hands it to them.
...
Long ago, someone dropped a [bag of holding](03.PlayerLog&Handouts/Mechanics/CLI/items/bag-of-holding.md) full of jewels into a [portable hole](03.PlayerLog&Handouts/Mechanics/CLI/items/portable-hole.md), creating an explosive portal to the Astral Plane. A 5,000 gp diamond contained within the bag absorbed some of the portal's volatile energy and became the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md) featured in this adventure.

The same Far Realm entity that wormed its way into the [shard solitaire's](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md) extradimensional rift has also attuned to the stone. The entity can't do anything with the stone other than what it has already done to [Zorhanna Adulare](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/zorhanna-adulare-kftgv.md) (as described in this adventure). When the entity escapes the rift, the stone cracks and becomes nonmagical.

Although the characters never get the chance to wield the power of Zorhanna's [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-diamond-kftgv.md), other [such items](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-kftgv.md) are scattered throughout the multiverse, waiting to be found.