...
| Fire and Darkness | 11 | Wrest the [Book of Vile Darkness](03.PlayerLog&Handouts/Mechanics/CLI/items/book-of-vile-darkness-variant-kftgv.md) from an efreeti and his lackeys. |
^heist-adventures
...
![Meera Raheer](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/001-00-002-meera-raheer.webp#center)

[Meera Raheer](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/meera-raheer-kftgv.md) (lawful good, human [commoner](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/commoner.md)) is a Golden Vault handler you can assign to oversee your players' heist crew.
...
You can add a rival crew to an adventure at any time. When you do, make it clear to the characters that they have competition. The characters might see evidence of their rivals, such as an alarm that has already been disabled or an [incapacitated](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated) guard. At some point, the characters might even catch their rivals trying to steal the adventure's MacGuffin from right under their noses!
...
|-------|------------------------|------------------------|-------------------------|
| Arlo | [Bandit captain](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit-captain.md) | [Knight](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/knight.md) | [Mage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/mage.md) |
| Enna | [Bandit](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md) | [Spy](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/spy.md) | [Assassin](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/assassin.md) |
| Gregir | [Bandit](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md) | [Thug](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/thug.md) | [Veteran](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/veteran.md) |
| Sabrina | [Bandit](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md) | [Thug](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/thug.md) | [Veteran](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/veteran.md) |
| Torgja | [Bandit](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/bandit.md) | [Thug](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/thug.md) | [Veteran](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/veteran.md) |
...
![Golden Vault Seal](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/003-00-004-golden-vault-seal.webp#center)
...
| The Stygian Gambit | Regor Falsain (neutral evil, human [noble](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/noble.md)), a gambler who wasn't invited to participate in the three-dragon ante tournament, hires the rivals to steal the erinyes statuette. |
| Reach for the Stars | Yexanthal (chaotic evil, elf [cult fanatic](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/cult-fanatic.md)) was one of [Markos Delphi](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/markos-delphi-kftgv.md)'s researchers until he was caught trying to steal The Celestial Codex. Eager to commune with Far Realm entities, Yexanthal hires the rivals to steal the book from Delphi Mansion. |
| Prisoner 13 | Horath Axebreaker (lawful evil, dwarf [veteran](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/veteran.md)) hires the rivals to retrieve a copy of [Prisoner 13](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/prisoner-13-kftgv.md)'s keystone tattoo so he can steal Clan Axebreaker's treasure for himself. |
| Tockworth's Clockworks | Tockworth's security key is a copy of a key that opens a vault containing vast wealth in another svirfneblin stronghold. Waltabeth Brambleroot (neutral evil, deep gnome [mage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/mage.md)) hires the rivals to retrieve the key for her so she can claim the treasure. |
| Masterpiece Imbroglio | The rivals are members of a thieves' guild from a neighboring city. They seek [Constantori's Portrait](03.PlayerLog&Handouts/Mechanics/CLI/items/constantoris-portrait-kftgv.md) for Skandor Torreth (neutral, human [assassin](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/assassin.md)), a guildmaster who needs information only the portrait knows. |
| Axe from the Grave | Zarthine Delthion (neutral, human [noble](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/noble.md)), the daughter of the wizard who gave Frody the Canaith mandolin, believes the instrument is rightfully hers. She hires the rivals to retrieve it. |
...
| Shard of the Accursed | Everett Stillwater (neutral evil, human [mage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/mage.md)) hires the rivals to steal the shard the characters seek to return to the tomb. He believes he can break the shard's curse and sell it on the black market for a high price. |
| Heart of Ashes | Barolophine (neutral evil, elf [archmage](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/archmage.md)) hires the rivals to recover the heart of Jhaeros, a focus item the archmage needs to fuel her journey to become a lich. |
| Affair on the Concordant Express | The rivals are members of [the Stranger](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/the-stranger-kftgv.md)'s former outlaw gang. They are determined to free [the Stranger](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/the-stranger-kftgv.md) before the Concordant Express reaches Mechanus. |
| Party at Paliset Hall | The [adult black dragon](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/adult-black-dragon.md) Inkscale, one of Zorhanna's oldest and bitterest enemies, hires the rivals to steal the [shard solitaire](03.PlayerLog&Handouts/Mechanics/CLI/items/shard-solitaire-kftgv.md) out of spite. |
| Fire and Darkness | Vrakir's jilted lover Zaltima, an [efreeti](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/efreeti.md), hires the rivals to steal the [Book of Vile Darkness](03.PlayerLog&Handouts/Mechanics/CLI/items/book-of-vile-darkness-variant-kftgv.md) for her. |
^rival-crew-motivations