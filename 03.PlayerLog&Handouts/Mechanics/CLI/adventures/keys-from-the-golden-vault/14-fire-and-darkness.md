...
For centuries, a powerful efreeti named Vrakir sent his armies against numerous foes and burned countless cities to ash. Now, the tyrant has found an artifact of unimaginable evil: the [Book of Vile Darkness](03.PlayerLog&Handouts/Mechanics/CLI/items/book-of-vile-darkness-variant-kftgv.md).
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/099-13-002-ch13-key.webp#center)
...
Syr Isbeth, the human leader of the defense effort, received a missive from the arcanaloth Nebukath professing the arcanaloth's sympathies for her cause and providing information about the book's location. Syr Isbeth doesn't know whether Nebukath can be trusted, but stealing the book would stymie Vrakir's war effort—it's too good an opportunity to pass up. She asks the characters to undertake this perilous mission, promising them the title to a regional stronghold, along with its retinue of five [knights](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/knight.md) and one hundred [guards](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/guard.md), if they bring her the book or proof of its destruction.
...
Farn Bindelbrot, a gnome operative for the Fated, identified the characters as having the skills needed for such a difficult task. Should the characters deliver the [Book of Vile Darkness](03.PlayerLog&Handouts/Mechanics/CLI/items/book-of-vile-darkness-variant-kftgv.md) to Farn, he will reward them with an [amulet of the planes](03.PlayerLog&Handouts/Mechanics/CLI/items/amulet-of-the-planes.md). Farn promises the Fated will then safely secure the book.
...
Remi has gotten the necessary information from Nebukath, but stealing the book is beyond her ability, so she recruits the characters to carry out this task for the order. Remi offers no reward, but if the characters bring the book or proof of its destruction to the order, each character receives a "blessing" of their choice, either from the gods they worship or from a god worshiped by Remi's holy order: a [blessing of health](03.PlayerLog&Handouts/Mechanics/CLI/rewards/blessing-of-health.md), a [blessing of protection](03.PlayerLog&Handouts/Mechanics/CLI/rewards/blessing-of-protection.md), or a [blessing of understanding](03.PlayerLog&Handouts/Mechanics/CLI/rewards/blessing-of-understanding.md), all of which are described in the "Dungeon Master's Guide".
...
![Map 13.1: Players' Map](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/100-13-003-player-map.webp#center)

### Brimstone Hold's Inhabitants

Here's a summary of Brimstone Hold's inhabitants:

- **Efreet.** Vrakir spends most of his time on the Elemental Plane of Fire, visiting Brimstone Hold only occasionally. In his absence, the hold is under the command of an efreeti named [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md).  
...
- **Various Defenders.** The hold is defended by [erinyes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/erinyes.md) devils (whose [truesight](03.PlayerLog&Handouts/Mechanics/CLI/rules/senses.md#Truesight) allows them to see through most forms of magical concealment), duergar, and [salamanders](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/salamander.md), as well as a [young red dragon](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/dragon/young-red-dragon.md) named Kalimrax and a [beholder](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/beholder.md) known as the Eye of the Efreet.  
...
- **Main Entrance.** A stone bridge spans the lava river and leads to the hold's main entrance. The bridge is mostly used by Vrakir's troops, who often return with prisoners in tow, and sometimes visitors who have business with [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) approach this way.  
...
- **Timing Arrival.** The characters can time their arrival to coincide with the arrival of a prisoner escort or supply shipment. Timing their arrival to Vrakir's presence or absence is harder, since the efreeti travels to the fortress via the [plane shift](03.PlayerLog&Handouts/Mechanics/CLI/spells/plane-shift.md) spell. Doing so might first require characters to spy on the hold's activities.  
- **Avoiding Confrontation.** Vrakir is a powerful adversary. The characters are best off avoiding a confrontation with him, at least until the [Book of Vile Darkness](03.PlayerLog&Handouts/Mechanics/CLI/items/book-of-vile-darkness-variant-kftgv.md) is out of his grasp.  
...
All exterior doors are made of solid iron and are barred on the inside. As an action, a character can try to break down a barred door, doing so with a successful DC 25 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) check.

Interior doors are made of iron and are unlocked unless the text states otherwise.

##### Secret Doors

Each secret door in the fortress is opened by stepping on a tiny pressure plate hidden in the floor nearby. As an action, a character can search the wall for secret doors and make a DC 15 Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) check. If the check is successful, the character finds the secret door and the pressure plate used to open it.
...
The hold's 20-foot-thick curtain walls are faced with blocks of carved basalt and filled with a rubble core. The walls on the hold's lower level (bordering areas B4 and B5) stand 40 feet high, while those on the hold's upper level (bordering area B6) stand 20 feet high. Crenellations rise another 3 to 8 feet. Scaling a wall without magic or climbing gear requires a successful DC 20 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) check.
...
Any fights or suspicious activities in the hold are reported to the [efreeti](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/efreeti.md) [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md), who places the defenders on high alert. Even if Vrakir is at the hold, the defenders bring their reports to [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) first, allowing him to deal with any trouble himself rather than risk Vrakir's ire. While on high alert, the hold's inhabitants can't be surprised, and [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) responds personally to any further reports of trouble, arriving after 1 minute with two [salamanders](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/salamander.md) from area B20. After 24 hours with no incidents, the hold goes off high alert.
...
> [!gallery]
> ![Map 13.2: DM's Map](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/101-map-13-02-dms-map.webp#gallery)
> ![Player Version](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/102-map-13-02-dms-map-player.webp#gallery)
...
Two [erinyes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/erinyes.md) are stationed on the rooftops of the towers closest to the bridge. If the characters approach the gatehouse and give a sound reason for being here, the erinyes open the way (see "Doors" and "Portcullises" below), escort the characters to area B10, and announce their presence to the salamanders in area B22 before returning to their posts.

When the hold is on high alert, a third [erinyes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/erinyes.md) from area B15 takes up position in the gatehouse's rear tower.
...
Lifting the bars from within the central yard of area B2 requires a successful DC 15 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) check, while bursting the gates from area B1 or B4 requires a successful DC 25 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) check. Any Medium or smaller creature attempting to force open one of these doors has disadvantage on its ability check to do so.
...
As an action, a creature can try to lift a portcullis above its head, doing so with a successful a DC 25 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) check. Any Medium or smaller creature attempting to do so has disadvantage on this check.
...
The [erinyes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/erinyes.md) stationed here carries a [rope of entanglement](03.PlayerLog&Handouts/Mechanics/CLI/items/rope-of-entanglement.md), which it uses to ensnare any prisoner who tries to escape.
...
![Gruk-Gruk](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/103-13-004-gruk-gruk.webp#center)
...
Eighty prisoners ([commoners](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/commoner.md)) labor here under the watchful eyes of ten [duergar](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/duergar.md).
...
Most of the prisoners are too fearful to speak with visitors, but one prisoner named Venture (chaotic good, tiefling [gladiator](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/gladiator.md)) tries to get the characters' attention, seeing the party's arrival as a golden opportunity to escape. If the characters smuggle her some weapons, rope, and a grappling hook, Venture agrees to start a prison riot (see "Prison Riot" below).

##### Portcullises

The passages into the hold's interior are blocked by portcullises. The winch to operate the northern portcullis is accessible from the yard. The winch to operate the southern portcullis is inside the passage leading to area B11. It takes 3 actions to raise a portcullis or 1 action to lower it using the winch. As an action, a creature can try to lift a portcullis above its head, doing so with a successful a DC 20 Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) check.
...
If the characters return to the prison yard after obtaining the [Book of Vile Darkness](03.PlayerLog&Handouts/Mechanics/CLI/items/book-of-vile-darkness-variant-kftgv.md), the prisoners start another riot and overcome their captors.
...
If the characters arrive at the hold while the traders are present, one of the larger buildings is inhabited by Klax (chaotic neutral [cambion](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/cambion.md)) and eight traders ([commoners](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/commoner.md)). The traders are indifferent to the characters, although Klax is protective of her business arrangement with [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) and turns in the party to the hold's defenders if the characters seem likely to threaten that arrangement.
...
One [erinyes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/erinyes.md) is on guard in each of these towers, occasionally leaving the tower to walk the battlements of the adjoining curtain walls. Each erinyes is hostile to anyone attempting to climb the outer walls but is otherwise indifferent to the goings-on in the yards below.
...
Two [erinyes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/erinyes.md) guard access to the harbor, one in each tower. These guards are hostile to anyone attempting to enter or leave the hold via the river without [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md)'s approval. The erinyes admit Klax and her traders after a cursory inspection of their cargo, although the erinyes become suspicious if the traders aren't following their usual schedule.
...
Kalimrax's lair contains 14,213 sp, 7,029 gp, 923 pp, eighteen gemstones (500 gp each), a fan made of couatl feathers (1,250 gp), a [figurine of wondrous power (bronze griffon)](03.PlayerLog&Handouts/Mechanics/CLI/items/figurine-of-wondrous-power-bronze-griffon.md), and a [mace of terror](03.PlayerLog&Handouts/Mechanics/CLI/items/mace-of-terror.md).
...
Two [duergar](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/duergar.md) are always on guard here. They react with suspicion toward the characters, as visitors don't usually come through this area, and become hostile if the characters attempt to force their way to or from area B4.
...
At night, twenty prisoners ([commoners](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/commoner.md)) sleep in these cells. During the day, the cells are empty.
...
A chaotic neutral [ogre](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/giant/ogre.md) named Yug occupies this cell. For the past three days, Yug has been confined here for breaking a duergar's arm in anger over the theft of Gruk-Gruk, a crude rag doll.
...
Three [erinyes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/erinyes.md) lounge in their hammocks here, resting between shifts patrolling the walls. The erinyes are immediately suspicious of the characters, as visitors don't usually come here. Unless the characters provide a compelling reason for their intrusion and succeed on a DC 20 Charisma ([Deception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Deception) or [Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion)) check, the erinyes try to capture the characters for questioning.
...
Six [duergar](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/duergar.md) are sleeping here on the stone slabs that serve as their beds. They wear their armor and keep their weapons within arm's reach. The sound of normal movement doesn't wake them, but they are roused by the sounds of battle or other loud noises in areas B15–B19.
...
The iron chests are unlocked. Each chest contains ten spare sets of plain, dwarf-sized clothing. One chest also holds a small black [pouch](03.PlayerLog&Handouts/Mechanics/CLI/items/pouch.md) containing two eight-sided obsidian dice (50 gp) and a dagger with a malachite blade (250 gp). The other chest also contains a [potion of resistance (fire)](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-fire-resistance.md) in a vial made from a hollowed-out dragon's fang.
...
Two [salamanders](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/salamander.md) stand guard here along with a [beholder](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/beholder.md) known as the Eye of the Efreet. These creatures are hostile unless the characters arrive with an escort, in which case the characters are directed to area B23 to make an appointment to see [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md). Once the characters proceed to area B25, the salamanders accompany them and remain there for the duration of their visit.
...
Nebukath the [arcanaloth](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/arcanaloth.md) sees to the hold's administrative tasks. Nebukath is initially indifferent toward the characters and presumes they have come seeking an audience with [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md). The arcanaloth languidly informs the characters that the efreeti is too busy to meet with them.
...
The office's three paintings are worth 100 gp each, or five times that to a collector of planar antiquities. Nebukath wears a [ring of telekinesis](03.PlayerLog&Handouts/Mechanics/CLI/items/ring-of-telekinesis.md) and a platinum brooch set with tourmaline (1,000 gp).
...
![Jarazoun the Efreeti](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/104-13-005-jarazoun-the-efreeti.webp#center)

If he hasn't been encountered and defeated elsewhere, the [efreeti](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/efreeti.md) [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) sits on the throne, acting as master of Brimstone Hold in Vrakir's absence. [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) has little patience for the business of running a stronghold and leaves most of the decision-making to Nebukath. The stronghold's denizens see [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) for the petty tyrant he is, but they obey him out of fear of his patron, Vrakir.

If the characters come before [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) posing as visitors with legitimate business at the hold, the efreeti treats them with indifference. He enjoys lording his power over petitioners and denies any requests the characters make dismissively, relenting only if plied with substantial wealth or flattery—a very rare magic item, 10,000 gp worth of treasure, or a successful DC 25 Charisma ([Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion)) check suffices.

If the characters insult [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) or reveal their true purpose, the efreeti becomes hostile and shouts for the salamanders in area B22 to apprehend the characters and imprison them in area B13. If the party resists, [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) fights desperately, fearing Vrakir's wrath if the characters were to escape.
...
[Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) wears a gold chain of office studded with fire opals (5,000 gp) and eight gold rings set with precious stones (250 gp each). He also carries the key to area B28.
...
[Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) entertains favored guests here. The ruby liquid is firewine imported from the City of Brass. Any creature that drinks the wine gains 15 temporary hit points. The creature must finish a long rest before it can gain this benefit again.
...
The brazier is a [brazier of commanding fire elementals](03.PlayerLog&Handouts/Mechanics/CLI/items/brazier-of-commanding-fire-elementals.md). Its command word, ilkath keri (Ignan for "blaze brightly"), is inscribed along the brazier's inside rim.
...
The doors to areas B28 and B29 are both locked. [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) carries the key to area B28, while Vrakir carries the key to area B29. As an action, a character can use thieves' tools to try to pick either lock, doing so with a successful DC 20 Dexterity check.

##### Statues

The statues are two [stone golems](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/stone-golem.md) that are normally quiescent and don't react to the characters' presence. However, the golems are magically attuned to the door to area B29 and become hostile if a creature attempts to open the door by any means other than using Vrakir's key. A character who succeeds on their ability check to pick the lock by 10 or more avoids triggering the golems. Entering area B29 by using magic (such as the [passwall](03.PlayerLog&Handouts/Mechanics/CLI/spells/passwall.md) spell) to bypass the door entirely doesn't trigger the golems.
...
[Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) is usually here when he isn't conducting business in area B25 or entertaining visitors in area B26.

##### Treasure

The lyre is an [instrument of the bards (Cli lyre)](03.PlayerLog&Handouts/Mechanics/CLI/items/instrument-of-the-bards-cli-lyre.md) decorated with carvings of phoenixes. [Jarazoun](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jarazoun-kftgv.md) fancies himself a musician but is unable to attune to the instrument.
...
The tome resembles the [Book of Vile Darkness](03.PlayerLog&Handouts/Mechanics/CLI/items/book-of-vile-darkness-variant-kftgv.md) but is actually a trained [mimic](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/mimic.md). Any character who examines the tome and succeeds on a DC 20 Intelligence ([Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana)) check recognizes it as a fraud. The mimic attacks any creature that touches or attacks it.

The room's back wall appears solid but is the anchor for a magical doorway to area B30: the demiplane where Vrakir keeps the real [Book of Vile Darkness](03.PlayerLog&Handouts/Mechanics/CLI/items/book-of-vile-darkness-variant-kftgv.md). Anyone examining the wall using [detect magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/detect-magic.md) can see the outline of the door. The scorch marks and cracked masonry are due to the book's corrupting influence, which seeps out every time the doorway is opened.

The key to opening the door is the gemstone set in the wall carving. The gem is trapped with a 6th-level [glyph of warding](03.PlayerLog&Handouts/Mechanics/CLI/spells/glyph-of-warding.md) spell. The glyph casts [disintegrate](03.PlayerLog&Handouts/Mechanics/CLI/spells/disintegrate.md) on any creature that touches the gem without speaking Vrakir's motto: atka ignari. While touching the gem, a creature can take an action to open the door to area B30 as if the creature had cast the [demiplane](03.PlayerLog&Handouts/Mechanics/CLI/spells/demiplane.md) spell; this causes the face in the wall to stretch its mouth wide as a shimmering gray portal appears within. Removing the gem from the wall causes the doorway to disappear, trapping anything in area B30 in the demiplane until the gem is replaced or someone else accesses the room with a [demiplane](03.PlayerLog&Handouts/Mechanics/CLI/spells/demiplane.md) spell.
...
![The Book of Vile Darkness](03.PlayerLog&Handouts/Mechanics/CLI/adventures/keys-from-the-golden-vault/img/105-13-006-book-of-vile-darkness.webp#center)

If the characters had a relatively easy time getting here, add two [invisible](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Invisible) [nycaloths](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/nycaloth.md) as guards. The nycaloths are mercenaries hired by Vrakir to protect the [Book of Vile Darkness](03.PlayerLog&Handouts/Mechanics/CLI/items/book-of-vile-darkness-variant-kftgv.md), and their [invisibility](03.PlayerLog&Handouts/Mechanics/CLI/spells/invisibility.md) spells end when they attack.

##### Treasure

The [Book of Vile Darkness](03.PlayerLog&Handouts/Mechanics/CLI/items/book-of-vile-darkness.md) is so blasphemous that its mere presence erodes the demiplane Vrakir made to contain it. Review the [artifact's description](03.PlayerLog&Handouts/Mechanics/CLI/items/book-of-vile-darkness.md) in the "Dungeon Master's Guide", then replace its Random Properties with the following preset ones:

- **Circle of Death.** While attuned to the book, you can cast [circle of death](03.PlayerLog&Handouts/Mechanics/CLI/spells/circle-of-death.md) (save DC 20) from it as an action. After you cast the spell, roll a `d6`. On a roll of 1–5, you can't use this property again until the next dawn.  
- **Condition Immunities.** While attuned to the book, you can't be [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed) or [frightened](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Frightened).  
- **Evil Presence.** The book houses an evil spirit that is hostile toward you. When you become attuned to the book, the spirit tries to leave the book and enter your body. If you fail a DC 20 Charisma saving throw, it succeeds, and you become an NPC under the DM's control until the intruding spirit is banished using magic such as the [dispel evil and good](03.PlayerLog&Handouts/Mechanics/CLI/spells/dispel-evil-and-good.md) spell. The banished spirit returns to the book.  
