...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/essentials-kit-divine-contention/img/023-ynkgo-donnabella.webp#center)
...
Use the [Spellcaster (Healer)](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/spellcaster-healer-slw.md) or [Spellcaster (Mage)](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/spellcaster-mage-slw.md) sidekick stat block to represent her.
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/essentials-kit-divine-contention/img/024-leeom-galandro.webp#center)
...
Use the [Expert](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/expert-slw.md) sidekick stat block to represent him.
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/essentials-kit-divine-contention/img/025-l3v6r-inverna.webp#center)
...
Use the [Warrior](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/warrior-slw.md) sidekick stat block to represent her.
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/essentials-kit-divine-contention/img/026-3krsm-nib.webp#center)
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/essentials-kit-divine-contention/img/027-pu4f2-pete.webp#center)
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/essentials-kit-divine-contention/img/028-gttxp-quinn.webp#center)
...
Use the [Warrior](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/warrior-slw.md) sidekick stat block to represent him.
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/essentials-kit-divine-contention/img/029-1qyge-ruby.webp#center)
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/essentials-kit-divine-contention/img/030-nemem-shanjan.webp#center)
...
Use the [Spellcaster (Healer)](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/spellcaster-healer-slw.md) or [Spellcaster (Mage)](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/spellcaster-mage-slw.md) sidekick stat block to represent him.
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/essentials-kit-divine-contention/img/031-nrqv1-talon.webp#center)
...
Use the [Expert](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/expert-slw.md) sidekick stat block to represent them.
...
- [Spellcaster (Healer)](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/spellcaster-healer-slw.md)  
...
|-------|------------|--------------|
| 8th | 49 (`9d8 + 9`) | **Ability Score Improvement.** The expert's Dex. score increases by 2, raising the modifier by 1, so increase the following numbers by 1: the Dex. saving throw bonus; the Armor Class; the [Acrobatics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Acrobatics), [Sleight of Hand](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Sleight%20of%20Hand), and [Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth) bonuses; and the bonuses to hit and damage of the expert's weapon attacks. |
| 9th | 55 (`10d8 + 10`) |  |
^level-hit-points-new-features
...
| Level | Hit Points | New Features |
|-------|------------|--------------|
| 8th | 40 (`9d8`) | **Ability Score Improvement.** The spellcaster's Int. (mage) or Wis. (healer) score increases by 2, raising the modifier by 1, so increase the following numbers by 1: the Int. or Wis. saving throw bonus; Int. or Wis. based skill bonuses; and the bonuses to hit and to saving throw DCs with spells. Spellcasting. The caster gains one 4th-level spell slot and learns one new 4th-level spell: [banishment](03.PlayerLog&Handouts/Mechanics/CLI/spells/banishment.md) (healer) or [polymorph](03.PlayerLog&Handouts/Mechanics/CLI/spells/polymorph.md) (mage). |
| 9th | 45 (`10d8`) | **Spellcasting.** The spellcaster gains one 4th-level and one 5th-level spell slot and learns one new 5th-level spell: [greater restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/greater-restoration.md) (healer) or [cone of cold](03.PlayerLog&Handouts/Mechanics/CLI/spells/cone-of-cold.md) (mage). |
^level-hit-points-new-features
...
| Level | Hit Points | New Features |
|-------|------------|--------------|
| 8th | 58 (`9d8 + 18`) | **Ability Score Improvement.** The warrior's Str. score increases by 2, raising the modifier by 1, so increase the following numbers by 1: the Str. saving throw bonus; the [Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics) bonuses; and the bonuses to hit and damage of the warrior's longsword attacks. |
