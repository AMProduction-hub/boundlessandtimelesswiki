...
|-----------|-------------|-------|
| 1-2 | Random Magic Item ([Table C](03.PlayerLog&Handouts/Mechanics/CLI/tables/magic-item-table-c.md)) | 500 gp |
...
This shrine to Lathander, god of light, was the first temple to be reconstructed in Leilon. Merrygold Brightshine, an outgoing young female halfling with the [priest](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/priest.md) statistics, cares for the shrine and offers council to any who pray at the small stone altar to Lathander within. She conducts services at the shrine each day at dawn.
