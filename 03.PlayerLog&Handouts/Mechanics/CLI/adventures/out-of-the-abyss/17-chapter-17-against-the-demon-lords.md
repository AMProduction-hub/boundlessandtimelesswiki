...
In the culmination of *Out of the Abyss*, the heroes implement [Vizeran DeVir](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/vizeran-devir-oota.md)'s scheme to take on the demon lords. The archmage's ritual draws the demon lords together to fight to the death, leaving Demogorgon victorious but weakened as the adventurers face off against the Prince of Demons. Even wounded and weakened, though, Demogorgon is a legendary foe, and the fate of the Underdark and all Faerûn rests on the adventurers' final battle.

## Readying the Plan

Over the course of their adventures, the characters have collected the components needed to create the talisman at the center of [Vizeran DeVir](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/vizeran-devir-oota.md)'s summoning ritual:
...
- Six feathers from six different angels (from the [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified) angels in the Labyrinth in chapter 14)  
...
After [Vizeran DeVir](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/vizeran-devir-oota.md) uses these components to create the talisman known as the *dark heart* to draw forth the exiled demon lords from across the Underdark, he expects the adventurers to plant it in Menzoberranzan. Having learned from Vizeran's apprentice Grin Ousstyl of the archmage's secret goal to see the city destroyed, the characters might decide to place the *dark heart* talisman elsewhere, determining the battlefield for their confrontation with the demon lords (see "Let This Be Their Battlefield").

![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/out-of-the-abyss/img/110-ooa17-01.webp#center)

## Enacting the Plan

Once the *dark heart* is in place, the ritual can begin. The adventurers and their allies take up a position not far from the *dark heart*, close to where the demons will appear. Where exactly depends on the placement of the talisman and the adventurers' own tactics and plans. They can use a [sending](03.PlayerLog&Handouts/Mechanics/CLI/spells/sending.md) spell to signal Vizeran to begin the ritual once the talisman is in place. (If none of the characters can cast [sending](03.PlayerLog&Handouts/Mechanics/CLI/spells/sending.md), Vizeran can provide the spell on a *spell scroll*).
...
> 
> A character can figure out the truth with a DC 20 Intelligence ([Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana)) check, or by consulting Gromph Baenre's grimoire (see chapter 15). Alternatively, Grin Ousstyl can tell the characters the truth, enraging his master as a result.
...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/out-of-the-abyss/img/111-ooa17-02.webp#center)
...
If the characters inform the myconids of their need for a place to stage a daring last battle, [Sovereign Basidia](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/sovereign-basidia-oota.md) or another myconid representative might offer Neverlight Grove. The ranks of the myconids have been decimated by Zuggtmoy's depredations and the fetid wedding, and many fear their beloved caverns are corrupted. They are willing to seek a new home (perhaps in the caverns of Araumycos) and grateful enough to the heroes that they will sacrifice their old home to help them.

#### Sloobludop

The ruins of the kuo-toa settlement (see chapter 3) could become the site of the final fight against the demon lords. [Shuushar the Awakened](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/shuushar-the-awakened-oota.md) can be convinced to help evacuate the remaining inhabitants if asked. The nearby Darklake creates its own challenges, particularly given the presence of ixitxachitl loyal to Demogorgon.
...
> 
> If the adventurers need some extra help in their epic final battle at the end of the campaign, consider the following option involving [Jimjar](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/jimjar-oota.md), the deep gnome gambler they met in the drow slave pen in chapter 1 of the adventure.
> 
...
|----------|--------------|
| 1 | 4 [barlguras](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/barlgura.md) |
| 2 | 4 [chasmes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/chasme.md) |
| 3 | 2 [hezrous](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/hezrou.md) |
| 4 | 3 [vrocks](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/vrock.md) |
^demon-sortie

#### Demon Thief

An [invisible](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Invisible) [quasit](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/quasit.md) tries to steal a small, valuable item from a party member. The target must succeed on a DC 13 Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) check to notice the theft as it happens. On a failed check, the quasit makes off with the item undetected. You can make the search for the item a loose thread for the conclusion of the adventure. Alternatively, have the quasit killed during the battle, with the stolen item turning up in the aftermath.
...
| 3–4 | **Flying Debris**. Each creature within 30 feet of a point you choose must make a DC 13 Dexterity saving throw, taking `3d6` bludgeoning damage and falling [prone](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Prone) on a failure. |
...
Demogorgon has been wounded during the fight, giving the characters an edge in the battle to come. Apply the following penalties to the [Demogorgon](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/demogorgon-mpmm.md) stat block in appendix D:
...
- His [feeblemind](03.PlayerLog&Handouts/Mechanics/CLI/spells/feeblemind.md) innate spell is expended, as are all but one use each of [dispel magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/dispel-magic.md), [fear](03.PlayerLog&Handouts/Mechanics/CLI/spells/fear.md), and [telekinesis](03.PlayerLog&Handouts/Mechanics/CLI/spells/telekinesis.md).  
...
When Orcus is defeated, he drops the [Wand of Orcus](03.PlayerLog&Handouts/Mechanics/CLI/items/wand-of-orcus.md) (see "chapter 7" of the *Dungeon Master's Guide*), which falls to the ground. A party member can try to grab the wand before Demogorgon seizes it as a trophy, but any such theft draws the attention and ire of the Prince of Demons. Angry at its master's defeat, the [Wand of Orcus](03.PlayerLog&Handouts/Mechanics/CLI/items/wand-of-orcus.md) tries to attune itself to the first willing creature other than Demogorgon that touches it. The attunement is instantaneous, allowing the wand's properties to be used during the battle.
...
The characters' continuing adventures could involve further cooperation with [Vizeran DeVir](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/vizeran-devir-oota.md) (if he survives) or delving deeper into the Underdark for legendary weapons or magic. The characters might even venture out into the other planes of existence with the aid of Araumycos or the librarians of Gravenhollow, seeking allies, lore, and resources to combat the demon lords and return them to the Abyss.
...
The fate of Gromph Baenre, instigator of chaos and Vizeran's rival, remains a mystery. If he yet lives, his role in recent events earns him many new enemies. Matron Mother [Quenthel Baenre](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/quenthel-baenre-oota.md) handpicks a new Archmage of Menzoberranzan to replace her troublesome brother, knowing Gromph will not be found until he chooses to reappear.
