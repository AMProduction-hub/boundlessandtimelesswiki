...
![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/out-of-the-abyss/img/099-ooa14-01.webp#center)
...
Twice each day that the party spends in the Labyrinth (whether traveling or resting), roll a `d20` and consult the Labyrinth Encounters table to determine what, if anything, they encounter. This table replaces the random encounter tables in chapter 2 for as long as the party remains in the Labyrinth.
...
This long-bodied reptile is either prowling a tunnel or resting in a cave when the characters encounter it. The [behir](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/behir.md) retreats if reduced to 80 or fewer hit points.

#### Flumphs

This cloister of [flumphs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/flumph.md) feeds on the psychic energy they detect from a nearby [mind flayer](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/mind-flayer.md) that has enslaved `2d4` [quaggoths](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/quaggoth.md). The flumphs warn adventurers who communicate with them about the nearby threats, but it is up to the characters whether they wish to engage those threats.

#### Gnoll Pack

![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/out-of-the-abyss/img/100-ooa14-02.webp#center)

A [gnoll fang of Yeenoghu](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/gnoll-fang-of-yeenoghu.md) named [Kurr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kurr-oota.md) made his way into the Labyrinth shortly after Yeenoghu was summoned to the Underdark. [Kurr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kurr-oota.md) brought with him a pack of hyenas and had them feast on the corpses of his slain victims. This heinous act transformed the hyenas into ten [gnolls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/gnoll.md). [Kurr's](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kurr-oota.md) pack now prowls the Labyrinth in search of Yeenoghu, slaughtering anything and anyone they happen upon.

Unknown to his gnoll progeny, [Kurr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kurr-oota.md) has succumbed to a form of madness that quells his feral demeanor. He's lost his appetite for carnage and is overcome with guilt for all of the creatures he has slain. When his pack happens upon the party, he sends his gnolls into battle but doesn't partake of the violence, hoping that the characters slaughter his brethren. Once they are dead, [Kurr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kurr-oota.md) bows his head solemnly, begs Yeenoghu's forgiveness (first in his own language and then in Abyssal), and then throws himself at the party's mercy.

[Kurr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kurr-oota.md) is suffering from a form of indefinite madness (see ""Madness"" in chapter 8 of the *Dungeon Master's Guide*) which, if cured, reverts him to a typically feral gnoll. While afflicted with madness, [Kurr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kurr-oota.md) can't bring himself to kill any living creature except in self-defense. If the characters spare his life, [Kurr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kurr-oota.md) can act as a guide, for he has explored a great deal of the Labyrinth and can lead the characters along a safe route to an Underdark shanty town (see "Filthriddens"). Characters have no random encounters if they follow [Kurr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kurr-oota.md) along this route, although they periodically stumble upon the corpses and bones of Underdark creatures slain by his gnolls.

The encounter with [Kurr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kurr-oota.md)'s pack occurs only once. Any subsequent occurrence of this encounter is with a pack of `3d6` [gnolls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/gnoll.md). These gnolls came to the Underdark with Yeenoghu. They cackle and scream the demon lord's name as they tear into their prey.

#### Grells

The [grells](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/grell.md) drop from an overhead shaft to feed.

#### Hezrous

These demons are tearing apart an iron ore cart, a rusted section of mining track, or some other old fixture. Party members can attempt to slip past the demons without arousing their attention. Doing so requires a successful DC 11 Dexterity ([Stealth](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Stealth)) check. On a failed check, the [demons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/hezrou.md) detect the party member and attack.

#### Manes

Characters can hear the mewling of this vile mob long before it appears. The [manes](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/manes.md) scour the Labyrinth for easy prey and move like a tide of putrid flesh.

#### Minotaurs

These [minotaurs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/minotaur.md) roams the Labyrinth, slaying creatures in the name of Baphomet.

#### Monodrone

This modron has become separated from its fellows (see "March to Nowhere"), and there is a 75 percent chance that it is looking to rejoin them. If the characters can understand its language, the [monodrone](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/monodrone.md) repeatedly says, "We are on the march!"
...
These [quaggoths](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/quaggoth.md) are hungry and attack the party regardless of its size. If there are five or more quaggoths in the group, one of them is a quaggoth thonot (see the "Variant: Quaggoth Thonot" sidebar in the "Quaggoth" entry of the *Monster Manual*). If the thonot dies, the other quaggoths immediately break off their attack and begin feasting on the thonot's remains, hoping to gain its psionic power.

#### Shriekers

The [shriekers](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/plant/shrieker.md) sound off when bright light or a creature is within 30 feet of them. Their shrieking has a 75 percent chance of attracting other monsters, in which case roll again on the Labyrinth Encounters table, treating another shrieker encounter as "no encounter."
...
No ordinary structure, the tower is a [Daern's instant fortress](03.PlayerLog&Handouts/Mechanics/CLI/items/daerns-instant-fortress.md) (see chapter 7, ""Treasure"," of the *Dungeon Master's Guide*). Made entirely of adamantine, the two-story tower has remained sealed since its last owner retreated inside and locked the door behind her—but not before a pair of shadow demons slipped in as well. The demons killed the owner and left her remains on the first floor. The tower can't be tipped over or otherwise moved from its position, and the arrow slits on each level are too narrow for anything bigger than a Tiny creature to squeeze through.

A character can learn the tower's command words by casting an [identify](03.PlayerLog&Handouts/Mechanics/CLI/spells/identify.md) spell on it. The command word to open the front door or the trap door on the roof is "mimsy." The command word to transform the tower into a one-inch metal cube is "brillig," but speaking it has no effect since the shadow demons are still inside. To return the tower to its cube form, the adventurers must first empty it of any creatures.

Four [gargoyles](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/gargoyle.md) perch atop the tower. They remain motionless as the characters enter the cavern, attacking only if anyone attempts to enter, climb, or damage the tower.

This cavern's rough floor has been flattened where the tower stands, while the floor behind the tower has collapsed into a shaft 300 feet deep and 100 feet in diameter. Several tunnels branch off from the rough-walled shaft at various points, allowing the characters to continue their journey after climbing down. They can move around the tower easily if they wish to ignore it.
...
Searching through the remains turns up two empty potion bottles and a [potion of mind reading](03.PlayerLog&Handouts/Mechanics/CLI/items/potion-of-mind-reading.md).
...
The two [shadow demons](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/fiend/shadow-demon.md) lurk in the darkness of this room and attack the first character who enters, likely taking their prey by surprise.

### Battlements

The top of the tower features an open space surrounded by a crenelated wall. If the four [gargoyles](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/elemental/gargoyle.md) have not yet attacked the adventurers, they do so here.
...
This wretched gnoll is named [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md). Thanks to treachery he committed against his kind, the minotaurs spared his life. However, their mercy comes with regular abuse and torment. The gnoll now sees himself as a loyal and willing servant of the brutes, and he is eager to lead gnolls and anyone else to his minotaur masters.

[Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md) is a [gnoll](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/gnoll.md) with the following modifications:

- [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md) has 11 hit points.  
- He has a walking speed of 25 feet.  
- He has disadvantage on Wisdom checks and Wisdom saving throws because of the physical and mental abuse he has suffered. A [lesser restoration](03.PlayerLog&Handouts/Mechanics/CLI/spells/lesser-restoration.md) spell rids him of these effects.  

Cringing and mewling, [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md) approaches the party with arms out and head down. He speaks in both Gnoll and Abyssal. If the characters can't understand him, he pantomimes helpful gestures and beckons them to follow him.

> [!readaloud] 
> 
> "Powerful masters," the gnoll whines. "You honor us by your presence. Seek you passage through the maze? The Spiral of the Great Horned King? I can help. Yes. Trust [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md) and he will see you through the maze, he will."
^4aa

Any aggressive action sends [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md) skittering back into the maze and to his masters. If the characters capture him, he shrieks and screams, drawing one [minotaur](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/minotaur.md) to investigate the racket.

Accepting [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md)'s offer transforms the cringing gnoll into a dutiful guide. He leads the characters through passage after passage, choosing directions seemingly at random until the characters encounter the minotaurs. If the battle turns against the minotaurs, [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md) flees.

If the adventurers show pity or kindness, [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md) becomes confused, as he has never experienced such things. A character can befriend the gnoll with a successful DC 20 Charisma ([Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion)) check. If any character uses magical healing on [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md), the check is automatically successful.

If the characters befriend [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md), he warns them to turn back, flee, and never return. He says his masters are vile minotaurs who wait in the maze, eager to kill all trespassers. If asked, [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md) explains that the minotaurs spared his life in exchange for leading travelers into the maze. If the characters insist on entering the maze, [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md) goes with them, trying to keep his new friends safe. If the characters defeat the minotaurs and move deeper into the Labyrinth, [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md) can accompany them as a follower and guide, giving the characters advantage on Wisdom ([Survival](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Survival)) checks to avoid becoming lost in the Labyrinth.

### Into the Maze

![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/out-of-the-abyss/img/101-ooa14-03.webp#center)
...
When the characters enter the maze, have them choose their pace (fast, normal, or slow). It takes 1 hour to navigate the maze at a fast pace, 2 hours at a normal pace, or 3 hours at a slow pace. Halfway through the journey, the navigator must make a DC 15 Wisdom ([Survival](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Survival)) check. A fast pace imposes a −5 penalty to the check. A slow pace grants a +5 bonus. On a success, the characters find their way out. On a failure, the characters must start the journey from the beginning.

The longer it takes the characters to navigate through the maze, the greater the risk of encountering the creatures within it. Every 30 minutes the party spends in the maze, roll a `d20` and consult the Maze Encounters table to see what, if anything, the characters meet.

If [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md) was attacked by the characters and fled into the maze, he does his best to bring threats down on them, in which case roll two d20s and take the higher result. If [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md) is friendly to the party and accompanying them, he tries to steer them away from danger, in which case roll two d20s and take the lower result.
...
A frenzied group of `2d4` [gnolls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/gnoll.md) is lost in the maze. The gnolls attack any creatures they see.

#### Minotaurs

These bloodthirsty [minotaurs](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/monstrosity/minotaur.md) are hunting gnolls but attack any other creatures they happen upon.

##### Treasure

The first time the characters fight the minotaurs, one of them carries 32 ep and 22 cp in a pouch made from a human face with the eyes and mouth sewn shut. The second time the characters encounter minotaurs, one of them wears silver caps (worth 25 gp each) on the ends of its horns.

## Filthriddens

Filthriddens was, until recently, a shanty town of Underdark exiles and refugees. The greatest threat to inhabitants—apart from food shortages—was the minotaurs that raided the settlement from time to time, dragging off screaming prisoners to meet a grisly fate. The recent arrival of the demon lords changed things. A group of minotaurs was on its way to raid Filthriddens when Yeenoghu and a pack of his frenzied followers tore through this part of the Labyrinth, catching the minotaurs off guard and slaughtering them. The sole witness to this carnage was [Grisha](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/grisha-oota.md), an escaped human slave of the drow. Yeenoghu's intercession saved him from the minotaurs.

Yeenoghu and his pack moved on, but [Grisha](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/grisha-oota.md) took the head of a slain minotaur and brought it back to Filthriddens. The skull became a talisman as [Grisha](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/grisha-oota.md) named Yeenoghu as the new protector and patron of Filthriddens. Residents who opposed this dark worship were exiled or executed in short order. The cult of Yeenoghu now controls the settlement, and [Grisha](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/grisha-oota.md) rules with an iron fist. He senses the power of Yeenoghu in all things—and particularly in the way in which cultists have begun to rise as undead ghouls after death.

### Grisha's Greeting

Filthriddens lies 48 miles from the Spiral of the Horned King, deeper in the Labyrinth. [Kurr](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/kurr-oota.md) (see "Random Encounters") or [Gash](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/gash-oota.md) (see "Gash the Gnoll") might lead the characters here if they don't find it on their own.
...
[Grisha](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/grisha-oota.md) (see appendix C) can recount the history of Filthriddens and how Yeenoghu saved its denizens from the oppression of the minotaurs. He can also reveal how he spent years as a slave of the drow. [Grisha](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/grisha-oota.md) seeks new disciples to grow his cult's power.

Twelve [cultists](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/cultist.md) (a mix of shield dwarves, halflings, and humans) support [Grisha](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/grisha-oota.md) if a fight breaks out. Ten of them are hidden in the shanties. Two more stand next to a zurkhwood door, beyond which lies a small side cave where cultists who have died and risen as undead are kept. If battle erupts, the cultists open the door and release six [ghouls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/undead/ghoul.md). The ghouls ignore the cultists as long as there are other creatures to feed on.
...
As the party travels deeper into the Labyrinth, any character with a passive Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) score of 15 or higher hears the sounds of marching feet off in the distance. To investigate the source of the noise, the characters must travel for 15 minutes through cramped tunnels requiring as much climbing as crawling. At the end of this time, the adventurers emerge onto a shelf 15 feet up the wall of a broad, straight tunnel some 20 feet high.
...
Twelve [monodrones](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/monodrone.md) and a [tridrone](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/construct/tridrone.md) have been wandering the Labyrinth since the last Great Modron March. The modrons became separated from their fellows and trapped here. Unable to find their way back to Mechanus, the modrons have been pressing on (and on), knowing that they must find their way back or be destroyed in the process.
...
> 
> On the shores of an underground lake, a pack of frenzied gnolls and hyenas surrounds a demon standing nearly twenty feet tall, with massive arms, clawed hands, cloven hooves, and the head of a bull. This is a goristro, whose heart [Vizeran DeVir](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/vizeran-devir-oota.md) has instructed you to claim.
> 
...
Any adventurer witnessing this horrible tableau must succeed on a DC 12 Wisdom saving throw or gain one level of madness (see "Madness" in chapter 2). If this causes the character to suffer a bout of indefinite madness, determine the nature of the madness using the Madness of Yeenoghu table in appendix D.

[Yeenoghu](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/npc/yeenoghu-mpmm.md) (see appendix D) has been wandering the Underdark since he was first summoned, and the adventurers have run across him and his pack. The characters' only advantage at this moment is that they haven't yet been detected. Considering their level at this stage of the adventure, the players might be creating new characters quite soon if they dare confront the demon lord.

If the characters stay hidden and observe, Yeenoghu leaves in short order. He is restless and eager for new prey. Yeenoghu gathers up most of the gnolls and hyenas and leads them down a tunnel on the right side of the cavern. Eight [gnolls](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/gnoll.md) led by a [gnoll pack lord](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/humanoid/gnoll-pack-lord.md) remain in the cavern, feasting on the goristro's corpse.
...
The close brush with Yeenoghu pays dividends to the adventurers by delivering two components of Vizeran's ritual into their hands. The first is the heart of the goristro, which the characters can remove from its corpse. The massive heart is the size of a small trunk and weighs nearly one hundred pounds. Any characters close to it while it is being transported imagine that they can occasionally hear it beating. A character who carries the heart, even in a [bag of holding](03.PlayerLog&Handouts/Mechanics/CLI/items/bag-of-holding.md) or similar extradimensional space, makes saving throws against madness with disadvantage.

The second component takes the form of a few spatters of a demon lord's blood. A successful DC 10 Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) check finds some of Yeenoghu's black blood on the fallen goristro's horns.
...
This chamber houses the [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified) remains of eight fallen angels, condemned by the gods to pass the ages in the dark depths. Each appears to have been carved from stone in some position of fear, suffering, hatred, or longing. Each statue is spotted with lichen and marred by mineral deposits, which have crystallized out of the water dripping from the ceiling over uncounted years.

Even though they are transformed into stone statues, the fallen angels remain very much alive, their [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified) bodies having become prisons for their minds and souls. They remember who they were. They know what they did and why they are here. They know everything transpiring around them. Yet they can do nothing. They are trapped forever, and the isolation, darkness, and endless torment of their fate have driven them mad. No spell can undo the angels' curse or free them from their [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified) state.

![](03.PlayerLog&Handouts/Mechanics/CLI/adventures/out-of-the-abyss/img/102-ooa14-04.webp#center)
...
This angel appears to be reaching out as if offering something. A character making contact with the angel must succeed on a DC 15 Charisma saving throw or become [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed) for 1 minute.

While the character is [charmed](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Charmed), the angel has a telepathic link with the character as long as it and the character remain on the same plane of existence. The angel issues commands to the character, and the character does its best to obey those commands if it is conscious. The angel typically commands a character to kill, maim, rob, or otherwise harm its companions.
...
A successful DC 15 Intelligence ([Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana)) check is needed to activate the device by puzzling out its array of gears and levers. It then takes 12 rounds for the engine to "align itself" and activate its magical effect. If an initiative order hasn't already been established by the time the engine activates, have everyone in the party roll initiative.
...
The engine shuts down if any part of it comes into contact with an [antimagic field](03.PlayerLog&Handouts/Mechanics/CLI/spells/antimagic-field.md) or if it is targeted by a successful [dispel magic](03.PlayerLog&Handouts/Mechanics/CLI/spells/dispel-magic.md) (DC 19). Otherwise, it can only be shut down by a [wish](03.PlayerLog&Handouts/Mechanics/CLI/spells/wish.md) spell or divine intervention.
...
| 11–15 | The engine makes a loud "WHAAAH" sound until the start of its next turn. For as long as the sound lasts, the engine projects an [antimagic field](03.PlayerLog&Handouts/Mechanics/CLI/spells/antimagic-field.md) (as the spell) around itself. |
| 16–19 | The hollow interior of the engine flickers with crimson light until the end of its turn, whereupon one dead character or NPC of the DM's choice is restored to life, as though subjected to a [resurrection](03.PlayerLog&Handouts/Mechanics/CLI/spells/resurrection.md) spell. The revived creature appears in a safe, unoccupied space within 120 feet of the engine. |
...
| 23–27 | The engine crackles with lightning. All creatures within 30 feet of the engine must make a DC 18 Dexterity saving throw or take `10d6` lightning damage. A target made primarily of metal or wearing metal armor has disadvantage on its saving throw. |
| 28–32 | The engine hums until the end of its turn, at which point a [green slaad](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/aberration/green-slaad.md) appears in a safe space within 120 feet of the engine. The slaad rolls initiative and, on its turn, attacks any other creatures it sees. |
| 33–35 | The engine groans loudly and turns each creature within 120 feet of it [invisible](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Invisible). A creature's invisibility lasts until it attacks or casts a spell. |
...
| 40–43 | Multicolored arcs of light play across the surface of the engine, which casts a [polymorph](03.PlayerLog&Handouts/Mechanics/CLI/spells/polymorph.md) spell (save DC 18) on each creature within 20 feet of it. Any creature that fails the saving throw is polymorphed into a [flying snake](03.PlayerLog&Handouts/Mechanics/CLI/bestiary/beast/flying-snake.md). |
...
| 58–60 | The engine flickers with blue light and casts [faerie fire](03.PlayerLog&Handouts/Mechanics/CLI/spells/faerie-fire.md), targeting all creatures within 20 feet of it (save DC 18). The spell's effect has a duration of 1 minute. |
| 61–66 | The engine spews harmless, multicolored sparks until the start of its next turn. |
| 67–70 | The engine emits a flash of violet light. Each creature within 20 feet of the engine must succeed on a DC 18 Constitution saving throw or be [petrified](03.PlayerLog&Handouts/Mechanics/CLI/rules/conditions.md#Petrified) until the engine's next turn. |
