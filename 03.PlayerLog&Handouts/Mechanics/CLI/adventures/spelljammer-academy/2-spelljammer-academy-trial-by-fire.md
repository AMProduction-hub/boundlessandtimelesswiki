...
![](012-02-001-o-sja02-splash.webp#center)
...
![](013-02-002-o-winston-ryeback.webp#center)
...
- **Words of Encouragement.** A character offering Miken advice to boost his confidence can make a DC 12 Charisma ([Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion)) check. If successful, his spirits are lifted, and you can jump to part 2 of the adventure.  
- **Problem Solving.** A character asking Miken about his studies kicks off a conversation about spelljamming, taking his mind off his troubles. If that character succeeds on a DC 12 Intelligence ([Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana)) check, Miken's spirits are lifted, and you can jump to part 2 of the adventure.  
- **Feeling the Vibe.** A character who speaks to Miken's crewmates can encourage them to reveal their own insecurities regarding the upcoming training exercises to put Miken's mind at ease. A successful DC 12 Charisma ([Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion)) check persuades the cadets to call Miken over to their table, bolstering his spirits, and you can jump to part 2 of the adventure.  

![](014-02-003-o-miken-haverstance.webp#center)
...
![](015-02-004-o-boatswain-tarto.webp#center)
...
![](016-02-005-o-sarthe-abizjn.webp#center)
...
- **Illusory Wards.** Characters can't sense that they are in an illusion, nor can the illusion be dispelled. The [detect magic](detect-magic.md) and [dispel magic](dispel-magic.md) spells don't register or disrupt the magic of the illusion, nor of the creatures or objects it creates.  
- **Damage.** Any character who is reduced to 0 hit points by the simulation falls [unconscious](conditions.md#Unconscious) but isn't dying. The character remains [unconscious](conditions.md#Unconscious) until the simulation ends, at which point the character awakens and gains 1 level of [exhaustion](conditions.md#Exhaustion) from lingering psychic shock.  
...
![](017-02-006-o-mister-blip.webp#center)
...
> 
> **Captain**: Wisdom ([Survival](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Survival)) or Charisma ([Persuasion](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Persuasion))
> 
> **Shipmate**: Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) or Dexterity ([Acrobatics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Acrobatics))
> 
> **Spelljammer**: Intelligence ([Investigation](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Investigation)) or Wisdom ([Survival](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Survival))
...
> **Shipmate**: Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) or Dexterity ([Acrobatics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Acrobatics))
> 
> **Spelljammer**: Intelligence ([Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana)) or Wisdom ([Survival](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Survival))
...
> **Shipmate**: Strength ([Athletics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Athletics)) or Dexterity ([Acrobatics](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Acrobatics))
> 
> **Spelljammer**: Intelligence ([Arcana](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Arcana)) or Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception))
> 
...
The wreckage is surrounded by a cloud of silvery dust particles that reduce visibility. After pulling alongside the wreck, characters searching for the logbook must make a DC 16 Wisdom ([Perception](03.PlayerLog&Handouts/Mechanics/CLI/rules/skills.md#Perception)) check, spotting it if successful. The logbook lays amid debris from the captain's cabin, all of which bobs in the derelict's gravity plane. The characters repeat this check each round until the logbook is spotted.

#### Retrieving the Logbook

The next, more difficult task is obtaining the book. While the debris rests in the ship's gravity plane, it's not exactly solid ground, and disturbing it could make finding the log difficult. This is a great opportunity for the players' ingenuity and creativity to shine. Let them come up with their own way of solving the problem, whether it's using [mage hand](mage-hand.md), tying a rope around a character's waist and leaping out toward the logbook, or other similar efforts—assigning a DC 13 check using an ability and skill that you deem appropriate. If successful, they are able to retrieve the logbook.
...
![](018-02-007-o-swashbuckling-splash.webp#center)
...
Two [shadows](shadow.md)—former crew members of the flying fish ship that lie strewn amid the asteroids—are attracted to the battle as it unfolds. At the start of the fourth round of combat, they appear at the stern of the characters' ship and attack the nearest creatures. Roll a `d20` for the shadows' initiative, again with no modifier.
...
![](020-02-009-o-scoring-sheet-handout.webp#center)
