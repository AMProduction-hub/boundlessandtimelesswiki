...
> [!infobox]
> # `=this.file.name`
> ![[themothers.png|cover hmedium]]
> [[themothers.png|Show To Players]]
> ###### Basic Information
> Type |  Stat |
> ---|---|
> Home | `=this.Location` |
...
>   "desc": "Her amulet can store one spell of up to 3rd level, which she can cast without expending a spell slot. She may change the stored spell during a long rest."
>
> "actions":
> - "name": "Eldritch Blast"
>   "desc": "Ranged Spell Attack: +7 to hit, range 120 ft., one creature. Hit: 10 (1d10 + 5) force damage. She fires two beams."
> - "name": "Shadowbind (Recharge 5–6)"
>   "desc": "Selaveth targets up to three creatures within 60 ft. They must succeed on a DC 15 Strength saving throw or be restrained by shadowy tendrils for 1 minute. They may repeat the save at the end of each of their turns."
>
> "source":
> - "Homebrew"
