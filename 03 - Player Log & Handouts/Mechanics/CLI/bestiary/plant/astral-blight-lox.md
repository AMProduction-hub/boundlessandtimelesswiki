...
---
# [Astral Blight](03 - Player Log & Handouts\Mechanics\CLI\bestiary\plant/astral-blight-lox.md)
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 10 ft., one target. Hit: 6\
    ...
    \ (escape DC 13). Until this grapple ends, the target takes 3 (1d6) cold damage\
    \ at the start of each of its turns. The blight has two vines, each of which can\
    \ grapple one creature."
  "name": "Heat-Draining Vine"
"source":
- "LoX"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/plant/token/astral-blight-lox.webp"
```
^statblock