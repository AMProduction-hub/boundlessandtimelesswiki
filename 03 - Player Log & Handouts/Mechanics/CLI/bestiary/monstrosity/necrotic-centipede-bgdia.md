...
---
# [Necrotic Centipede](03 - Player Log & Handouts\Mechanics\CLI\bestiary\monstrosity/necrotic-centipede-bgdia.md)
...
- "desc": "Melee Weapon Attack: +11 to hit, reach 10 ft., one target. Hit: 40\
    ...
    \ is a creature, it is [grappled](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
...
- "desc": "The centipede makes one bite attack against a Medium or smaller creature\
    ...
    \ it has total cover against attacks and other effects outside the centipede,\
    \ and it takes 21 (6d6) acid damage at the start of each of the centipede's\
    \ turns.\n\nIf the centipede takes 30 damage or more on a single turn from a creature\
    \ inside it, the centipede must succeed on a DC 15 Constitution saving throw at\
...
"source":
- "BGDIA"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/monstrosity/token/necrotic-centipede-bgdia.webp"
```
^statblock