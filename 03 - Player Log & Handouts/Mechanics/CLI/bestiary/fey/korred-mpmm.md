...
aliases: ["Korred"]
---
# [Korred](03 - Player Log & Handouts\Mechanics\CLI\bestiary\fey/korred-mpmm.md)
...
Korreds prefer to keep their own company but occasionally consort with creatures of elemental earth such as [galeb duhr](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/elemental/galeb-duhr.md). They often gather with other korreds to perform ceremonial dances, beating out rhythms on stone with their hooves and clubs. In the depths of the Material Plane, korreds typically flee from other creatures, but they become aggressive when they feel insulted or are annoyed by the sounds of mining.
...
- "desc": "The korred casts one of the following spells, requiring no spell components\
    ...
    \ (as an action), [meld into stone](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/meld-into-stone.md),\
    \ [stone shape](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/stone-shape.md)\n\
    \n1/day: [Otto's irresistible dance](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/ottos-irresistible-dance.md)"
  "name": "Spellcasting"
- "desc": "The korred has advantage on Dexterity ([Stealth](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/skills.md#Stealth))\
...
- "desc": "The korred has at least one 50-foot-long rope woven out of its hair. The\
    ...
    \ succeed on a DC 13 Dexterity saving throw or become [grappled](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Grappled)\
    \ by the rope (escape DC 13). Until this grapple ends, the target is [restrained](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Restrained).\
    \ The korred can use a bonus action to release the target, which is also freed\
    \ if the korred dies or becomes [incapacitated](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Incapacitated).\n\
...
- "MPMM"
- "VGM"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/fey/token/korred-mpmm.webp"
```
^statblock
