...
aliases: ["Forlarren"]
---
# [Forlarren](03 - Player Log & Handouts\Mechanics\CLI\bestiary\fey/forlarren-mff.md)
...
A forlarren in its fey aspect demonstrates self-destructive urges that reflect the inherent tension in its nature. That aspect might drive it to drink itself nearly to death, or to throw itself into caring for others with such relentless energy that it eventually collapses from [exhaustion](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/rules/conditions.md#Exhaustion). Unfortunately, when it reaches that breaking point, its diabolical nature asserts itself, and it remains in this scheming, dominating mindset until its plans are foiled and it faces defeat. Then, overwhelmed with fear and shame, the forlarren's diabolical nature fades and its fey aspect emerges once again.
...
- "desc": "The forlarren's innate spellcasting ability is Charisma (spell save DC\
    ...
    \nAt will: [expeditious retreat](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/expeditious-retreat.md),\
    ...
    \n3/day each: [aid](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/spells/aid.md),\
...
"source":
- "MFF"
"image": "03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/bestiary/fey/token/forlarren-mff.webp"
```
^statblock