...
Lamprey ships are antiquated, being among the oldest spelljamming ships still in use. [Psurlons](psurlon-bam.md) (see "Boo's Astral Menagerie") are particularly fond of them.
...
```ad-statblock
title: Lamprey Ship
![](03%20-%20Player%20Log%20&%20Handouts/Mechanics/CLI/vehicles/token/lamprey-ship-aag.webp#token)
